...
const categories = ['Popular', 'Destinations', 'Services', 'Events'];
        ...
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
          <View style={styles.topBar}>
            <View style={styles.brandRow}>
              <View style={styles.logoFrame}><Image source={require('./assets/trans-globe-logo.png')} style={styles.logo} resizeMode="contain" accessibilityLabel="Trans Globe logo" /></View>
          ...
          <View style={styles.searchWrap}>
            ...
            <TextInput value={search} onChangeText={setSearch} placeholder="Find your next study destination" placeholderTextColor="#8A96A8" accessibilityLabel="Find your next study destination" style={styles.heroSearchInput} />
          </View>
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.categoryRow}>
            {categories.map((category) => <Pressable key={category} accessibilityRole="button" accessibilityLabel={`${category} category`} onPress={() => setSelectedCategory(category)} style={({ pressed }) => [styles.categoryChip, selectedCategory === category && styles.categoryChipSelected, pressed && styles.pressed]}><Text style={[styles.categoryText, selectedCategory === category && styles.categoryTextSelected]}>{category}</Text></Pressable>)}
          </ScrollView>

          <ImageBackground source={require('./assets/student-guidance.jpg')} style={styles.hero} imageStyle={styles.heroImage} resizeMode="cover">
...
const styles = StyleSheet.create({
  ...
  scrollContent: { paddingHorizontal: 20, paddingTop: 14, paddingBottom: 24, maxWidth: 900, width: '100%' as const, alignSelf: 'center' },
  ...
  logoFrame: { width: 42, height: 42, borderRadius: 14, backgroundColor: colors.white, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: colors.line }, logo: { width: 34, height: 34 },
  ...
  hero: { minHeight: 232, borderRadius: 24, overflow: 'hidden', backgroundColor: colors.navy, marginBottom: 28, paddingBottom: 14 }, heroImage: { opacity: 0.22 } as ImageStyle, heroShade: { ...StyleSheet.absoluteFill, backgroundColor: 'rgba(14,35,74,0.56)' }, heroContent: { padding: 23, maxWidth: 540 }, heroTag: { alignSelf: 'flex-start', borderRadius: 99, backgroundColor: 'rgba(255,255,255,0.17)', paddingHorizontal: 10, paddingVertical: 6, marginBottom: 12 }, heroTagText: { color: '#FFD0D2', fontSize: 9, letterSpacing: 1.1, fontWeight: '800' }, heroTitle: { color: colors.white, fontSize: 29, lineHeight: 33, fontWeight: '800', letterSpacing: -0.7 }, heroCopy: { color: '#D4DEEF', fontSize: 13, lineHeight: 19, marginTop: 10, maxWidth: 390 },
  primaryButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', alignSelf: 'flex-start', minHeight: 46, paddingHorizontal: 16, borderRadius: 13, backgroundColor: colors.red, marginTop: 17, gap: 12 }, primaryButtonText: { color: colors.white, fontSize: 13, fontWeight: '800' }, buttonArrow: { color: colors.white, fontSize: 18, lineHeight: 18 }, heroStat: { alignSelf: 'flex-end', marginRight: 18, backgroundColor: colors.white, borderRadius: 13, paddingVertical: 9, paddingHorizontal: 12 }, heroStatValue: { color: colors.navy, fontSize: 14, fontWeight: '800' }, heroStatLabel: { color: colors.muted, fontSize: 9, marginTop: 2 },
  ...
  searchWrap: { flexDirection: 'row', alignItems: 'center', height: 50, borderRadius: 16, borderWidth: 1, borderColor: colors.line, backgroundColor: colors.white, paddingHorizontal: 14, marginBottom: 12 }, searchGlyph: { color: colors.navy, fontSize: 23, lineHeight: 24, marginRight: 8 }, heroSearchInput: { flex: 1, height: 48, color: colors.ink, fontSize: 13 }, categoryRow: { gap: 8, paddingBottom: 4, marginBottom: 18 }, categoryChip: { minHeight: 40, borderRadius: 20, borderWidth: 1, borderColor: colors.line, backgroundColor: colors.white, justifyContent: 'center', paddingHorizontal: 16 }, categoryChipSelected: { backgroundColor: colors.red, borderColor: colors.red }, categoryText: { color: colors.muted, fontSize: 12, fontWeight: '700' }, categoryTextSelected: { color: colors.white }, toolGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10, marginBottom: 27 }, toolCard: { width: '48.8%', minHeight: 126, backgroundColor: colors.white, borderRadius: 17, borderWidth: 1, borderColor: colors.line, padding: 14 }, toolMark: { width: 36, height: 36, borderRadius: 12, backgroundColor: '#EAF2FF', alignItems: 'center', justifyContent: 'center', marginBottom: 12 }, toolMarkOrange: { backgroundColor: '#FFF3DE' }, toolMarkGreen: { backgroundColor: '#E6F8F0' }, toolMarkPurple: { backgroundColor: '#F0EBFF' }, toolMarkText: { color: colors.navy, fontSize: 11, fontWeight: '800' }, toolTitle: { color: colors.ink, fontSize: 13, fontWeight: '800', lineHeight: 17 }, toolCaption: { color: colors.muted, fontSize: 10, marginTop: 5 },
  destinationRow: { gap: 12, paddingBottom: 4, marginBottom: 25 }, destinationCard: { width: 214, height: 145, borderRadius: 18, overflow: 'hidden', backgroundColor: colors.navy }, destinationImage: { ...StyleSheet.absoluteFill } as ImageStyle, destinationOverlay: { ...StyleSheet.absoluteFill, backgroundColor: 'rgba(14,35,74,0.30)' }, destinationText: { position: 'absolute', left: 14, right: 10, bottom: 13 }, destinationName: { color: colors.white, fontSize: 17, fontWeight: '800' }, destinationDetail: { color: '#E4ECF8', fontSize: 10, marginTop: 3 },
