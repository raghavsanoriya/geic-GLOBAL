...
<head>
    ...
    <style>
        ...
        .pagination{display:flex;justify-content:flex-end;padding:14px 20px;overflow-x:auto}.pagination nav{display:flex;align-items:center;gap:4px}.pagination nav>div{display:flex;align-items:center;gap:4px}.pagination nav p{margin:0;color:var(--admin-muted);font-size:11px}.pagination nav a,.pagination nav span{display:inline-flex;min-width:34px;height:34px;align-items:center;justify-content:center;padding:0 9px;border:1px solid #dfe6f0;border-radius:8px;color:#52627d;font-size:11px;line-height:1;white-space:nowrap}.pagination nav a:hover{border-color:var(--admin-primary);background:var(--admin-primary-soft);color:var(--admin-primary-dark)}.pagination nav span[aria-current="page"]{border-color:var(--admin-primary);background:var(--admin-primary);color:#fff}.pagination nav svg{display:block;width:16px!important;height:16px!important;max-width:16px;max-height:16px}.pagination nav span[aria-disabled="true"]{color:#aeb9c9;background:#f8faff}
