...
<style>
    ...
    .tg-emi{display:grid;grid-template-columns:minmax(0,.95fr) minmax(300px,1.05fr);gap:22px}.tg-emi__form,.tg-emi__result{padding:30px}.tg-emi__form h2,.tg-emi__result h2{margin:0;color:var(--tool-navy);font-size:25px;letter-spacing:-.03em}.tg-field{margin-top:20px}.tg-field label{display:flex;justify-content:space-between;gap:10px;color:var(--tool-navy);font-size:13px;font-weight:700}.tg-field output{color:var(--tool-red);font-weight:800}.tg-field input{width:100%;margin-top:10px;border:1px solid var(--tool-line);border-radius:12px;background:#fff;color:var(--tool-navy);font:inherit;padding:14px 15px}.tg-field input:focus-visible,.tg-tool :is(a,button):focus-visible{outline:3px solid rgba(227,30,36,.28);outline-offset:3px}.tg-field input[type=range]{padding:0;accent-color:var(--tool-red)}.tg-emi__result{display:flex;flex-direction:column;justify-content:center;background:linear-gradient(145deg,#0e2145,#193564);color:#fff}.tg-emi__result h2{color:#fff}.tg-emi__value{margin-top:22px;color:#fff;font-size:clamp(44px,6vw,72px);line-height:1;font-weight:800;letter-spacing:-.06em}.tg-emi__sub{margin-top:10px;color:rgba(255,255,255,.66);font-size:13px}.tg-emi__breakdown{display:grid;grid-template-columns:repeat(2,1fr);gap:10px;margin-top:26px}.tg-emi__breakdown div{padding:15px;border:1px solid rgba(255,255,255,.15);border-radius:14px;background:rgba(255,255,255,.07)}.tg-emi__breakdown strong{display:block;color:#fff;font-size:18px}.tg-emi__breakdown span{display:block;margin-top:3px;color:rgba(255,255,255,.6);font-size:11px}.tg-emi__disclaimer{margin-top:20px;color:rgba(255,255,255,.52);font-size:11px;line-height:1.55}.tg-emi-heading{padding-top:30px;padding-bottom:12px}.tg-emi-heading h2{max-width:820px;margin:10px 0 0;color:var(--tool-navy);font-size:clamp(27px,3.3vw,42px);line-height:1.08;letter-spacing:-.045em}.tg-emi-heading p{max-width:720px;margin:12px 0 0;color:var(--tool-muted);font-size:14px;line-height:1.6}.tg-emi-analysis{padding-top:28px}.tg-emi-analysis__grid{display:grid;grid-template-columns:minmax(0,1.15fr) minmax(330px,.85fr);gap:18px}.tg-emi-chart-card,.tg-emi-table-card{padding:25px}.tg-emi-chart-card__head{display:flex;align-items:center;justify-content:space-between;gap:16px}.tg-emi-chart-card__head h3,.tg-emi-table-card h3{margin:0;color:var(--tool-navy);font-size:19px}.tg-emi-legend{display:flex;flex-wrap:wrap;gap:12px;color:var(--tool-muted);font-size:11px}.tg-emi-legend span{display:inline-flex;align-items:center;gap:5px}.tg-emi-legend i{display:block;width:9px;height:9px;border-radius:3px;background:var(--tool-red)}.tg-emi-legend span:nth-child(2) i{background:#273561}.tg-emi-legend span:nth-child(3) i{background:#a4b1c3}.tg-emi-chart{position:relative;min-height:238px;margin-top:20px;padding:14px 12px 0;border-bottom:1px solid var(--tool-line);background:repeating-linear-gradient(to bottom,transparent 0,transparent 51px,rgba(223,231,240,.7) 52px)}.tg-emi-chart__plot{position:relative;z-index:1;display:grid;grid-template-columns:repeat(var(--emi-years),minmax(10px,1fr));align-items:end;gap:8px;height:200px}.tg-emi-chart__bar{display:flex;height:100%;min-width:0;flex-direction:column;justify-content:flex-end;gap:0}.tg-emi-chart__segment{display:block;width:100%;min-height:2px}.tg-emi-chart__segment--principal{height:calc(var(--emi-principal) * 1%);border-radius:4px 4px 0 0;background:#273561}.tg-emi-chart__segment--interest{height:calc(var(--emi-interest) * 1%);background:var(--tool-red)}.tg-emi-chart__line{position:absolute;z-index:2;inset:14px 12px 24px;pointer-events:none}.tg-emi-chart__line polyline{fill:none;stroke:#9eacbd;stroke-width:3;stroke-linecap:round;stroke-linejoin:round}.tg-emi-chart__years{display:grid;grid-template-columns:repeat(var(--emi-years),minmax(10px,1fr));gap:8px;margin-top:7px;color:var(--tool-muted);font-size:10px;text-align:center}.tg-emi-table-wrap{overflow:auto;margin-top:15px}.tg-emi-table{width:100%;min-width:520px;border-collapse:collapse}.tg-emi-table th,.tg-emi-table td{padding:11px 10px;border-bottom:1px solid var(--tool-line);text-align:right;font-size:11px}.tg-emi-table th{color:#71819b;font-size:10px;letter-spacing:.08em;text-transform:uppercase}.tg-emi-table th:first-child,.tg-emi-table td:first-child{text-align:left}.tg-emi-table td{color:var(--tool-muted)}.tg-emi-table td:first-child{color:var(--tool-navy);font-weight:800}.tg-emi-table tr:last-child td{border-bottom:0}.tg-emi-table__total{font-weight:800;color:var(--tool-red)!important}
    ...
    @media(max-width:991px){.tg-emi-analysis__grid{grid-template-columns:1fr}}
    @media(max-width:767px){.tg-emi-heading{padding-top:20px}.tg-emi-heading h2{font-size:28px}.tg-emi-chart-card,.tg-emi-table-card{padding:18px}.tg-emi-chart-card__head{align-items:flex-start;flex-direction:column}.tg-emi-chart{min-height:218px}.tg-emi-chart__plot{height:180px;gap:4px}.tg-emi-chart__years{gap:4px;font-size:9px}.tg-emi-chart__line{inset:14px 8px 24px}.tg-emi-table th,.tg-emi-table td{padding:10px 8px;font-size:10px}}
    .tg-emi-analysis__grid>*{min-width:0}
    /* Keep the repayment trend inside its chart frame at every viewport. */
    .tg-emi-chart__line{width:calc(100% - 24px);height:calc(100% - 38px);display:block}
    @media(max-width:767px){.tg-emi-chart__line{width:calc(100% - 16px);height:calc(100% - 38px)}}
    </style>
...
<main class="tg-tool">
    ...
    @elseif($isEmi)
        <section class="tg-tool__section tg-emi-heading"><div class="tg-tool__wrap"><span class="tg-tool__eyebrow">Plan your funding</span><h2>EMI calculator for an overseas education loan.</h2><p>See the monthly commitment, total interest and repayment timeline before you compare lenders.</p></div></section>
        ...
        <section class="tg-tool__section tg-tool__section--soft tg-emi-analysis"><div class="tg-tool__wrap"><div class="tg-tool__section-head"><div><span class="tg-tool__eyebrow">Repayment view</span><h2>See how your loan changes year by year.</h2></div><p>Principal, interest and remaining balance are recalculated whenever you move a slider.</p></div><div class="tg-emi-analysis__grid"><div class="tg-tool__card tg-emi-chart-card"><div class="tg-emi-chart-card__head"><h3>Annual repayment split</h3><div class="tg-emi-legend" aria-label="Chart legend"><span><i></i>Interest</span><span><i></i>Principal</span><span><i></i>Balance</span></div></div><div class="tg-emi-chart" data-emi-chart style="--emi-years:10"><div class="tg-emi-chart__plot" data-emi-bars></div><svg class="tg-emi-chart__line" viewBox="0 0 100 100" preserveAspectRatio="none" aria-hidden="true"><polyline data-emi-line points=""></polyline></svg><div class="tg-emi-chart__years" data-emi-years></div></div></div><div class="tg-tool__card tg-emi-table-card"><h3>Annual amortisation</h3><div class="tg-emi-table-wrap"><table class="tg-emi-table"><thead><tr><th>Year</th><th>Principal</th><th>Interest</th><th>EMI</th><th>Balance</th></tr></thead><tbody data-emi-schedule></tbody></table></div></div></div></div></section>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const chart = document.querySelector('[data-emi-chart]');
    const bars = document.querySelector('[data-emi-bars]');
    const yearsEl = document.querySelector('[data-emi-years]');
    const line = document.querySelector('[data-emi-line]');
    const schedule = document.querySelector('[data-emi-schedule]');

    const renderSchedule = (p, annual, years, emi) => {
        let balance = p;
        const rows = [];
        for (let year = 1; year <= years; year++) {
            let principalPaid = 0, interestPaid = 0;
            for (let month = 0; month < 12 && balance > 0.01; month++) {
                const interest = balance * annual / 1200;
                const principalPart = Math.min(balance, Math.max(0, emi - interest));
                interestPaid += interest;
                principalPaid += principalPart;
                balance = Math.max(0, balance - principalPart);
            }
            rows.push({ year, principal: principalPaid, interest: interestPaid, emi: emi * 12, balance });
        }
        const maxAnnual = Math.max(...rows.map(row => row.principal + row.interest), 1);
        chart.style.setProperty('--emi-years', rows.length);
        bars.innerHTML = rows.map(row => `<div class="tg-emi-chart__bar" title="Year ${row.year}: ${money(row.principal)} principal, ${money(row.interest)} interest"><span class="tg-emi-chart__segment tg-emi-chart__segment--interest" style="--emi-interest:${(row.interest / maxAnnual * 100).toFixed(2)}"></span><span class="tg-emi-chart__segment tg-emi-chart__segment--principal" style="--emi-principal:${(row.principal / maxAnnual * 100).toFixed(2)}"></span></div>`).join('');
        yearsEl.innerHTML = rows.map(row => `<span>${row.year}</span>`).join('');
        const maxBalance = Math.max(p, 1);
        line.setAttribute('points', rows.map((row, index) => `${rows.length === 1 ? 50 : index / (rows.length - 1) * 100},${100 - row.balance / maxBalance * 88}`).join(' '));
        schedule.innerHTML = rows.map(row => `<tr><td>Year ${row.year}</td><td>${money(row.principal)}</td><td>${money(row.interest)}</td><td class="tg-emi-table__total">${money(row.emi)}</td><td>${money(row.balance)}</td></tr>`).join('');
    };
    ...
    const update = () => {
        ...
        renderSchedule(p, annual, years, emi);
    };
