...
<!-- Mirrored from lms.rocket-soft.org/bundles/Microsoft-Office-Beginner-to-Expert-Bundle by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:32:15 GMT -->
...
<meta name='robots' content="index, follow, all">
    ...
    <meta name="description" content="Learn to create professional documents with this beginner to advanced Ultimate Microsoft office Course.">
    <meta property="og:description" content="Learn to create professional documents with this beginner to advanced Ultimate Microsoft office Course.">
    <meta name='twitter:description' content='Learn to create professional documents with this beginner to advanced Ultimate Microsoft office Course.'>
...
<!-- Open Graph -->
<meta property='og:title' content='Microsoft Office Beginner to Expert Bundle'>
<meta name='twitter:card' content='summary'>
<meta name='twitter:title' content='Microsoft Office Beginner to Expert Bundle'>
...
<meta property='og:type' content='website'>
    ...
    <title>Microsoft Office Beginner to Expert Bundle | Rocket LMS</title>
    ...
    <link rel="stylesheet" href="../assets/design_1/css/parts/show_course.min.css">
            <link rel="stylesheet" href="../assets/design_1/css/parts/course_cards/row_card_1.min.css">
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
    ...
    <img src="../store/1015/office_bundle_c.jpg" class="course-hero__cover-img img-cover rounded-32" alt="Microsoft Office Beginner to Expert Bundle"/>

    <div class="course-hero__content position-relative z-index-3">
                    <div class="d-flex align-items-center text-white opacity-50">
                <a href="../bundles.html" class="text-white">Course Bundles</a>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
        ...
        <div class="d-flex align-items-center flex-wrap gap-12 mt-4">
            <h1 class="course-hero__title font-32 font-weight-bold text-white text-ellipsis">Microsoft Office Beginner to Expert Bundle</h1>
...
</svg>                    <span class="ml-4 font-12 text-white">Top Seller</span>
                </div>
            </div>
        </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.06 19.39c-.62.42-1.4.77-2.35 1.08l-1.58.52c-3.97 1.28-6.06.21-7.35-3.76L2.5 13.28c-1.28-3.97-.22-6.07 3.75-7.35l1.58-.52c.41-.13.8-.24 1.17-.31-.3.61-.54 1.35-.74 2.2l-.98 4.19c-.98 4.18.31 6.24 4.48 7.23l1.68.4c.58.14 1.12.23 1.62.27zM12.64 8.53l4.85 1.23M11.66 12.4l2.9.74"/>
                ...
                <span class="opacity-50">Courses</span>
            </div>
        </div>
    ...
    <div class="course-tabs-card position-relative">
        ...
        <div class="position-relative d-flex align-items-center gap-20 gap-lg-40 flex-wrap bg-white px-16 px-lg-20 rounded-12 z-index-2 w-100">
            <div class="navbar-item d-flex-center cursor-pointer active" data-tab-toggle data-tab-href="#aboutBundleTab">
                <span class="">About the Bundle</span>
            </div>

            <div class="navbar-item d-flex-center cursor-pointer " data-tab-toggle data-tab-href="#coursesTab">
            ...
            <div class="navbar-item d-flex-center cursor-pointer " data-tab-toggle data-tab-href="#reviewsTab">
    ...
    <div class="custom-tabs-body mt-16">
        ...
        <div class="custom-tabs-content active" id="aboutBundleTab">
            <div class="bg-white py-16 rounded-24">

    
            <div class="px-16">
            <h2 class="font-16 font-weight-bold">About This Bundle</h2>
            ...
            <div class="">
                ...
                <p class="mt-4 font-12 text-gray-500">Check the frequently asked questions about this bundle.</p>
            </div>

                            <div class="accordion p-20 rounded-16 border-gray-200 bg-white mt-16">
                    <div class="accordion__title d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center cursor-pointer" href="#bundleFAQ_52" data-parent="#bundleFAQParent" role="button" data-toggle="collapse">
                            <div class="size-24">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 11.36v-.21c0-.68.42-1.04.84-1.33.41-.28.82-.64.82-1.3 0-.92-.74-1.66-1.66-1.66-.92 0-1.66.74-1.66 1.66M11.995 13.75h.01"/>
                        ...
                        <div class="collapse-arrow-icon d-flex cursor-pointer" href="#bundleFAQ_52" data-parent="#bundleFAQParent" role="button" data-toggle="collapse">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
                    ...
                    <div id="bundleFAQ_52" class="accordion__collapse pt-0 mt-20 border-0 " role="tabpanel">
                        <div class="p-16 rounded-8 border-gray-200 text-gray-500 mt-8">
                            ...
                            <div class="accordion p-20 rounded-16 border-gray-200 bg-white mt-20">
                    <div class="accordion__title d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center cursor-pointer" href="#bundleFAQ_53" data-parent="#bundleFAQParent" role="button" data-toggle="collapse">
                            <div class="size-24">
                                <svg width="24px" height="24px" class="icons text-primary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M17 18.43h-4l-4.45 2.96A.997.997 0 017 20.56v-2.13c-3 0-5-2-5-5v-6c0-3 2-5 5-5h10c3 0 5 2 5 5v6c0 3-2 5-5 5z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 11.36v-.21c0-.68.42-1.04.84-1.33.41-.28.82-.64.82-1.3 0-.92-.74-1.66-1.66-1.66-.92 0-1.66.74-1.66 1.66M11.995 13.75h.01"/>
                        ...
                        <div class="collapse-arrow-icon d-flex cursor-pointer" href="#bundleFAQ_53" data-parent="#bundleFAQParent" role="button" data-toggle="collapse">
                            <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>                        </div>
                    </div>

                    <div id="bundleFAQ_53" class="accordion__collapse pt-0 mt-20 border-0 " role="tabpanel">
                        <div class="p-16 rounded-8 border-gray-200 text-gray-500 mt-8">
...
He enjoys teaching others how to use and ...</div>
        ...
        <div class="custom-tabs-content " id="coursesTab">
            <div class="row">
    ...
    <div class="d-flex flex-column flex-lg-row bg-white rounded-24">
        ...
        <div class="py-0 py-lg-16">
            <a href="../course/Excel-from-Beginner-to-Advanced.html">
  ...
  <path d="M15 16c-.56 0-1.01-.45-1.01-1s.45-1 1-1 1 .45 1 1-.44 1-.99 1zM9.01 10C8.45 10 8 9.55 8 9s.45-1 1-1 1 .45 1 1-.44 1-.99 1zM9 15.75c-.19 0-.38-.07-.53-.22a.755.755 0 010-1.06l6-6c.29-.29.77-.29 1.06 0 .29.29.29.77 0 1.06l-6 6c-.15.15-.34.22-.53.22z"/>
</svg>                        <span class="ml-4 text-white font-14">20% Off</span>
                    </div>
        ...
        <div class="p-16 d-flex flex-column flex-1">
            <a href="../course/Excel-from-Beginner-to-Advanced.html" class="mb-8">
                <h3 class="course-title font-16 font-weight-bold text-dark">Excel from Beginner to Advanced</h3>
            </a>

            <div class="stars-card d-flex align-items-center mb-12">
                    <span class="stars-card__item active">
                <svg width="14px" height="14px" class="icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
</svg>            </span>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
                            ...
                            <div class="mb-12 font-14 text-gray-500">Excel from Beginner to Advanced equips you with comprehensive skills, covering  formulas, data analysis, charts, pivot tables, and automation. Master spreadsheet , streamline tasks, and gain confidence using Excel for personal, academic, or professional data management success.</div>
            ...
            <div class="mt-auto">
                <div class="d-flex align-items-center">
                    ...
                    <div class="ml-4">
                        <a href="../users/robert-ransdell/profile.html" target="_blank" class="font-14 font-weight-bold text-dark">Robert Ransdell</a>
                        <p class="mt-2 font-14 text-gray-500 text-ellipsis">System Administrator at Amazon</p>
                    </div>
                </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M21.66 10.44l-.98 4.18c-.84 3.61-2.5 5.07-5.62 4.77-.5-.04-1.04-.13-1.62-.27l-1.68-.4c-4.17-.99-5.46-3.05-4.48-7.23l.98-4.19c.2-.85.44-1.59.74-2.2 1.17-2.42 3.16-3.07 6.5-2.28l1.67.39c4.19.98 5.47 3.05 4.49 7.23z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.06 19.39c-.62.42-1.4.77-2.35 1.08l-1.58.52c-3.97 1.28-6.06.21-7.35-3.76L2.5 13.28c-1.28-3.97-.22-6.07 3.75-7.35l1.58-.52c.41-.13.8-.24 1.17-.31-.3.61-.54 1.35-.74 2.2l-.98 4.19c-.98 4.18.31 6.24 4.48 7.23l1.68.4c.58.14 1.12.23 1.62.27zM12.64 8.53l4.85 1.23M11.66 12.4l2.9.74"/>
</svg>                        <span class="ml-4">5</span>
                        <span class="ml-4">Lessons</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="d-flex align-items-center justify-content-between flex-lg-column px-16 pb-16 pt-lg-40 pb-lg-12 px-lg-12 border-left-gray-200">
            <div class="d-flex-center flex-column font-24 font-weight-bold text-primary">
                                    <span class="font-14 font-weight-400 text-gray-500 text-decoration-line-through mb-4">$100</span>
        <span class="">$80</span>
                                    </div>

            <div class="d-flex align-items-center gap-12 mt-auto">
                                    <a href="../course/Excel-from-Beginner-to-Advanced.html" class="course-row-card-1__add-to-cart-btn btn btn-primary btn-lg rounded-12">Add to Cart</a>
                
                <a  href="../login.html"  class="d-flex-center size-48 rounded-12 border-gray-200 text-gray-500">
  ...
  <path d="M16.44 3.102c-1.81 0-3.43.88-4.44 2.23a5.549 5.549 0 00-4.44-2.23c-3.07 0-5.56 2.5-5.56 5.59 0 1.19.19 2.29.52 3.31 1.58 5 6.45 7.99 8.86 8.81.34.12.9.12 1.24 0 2.41-.82 7.28-3.81 8.86-8.81.33-1.02.52-2.12.52-3.31 0-3.09-2.49-5.59-5.56-5.59z"/>
    ...
    <div class="d-flex flex-column flex-lg-row bg-white rounded-24">
        ...
        <div class="py-0 py-lg-16">
            <a href="../course/New-Learning-Page.html">
                <div class="course-row-card-1__image position-relative bg-gray-200">
        ...
        <div class="p-16 d-flex flex-column flex-1">
            <a href="../course/New-Learning-Page.html" class="mb-8">
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
                            ...
                            <div class="mb-12 font-14 text-gray-500">Instructors will be able to create unlimited video courses, live classes, text courses, projects, quizzes, files, etc and students will be able to use the educational material and increase their skill level.</div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.06 19.39c-.62.42-1.4.77-2.35 1.08l-1.58.52c-3.97 1.28-6.06.21-7.35-3.76L2.5 13.28c-1.28-3.97-.22-6.07 3.75-7.35l1.58-.52c.41-.13.8-.24 1.17-.31-.3.61-.54 1.35-.74 2.2l-.98 4.19c-.98 4.18.31 6.24 4.48 7.23l1.68.4c.58.14 1.12.23 1.62.27zM12.64 8.53l4.85 1.23M11.66 12.4l2.9.74"/>
        ...
        <div class="d-flex align-items-center justify-content-between flex-lg-column px-16 pb-16 pt-lg-40 pb-lg-12 px-lg-12 border-left-gray-200">
            ...
            <div class="d-flex align-items-center gap-12 mt-auto">
                                    <a href="../course/New-Learning-Page.html" class="course-row-card-1__add-to-cart-btn btn btn-primary btn-lg rounded-12">Add to Cart</a>
  ...
  <path d="M16.44 3.102c-1.81 0-3.43.88-4.44 2.23a5.549 5.549 0 00-4.44-2.23c-3.07 0-5.56 2.5-5.56 5.59 0 1.19.19 2.29.52 3.31 1.58 5 6.45 7.99 8.86 8.81.34.12.9.12 1.24 0 2.41-.82 7.28-3.81 8.86-8.81.33-1.02.52-2.12.52-3.31 0-3.09-2.49-5.59-5.56-5.59z"/>
    ...
    <div class="d-flex flex-column flex-lg-row bg-white rounded-24">
        ...
        <div class="py-0 py-lg-16">
            <a href="../course/Learn-Linux-in-5-Days.html">
                <div class="course-row-card-1__image position-relative bg-gray-200">
        ...
        <div class="p-16 d-flex flex-column flex-1">
            <a href="../course/Learn-Linux-in-5-Days.html" class="mb-8">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.06 19.39c-.62.42-1.4.77-2.35 1.08l-1.58.52c-3.97 1.28-6.06.21-7.35-3.76L2.5 13.28c-1.28-3.97-.22-6.07 3.75-7.35l1.58-.52c.41-.13.8-.24 1.17-.31-.3.61-.54 1.35-.74 2.2l-.98 4.19c-.98 4.18.31 6.24 4.48 7.23l1.68.4c.58.14 1.12.23 1.62.27zM12.64 8.53l4.85 1.23M11.66 12.4l2.9.74"/>
        ...
        <div class="d-flex align-items-center justify-content-between flex-lg-column px-16 pb-16 pt-lg-40 pb-lg-12 px-lg-12 border-left-gray-200">
            ...
            <div class="d-flex align-items-center gap-12 mt-auto">
                                    <a href="../course/Learn-Linux-in-5-Days.html" class="course-row-card-1__add-to-cart-btn btn btn-primary btn-lg rounded-12">Add to Cart</a>
  ...
  <path d="M16.44 3.102c-1.81 0-3.43.88-4.44 2.23a5.549 5.549 0 00-4.44-2.23c-3.07 0-5.56 2.5-5.56 5.59 0 1.19.19 2.29.52 3.31 1.58 5 6.45 7.99 8.86 8.81.34.12.9.12 1.24 0 2.41-.82 7.28-3.81 8.86-8.81.33-1.02.52-2.12.52-3.31 0-3.09-2.49-5.59-5.56-5.59z"/>
    ...
    <div class="d-flex flex-column flex-lg-row bg-white rounded-24">
        ...
        <div class="py-0 py-lg-16">
            <a href="../course/New-in-App-Live-System.html">
                <div class="course-row-card-1__image position-relative bg-gray-200">
        ...
        <div class="p-16 d-flex flex-column flex-1">
            <a href="../course/New-in-App-Live-System.html" class="mb-8">
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
                            ...
                            <div class="mb-12 font-14 text-gray-500">Agora Live Class Streaming enables real-time, high-quality interactive online classes with video, audio, and screen sharing. Engage students worldwide, foster collaboration, and deliver immersive learning experiences seamlessly, making education more accessible, engaging, and effective for everyone involved.</div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.06 19.39c-.62.42-1.4.77-2.35 1.08l-1.58.52c-3.97 1.28-6.06.21-7.35-3.76L2.5 13.28c-1.28-3.97-.22-6.07 3.75-7.35l1.58-.52c.41-.13.8-.24 1.17-.31-.3.61-.54 1.35-.74 2.2l-.98 4.19c-.98 4.18.31 6.24 4.48 7.23l1.68.4c.58.14 1.12.23 1.62.27zM12.64 8.53l4.85 1.23M11.66 12.4l2.9.74"/>
        ...
        <div class="d-flex align-items-center justify-content-between flex-lg-column px-16 pb-16 pt-lg-40 pb-lg-12 px-lg-12 border-left-gray-200">
            ...
            <div class="d-flex align-items-center gap-12 mt-auto">
                                    <a href="../course/New-in-App-Live-System.html" class="course-row-card-1__add-to-cart-btn btn btn-primary btn-lg rounded-12">Add to Cart</a>
...
<div class="js-reply-to-comment-html d-none">
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
        ...
        <div class="d-flex align-items-center">
            <span class="font-12 text-gray-500">24 Jun 2022 11:09</span>
                ...
                <div class="actions-dropdown__dropdown-menu dropdown-menu-top-32">
                    <ul class="my-8">
                        ...
                        <li class="actions-dropdown__dropdown-menu-item">
                            <button type="button" class="js-reply-review" data-review="37">Reply</button>
                        </li>
...
<div class="js-reply-to-review-html d-none">
    ...
    <form action="https://lms.rocket-soft.org/bundles/reviews/store-reply-comment" class="mt-16" method="post">
  ...
  <path d="M12 2C6.49 2 2 6.49 2 12s4.49 10 10 10 10-4.49 10-10S17.51 2 12 2zm-.75 6c0-.41.34-.75.75-.75s.75.34.75.75v5c0 .41-.34.75-.75.75s-.75-.34-.75-.75V8zm1.67 8.38c-.05.13-.12.23-.21.33-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08s-.26-.03-.38-.08-.23-.12-.33-.21c-.09-.1-.16-.2-.21-.33A.995.995 0 0111 16c0-.13.03-.26.08-.38s.12-.23.21-.33c.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.09.1.16.21.21.33.05.12.08.25.08.38s-.03.26-.08.38z"/>
    ...
    <div class="position-relative bg-white rounded-24 pb-24 z-index-2">
        ...
        <div class="course-right-side__thumbnail position-relative bg-gray-200">
            <img src="../store/1/default_images/bundles/Mask%20group.jpg" class="img-cover" alt="Microsoft Office Beginner to Expert Bundle">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12.62 20.81c-.34.12-.9.12-1.24 0C8.48 19.82 2 15.69 2 8.69 2 5.6 4.49 3.1 7.56 3.1c1.82 0 3.43.88 4.44 2.24a5.53 5.53 0 014.44-2.24C19.51 3.1 22 5.6 22 8.69c0 7-6.48 11.13-9.38 12.12z"/>
                ...
                <div class="js-share-course d-flex-center flex-column text-gray-500 font-12 cursor-pointer" data-path="/bundles/Microsoft-Office-Beginner-to-Expert-Bundle/share-modal">
                    <svg width="20px" height="20px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
...
<div class="course-right-side-section position-relative mt-28">
    ...
    <div class="position-relative card-before-line bg-white rounded-24 p-16 z-index-2">
        <h4 class="font-14 font-weight-bold">Bundle Details</h4>
...
<a href="../login.html" class="">
  ...
  <path d="M8.94 10v5.14c0 .8.88 1.27 1.55.84l.94-.62a1 1 0 011.1 0l.89.6a.997.997 0 001.55-.83V10H8.94z" opacity=".6"/>
                ...
                <div class="ml-8">
                    <h3 class="course-show__gift-card-title font-14">Send Bundle as Gift</h3>
    ...
    <div class="course-right-side-section position-relative mt-28">
        ...
        <div class="position-relative card-before-line bg-white rounded-24 p-16 z-index-2">
            ...
            <div class="d-flex gap-12 flex-wrap mt-16">
                                    <a href="../tags/bundles/office.html" target="_blank" class="d-flex-center p-10 rounded-8 bg-gray-100 font-12 text-gray-500 text-center">office</a>
                                    <a href="../tags/bundles/bundle.html" target="_blank" class="d-flex-center p-10 rounded-8 bg-gray-100 font-12 text-gray-500 text-center">bundle</a>
                            </div>
        </div>
    </div>
                ...
                <a href="../reward-courses.html" class="d-flex sidebar-ads rounded-16">
                    <img src="../store/1/default_images/banners/rewards-banner-side.png" class="img-cover rounded-16" alt="Rewards - Bundle Sidebar">
                </a>
            </div>
            </div>
            </div>
...
<!-- Mirrored from lms.rocket-soft.org/bundles/Microsoft-Office-Beginner-to-Expert-Bundle by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:32:39 GMT -->
</html>
