...
<!-- Mirrored from lms.rocket-soft.org/course/How-to-Travel-Around-the-World by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:31:21 GMT -->
...
<meta name='robots' content="index, follow, all">
    ...
    <meta name="description" content="The Most Complete and Updated Travel Course! Get the Best Travel Tips to Plan your World Trip without breaking the bank!">
    <meta property="og:description" content="The Most Complete and Updated Travel Course! Get the Best Travel Tips to Plan your World Trip without breaking the bank!">
    <meta name='twitter:description' content='The Most Complete and Updated Travel Course! Get the Best Travel Tips to Plan your World Trip without breaking the bank!'>
...
<!-- Open Graph -->
<meta property='og:title' content='How to Travel Around the World'>
<meta name='twitter:card' content='summary'>
<meta name='twitter:title' content='How to Travel Around the World'>


<meta property='og:site_name' content='https://lms.rocket-soft.org/Rocket LMS'>
<meta property='og:image' content='https://lms.rocket-soft.org/store/867/How to Travel Around the World on a Budget.jpg'>
<meta name='twitter:image' content='https://lms.rocket-soft.org/store/867/How to Travel Around the World on a Budget.jpg'>
<meta property='og:locale' content='../en_US.html'>
<meta property='og:type' content='website'>



    <title>How to Travel Around the World | Rocket LMS</title>
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
    ...
    <img src="../store/867/How%20to%20Travel%20Around%20the%20World%20on%20a%20Budget_c.jpg" class="course-hero__cover-img img-cover rounded-32" alt="How to Travel Around the World"/>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
        ...
        <div class="d-flex align-items-center flex-wrap gap-12 mt-4">
            <h1 class="course-hero__title font-32 font-weight-bold text-white text-ellipsis">How to Travel Around the World</h1>
            ...
            <div class="d-flex flex-wrap align-items-center gap-12">
                    ...
                    <div class="mt-8 text-white opacity-50">Traveling around the world involves careful planning, budgeting, and research. Choose destinations, book affordable flights, arrange accommodations, and secure necessary visas. Embrace diverse cultures, stay flexible, and prioritize safety while creating unforgettable global adventures and lifelong memories.</div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.06 19.39c-.62.42-1.4.77-2.35 1.08l-1.58.52c-3.97 1.28-6.06.21-7.35-3.76L2.5 13.28c-1.28-3.97-.22-6.07 3.75-7.35l1.58-.52c.41-.13.8-.24 1.17-.31-.3.61-.54 1.35-.74 2.2l-.98 4.19c-.98 4.18.31 6.24 4.48 7.23l1.68.4c.58.14 1.12.23 1.62.27zM12.64 8.53l4.85 1.23M11.66 12.4l2.9.74"/>
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Sustainable travel</span>
                        </div>
                                            <div class="d-flex align-items-center p-16 rounded-8 bg-white">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Working abroad options</span>
                        </div>
                                            <div class="d-flex align-items-center p-16 rounded-8 bg-white">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Travel insurance</span>
                        </div>
                                            <div class="d-flex align-items-center p-16 rounded-8 bg-white">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Money saving tips</span>
                        </div>
                                            <div class="d-flex align-items-center p-16 rounded-8 bg-white">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Cultural sensitivity</span>
                        </div>
                                            <div class="d-flex align-items-center p-16 rounded-8 bg-white">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Safety considerations</span>
                        </div>
                                            <div class="d-flex align-items-center p-16 rounded-8 bg-white">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Packing efficiently</span>
                        </div>
                                            <div class="d-flex align-items-center p-16 rounded-8 bg-white">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Transportation hacks</span>
                        </div>
                                            <div class="d-flex align-items-center p-16 rounded-8 bg-white">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Accommodation options</span>
                        </div>
                                            <div class="d-flex align-items-center p-16 rounded-8 bg-white">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Budget travel planning</span>
                        </div>
                                    </div>
            </div>
        </div>
  ...
  <path d="M16.31 7.84c0 .41-.33.75-.75.75h-5.25c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h5.25c.42 0 .75.34.75.75zM7.97 6.87L5.72 9.12c-.15.15-.34.22-.53.22s-.39-.07-.53-.22l-.75-.75c-.3-.29-.3-.77 0-1.06.29-.29.76-.29 1.06 0l.22.22 1.72-1.72c.29-.29.76-.29 1.06 0 .29.29.29.77 0 1.06zM16.31 14.84c0 .41-.33.75-.75.75h-5.25c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h5.25c.42 0 .75.34.75.75zM7.97 13.87l-2.25 2.25c-.15.15-.34.22-.53.22s-.39-.07-.53-.22l-.75-.75c-.3-.29-.3-.77 0-1.06.29-.29.76-.29 1.06 0l.22.22 1.72-1.72c.29-.29.76-.29 1.06 0 .29.29.29.77 0 1.06z"/>
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Openness to new cultures</span>
                        </div>
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Flexible attitude</span>
                        </div>
                                            <div class="d-flex align-items-center mt-16">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Budgeting mindset</span>
                        </div>
                                            <div class="d-flex align-items-center mt-16">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Desire to travel</span>
                        </div>
                                            <div class="d-flex align-items-center mt-16">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Passport (or plan to get one)</span>
                        </div>
                                    </div>
            ...
            <div class="">
                ...
                <p class="mt-4 font-12 text-gray-500">Check the frequently asked questions about this course.</p>
                    ...
                    <div class="accordion__title d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center cursor-pointer" href="#courseFAQ_35" data-parent="#courseFAQParent" role="button" data-toggle="collapse">
                            <div class="size-24">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 11.36v-.21c0-.68.42-1.04.84-1.33.41-.28.82-.64.82-1.3 0-.92-.74-1.66-1.66-1.66-.92 0-1.66.74-1.66 1.66M11.995 13.75h.01"/>
                        ...
                        <div class="collapse-arrow-icon d-flex cursor-pointer" href="#courseFAQ_35" data-parent="#courseFAQParent" role="button" data-toggle="collapse">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
                    ...
                    <div id="courseFAQ_35" class="accordion__collapse border-0 " role="tabpanel">
                    ...
                    <div class="accordion__title d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center cursor-pointer" href="#courseFAQ_36" data-parent="#courseFAQParent" role="button" data-toggle="collapse">
                            <div class="size-24">
                                <svg width="24px" height="24px" class="icons text-primary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M17 18.43h-4l-4.45 2.96A.997.997 0 017 20.56v-2.13c-3 0-5-2-5-5v-6c0-3 2-5 5-5h10c3 0 5 2 5 5v6c0 3-2 5-5 5z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 11.36v-.21c0-.68.42-1.04.84-1.33.41-.28.82-.64.82-1.3 0-.92-.74-1.66-1.66-1.66-.92 0-1.66.74-1.66 1.66M11.995 13.75h.01"/>
                        ...
                        <div class="collapse-arrow-icon d-flex cursor-pointer" href="#courseFAQ_36" data-parent="#courseFAQParent" role="button" data-toggle="collapse">
                            <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>                        </div>
                    </div>

                    <div id="courseFAQ_36" class="accordion__collapse border-0 " role="tabpanel">
                        <div class="p-16 rounded-8 border-gray-200 text-gray-500 mt-8">
            ...
            <div class="row">
                            ...
                            <a href="Health-And-Fitness-Masterclass.html">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
        ...
        <img src="../store/863/Health%20And%20Fitness%20Masterclass%20Beginner%20To%20Advanced.jpg" class="img-cover rounded-12" alt="Health And Fitness Masterclass">

        <div class="course-prerequisite-card__body d-flex flex-column p-12">
            <h3 class="card-title font-14 font-weight-bold text-white">Health And Fitness Masterclass 2002</h3>
...
I try ...</div>
                ...
                <div class="swiper-wrapper py-0 mx-16 mx-md-32">
                            ...
                            <div class="bg-white p-16 rounded-12 border-gray-200">
                                ...
                                <div class="course-recent-review-desc mt-16 text-gray-500">
                                    This course is full of traveling information. I'm so thankful for new tips that I didn't hear before. Thanks:)
                                </div>
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
            ...
            <div class="ml-8">
                ...
                <p class="mt-4 font-12 text-gray-500">This course includes 2 modules, 4 lessons, and 0 hours of materials.</p>
            </div>
        </div>
            ...
            <div id="chaptersAccordion">
                ...
                <div class="accordion__title d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center cursor-pointer" href="#collapseChapter5" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
  ...
  <path d="M7.24 13.43h-1.9C3.15 13.43 2 14.58 2 16.76v1.9C2 20.85 3.15 22 5.33 22h1.9c2.18 0 3.33-1.15 3.33-3.33v-1.9c.01-2.19-1.14-3.34-3.32-3.34z" opacity=".4"/>
                        ...
                        <div class="ml-8">
                            <div class="font-14 font-weight-bold">Let&#039;s Start!</div>
                            <div class="d-flex align-items-center mt-4 font-12 text-gray-500">2 Parts </div>
                        </div>
                    </div>

                    <div class="collapse-arrow-icon d-flex cursor-pointer" href="#collapseChapter5" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
                        <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>                    </div>
                </div>

                <div id="collapseChapter5" class="accordion__collapse border-0 " role="tabpanel">
                                                                                                        <div class="accordion bg-gray-100 border-gray-200 p-16 rounded-12 mt-16">
    <div class="accordion__title d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center cursor-pointer" href="#collapseFiles52" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 22h6c5 0 7-2 7-7V9c0-5-2-7-7-7H9C4 2 2 4 2 9v6c0 5 2 7 7 7zM15.75 9h-7.5M15.75 15h-7.5"/>
            ...
            <div class="font-14 font-weight-bold d-block">Welcome to the Course!</div>
        </div>

        <div class="d-flex align-items-center gap-12">
                            <span class="px-8 py-4 bg-primary-20 text-primary font-12 rounded-8">Free</span>
            
            <div class="collapse-arrow-icon d-flex cursor-pointer" href="#collapseFiles52" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
                <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>            </div>
        </div>
    ...
    <div id="collapseFiles52" class="accordion__collapse border-0 " role="tabpanel">
        <div class="p-16 rounded-12 border-gray-200 bg-gray-100 mt-16">
            <div class="font-14 text-gray-500">
                <p>A warm welcome to the course! Feel free to contact me if you have any questions</p>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7.99 21.97L7.98 19c0-1.11.89-2 2-2h4.01c1.1 0 1.99.89 2 1.99l.03 2.99M8.94 4.95l.05-2.89M11.94 4.95l.05-2.89M14.94 4.92l.05-2.88"/>
                ...
                <div class="ml-8">
                    ...
                    <span class="d-block font-12 font-weight-bold text-gray-500 mt-4">13.10 MB</span>
                </div>
            </div>

            <div class="mt-16 mt-lg-0">
                                                            <a href="How-to-Travel-Around-the-World/file/52/Welcome-to-the-Course%21.mkv" class="btn btn-lg btn-primary">
                            <svg width="16px" height="16px" class="icons text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7 4.13c-3.54.52-5 2.6-5 6.87v4c0 5 2 7 7 7h6c5 0 7-2 7-7v-4c0-4.27-1.46-6.35-5-6.87"/>
                                                                                                                ...
                                                                                                                <div class="accordion bg-gray-100 border-gray-200 p-16 rounded-12 mt-16">
    <div class="accordion__title d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center cursor-pointer" href="#collapseFiles53" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
            <div class="d-flex mr-8">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 22h6c5 0 7-2 7-7V9c0-5-2-7-7-7H9C4 2 2 4 2 9v6c0 5 2 7 7 7zM15.75 9h-7.5M15.75 15h-7.5"/>
            ...
            <div class="font-14 font-weight-bold d-block">Health &amp; Safety</div>
        </div>

        <div class="d-flex align-items-center gap-12">
            
            <div class="collapse-arrow-icon d-flex cursor-pointer" href="#collapseFiles53" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
                <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>            </div>
        </div>
    ...
    <div id="collapseFiles53" class="accordion__collapse border-0 " role="tabpanel">
        <div class="p-16 rounded-12 border-gray-200 bg-gray-100 mt-16">
            <div class="font-14 text-gray-500">
                <p>The point of this lecture is to share with you numerous safety tips I've learned during my journey.</p>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7 4.13c-3.54.52-5 2.6-5 6.87v4c0 5 2 7 7 7h6c5 0 7-2 7-7v-4c0-4.27-1.46-6.35-5-6.87"/>
                                ...
                                <div class="accordion p-12 rounded-12 border-gray-200 bg-white mt-16">
                <div class="accordion__title d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center cursor-pointer" href="#collapseChapter6" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
                        <div class="d-flex-center size-48 rounded-12 bg-primary-20">
                            <svg width="24px" height="24px" class="icons text-primary" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M7.24 2h-1.9C3.15 2 2 3.15 2 5.33v1.9c0 2.18 1.15 3.33 3.33 3.33h1.9c2.18 0 3.33-1.15 3.33-3.33v-1.9C10.57 3.15 9.42 2 7.24 2z"/>
  <path d="M18.67 2h-1.9c-2.18 0-3.33 1.15-3.33 3.33v1.9c0 2.18 1.15 3.33 3.33 3.33h1.9c2.18 0 3.33-1.15 3.33-3.33v-1.9C22 3.15 20.85 2 18.67 2z" opacity=".4"/>
  ...
  <path d="M7.24 13.43h-1.9C3.15 13.43 2 14.58 2 16.76v1.9C2 20.85 3.15 22 5.33 22h1.9c2.18 0 3.33-1.15 3.33-3.33v-1.9c.01-2.19-1.14-3.34-3.32-3.34z" opacity=".4"/>
                        ...
                        <div class="ml-8">
                            <div class="font-14 font-weight-bold">Ready to go?</div>
                            <div class="d-flex align-items-center mt-4 font-12 text-gray-500">2 Parts </div>
                        </div>
                    </div>

                    <div class="collapse-arrow-icon d-flex cursor-pointer" href="#collapseChapter6" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
                        <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>                    </div>
                </div>

                <div id="collapseChapter6" class="accordion__collapse border-0 " role="tabpanel">
                                                                                                        <div class="accordion bg-gray-100 border-gray-200 p-16 rounded-12 mt-16">
    <div class="accordion__title d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center cursor-pointer" href="#collapseFiles55" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
            <div class="d-flex mr-8">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 22h6c5 0 7-2 7-7V9c0-5-2-7-7-7H9C4 2 2 4 2 9v6c0 5 2 7 7 7zM15.75 9h-7.5M15.75 15h-7.5"/>
            ...
            <div class="font-14 font-weight-bold d-block">Ready to go? The last things to do!</div>
        </div>

        <div class="d-flex align-items-center gap-12">
            
            <div class="collapse-arrow-icon d-flex cursor-pointer" href="#collapseFiles55" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
                <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>            </div>
        </div>
    ...
    <div id="collapseFiles55" class="accordion__collapse border-0 " role="tabpanel">
        <div class="p-16 rounded-12 border-gray-200 bg-gray-100 mt-16">
            <div class="font-14 text-gray-500">
                <p>In this video I'll share with you some tips to earn money on the road and I will take my example as a digital nomad to show you what works.</p>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7 4.13c-3.54.52-5 2.6-5 6.87v4c0 5 2 7 7 7h6c5 0 7-2 7-7v-4c0-4.27-1.46-6.35-5-6.87"/>
                                                                                                                ...
                                                                                                                <div class="accordion bg-gray-100 border-gray-200 p-16 rounded-12 mt-16">
    <div class="accordion__title d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center cursor-pointer" href="#collapseFiles54" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
            <div class="d-flex mr-8">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 22h6c5 0 7-2 7-7V9c0-5-2-7-7-7H9C4 2 2 4 2 9v6c0 5 2 7 7 7zM15.75 9h-7.5M15.75 15h-7.5"/>
            ...
            <div class="font-14 font-weight-bold d-block">Where To Sleep during your Travels?</div>
        </div>

        <div class="d-flex align-items-center gap-12">
            
            <div class="collapse-arrow-icon d-flex cursor-pointer" href="#collapseFiles54" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
                <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>            </div>
        </div>
    ...
    <div id="collapseFiles54" class="accordion__collapse border-0 " role="tabpanel">
        <div class="p-16 rounded-12 border-gray-200 bg-gray-100 mt-16">
            <div class="font-14 text-gray-500">
                <p>After this lesson you'll know what exactly is Couchsurfing and what to expect.</p>
            </div>
                ...
                <div class="actions-dropdown__dropdown-menu dropdown-menu-top-32">
                    <ul class="my-8">
                        ...
                        <li class="actions-dropdown__dropdown-menu-item">
                            <button type="button" class="js-reply-comment" data-comment="50" data-item="2006" data-item-name="webinar_id">Reply</button>
                        </li>

                        <li class="actions-dropdown__dropdown-menu-item">
                            <button type="button" class="js-report-comment" data-comment="50" data-item="2006" data-item-name="webinar_id">Report</button>
                        </li>
...
<div class="js-reply-to-comment-html d-none">
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
        ...
        <div class="d-flex align-items-center">
            <span class="font-12 text-gray-500">13 Jul 2021 18:15</span>
  ...
  <path stroke-width="1.5" d="M5 10c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zM19 10c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zM12 10c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"/>
                ...
                <div class="actions-dropdown__dropdown-menu dropdown-menu-top-32">
                    <ul class="my-8">
                        ...
                        <li class="actions-dropdown__dropdown-menu-item">
                            <button type="button" class="js-reply-review" data-review="20">Reply</button>
                        </li>
...
<div class="js-reply-to-review-html d-none">
    ...
    <form action="https://lms.rocket-soft.org/reviews/store-reply-comment" class="mt-16" method="post">
        <input type="hidden" name="webinar_id" value="2006"/>
    ...
    <div class="position-relative bg-white rounded-24 pb-24 z-index-2">
        ...
        <div class="course-right-side__thumbnail position-relative bg-gray-200">
            <img src="../store/867/How%20to%20Travel%20Around%20the%20World%20on%20a%20Budget.jpg" class="img-cover" alt="How to Travel Around the World">
                     ...
                     data-video-path="https://lms.rocket-soft.org/store/867/How to Travel Around the World on a Budget.mkv"
                     data-video-source="upload"
                     data-thumbnail="/store/867/How to Travel Around the World on a Budget.jpg"
                >
  ...
  <path d="M17.49 9.6L5.6 16.77c-.7.42-1.6-.08-1.6-.9v-8c0-3.49 3.77-5.67 6.8-3.93l4.59 2.64 2.09 1.2c.69.41.7 1.41.01 1.82zM18.089 15.46l-4.05 2.34-4.04 2.33c-1.45.83-3.09.66-4.28-.18-.58-.4-.51-1.29.1-1.65l12.71-7.62c.6-.36 1.39-.02 1.5.67.25 1.55-.39 3.22-1.94 4.11z"/>
        ...
        <form action="https://lms.rocket-soft.org/cart/store" method="post">
            <input type="hidden" name="_token" value="KkDAnXKdDFkgpTFwX3uTuPHuAseZywMbZmqb7QZE">
            <input type="hidden" name="item_id" value="2006">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.996 11h.01M11.995 11h.01M7.995 11h.008"/>
            ...
            <div class="d-flex align-items-center justify-content-around mt-16 p-12 rounded-12 border-dashed border-gray-200">
                                    <a href="https://calendar.google.com/calendar/render?action=TEMPLATE&amp;dates=20220302T000000/20220302T000000&amp;ctz=UTC&amp;text=How+to+Travel+Around+the+World" target="_blank" class="d-flex-center flex-column text-gray-500 font-12">
                        <svg width="20px" height="20px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8 2v3M16 2v3M3.5 9.09h17M21 8.5V17c0 3-1.5 5-5 5H8c-3.5 0-5-2-5-5V8.5c0-3 1.5-5 5-5h8c3.5 0 5 2 5 5z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12.62 20.81c-.34.12-.9.12-1.24 0C8.48 19.82 2 15.69 2 8.69 2 5.6 4.49 3.1 7.56 3.1c1.82 0 3.43.88 4.44 2.24a5.53 5.53 0 014.44-2.24C19.51 3.1 22 5.6 22 8.69c0 7-6.48 11.13-9.38 12.12z"/>
                ...
                <div class="js-share-course d-flex-center flex-column text-gray-500 font-12 cursor-pointer" data-path="/course/How-to-Travel-Around-the-World/share-modal">
                    <svg width="20px" height="20px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
...
<div class="course-right-side-section position-relative mt-28">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
                ...
                <span class="">2 Mar 2022 | 00:00</span>
            </div>
    ...
    <div class="course-right-side-section position-relative mt-28">
        ...
        <div class="position-relative card-before-line bg-white rounded-24 p-16 z-index-2">
            ...
            <div class="d-flex gap-12 flex-wrap mt-16">
                                    <a href="../tags/courses/travel.html" target="_blank" class="d-flex-center p-10 rounded-8 bg-gray-100 font-12 text-gray-500 text-center">travel</a>
                                    <a href="../tags/courses/trip.html" target="_blank" class="d-flex-center p-10 rounded-8 bg-gray-100 font-12 text-gray-500 text-center">trip</a>
                                    <a href="../tags/courses/World%2bTrip.html" target="_blank" class="d-flex-center p-10 rounded-8 bg-gray-100 font-12 text-gray-500 text-center">World Trip</a>
                            </div>
        </div>
    </div>
    ...
    <div class="container d-flex flex-column flex-lg-row align-items-lg-center justify-content-lg-between h-100">
        <div class="d-flex align-items-center mb-16 mb-lg-0">
            <div class="course-bottom-fixed-card__course-img rounded-8">
                <img src="../store/867/How%20to%20Travel%20Around%20the%20World%20on%20a%20Budget.jpg" class="img-cover rounded-8" alt="How to Travel Around the World">
            </div>
            <div class="ml-8">
                <div class="font-12 text-gray-500">You are viewing</div>
                <div class="mt-4 font-14 font-weight-bold">How to Travel Around the World</div>
            </div>
        </div>
...
<!-- Mirrored from lms.rocket-soft.org/course/How-to-Travel-Around-the-World by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:31:51 GMT -->
</html>
