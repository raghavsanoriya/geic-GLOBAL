...
<!-- Mirrored from lms.rocket-soft.org/course/Learn-and-Understand-AngularJS by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:38:52 GMT -->
...
<meta name='robots' content="index, follow, all">
    ...
    <meta name="description" content="Master AngularJS and the Javascript concepts behind it, design custom directives, and build a single page application.">
    <meta property="og:description" content="Master AngularJS and the Javascript concepts behind it, design custom directives, and build a single page application.">
    <meta name='twitter:description' content='Master AngularJS and the Javascript concepts behind it, design custom directives, and build a single page application.'>
...
<!-- Open Graph -->
<meta property='og:title' content='Learn and Understand AngularJS'>
<meta name='twitter:card' content='summary'>
<meta name='twitter:title' content='Learn and Understand AngularJS'>


<meta property='og:site_name' content='https://lms.rocket-soft.org/Rocket LMS'>
<meta property='og:image' content='https://lms.rocket-soft.org/store/3/Learn and Understand AngularJS.jpg'>
<meta name='twitter:image' content='https://lms.rocket-soft.org/store/3/Learn and Understand AngularJS.jpg'>
<meta property='og:locale' content='../en_US.html'>
<meta property='og:type' content='website'>



    <title>Learn and Understand AngularJS | Rocket LMS</title>
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
    ...
    <img src="../store/3/Learn%20and%20Understand%20AngularJS_c.png" class="course-hero__cover-img img-cover rounded-32" alt="Learn and Understand AngularJS"/>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
        ...
        <div class="d-flex align-items-center flex-wrap gap-12 mt-4">
            <h1 class="course-hero__title font-32 font-weight-bold text-white text-ellipsis">Learn and Understand AngularJS</h1>
            ...
            <div class="d-flex flex-wrap align-items-center gap-12">
                    ...
                    <div class="mt-8 text-white opacity-50">Learn and Understand AngularJS with this course covering core concepts, directives, controllers, and services. Gain experience building dynamic, single-page applications, strengthen your frontend development skills, and master the framework to create responsive, maintainable web applications efficiently.</div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.06 19.39c-.62.42-1.4.77-2.35 1.08l-1.58.52c-3.97 1.28-6.06.21-7.35-3.76L2.5 13.28c-1.28-3.97-.22-6.07 3.75-7.35l1.58-.52c.41-.13.8-.24 1.17-.31-.3.61-.54 1.35-.74 2.2l-.98 4.19c-.98 4.18.31 6.24 4.48 7.23l1.68.4c.58.14 1.12.23 1.62.27zM12.64 8.53l4.85 1.23M11.66 12.4l2.9.74"/>
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Performance optimization</span>
                        </div>
                                            <div class="d-flex align-items-center p-16 rounded-8 bg-white">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Testing strategies</span>
                        </div>
                                            <div class="d-flex align-items-center p-16 rounded-8 bg-white">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Form validation</span>
                        </div>
                                            <div class="d-flex align-items-center p-16 rounded-8 bg-white">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Services development</span>
                        </div>
                                            <div class="d-flex align-items-center p-16 rounded-8 bg-white">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Routing implementation</span>
                        </div>
                                            <div class="d-flex align-items-center p-16 rounded-8 bg-white">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Dependency injection</span>
                        </div>
                                            <div class="d-flex align-items-center p-16 rounded-8 bg-white">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Data binding techniques</span>
                        </div>
                                            <div class="d-flex align-items-center p-16 rounded-8 bg-white">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Directives creation</span>
                        </div>
                                            <div class="d-flex align-items-center p-16 rounded-8 bg-white">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">AngularJS architecture</span>
                        </div>
                                    </div>
            </div>
        </div>
  ...
  <path d="M16.31 7.84c0 .41-.33.75-.75.75h-5.25c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h5.25c.42 0 .75.34.75.75zM7.97 6.87L5.72 9.12c-.15.15-.34.22-.53.22s-.39-.07-.53-.22l-.75-.75c-.3-.29-.3-.77 0-1.06.29-.29.76-.29 1.06 0l.22.22 1.72-1.72c.29-.29.76-.29 1.06 0 .29.29.29.77 0 1.06zM16.31 14.84c0 .41-.33.75-.75.75h-5.25c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h5.25c.42 0 .75.34.75.75zM7.97 13.87l-2.25 2.25c-.15.15-.34.22-.53.22s-.39-.07-.53-.22l-.75-.75c-.3-.29-.3-.77 0-1.06.29-.29.76-.29 1.06 0l.22.22 1.72-1.72c.29-.29.76-.29 1.06 0 .29.29.29.77 0 1.06z"/>
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Node.js installed</span>
                        </div>
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Modern web browser</span>
                        </div>
                                            <div class="d-flex align-items-center mt-16">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Text editor or IDE</span>
                        </div>
                                            <div class="d-flex align-items-center mt-16">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">JavaScript fundamentals</span>
                        </div>
                                            <div class="d-flex align-items-center mt-16">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Basic HTML/CSS knowledge</span>
                        </div>
                                    </div>
            ...
            <div class="">
                ...
                <p class="mt-4 font-12 text-gray-500">Check the frequently asked questions about this course.</p>
                    ...
                    <div class="accordion__title d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center cursor-pointer" href="#courseFAQ_28" data-parent="#courseFAQParent" role="button" data-toggle="collapse">
                            <div class="size-24">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 11.36v-.21c0-.68.42-1.04.84-1.33.41-.28.82-.64.82-1.3 0-.92-.74-1.66-1.66-1.66-.92 0-1.66.74-1.66 1.66M11.995 13.75h.01"/>
                        ...
                        <div class="collapse-arrow-icon d-flex cursor-pointer" href="#courseFAQ_28" data-parent="#courseFAQParent" role="button" data-toggle="collapse">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
                    ...
                    <div id="courseFAQ_28" class="accordion__collapse border-0 " role="tabpanel">
...
James's company, The Sound Agency, works with major brands worldwide to improve the way they sound. Their ...</div>
                ...
                <div class="swiper-wrapper py-0 mx-16 mx-md-32">
                            ...
                            <div class="bg-white p-16 rounded-12 border-gray-200">
                                ...
                                <div class="course-recent-review-desc mt-16 text-gray-500">
                                    this last lecture about controller and routing didnt worked for me. Second page is not loading even after taking uploaded resources.
                                </div>
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
            ...
            <div id="chaptersAccordion">
                ...
                <div class="accordion__title d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center cursor-pointer" href="#collapseChapter16" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
  ...
  <path d="M7.24 13.43h-1.9C3.15 13.43 2 14.58 2 16.76v1.9C2 20.85 3.15 22 5.33 22h1.9c2.18 0 3.33-1.15 3.33-3.33v-1.9c.01-2.19-1.14-3.34-3.32-3.34z" opacity=".4"/>
                        ...
                        <div class="ml-8">
                            <div class="font-14 font-weight-bold">Getting Started</div>
                            <div class="d-flex align-items-center mt-4 font-12 text-gray-500">2 Parts  | 0:20 Hours</div>
                        </div>
                    </div>

                    <div class="collapse-arrow-icon d-flex cursor-pointer" href="#collapseChapter16" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
                        <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>                    </div>
                </div>

                <div id="collapseChapter16" class="accordion__collapse border-0 " role="tabpanel">
                                                                                                        <div class="accordion bg-gray-100 border-gray-200 p-16 rounded-12 mt-16">
    <div class="accordion__title d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center cursor-pointer" href="#collapseSession65" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19.52 17.1l-2.78-1.95V8.84l2.78-1.95c1.36-.95 2.48-.37 2.48 1.3v7.62c0 1.67-1.12 2.25-2.48 1.29zM11.5 11a1.5 1.5 0 100-3 1.5 1.5 0 000 3z"/>
            ...
            <div class="font-14 font-weight-bold d-block">Getting Started</div>
        </div>

        <div class="collapse-arrow-icon d-flex cursor-pointer" href="#collapseSession65" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
            <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>        </div>
    </div>

    <div id="collapseSession65" class="accordion__collapse border-0 " role="tabpanel">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
                    ...
                    <div class="ml-8">
                        ...
                        <span class="d-block font-12 font-weight-bold text-gray-500 mt-4">12 Dec 2023 | 01:30</span>
                    </div>
                </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
                                                                                                                ...
                                                                                                                <div class="accordion bg-gray-100 border-gray-200 p-16 rounded-12 mt-16">
    <div class="accordion__title d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center cursor-pointer" href="#collapseQuiz31" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
            <div class="d-flex mr-8">
                <svg width="20px" height="20px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M16 4.02c3.33.18 5 1.41 5 5.98v6c0 4-1 6-6 6H9c-5 0-6-2-6-6v-6c0-4.56 1.67-5.8 5-5.98"/>
            ...
            <div class="font-14 font-weight-bold d-block">Placement Quiz</div>
        </div>

        <div class="collapse-arrow-icon d-flex cursor-pointer" href="#collapseQuiz31" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
            <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>        </div>
    </div>

    <div id="collapseQuiz31" class="accordion__collapse border-0 " role="tabpanel">
                    <div class="p-16 rounded-12 border-gray-200 bg-gray-100">
                <div class="font-14 text-gray-500">
                    <p>Determine your current AngularJS knowledge with this placement quiz to start the course at the right level.</p>
                </div>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M14.43 5.93L20.5 12l-6.07 6.07M3.5 12h16.83"/>
                                ...
                                <div class="accordion p-12 rounded-12 border-gray-200 bg-white mt-16">
                <div class="accordion__title d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center cursor-pointer" href="#collapseChapter17" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
                        <div class="d-flex-center size-48 rounded-12 bg-primary-20">
                            <svg width="24px" height="24px" class="icons text-primary" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M7.24 2h-1.9C3.15 2 2 3.15 2 5.33v1.9c0 2.18 1.15 3.33 3.33 3.33h1.9c2.18 0 3.33-1.15 3.33-3.33v-1.9C10.57 3.15 9.42 2 7.24 2z"/>
  <path d="M18.67 2h-1.9c-2.18 0-3.33 1.15-3.33 3.33v1.9c0 2.18 1.15 3.33 3.33 3.33h1.9c2.18 0 3.33-1.15 3.33-3.33v-1.9C22 3.15 20.85 2 18.67 2z" opacity=".4"/>
  ...
  <path d="M7.24 13.43h-1.9C3.15 13.43 2 14.58 2 16.76v1.9C2 20.85 3.15 22 5.33 22h1.9c2.18 0 3.33-1.15 3.33-3.33v-1.9c.01-2.19-1.14-3.34-3.32-3.34z" opacity=".4"/>
                        ...
                        <div class="ml-8">
                            <div class="font-14 font-weight-bold">Model, View, Whatever...</div>
                            <div class="d-flex align-items-center mt-4 font-12 text-gray-500">2 Parts  | 0:40 Hours</div>
                        </div>
                    </div>

                    <div class="collapse-arrow-icon d-flex cursor-pointer" href="#collapseChapter17" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
                        <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>                    </div>
                </div>

                <div id="collapseChapter17" class="accordion__collapse border-0 " role="tabpanel">
                                                                                                        <div class="accordion bg-gray-100 border-gray-200 p-16 rounded-12 mt-16">
    <div class="accordion__title d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center cursor-pointer" href="#collapseSession66" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
            <div class="d-flex mr-8">
                <svg width="20px" height="20px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12.53 20.42H6.21c-3.16 0-4.21-2.1-4.21-4.21V7.79c0-3.16 1.05-4.21 4.21-4.21h6.32c3.16 0 4.21 1.05 4.21 4.21v8.42c0 3.16-1.06 4.21-4.21 4.21z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19.52 17.1l-2.78-1.95V8.84l2.78-1.95c1.36-.95 2.48-.37 2.48 1.3v7.62c0 1.67-1.12 2.25-2.48 1.29zM11.5 11a1.5 1.5 0 100-3 1.5 1.5 0 000 3z"/>
            ...
            <div class="font-14 font-weight-bold d-block">Modules, Apps, and Controllers</div>
        </div>

        <div class="collapse-arrow-icon d-flex cursor-pointer" href="#collapseSession66" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
            <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>        </div>
    </div>

    <div id="collapseSession66" class="accordion__collapse border-0 " role="tabpanel">
        <div class="p-16 rounded-12 border-gray-200 bg-gray-100 text-gray-500">
            <div class="font-14 text-gray-500">
                <p>AngularJS enables you to control the DOM via modules, apps, and controllers -- all without polluting the global namespace.<br />
This lecture contains downloadable source code. Download the file below and unzip (or extract) it.</p>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
                    ...
                    <div class="ml-8">
                        <span class="d-block font-12 text-gray-400">Start Date</span>
                        <span class="d-block font-12 font-weight-bold text-gray-500 mt-4">15 Dec 2023 | 09:30</span>
                    </div>
                </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
                                                                                                                ...
                                                                                                                <div class="accordion bg-gray-100 border-gray-200 p-16 rounded-12 mt-16">
    <div class="accordion__title d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center cursor-pointer" href="#collapseSession67" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
            <div class="d-flex mr-8">
                <svg width="20px" height="20px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12.53 20.42H6.21c-3.16 0-4.21-2.1-4.21-4.21V7.79c0-3.16 1.05-4.21 4.21-4.21h6.32c3.16 0 4.21 1.05 4.21 4.21v8.42c0 3.16-1.06 4.21-4.21 4.21z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19.52 17.1l-2.78-1.95V8.84l2.78-1.95c1.36-.95 2.48-.37 2.48 1.3v7.62c0 1.67-1.12 2.25-2.48 1.29zM11.5 11a1.5 1.5 0 100-3 1.5 1.5 0 000 3z"/>
            ...
            <div class="font-14 font-weight-bold d-block">Data Binding and Directives</div>
        </div>

        <div class="collapse-arrow-icon d-flex cursor-pointer" href="#collapseSession67" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
            <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>        </div>
    </div>

    <div id="collapseSession67" class="accordion__collapse border-0 " role="tabpanel">
        <div class="p-16 rounded-12 border-gray-200 bg-gray-100 text-gray-500">
            <div class="font-14 text-gray-500">
                <p>Our first visual AngularJS code. Now that we understand scope, let's use it to output content to a page.</p><br />
<br />
<p>This lecture contains downloadable source code. Download the file below and unzip (or extract) it.</p>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
                    ...
                    <div class="ml-8">
                        <span class="d-block font-12 text-gray-400">Start Date</span>
                        <span class="d-block font-12 font-weight-bold text-gray-500 mt-4">18 Dec 2023 | 05:30</span>
                    </div>
                </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
            ...
            <div id="collapseCertificatesAccordion" class="accordion__collapse border-0 " role="tabpanel">
                            ...
                            <div class="accordion bg-gray-100 border-gray-200 p-16 rounded-12 mt-16">
    <div class="accordion__title d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center cursor-pointer" href="#quizCertificateCollapse31" data-parent="#certificateAccordion" role="button" data-toggle="collapse">
            <div class="d-flex mr-8">
                <svg width="20px" height="20px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7.52 13.52l-.01 7.38c0 .9.63 1.34 1.41.97l2.68-1.27c.22-.11.59-.11.81 0l2.69 1.27c.77.36 1.41-.07 1.41-.97v-7.56"/>
        ...
        <div class="collapse-arrow-icon d-flex cursor-pointer" href="#quizCertificateCollapse31" data-parent="#certificateAccordion" role="button" data-toggle="collapse">
            <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>        </div>
    </div>

    <div id="quizCertificateCollapse31" class="accordion__collapse border-0 " role="tabpanel">
  ...
  <path d="M14.35 2h-4.7c-1.04 0-1.89.84-1.89 1.88v.94c0 1.04.84 1.88 1.88 1.88h4.71c1.04 0 1.88-.84 1.88-1.88v-.94C16.24 2.84 15.39 2 14.35 2zM10.81 16.95c-.19 0-.38-.07-.53-.22l-1.5-1.5a.754.754 0 010-1.06c.29-.29.77-.29 1.06 0l.97.97 3.47-3.47c.29-.29.77-.29 1.06 0 .29.29.29.77 0 1.06l-4 4c-.14.15-.34.22-.53.22z"/>
            ...
            <div class="ml-14">
                ...
                <div class="mt-4 text-gray-500">You will receive this certificate after passing the “Placement QuizZ” quiz.</div>
            </div>
        </div>
...
<div class="js-reply-to-comment-html d-none">
  ...
  <path d="M12 2C6.49 2 2 6.49 2 12s4.49 10 10 10 10-4.49 10-10S17.51 2 12 2zm-.75 6c0-.41.34-.75.75-.75s.75.34.75.75v5c0 .41-.34.75-.75.75s-.75-.34-.75-.75V8zm1.67 8.38c-.05.13-.12.23-.21.33-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08s-.26-.03-.38-.08-.23-.12-.33-.21c-.09-.1-.16-.2-.21-.33A.995.995 0 0111 16c0-.13.03-.26.08-.38s.12-.23.21-.33c.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.09.1.16.21.21.33.05.12.08.25.08.38s-.03.26-.08.38z"/>
    ...
    <div class="review-rate-box position-relative">
        ...
        <div class="position-relative d-flex-center flex-column text-center bg-gray-100 border-gray-200 rounded-12 p-14 p-lg-20 z-index-2 w-100 h-100">
            <div class="font-44 font-weight-bold">2.75</div>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
    ...
    <div class="flex-1 ml-24">
            ...
            <div class="mt-16">
                <div class="font-12 text-gray-500">Content Quality (2)</div>
                <div class="review-progress position-relative mt-8 rounded-4 bg-gray-100">
                    <span class="review-progress__bar rounded-4 bg-warning" style="width: 40%"></span>
                </div>
            </div>
                    
            <div class="mt-16">
                <div class="font-12 text-gray-500">Instructor Skills (3)</div>
                <div class="review-progress position-relative mt-8 rounded-4 bg-gray-100">
            ...
            <div class="mt-16">
                <div class="font-12 text-gray-500">Value for Money (3)</div>
                <div class="review-progress position-relative mt-8 rounded-4 bg-gray-100">
                    <span class="review-progress__bar rounded-4 bg-warning" style="width: 60%"></span>
                </div>
            </div>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
        ...
        <div class="d-flex align-items-center">
            <span class="font-12 text-gray-500">13 Jul 2021 23:27</span>
                ...
                <div class="actions-dropdown__dropdown-menu dropdown-menu-top-32">
                    <ul class="my-8">
                        ...
                        <li class="actions-dropdown__dropdown-menu-item">
                            <button type="button" class="js-reply-review" data-review="27">Reply</button>
                        </li>
...
<div class="js-reply-to-review-html d-none">
    ...
    <form action="https://lms.rocket-soft.org/reviews/store-reply-comment" class="mt-16" method="post">
        <input type="hidden" name="webinar_id" value="2001"/>
  ...
  <path d="M12 2C6.49 2 2 6.49 2 12s4.49 10 10 10 10-4.49 10-10S17.51 2 12 2zm-.75 6c0-.41.34-.75.75-.75s.75.34.75.75v5c0 .41-.34.75-.75.75s-.75-.34-.75-.75V8zm1.67 8.38c-.05.13-.12.23-.21.33-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08s-.26-.03-.38-.08-.23-.12-.33-.21c-.09-.1-.16-.2-.21-.33A.995.995 0 0111 16c0-.13.03-.26.08-.38s.12-.23.21-.33c.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.09.1.16.21.21.33.05.12.08.25.08.38s-.03.26-.08.38z"/>
    ...
    <div class="position-relative bg-white rounded-24 pb-24 z-index-2">
        ...
        <div class="course-right-side__thumbnail position-relative bg-gray-200">
            <img src="../store/3/Learn%20and%20Understand%20AngularJS.jpg" class="img-cover" alt="Learn and Understand AngularJS">

                            <div id="webinarDemoVideoBtn" class="has-video-icon d-flex-center size-64 rounded-circle cursor-pointer"
                     data-video-path="https://lms.rocket-soft.org/store/3/Learn and Understand AngularJS.mkv"
                     data-video-source="upload"
                     data-thumbnail="/store/3/Learn and Understand AngularJS.jpg"
                >
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.996 11h.01M11.995 11h.01M7.995 11h.008"/>
            ...
            <div class="d-flex align-items-center justify-content-around mt-16 p-12 rounded-12 border-dashed border-gray-200">
                                    <a href="https://calendar.google.com/calendar/render?action=TEMPLATE&amp;dates=20231209T153000/20231209T153000&amp;ctz=UTC&amp;text=Learn+and+Understand+AngularJS" target="_blank" class="d-flex-center flex-column text-gray-500 font-12">
                        <svg width="20px" height="20px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8 2v3M16 2v3M3.5 9.09h17M21 8.5V17c0 3-1.5 5-5 5H8c-3.5 0-5-2-5-5V8.5c0-3 1.5-5 5-5h8c3.5 0 5 2 5 5z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12.62 20.81c-.34.12-.9.12-1.24 0C8.48 19.82 2 15.69 2 8.69 2 5.6 4.49 3.1 7.56 3.1c1.82 0 3.43.88 4.44 2.24a5.53 5.53 0 014.44-2.24C19.51 3.1 22 5.6 22 8.69c0 7-6.48 11.13-9.38 12.12z"/>
                ...
                <div class="js-share-course d-flex-center flex-column text-gray-500 font-12 cursor-pointer" data-path="/course/Learn-and-Understand-AngularJS/share-modal">
                    <svg width="20px" height="20px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
...
<div class="course-right-side-section position-relative mt-28">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
                ...
                <span class="">9 Dec 2023 | 15:30</span>
            </div>
    ...
    <div class="course-right-side-section position-relative mt-28">
        ...
        <div class="position-relative card-before-line bg-white rounded-24 p-16 z-index-2">
            ...
            <div class="d-flex gap-12 flex-wrap mt-16">
                                    <a href="../tags/courses/Angular.html" target="_blank" class="d-flex-center p-10 rounded-8 bg-gray-100 font-12 text-gray-500 text-center">Angular</a>
                                    <a href="../tags/courses/AngularJS.html" target="_blank" class="d-flex-center p-10 rounded-8 bg-gray-100 font-12 text-gray-500 text-center">AngularJS</a>
                                    <a href="../tags/courses/Javascript.html" target="_blank" class="d-flex-center p-10 rounded-8 bg-gray-100 font-12 text-gray-500 text-center">Javascript</a>
                            </div>
        </div>
    </div>
    ...
    <div class="container d-flex flex-column flex-lg-row align-items-lg-center justify-content-lg-between h-100">
        <div class="d-flex align-items-center mb-16 mb-lg-0">
            <div class="course-bottom-fixed-card__course-img rounded-8">
                <img src="../store/3/Learn%20and%20Understand%20AngularJS.jpg" class="img-cover rounded-8" alt="Learn and Understand AngularJS">
            </div>
            <div class="ml-8">
                <div class="font-12 text-gray-500">You are viewing</div>
                <div class="mt-4 font-14 font-weight-bold">Learn and Understand AngularJS</div>
            </div>
        </div>
...
<!-- Mirrored from lms.rocket-soft.org/course/Learn-and-Understand-AngularJS by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:39:14 GMT -->
</html>
