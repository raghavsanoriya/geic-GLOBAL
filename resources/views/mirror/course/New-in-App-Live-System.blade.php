...
<!-- Mirrored from lms.rocket-soft.org/course/New-in-App-Live-System by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:39:14 GMT -->
...
<meta name='robots' content="index, follow, all">
    ...
    <meta name="description" content="Online Course Creation can be simple once you have mastered the art of speaking in front of a camera.">
    <meta property="og:description" content="Online Course Creation can be simple once you have mastered the art of speaking in front of a camera.">
    <meta name='twitter:description' content='Online Course Creation can be simple once you have mastered the art of speaking in front of a camera.'>
...
<!-- Open Graph -->
<meta property='og:title' content='New In-App Live System'>
<meta name='twitter:card' content='summary'>
<meta name='twitter:title' content='New In-App Live System'>


<meta property='og:site_name' content='https://lms.rocket-soft.org/Rocket LMS'>
<meta property='og:image' content='../store/1015/new_live_system.jpg'>
<meta name='twitter:image' content='../store/1015/new_live_system.jpg'>
<meta property='og:locale' content='../en_US.html'>
<meta property='og:type' content='website'>



    <title>New In-App Live System | Rocket LMS</title>
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
    ...
    <img src="../store/1015/new_live_system_c.jpg" class="course-hero__cover-img img-cover rounded-32" alt="New In-App Live System"/>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
        ...
        <div class="d-flex align-items-center flex-wrap gap-12 mt-4">
            <h1 class="course-hero__title font-32 font-weight-bold text-white text-ellipsis">New In-App Live System</h1>
            ...
            <div class="d-flex flex-wrap align-items-center gap-12">
                                    ...
                                    <div class="d-flex-center gap-4 p-4 pr-8 rounded-32" style="background-color: rgb(28, 28, 28); color: #ffffff;">
                                                <span class="font-12">Bestseller</span>
                    </div>
                            </div>
        </div>

                    <div class="mt-8 text-white opacity-50">Agora Live Class Streaming enables real-time, high-quality interactive online classes with video, audio, and screen sharing. Engage students worldwide, foster collaboration, and deliver immersive learning experiences seamlessly, making education more accessible, engaging, and effective for everyone involved.</div>
            ...
            <div class="">
                ...
                <p class="mt-4 font-12 text-gray-500">Check the frequently asked questions about this course.</p>
                    ...
                    <div class="accordion__title d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center cursor-pointer" href="#courseFAQ_43" data-parent="#courseFAQParent" role="button" data-toggle="collapse">
                            <div class="size-24">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 11.36v-.21c0-.68.42-1.04.84-1.33.41-.28.82-.64.82-1.3 0-.92-.74-1.66-1.66-1.66-.92 0-1.66.74-1.66 1.66M11.995 13.75h.01"/>
                        ...
                        <div class="collapse-arrow-icon d-flex cursor-pointer" href="#courseFAQ_43" data-parent="#courseFAQParent" role="button" data-toggle="collapse">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
                    ...
                    <div id="courseFAQ_43" class="accordion__collapse border-0 " role="tabpanel">
                    ...
                    <div class="accordion__title d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center cursor-pointer" href="#courseFAQ_44" data-parent="#courseFAQParent" role="button" data-toggle="collapse">
                            <div class="size-24">
                                <svg width="24px" height="24px" class="icons text-primary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M17 18.43h-4l-4.45 2.96A.997.997 0 017 20.56v-2.13c-3 0-5-2-5-5v-6c0-3 2-5 5-5h10c3 0 5 2 5 5v6c0 3-2 5-5 5z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 11.36v-.21c0-.68.42-1.04.84-1.33.41-.28.82-.64.82-1.3 0-.92-.74-1.66-1.66-1.66-.92 0-1.66.74-1.66 1.66M11.995 13.75h.01"/>
                        ...
                        <div class="collapse-arrow-icon d-flex cursor-pointer" href="#courseFAQ_44" data-parent="#courseFAQParent" role="button" data-toggle="collapse">
                            <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>                        </div>
                    </div>

                    <div id="courseFAQ_44" class="accordion__collapse border-0 " role="tabpanel">
                        <div class="p-16 rounded-8 border-gray-200 text-gray-500 mt-8">
                            ...
                            <div class="accordion p-20 rounded-12 border-gray-200 bg-white mt-20">
                    <div class="accordion__title d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center cursor-pointer" href="#courseFAQ_45" data-parent="#courseFAQParent" role="button" data-toggle="collapse">
                            <div class="size-24">
                                <svg width="24px" height="24px" class="icons text-primary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M17 18.43h-4l-4.45 2.96A.997.997 0 017 20.56v-2.13c-3 0-5-2-5-5v-6c0-3 2-5 5-5h10c3 0 5 2 5 5v6c0 3-2 5-5 5z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 11.36v-.21c0-.68.42-1.04.84-1.33.41-.28.82-.64.82-1.3 0-.92-.74-1.66-1.66-1.66-.92 0-1.66.74-1.66 1.66M11.995 13.75h.01"/>
                        ...
                        <div class="collapse-arrow-icon d-flex cursor-pointer" href="#courseFAQ_45" data-parent="#courseFAQParent" role="button" data-toggle="collapse">
                            <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>                        </div>
                    </div>

                    <div id="courseFAQ_45" class="accordion__collapse border-0 " role="tabpanel">
                        <div class="p-16 rounded-8 border-gray-200 text-gray-500 mt-8">
                            ...
                            <div class="bg-white p-16 rounded-12 border-gray-200">
                                <div class="d-flex align-content-center">
                                    ...
                                    <div class="ml-8">
                                        ...
                                        <span class="d-block font-12 mt-4 text-gray-500">2 Mar 2022</span>
                                    </div>
                                </div>
...
Thank Robert :)
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
            ...
            <div class="ml-8">
                ...
                <p class="mt-4 font-12 text-gray-500">This course includes 1 modules, 3 lessons, and 166666:45 hours of materials.</p>
            </div>
        </div>
            ...
            <div id="chaptersAccordion">
                ...
                <div class="accordion__title d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center cursor-pointer" href="#collapseChapter30" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
  ...
  <path d="M7.24 13.43h-1.9C3.15 13.43 2 14.58 2 16.76v1.9C2 20.85 3.15 22 5.33 22h1.9c2.18 0 3.33-1.15 3.33-3.33v-1.9c.01-2.19-1.14-3.34-3.32-3.34z" opacity=".4"/>
                        ...
                        <div class="ml-8">
                            ...
                            <div class="d-flex align-items-center mt-4 font-12 text-gray-500">3 Parts  | 166666:45 Hours</div>
                        </div>
                    </div>

                    <div class="collapse-arrow-icon d-flex cursor-pointer" href="#collapseChapter30" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
                        <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>                    </div>
                </div>

                <div id="collapseChapter30" class="accordion__collapse border-0 " role="tabpanel">
                                                                                                        <div class="accordion bg-gray-100 border-gray-200 p-16 rounded-12 mt-16">
    <div class="accordion__title d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center cursor-pointer" href="#collapseSession74" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19.52 17.1l-2.78-1.95V8.84l2.78-1.95c1.36-.95 2.48-.37 2.48 1.3v7.62c0 1.67-1.12 2.25-2.48 1.29zM11.5 11a1.5 1.5 0 100-3 1.5 1.5 0 000 3z"/>
            ...
            <div class="font-14 font-weight-bold d-block">First sesions</div>
        </div>

        <div class="collapse-arrow-icon d-flex cursor-pointer" href="#collapseSession74" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
            <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>        </div>
    </div>

    <div id="collapseSession74" class="accordion__collapse border-0 " role="tabpanel">
        <div class="p-16 rounded-12 border-gray-200 bg-gray-100 text-gray-500">
            <div class="font-14 text-gray-500">
                <p>Online Course Creation can be simple once you have mastered the art of speaking in front of a camera. Imagine yourself delivering an entire course filled with great lectures</p>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
                    ...
                    <div class="ml-8">
                        ...
                        <span class="d-block font-12 font-weight-bold text-gray-500 mt-4">1 Mar 2022 | 18:30</span>
                    </div>
                </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
                    ...
                    <div class="ml-8">
                        ...
                        <span class="d-block font-12 font-weight-bold text-gray-500 mt-4">3 Minutes</span>
                    </div>
                </div>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
                                                                                                                ...
                                                                                                                <div class="accordion bg-gray-100 border-gray-200 p-16 rounded-12 mt-16">
    <div class="accordion__title d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center cursor-pointer" href="#collapseSession75" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
            <div class="d-flex mr-8">
                <svg width="20px" height="20px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12.53 20.42H6.21c-3.16 0-4.21-2.1-4.21-4.21V7.79c0-3.16 1.05-4.21 4.21-4.21h6.32c3.16 0 4.21 1.05 4.21 4.21v8.42c0 3.16-1.06 4.21-4.21 4.21z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19.52 17.1l-2.78-1.95V8.84l2.78-1.95c1.36-.95 2.48-.37 2.48 1.3v7.62c0 1.67-1.12 2.25-2.48 1.29zM11.5 11a1.5 1.5 0 100-3 1.5 1.5 0 000 3z"/>
            ...
            <div class="font-14 font-weight-bold d-block">Join to This Session</div>
        </div>

        <div class="collapse-arrow-icon d-flex cursor-pointer" href="#collapseSession75" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
            <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>        </div>
    </div>

    <div id="collapseSession75" class="accordion__collapse border-0 " role="tabpanel">
        <div class="p-16 rounded-12 border-gray-200 bg-gray-100 text-gray-500">
            <div class="font-14 text-gray-500">
                <p>The skill you will learn in this class is not primarily theoretical or academic. It is a skill that requires physical habits.</p>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
                    ...
                    <div class="ml-8">
                        <span class="d-block font-12 text-gray-400">Start Date</span>
                        <span class="d-block font-12 font-weight-bold text-gray-500 mt-4">2 Mar 2022 | 10:00</span>
                    </div>
                </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
                    ...
                    <div class="ml-8">
                        <span class="d-block font-12 text-gray-400">Duration</span>
                        <span class="d-block font-12 font-weight-bold text-gray-500 mt-4">9999999 Minutes</span>
                    </div>
                </div>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12.65 8.65L16 12l-3.35 3.35"/>
</svg>                        <span class="ml-4 text-gray-500">Go to Course</span>
                    </button>
                            </div>
        </div>
                                                                                                                ...
                                                                                                                <div class="accordion bg-gray-100 border-gray-200 p-16 rounded-12 mt-16">
    <div class="accordion__title d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center cursor-pointer" href="#collapseSession76" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
            <div class="d-flex mr-8">
                <svg width="20px" height="20px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12.53 20.42H6.21c-3.16 0-4.21-2.1-4.21-4.21V7.79c0-3.16 1.05-4.21 4.21-4.21h6.32c3.16 0 4.21 1.05 4.21 4.21v8.42c0 3.16-1.06 4.21-4.21 4.21z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19.52 17.1l-2.78-1.95V8.84l2.78-1.95c1.36-.95 2.48-.37 2.48 1.3v7.62c0 1.67-1.12 2.25-2.48 1.29zM11.5 11a1.5 1.5 0 100-3 1.5 1.5 0 000 3z"/>
            ...
            <div class="font-14 font-weight-bold d-block">Introduction Session</div>
        </div>

        <div class="collapse-arrow-icon d-flex cursor-pointer" href="#collapseSession76" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
            <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>        </div>
    </div>

    <div id="collapseSession76" class="accordion__collapse border-0 " role="tabpanel">
        <div class="p-16 rounded-12 border-gray-200 bg-gray-100 text-gray-500">
            <div class="font-14 text-gray-500">
                <p>The skill you will learn in this class is not primarily theoretical or academic. It is a skill that requires physical habits.</p>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
                    ...
                    <div class="ml-8">
                        <span class="d-block font-12 text-gray-400">Start Date</span>
                        <span class="d-block font-12 font-weight-bold text-gray-500 mt-4">1 Mar 2022 | 08:30</span>
                    </div>
                </div>
...
<div class="js-reply-to-comment-html d-none">
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
        ...
        <div class="d-flex align-items-center">
            <span class="font-12 text-gray-500">2 Mar 2022 15:57</span>
                ...
                <div class="actions-dropdown__dropdown-menu dropdown-menu-top-32">
                    <ul class="my-8">
                        ...
                        <li class="actions-dropdown__dropdown-menu-item">
                            <button type="button" class="js-reply-review" data-review="33">Reply</button>
                        </li>
...
<div class="js-reply-to-review-html d-none">
    ...
    <div class="position-relative bg-white rounded-24 pb-24 z-index-2">
        ...
        <div class="course-right-side__thumbnail position-relative bg-gray-200">
            <img src="../store/1015/new_live_system.jpg" class="img-cover" alt="New In-App Live System">
                     ...
                     data-thumbnail="../store/1015/new_live_system.jpg"
                >
  ...
  <path d="M17.49 9.6L5.6 16.77c-.7.42-1.6-.08-1.6-.9v-8c0-3.49 3.77-5.67 6.8-3.93l4.59 2.64 2.09 1.2c.69.41.7 1.41.01 1.82zM18.089 15.46l-4.05 2.34-4.04 2.33c-1.45.83-3.09.66-4.28-.18-.58-.4-.51-1.29.1-1.65l12.71-7.62c.6-.36 1.39-.02 1.5.67.25 1.55-.39 3.22-1.94 4.11z"/>
        ...
        <div class="d-flex align-items-center text-center">
            ...
            <button type="button" class="btn btn-block btn-primary btn-lg js-join-waitlist-user"  data-path="/course/New-in-App-Live-System/waitlists/get-modal">
                            Join Waitlist
                    </button>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.996 11h.01M11.995 11h.01M7.995 11h.008"/>
            ...
            <div class="d-flex align-items-center justify-content-around mt-16 p-12 rounded-12 border-dashed border-gray-200">
                                    <a href="https://calendar.google.com/calendar/render?action=TEMPLATE&amp;dates=20260301T020000/20260301T020000&amp;ctz=UTC&amp;text=New+In-App+Live+System" target="_blank" class="d-flex-center flex-column text-gray-500 font-12">
                        <svg width="20px" height="20px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8 2v3M16 2v3M3.5 9.09h17M21 8.5V17c0 3-1.5 5-5 5H8c-3.5 0-5-2-5-5V8.5c0-3 1.5-5 5-5h8c3.5 0 5 2 5 5z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12.62 20.81c-.34.12-.9.12-1.24 0C8.48 19.82 2 15.69 2 8.69 2 5.6 4.49 3.1 7.56 3.1c1.82 0 3.43.88 4.44 2.24a5.53 5.53 0 014.44-2.24C19.51 3.1 22 5.6 22 8.69c0 7-6.48 11.13-9.38 12.12z"/>
                ...
                <div class="js-share-course d-flex-center flex-column text-gray-500 font-12 cursor-pointer" data-path="/course/New-in-App-Live-System/share-modal">
                    <svg width="20px" height="20px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
...
<div class="course-right-side-section position-relative mt-28">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
                ...
                <span class="">1 Mar 2026 | 02:00</span>
            </div>
    ...
    <div class="course-right-side-section position-relative mt-28">
        ...
        <div class="position-relative card-before-line bg-white rounded-24 p-16 z-index-2">
            ...
            <div class="d-flex gap-12 flex-wrap mt-16">
                                    <a href="../tags/courses/Live%2bClass.html" target="_blank" class="d-flex-center p-10 rounded-8 bg-gray-100 font-12 text-gray-500 text-center">Live Class</a>
                                    <a href="../tags/courses/New%2bLive%2bSystem.html" target="_blank" class="d-flex-center p-10 rounded-8 bg-gray-100 font-12 text-gray-500 text-center">New Live System</a>
                            </div>
        </div>
    </div>
    ...
    <div class="container d-flex flex-column flex-lg-row align-items-lg-center justify-content-lg-between h-100">
        <div class="d-flex align-items-center mb-16 mb-lg-0">
            <div class="course-bottom-fixed-card__course-img rounded-8">
                <img src="../store/1015/new_live_system.jpg" class="img-cover rounded-8" alt="New In-App Live System">
            </div>
            <div class="ml-8">
                <div class="font-12 text-gray-500">You are viewing</div>
                <div class="mt-4 font-14 font-weight-bold">New In-App Live System</div>
            </div>
        </div>
...
<!-- Mirrored from lms.rocket-soft.org/course/New-in-App-Live-System by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:39:31 GMT -->
</html>
