...
<!-- Mirrored from lms.rocket-soft.org/course/How-to-Manage-Your-Virtual-Team by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:39:57 GMT -->
...
<meta name='robots' content="index, follow, all">
    ...
    <meta name="description" content="Learn step-by-step tips that help you get things done with your virtual team by increasing trust and accountability">
    <meta property="og:description" content="Learn step-by-step tips that help you get things done with your virtual team by increasing trust and accountability">
    <meta name='twitter:description' content='Learn step-by-step tips that help you get things done with your virtual team by increasing trust and accountability'>
...
<!-- Open Graph -->
<meta property='og:title' content='How to Manage Your Virtual Team'>
<meta name='twitter:card' content='summary'>
<meta name='twitter:title' content='How to Manage Your Virtual Team'>


<meta property='og:site_name' content='https://lms.rocket-soft.org/Rocket LMS'>
<meta property='og:image' content='https://lms.rocket-soft.org/store/929/How to Manage &amp; Influence Your Virtual Team.jpg'>
<meta name='twitter:image' content='https://lms.rocket-soft.org/store/929/How to Manage &amp; Influence Your Virtual Team.jpg'>
<meta property='og:locale' content='../en_US.html'>
<meta property='og:type' content='website'>



    <title>How to Manage Your Virtual Team | Rocket LMS</title>
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
    ...
    <img src="../store/929/How%20to%20Manage%20%26%20Influence%20Your%20Virtual%20Team_c.jpg.png" class="course-hero__cover-img img-cover rounded-32" alt="How to Manage Your Virtual Team"/>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
        ...
        <div class="d-flex align-items-center flex-wrap gap-12 mt-4">
            <h1 class="course-hero__title font-32 font-weight-bold text-white text-ellipsis">How to Manage Your Virtual Team</h1>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.06 19.39c-.62.42-1.4.77-2.35 1.08l-1.58.52c-3.97 1.28-6.06.21-7.35-3.76L2.5 13.28c-1.28-3.97-.22-6.07 3.75-7.35l1.58-.52c.41-.13.8-.24 1.17-.31-.3.61-.54 1.35-.74 2.2l-.98 4.19c-.98 4.18.31 6.24 4.48 7.23l1.68.4c.58.14 1.12.23 1.62.27zM12.64 8.53l4.85 1.23M11.66 12.4l2.9.74"/>
</svg>                <span class="mx-4 font-weight-bold">7</span>
        ...
        <div class="d-flex align-items-center justify-content-between mt-20">
            <div class="d-flex align-items-center">
                ...
                <div class="ml-8">
                    <a href="../users/kate-williams/profile.html" target="_blank" class="font-14 font-weight-bold text-white">Kate Williams</a>
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Hybrid work models</span>
                        </div>
                                            <div class="d-flex align-items-center p-16 rounded-8 bg-white">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Engagement strategies</span>
                        </div>
                                            <div class="d-flex align-items-center p-16 rounded-8 bg-white">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Security protocols</span>
                        </div>
                                            <div class="d-flex align-items-center p-16 rounded-8 bg-white">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Cultural awareness</span>
                        </div>
                                            <div class="d-flex align-items-center p-16 rounded-8 bg-white">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Productivity measurement</span>
                        </div>
                                            <div class="d-flex align-items-center p-16 rounded-8 bg-white">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Time zone management</span>
                        </div>
                                            <div class="d-flex align-items-center p-16 rounded-8 bg-white">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Performance tracking</span>
                        </div>
                                            <div class="d-flex align-items-center p-16 rounded-8 bg-white">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Remote communication tools</span>
                        </div>
                                            <div class="d-flex align-items-center p-16 rounded-8 bg-white">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Virtual team building</span>
                        </div>
                                    </div>
            </div>
        </div>
  ...
  <path d="M16.31 7.84c0 .41-.33.75-.75.75h-5.25c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h5.25c.42 0 .75.34.75.75zM7.97 6.87L5.72 9.12c-.15.15-.34.22-.53.22s-.39-.07-.53-.22l-.75-.75c-.3-.29-.3-.77 0-1.06.29-.29.76-.29 1.06 0l.22.22 1.72-1.72c.29-.29.76-.29 1.06 0 .29.29.29.77 0 1.06zM16.31 14.84c0 .41-.33.75-.75.75h-5.25c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h5.25c.42 0 .75.34.75.75zM7.97 13.87l-2.25 2.25c-.15.15-.34.22-.53.22s-.39-.07-.53-.22l-.75-.75c-.3-.29-.3-.77 0-1.06.29-.29.76-.29 1.06 0l.22.22 1.72-1.72c.29-.29.76-.29 1.06 0 .29.29.29.77 0 1.06z"/>
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Webcam for video calls</span>
                        </div>
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Openness to new methods</span>
                        </div>
                                            <div class="d-flex align-items-center mt-16">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Collaboration tools access</span>
                        </div>
                                            <div class="d-flex align-items-center mt-16">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Internet connection</span>
                        </div>
                                            <div class="d-flex align-items-center mt-16">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Experience managing people</span>
                        </div>
                                    </div>
            ...
            <div class="">
                ...
                <p class="mt-4 font-12 text-gray-500">Check the frequently asked questions about this course.</p>
                    ...
                    <div class="accordion__title d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center cursor-pointer" href="#courseFAQ_23" data-parent="#courseFAQParent" role="button" data-toggle="collapse">
                            <div class="size-24">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 11.36v-.21c0-.68.42-1.04.84-1.33.41-.28.82-.64.82-1.3 0-.92-.74-1.66-1.66-1.66-.92 0-1.66.74-1.66 1.66M11.995 13.75h.01"/>
                        ...
                        <div class="collapse-arrow-icon d-flex cursor-pointer" href="#courseFAQ_23" data-parent="#courseFAQParent" role="button" data-toggle="collapse">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
                    ...
                    <div id="courseFAQ_23" class="accordion__collapse border-0 " role="tabpanel">
                    ...
                    <div class="accordion__title d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center cursor-pointer" href="#courseFAQ_24" data-parent="#courseFAQParent" role="button" data-toggle="collapse">
                            <div class="size-24">
                                <svg width="24px" height="24px" class="icons text-primary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M17 18.43h-4l-4.45 2.96A.997.997 0 017 20.56v-2.13c-3 0-5-2-5-5v-6c0-3 2-5 5-5h10c3 0 5 2 5 5v6c0 3-2 5-5 5z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 11.36v-.21c0-.68.42-1.04.84-1.33.41-.28.82-.64.82-1.3 0-.92-.74-1.66-1.66-1.66-.92 0-1.66.74-1.66 1.66M11.995 13.75h.01"/>
                        ...
                        <div class="collapse-arrow-icon d-flex cursor-pointer" href="#courseFAQ_24" data-parent="#courseFAQParent" role="button" data-toggle="collapse">
                            <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>                        </div>
                    </div>

                    <div id="courseFAQ_24" class="accordion__collapse border-0 " role="tabpanel">
                        <div class="p-16 rounded-8 border-gray-200 text-gray-500 mt-8">
                            ...
                            <div class="accordion p-20 rounded-12 border-gray-200 bg-white mt-20">
                    <div class="accordion__title d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center cursor-pointer" href="#courseFAQ_25" data-parent="#courseFAQParent" role="button" data-toggle="collapse">
                            <div class="size-24">
                                <svg width="24px" height="24px" class="icons text-primary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M17 18.43h-4l-4.45 2.96A.997.997 0 017 20.56v-2.13c-3 0-5-2-5-5v-6c0-3 2-5 5-5h10c3 0 5 2 5 5v6c0 3-2 5-5 5z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 11.36v-.21c0-.68.42-1.04.84-1.33.41-.28.82-.64.82-1.3 0-.92-.74-1.66-1.66-1.66-.92 0-1.66.74-1.66 1.66M11.995 13.75h.01"/>
                        ...
                        <div class="collapse-arrow-icon d-flex cursor-pointer" href="#courseFAQ_25" data-parent="#courseFAQParent" role="button" data-toggle="collapse">
                            <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>                        </div>
                    </div>

                    <div id="courseFAQ_25" class="accordion__collapse border-0 " role="tabpanel">
                        <div class="p-16 rounded-8 border-gray-200 text-gray-500 mt-8">
...
<div class="course-about-instructor-card position-relative mt-32 mt-lg-60">
        ...
        <div class="course-about-instructor-card__details flex-1 py-16">
            <div class="d-flex align-items-center">
                <div class="position-relative d-flex-center size-80 rounded-12 bg-gray-200">
                    <img src="../store/929/setting/avatar.jpg" alt="Kate Williams" class="img-cover rounded-12">
                </div>

                <div class="ml-12 flex-1">
                    <a href="../users/kate-williams/profile.html" target="_blank" class="">
                        <h6 class="font-14 font-weight-bold text-dark">Kate Williams</h6>
                    </a>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M5.63 13.08l-.01 4.69c0 1.27.98 2.63 2.18 3.03l3.19 1.06c.55.18 1.46.18 2.02 0l3.19-1.06c1.2-.4 2.18-1.76 2.18-3.03v-4.64M21.4 15V9"/>
            ...
            <div class="mt-16 text-gray-500 line-height-1-5">"Short courses for busy managers"
...
I'm an Amazon bestselling author of 4 books about team management (including "Influencing Virtual Teams," "Don't Reply All," "Project Kickoff," and "Effective ...</div>
        </div>

        <div class="course-about-instructor-card__secondary-img position-relative">
            <img src="../store/929/setting/profile_secondary_image.png" alt="Kate Williams" class="img-cover">

                            <a href="../login.html" target="_blank" class="course-about-instructor-card__book-meeting-btn d-inline-flex align-items-center gap-8 px-24 py-12 cursor-pointer">
...
</svg>                    <span class="text-white">Book a Meeting</span>
                </a>
                    </div>
    </div>
</div>
                ...
                <div class="swiper-wrapper py-0 mx-16 mx-md-32">
                            ...
                            <div class="bg-white p-16 rounded-12 border-gray-200">
                                <div class="d-flex align-content-center">
                                    <div class="size-40 rounded-circle">
                                        <img src="../store/995/setting/avatar.jpg" alt="Camelia Schofield" class="img-cover rounded-circle">
                                    </div>
                                    <div class="ml-8">
                                        <span class="d-block font-weight-bold">Camelia Schofield</span>
                                        <span class="d-block font-12 mt-4 text-gray-500">13 Jul 2021</span>
                                    </div>
                                </div>

                                <div class="course-recent-review-desc mt-16 text-gray-500">
                                    Good Course, It has good tips and information, it is important to apply these on your day-to-day to make sure that you get the best of it. Liked the ...
                                </div>
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
            ...
            <div class="ml-8">
                ...
                <p class="mt-4 font-12 text-gray-500">This course includes 2 modules, 7 lessons, and 0 hours of materials.</p>
            </div>
        </div>
            ...
            <div id="chaptersAccordion">
                ...
                <div class="accordion__title d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center cursor-pointer" href="#collapseChapter9" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
  ...
  <path d="M7.24 13.43h-1.9C3.15 13.43 2 14.58 2 16.76v1.9C2 20.85 3.15 22 5.33 22h1.9c2.18 0 3.33-1.15 3.33-3.33v-1.9c.01-2.19-1.14-3.34-3.32-3.34z" opacity=".4"/>
                        ...
                        <div class="ml-8">
                            ...
                            <div class="d-flex align-items-center mt-4 font-12 text-gray-500">3 Parts </div>
                        </div>
                    </div>

                    <div class="collapse-arrow-icon d-flex cursor-pointer" href="#collapseChapter9" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
                        <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>                    </div>
                </div>

                <div id="collapseChapter9" class="accordion__collapse border-0 " role="tabpanel">
                                                                                                        <div class="accordion bg-gray-100 border-gray-200 p-16 rounded-12 mt-16">
    <div class="accordion__title d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center cursor-pointer" href="#collapseFiles37" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 22h6c5 0 7-2 7-7V9c0-5-2-7-7-7H9C4 2 2 4 2 9v6c0 5 2 7 7 7zM15.75 9h-7.5M15.75 15h-7.5"/>
        ...
        <div class="d-flex align-items-center gap-12">
            ...
            <div class="collapse-arrow-icon d-flex cursor-pointer" href="#collapseFiles37" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
                <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>            </div>
        </div>
    ...
    <div id="collapseFiles37" class="accordion__collapse border-0 " role="tabpanel">
        <div class="p-16 rounded-12 border-gray-200 bg-gray-100 mt-16">
            <div class="font-14 text-gray-500">
                <p>In this welcome  video, I give you a quick overview of what the course is about.</p>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7.99 21.97L7.98 19c0-1.11.89-2 2-2h4.01c1.1 0 1.99.89 2 1.99l.03 2.99M8.94 4.95l.05-2.89M11.94 4.95l.05-2.89M14.94 4.92l.05-2.88"/>
                ...
                <div class="ml-8">
                    ...
                    <span class="d-block font-12 font-weight-bold text-gray-500 mt-4">10.58 MB</span>
                </div>
            </div>

            <div class="mt-16 mt-lg-0">
                                                            <a href="How-to-Manage-Your-Virtual-Team/file/37/Introduction.mkv" class="btn btn-lg btn-primary">
                            <svg width="16px" height="16px" class="icons text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7 4.13c-3.54.52-5 2.6-5 6.87v4c0 5 2 7 7 7h6c5 0 7-2 7-7v-4c0-4.27-1.46-6.35-5-6.87"/>
                                                                                                                ...
                                                                                                                <div class="accordion bg-gray-100 border-gray-200 p-16 rounded-12 mt-16">
    <div class="accordion__title d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center cursor-pointer" href="#collapseFiles38" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
            <div class="d-flex mr-8">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 22h6c5 0 7-2 7-7V9c0-5-2-7-7-7H9C4 2 2 4 2 9v6c0 5 2 7 7 7zM15.75 9h-7.5M15.75 15h-7.5"/>
            ...
            <div class="font-14 font-weight-bold d-block">Principles of Behavior Change</div>
        </div>

        <div class="d-flex align-items-center gap-12">
            
            <div class="collapse-arrow-icon d-flex cursor-pointer" href="#collapseFiles38" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
                <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>            </div>
        </div>
    ...
    <div id="collapseFiles38" class="accordion__collapse border-0 " role="tabpanel">
        <div class="p-16 rounded-12 border-gray-200 bg-gray-100 mt-16">
            <div class="font-14 text-gray-500">
                <p>In this lecture, I discuss an overview of the "Principles of Behavior Change" module, the 4 power principles of behavior change, and what you should know about those principles when managing your virtual team.</p>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7 4.13c-3.54.52-5 2.6-5 6.87v4c0 5 2 7 7 7h6c5 0 7-2 7-7v-4c0-4.27-1.46-6.35-5-6.87"/>
                                                                                                                ...
                                                                                                                <div class="accordion bg-gray-100 border-gray-200 p-16 rounded-12 mt-16">
    <div class="accordion__title d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center cursor-pointer" href="#collapseQuiz30" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
            <div class="d-flex mr-8">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M16 4.02c3.33.18 5 1.41 5 5.98v6c0 4-1 6-6 6H9c-5 0-6-2-6-6v-6c0-4.56 1.67-5.8 5-5.98"/>
            ...
            <div class="font-14 font-weight-bold d-block">First Quiz</div>
        </div>

        <div class="collapse-arrow-icon d-flex cursor-pointer" href="#collapseQuiz30" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
            <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>        </div>
    </div>

    <div id="collapseQuiz30" class="accordion__collapse border-0 " role="tabpanel">
                    <div class="p-16 rounded-12 border-gray-200 bg-gray-100">
                <div class="font-14 text-gray-500">
                    <p>Measure your team management knowledge with this evaluation quiz to review skills and strategies learned during training.</p>
                </div>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M22 12c0 5.52-4.48 10-10 10s-8.89-5.56-8.89-5.56m0 0h4.52m-4.52 0v5M2 12C2 6.48 6.44 2 12 2c6.67 0 10 5.56 10 5.56m0 0v-5m0 5h-4.44"/>
                    ...
                    <div class="ml-8">
                        ...
                        <span class="d-block font-12 font-weight-bold text-gray-500 mt-4">0/5</span>
                    </div>
                </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M14.43 5.93L20.5 12l-6.07 6.07M3.5 12h16.83"/>
                                ...
                                <div class="accordion p-12 rounded-12 border-gray-200 bg-white mt-16">
                <div class="accordion__title d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center cursor-pointer" href="#collapseChapter10" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
                        <div class="d-flex-center size-48 rounded-12 bg-primary-20">
                            <svg width="24px" height="24px" class="icons text-primary" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M7.24 2h-1.9C3.15 2 2 3.15 2 5.33v1.9c0 2.18 1.15 3.33 3.33 3.33h1.9c2.18 0 3.33-1.15 3.33-3.33v-1.9C10.57 3.15 9.42 2 7.24 2z"/>
  <path d="M18.67 2h-1.9c-2.18 0-3.33 1.15-3.33 3.33v1.9c0 2.18 1.15 3.33 3.33 3.33h1.9c2.18 0 3.33-1.15 3.33-3.33v-1.9C22 3.15 20.85 2 18.67 2z" opacity=".4"/>
  ...
  <path d="M7.24 13.43h-1.9C3.15 13.43 2 14.58 2 16.76v1.9C2 20.85 3.15 22 5.33 22h1.9c2.18 0 3.33-1.15 3.33-3.33v-1.9c.01-2.19-1.14-3.34-3.32-3.34z" opacity=".4"/>
                        ...
                        <div class="ml-8">
                            <div class="font-14 font-weight-bold">Tactics of Influence &amp; Persuasion</div>
                            <div class="d-flex align-items-center mt-4 font-12 text-gray-500">4 Parts </div>
                        </div>
                    </div>

                    <div class="collapse-arrow-icon d-flex cursor-pointer" href="#collapseChapter10" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
                        <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>                    </div>
                </div>

                <div id="collapseChapter10" class="accordion__collapse border-0 " role="tabpanel">
                                                                                                        <div class="accordion bg-gray-100 border-gray-200 p-16 rounded-12 mt-16">
    <div class="accordion__title d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center cursor-pointer" href="#collapseFiles40" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
            <div class="d-flex mr-8">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 22h6c5 0 7-2 7-7V9c0-5-2-7-7-7H9C4 2 2 4 2 9v6c0 5 2 7 7 7zM15.75 9h-7.5M15.75 15h-7.5"/>
            ...
            <div class="font-14 font-weight-bold d-block">Before the Meeting</div>
        </div>

        <div class="d-flex align-items-center gap-12">
            
            <div class="collapse-arrow-icon d-flex cursor-pointer" href="#collapseFiles40" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
                <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>            </div>
        </div>
    ...
    <div id="collapseFiles40" class="accordion__collapse border-0 " role="tabpanel">
        <div class="p-16 rounded-12 border-gray-200 bg-gray-100 mt-16">
            <div class="font-14 text-gray-500">
                <p>In this lecture, I discuss the five things you should do before every meeting, and how to manage everyone’s expectations through a well-crafted meeting agenda.</p>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7 4.13c-3.54.52-5 2.6-5 6.87v4c0 5 2 7 7 7h6c5 0 7-2 7-7v-4c0-4.27-1.46-6.35-5-6.87"/>
                                                                                                                ...
                                                                                                                <div class="accordion bg-gray-100 border-gray-200 p-16 rounded-12 mt-16">
    <div class="accordion__title d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center cursor-pointer" href="#collapseFiles42" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
            <div class="d-flex mr-8">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 22h6c5 0 7-2 7-7V9c0-5-2-7-7-7H9C4 2 2 4 2 9v6c0 5 2 7 7 7zM15.75 9h-7.5M15.75 15h-7.5"/>
            ...
            <div class="font-14 font-weight-bold d-block">After the Meeting</div>
        </div>

        <div class="d-flex align-items-center gap-12">
            
            <div class="collapse-arrow-icon d-flex cursor-pointer" href="#collapseFiles42" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
                <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>            </div>
        </div>
    ...
    <div id="collapseFiles42" class="accordion__collapse border-0 " role="tabpanel">
        <div class="p-16 rounded-12 border-gray-200 bg-gray-100 mt-16">
            <div class="font-14 text-gray-500">
                <p>In this lecture, I discuss the two things you should do after every meeting, and how to follow up with your team to make sure they are committed to getting their actions completed.</p>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7 4.13c-3.54.52-5 2.6-5 6.87v4c0 5 2 7 7 7h6c5 0 7-2 7-7v-4c0-4.27-1.46-6.35-5-6.87"/>
                                                                                                                ...
                                                                                                                <div class="accordion bg-gray-100 border-gray-200 p-16 rounded-12 mt-16">
    <div class="accordion__title d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center cursor-pointer" href="#collapseFiles41" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
            <div class="d-flex mr-8">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 22h6c5 0 7-2 7-7V9c0-5-2-7-7-7H9C4 2 2 4 2 9v6c0 5 2 7 7 7zM15.75 9h-7.5M15.75 15h-7.5"/>
            ...
            <div class="font-14 font-weight-bold d-block">During the Meeting</div>
        </div>

        <div class="d-flex align-items-center gap-12">
            
            <div class="collapse-arrow-icon d-flex cursor-pointer" href="#collapseFiles41" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
                <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>            </div>
        </div>
    ...
    <div id="collapseFiles41" class="accordion__collapse border-0 " role="tabpanel">
        <div class="p-16 rounded-12 border-gray-200 bg-gray-100 mt-16">
            <div class="font-14 text-gray-500">
                <p>In this lecture, I discuss the five things you should do during every meeting, and how to facilitate your meetings to keep everyone focused on their tasks.</p>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7 4.13c-3.54.52-5 2.6-5 6.87v4c0 5 2 7 7 7h6c5 0 7-2 7-7v-4c0-4.27-1.46-6.35-5-6.87"/>
                                                                                                                ...
                                                                                                                <div class="accordion bg-gray-100 border-gray-200 p-16 rounded-12 mt-16">
    <div class="accordion__title d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center cursor-pointer" href="#collapseFiles39" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
            <div class="d-flex mr-8">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 22h6c5 0 7-2 7-7V9c0-5-2-7-7-7H9C4 2 2 4 2 9v6c0 5 2 7 7 7zM15.75 9h-7.5M15.75 15h-7.5"/>
            ...
            <div class="font-14 font-weight-bold d-block">The Power of Writing</div>
        </div>

        <div class="d-flex align-items-center gap-12">
            
            <div class="collapse-arrow-icon d-flex cursor-pointer" href="#collapseFiles39" data-parent="#chaptersAccordion" role="button" data-toggle="collapse">
                <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>            </div>
        </div>
    ...
    <div id="collapseFiles39" class="accordion__collapse border-0 " role="tabpanel">
        <div class="p-16 rounded-12 border-gray-200 bg-gray-100 mt-16">
            <div class="font-14 text-gray-500">
                <p>In this lecture, I discuss the following: The mysterious power of writing things down and The advantages of writing tasks out to your virtual team</p>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
            ...
            <div id="collapseCertificatesAccordion" class="accordion__collapse border-0 " role="tabpanel">
                            ...
                            <div class="accordion bg-gray-100 border-gray-200 p-16 rounded-12 mt-16">
    <div class="accordion__title d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center cursor-pointer" href="#quizCertificateCollapse30" data-parent="#certificateAccordion" role="button" data-toggle="collapse">
            <div class="d-flex mr-8">
                <svg width="20px" height="20px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7.52 13.52l-.01 7.38c0 .9.63 1.34 1.41.97l2.68-1.27c.22-.11.59-.11.81 0l2.69 1.27c.77.36 1.41-.07 1.41-.97v-7.56"/>
        ...
        <div class="collapse-arrow-icon d-flex cursor-pointer" href="#quizCertificateCollapse30" data-parent="#certificateAccordion" role="button" data-toggle="collapse">
            <svg width="16px" height="16px" class="icons text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>        </div>
    </div>

    <div id="quizCertificateCollapse30" class="accordion__collapse border-0 " role="tabpanel">
  ...
  <path d="M14.35 2h-4.7c-1.04 0-1.89.84-1.89 1.88v.94c0 1.04.84 1.88 1.88 1.88h4.71c1.04 0 1.88-.84 1.88-1.88v-.94C16.24 2.84 15.39 2 14.35 2zM10.81 16.95c-.19 0-.38-.07-.53-.22l-1.5-1.5a.754.754 0 010-1.06c.29-.29.77-.29 1.06 0l.97.97 3.47-3.47c.29-.29.77-.29 1.06 0 .29.29.29.77 0 1.06l-4 4c-.14.15-.34.22-.53.22z"/>
            ...
            <div class="ml-14">
                ...
                <div class="mt-4 text-gray-500">You will receive this certificate after passing the “First QuizZ” quiz.</div>
            </div>
        </div>
    ...
    <div class="d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center">
            <div class="size-48 rounded-circle bg-gray-100">
                <img src="../store/979/setting/avatar.jpg" class="js-avatar-img img-cover rounded-circle" alt="Sara Sullivan">
            </div>
            <div class="ml-8">
                <h6 class="font-14 font-weight-bold">Sara Sullivan</h6>
                <div class="mt-4 font-12 text-gray-500">Student</div>
            </div>
        </div>

        <div class="d-flex align-items-center">
            <span class="font-12 text-gray-500">9 Jul 2021</span>
                ...
                <div class="actions-dropdown__dropdown-menu dropdown-menu-top-32">
                    <ul class="my-8">
                        ...
                        <li class="actions-dropdown__dropdown-menu-item">
                            <button type="button" class="js-reply-comment" data-comment="45" data-item="1999" data-item-name="webinar_id">Reply</button>
                        </li>

                        <li class="actions-dropdown__dropdown-menu-item">
                            <button type="button" class="js-report-comment" data-comment="45" data-item="1999" data-item-name="webinar_id">Report</button>
                        </li>
...
<div class="js-reply-to-comment-html d-none">
  ...
  <path d="M12 2C6.49 2 2 6.49 2 12s4.49 10 10 10 10-4.49 10-10S17.51 2 12 2zm-.75 6c0-.41.34-.75.75-.75s.75.34.75.75v5c0 .41-.34.75-.75.75s-.75-.34-.75-.75V8zm1.67 8.38c-.05.13-.12.23-.21.33-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08s-.26-.03-.38-.08-.23-.12-.33-.21c-.09-.1-.16-.2-.21-.33A.995.995 0 0111 16c0-.13.03-.26.08-.38s.12-.23.21-.33c.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.09.1.16.21.21.33.05.12.08.25.08.38s-.03.26-.08.38z"/>
    ...
    <div class="review-rate-box position-relative">
        ...
        <div class="position-relative d-flex-center flex-column text-center bg-gray-100 border-gray-200 rounded-12 p-14 p-lg-20 z-index-2 w-100 h-100">
            <div class="font-44 font-weight-bold">3.75</div>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
    ...
    <div class="flex-1 ml-24">
            ...
            <div class="mt-16">
                <div class="font-12 text-gray-500">Content Quality (4)</div>
                <div class="review-progress position-relative mt-8 rounded-4 bg-gray-100">
                    <span class="review-progress__bar rounded-4 bg-warning" style="width: 80%"></span>
                </div>
            </div>
                    
            <div class="mt-16">
                <div class="font-12 text-gray-500">Instructor Skills (4)</div>
                <div class="review-progress position-relative mt-8 rounded-4 bg-gray-100">
                    <span class="review-progress__bar rounded-4 bg-warning" style="width: 80%"></span>
                </div>
            </div>
            ...
            <div class="mt-16">
                <div class="font-12 text-gray-500">Value for Money (4)</div>
                <div class="review-progress position-relative mt-8 rounded-4 bg-gray-100">
                    <span class="review-progress__bar rounded-4 bg-warning" style="width: 80%"></span>
                </div>
            </div>
            ...
            <div class="mt-16">
                <div class="font-12 text-gray-500">Support Quality (3)</div>
                <div class="review-progress position-relative mt-8 rounded-4 bg-gray-100">
                    <span class="review-progress__bar rounded-4 bg-warning" style="width: 60%"></span>
                </div>
            </div>
    ...
    <div class="d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center">
            <div class="size-48 rounded-circle bg-gray-100">
                <img src="../store/995/setting/avatar.jpg" class="js-avatar-img img-cover rounded-circle" alt="Camelia Schofield">
            </div>
            <div class="ml-8">
                <h6 class="font-14 font-weight-bold">Camelia Schofield</h6>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
        ...
        <div class="d-flex align-items-center">
            <span class="font-12 text-gray-500">13 Jul 2021 23:30</span>
  ...
  <path stroke-width="1.5" d="M5 10c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zM19 10c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zM12 10c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"/>
                ...
                <div class="actions-dropdown__dropdown-menu dropdown-menu-top-32">
                    <ul class="my-8">
                        ...
                        <li class="actions-dropdown__dropdown-menu-item">
                            <button type="button" class="js-reply-review" data-review="29">Reply</button>
                        </li>
    ...
    <div class="mt-12 text-gray-500 font-14">
        Good Course, It has good tips and information, it is important to apply these on your day-to-day to make sure that you get the best of it. Liked the summary slides.
    </div>
...
<div class="js-reply-to-review-html d-none">
    ...
    <form action="https://lms.rocket-soft.org/reviews/store-reply-comment" class="mt-16" method="post">
        <input type="hidden" name="webinar_id" value="1999"/>
  ...
  <path d="M12 2C6.49 2 2 6.49 2 12s4.49 10 10 10 10-4.49 10-10S17.51 2 12 2zm-.75 6c0-.41.34-.75.75-.75s.75.34.75.75v5c0 .41-.34.75-.75.75s-.75-.34-.75-.75V8zm1.67 8.38c-.05.13-.12.23-.21.33-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08s-.26-.03-.38-.08-.23-.12-.33-.21c-.09-.1-.16-.2-.21-.33A.995.995 0 0111 16c0-.13.03-.26.08-.38s.12-.23.21-.33c.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.09.1.16.21.21.33.05.12.08.25.08.38s-.03.26-.08.38z"/>
    ...
    <div class="position-relative bg-white rounded-24 pb-24 z-index-2">
        ...
        <div class="course-right-side__thumbnail position-relative bg-gray-200">
            <img src="../store/929/How%20to%20Manage%20%26%20Influence%20Your%20Virtual%20Team.jpg" class="img-cover" alt="How to Manage Your Virtual Team">

                            <div id="webinarDemoVideoBtn" class="has-video-icon d-flex-center size-64 rounded-circle cursor-pointer"
                     data-video-path="https://lms.rocket-soft.org/store/929/How To Manage &amp; Influence Your Virtual Team.mkv"
                     data-video-source="upload"
                     data-thumbnail="/store/929/How to Manage &amp; Influence Your Virtual Team.jpg"
                >
  ...
  <path d="M17.49 9.6L5.6 16.77c-.7.42-1.6-.08-1.6-.9v-8c0-3.49 3.77-5.67 6.8-3.93l4.59 2.64 2.09 1.2c.69.41.7 1.41.01 1.82zM18.089 15.46l-4.05 2.34-4.04 2.33c-1.45.83-3.09.66-4.28-.18-.58-.4-.51-1.29.1-1.65l12.71-7.62c.6-.36 1.39-.02 1.5.67.25 1.55-.39 3.22-1.94 4.11z"/>
        ...
        <form action="https://lms.rocket-soft.org/cart/store" method="post">
            <input type="hidden" name="_token" value="KkDAnXKdDFkgpTFwX3uTuPHuAseZywMbZmqb7QZE">
            <input type="hidden" name="item_id" value="1999">
        ...
        <h6 class="font-12 font-weight-bold mb-16">Select a Pricing Plan</h6>
            ...
            <div class="course-right-side__price-plan position-relative custom-input-button position-relative mt-12">
                <input class="form-check-input" type="radio"
                       disabled
                       data-discount-price="$40"
                       value=""
                       name="ticket_id"
                       id="courseOff30">

                <label for="courseOff30" class="position-relative d-flex flex-column align-items-start p-16 rounded-12 bg-white disabled">
                    <span class="course-price-plan-title font-12 font-weight-bold">First Students Offer (20% Off)</span>
                    <span class="course-price-plan-subtitle font-12 mt-8">Available for the first 100 students until 9 June 2021</span>
                </label>
    ...
    <div id="priceBox" class="d-flex align-items-end justify-content-center  mt-20 px-16">
        ...
        <div class="d-flex align-items-center text-center">
            ...
            <button type="button" class="btn btn-block btn-primary btn-lg js-course-add-to-cart-btn">
                            Add to Cart
                    </button>

                    <a href="../login.html" class=" btn btn-outline-warning btn-block btn-lg mt-14 " rel="nofollow" data-path="/course/How-to-Manage-Your-Virtual-Team/points/get-modal">
                Buy with 500 points
            </a>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12.62 20.81c-.34.12-.9.12-1.24 0C8.48 19.82 2 15.69 2 8.69 2 5.6 4.49 3.1 7.56 3.1c1.82 0 3.43.88 4.44 2.24a5.53 5.53 0 014.44-2.24C19.51 3.1 22 5.6 22 8.69c0 7-6.48 11.13-9.38 12.12z"/>
                ...
                <div class="js-share-course d-flex-center flex-column text-gray-500 font-12 cursor-pointer" data-path="/course/How-to-Manage-Your-Virtual-Team/share-modal">
                    <svg width="20px" height="20px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
...
<div class="course-right-side-section position-relative mt-28">
    ...
    <div class="position-relative bg-white rounded-24 p-16 z-index-2">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="ml-8">
                <div class="d-flex align-items-center gap-8">
                    <a href="../users/kate-williams/profile.html" target="_blank">
                        <span class="d-block font-weight-bold text-dark">Kate Williams</span>
                    </a>
                </div>

                <p class="mt-2 font-12 text-gray-500">Computer Engineer at Oracle</p>
            </div>
        </div>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
                    ...
                    <img src="../store/1/default_images/badges/sales2.svg" class="img-cover rounded-8" alt="Top Seller">
                            ...
                            <div class="size-32 rounded-8" data-toggle="tooltip" data-placement="bottom" data-html="true" title="Support Rating from 3 to 4">
                    <img src="../store/1/default_images/badges/support2.svg" class="img-cover rounded-8" alt="Amazing Support">
                </div>
                    </div>

        <div class="d-flex align-items-center gap-16 mt-16">
            <a href="../users/kate-williams/profile.html" target="_blank" class="btn btn-primary btn-lg flex-1">Profile</a>

                            <a href="../login.html" target="_blank" class="d-inline-flex-center size-48 rounded-12 border-2 border-gray-400">
            ...
            <div class="position-relative d-flex align-items-center bg-white p-16 rounded-16 z-index-2 w-100 h-100">
                <div class="d-flex-center size-56 rounded-circle bg-success-20">
                    <div class="d-flex-center size-40 rounded-circle bg-success">
                        <svg width="24px" height="24px" class="icons text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M19.48 12.95h2.02v-1.44c0-2.07-1.69-3.76-3.76-3.76H6.26c-2.07 0-3.76 1.69-3.76 3.76v3.65c.79-.72 1.85-1.16 3-1.16a4.5 4.5 0 014.5 4.5c0 .53-.09 1.03-.26 1.5-.27.79-.77 1.47-1.4 2h9.4c2.07 0 3.76-1.69 3.76-3.76v-1.19h-1.9c-1.08 0-2.07-.79-2.16-1.87-.06-.63.18-1.22.6-1.63.37-.38.88-.6 1.44-.6z" opacity=".4"/>
  <path d="M5.5 14c-1.15 0-2.21.44-3 1.16A4.428 4.428 0 001 18.5 4.5 4.5 0 005.5 23c1.08 0 2.06-.38 2.84-1 .63-.53 1.13-1.21 1.4-2 .17-.47.26-.97.26-1.5A4.5 4.5 0 005.5 14zm2.7 3.63c0 .31-.25.55-.55.55-.3 0-.55-.24-.55-.55v-.11c0-.12-.09-.22-.21-.22H4.63a.547.547 0 01-.48.81c-.14 0-.28-.06-.38-.16l-.81-.81a.567.567 0 01-.12-.18.607.607 0 010-.42c.03-.06.07-.13.12-.18l.81-.8c.21-.22.56-.22.77 0 .18.17.2.44.09.64h2.26c.72 0 1.31.59 1.31 1.32v.11zM6.85 21.6c-.15 0-.29-.05-.39-.16a.532.532 0 01-.09-.64H4.11c-.72 0-1.31-.59-1.31-1.32v-.11c0-.31.25-.55.55-.55.3 0 .55.24.55.55v.11c0 .12.09.22.21.22h2.26a.547.547 0 01.09-.65.55.55 0 01.77 0l.81.81c.05.05.09.11.12.18.05.13.05.28 0 .42-.03.06-.07.13-.12.18l-.81.8c-.1.11-.24.16-.38.16zM14.85 3.95v3.8H6.26c-2.07 0-3.76 1.69-3.76 3.76V7.84c0-1.19.73-2.25 1.84-2.67l7.94-3c1.24-.46 2.57.45 2.57 1.78zM22.56 13.97v2.06c0 .55-.44 1-1 1.02H19.6c-1.08 0-2.07-.79-2.16-1.87-.06-.63.18-1.22.6-1.63.37-.38.88-.6 1.44-.6h2.08c.56.02 1 .47 1 1.02zM14 12.75H7c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h7c.41 0 .75.34.75.75s-.34.75-.75.75z"/>
</svg>                    </div>
                </div>
                <div class="ml-8">
                    <h6 class="font-14 font-weight-bold text-dark">Get Cashback</h6>

                                                                        <div class="mt-4 font-12 text-gray-500">Buy this product to earn $5 as cashback.</div>
                                                            </div>
            </div>
        </div>
...
<a href="../login.html" class="">
  ...
  <path d="M8.94 10v5.14c0 .8.88 1.27 1.55.84l.94-.62a1 1 0 011.1 0l.89.6a.997.997 0 001.55-.83V10H8.94z" opacity=".6"/>
                ...
                <div class="ml-8">
                    <h3 class="course-show__gift-card-title font-14">Send Course as Gift</h3>
                    <div class="course-show__gift-card-subtitle mt-4 font-12">Send as a gift to friends</div>
                </div>
            </div>
        </div>
    </a>
    ...
    <div class="course-right-side-section position-relative mt-28">
        ...
        <div class="position-relative card-before-line bg-white rounded-24 p-16 z-index-2">
            ...
            <div class="d-flex gap-12 flex-wrap mt-16">
                                    <a href="../tags/courses/Virtual%2bTeam.html" target="_blank" class="d-flex-center p-10 rounded-8 bg-gray-100 font-12 text-gray-500 text-center">Virtual Team</a>
                                    <a href="../tags/courses/Team.html" target="_blank" class="d-flex-center p-10 rounded-8 bg-gray-100 font-12 text-gray-500 text-center">Team</a>
                            </div>
        </div>
    </div>
    ...
    <div class="container d-flex flex-column flex-lg-row align-items-lg-center justify-content-lg-between h-100">
        <div class="d-flex align-items-center mb-16 mb-lg-0">
            <div class="course-bottom-fixed-card__course-img rounded-8">
                <img src="../store/929/How%20to%20Manage%20%26%20Influence%20Your%20Virtual%20Team.jpg" class="img-cover rounded-8" alt="How to Manage Your Virtual Team">
            </div>
            <div class="ml-8">
                <div class="font-12 text-gray-500">You are viewing</div>
                <div class="mt-4 font-14 font-weight-bold">How to Manage Your Virtual Team</div>
            </div>
        </div>
                    ...
                    <div id="publicChatFloatCta" class="public-chat-float" style="width: 320px;">
                        <a href="../login.html" class="public-chat-cta-card public-chat-cta-card--no-hover card-with-mask d-block" style="box-shadow: 0 8px 32px rgba(0, 0, 0, 0.12); border-radius: 16px;">
                            ...
                            <div class="public-chat-cta-card-box position-relative z-index-2 d-flex align-items-center p-16 rounded-16">
                                ...
                                <div class="public-chat-cta-card-icon-1 d-flex-center size-56 rounded-circle flex-shrink-0">
                                    <div class="public-chat-cta-card-icon-2 d-flex-center size-40 rounded-circle position-relative z-index-2">
                                        <img src="../store/929/setting/avatar.jpg"
                                             alt="Kate Williams"
...
<!-- Mirrored from lms.rocket-soft.org/course/How-to-Manage-Your-Virtual-Team by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:40:29 GMT -->
</html>
