...
<!-- Mirrored from www.geic.in/register by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:22:22 GMT -->
...
<meta property='og:type' content='website'>
    ...
    <title>Register | Trans Globe Indore LMS</title>
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
                    ...
                    <div class="position-relative bg-white rounded-32 p-16 z-index-2">
                        <div class="row">
                            <div class="col-12 col-lg-6">
                                    ...
                                    <form method="Post" action="https://www.geic.in/register" class="js-auth-page-form mt-16">
        <input type="hidden" name="_token" value="KkDAnXKdDFkgpTFwX3uTuPHuAseZywMbZmqb7QZE">

        <div class="pl-16 ">
            <div class="font-16 font-weight-bold">Join us now! 😊</div>
            <h1 class="font-24 mt-4">Create an account</h1>
        </div>

        <div class="auth-page-form-container pr-16 mt-16 pt-16" data-simplebar >

                            <div class="mb-28">
                    <div class="font-12 text-gray-500">Select a role</div>

                    <div class="d-flex align-items-center gap-4 p-4 rounded-12 border-gray-300 mt-8">
                        <div class="auth-register-method-item flex-1">
                            <input type="radio" name="account_type" value="user" id="userRole" class="" checked>
                            <label class="d-flex-center cursor-pointer" for="userRole">Student</label>
                        </div>

                                                    <div class="auth-register-method-item flex-1">
                                <input type="radio" name="account_type" value="teacher" id="teacherRole" class="" >
                                <label class="d-flex-center cursor-pointer" for="teacherRole">Instructor</label>
                            </div>
                                                    <div class="auth-register-method-item flex-1">
                                <input type="radio" name="account_type" value="organization" id="organizationRole" class="" >
                                <label class="d-flex-center cursor-pointer" for="organizationRole">Organization</label>
                            </div>
                                            </div>
                </div>
    ...
    <div class="register-mobile-form-group position-relative ">
        <label class="form-group-label">Phone (Optional)</label>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 20.27c3.53 0 6.82-2.08 9.11-5.68.9-1.41.9-3.78 0-5.19-2.29-3.6-5.58-5.68-9.11-5.68-3.53 0-6.82 2.08-9.11 5.68-.9 1.41-.9 3.78 0 5.19 2.29 3.6 5.58 5.68 9.11 5.68z"/>
            ...
            <div class="form-group ">
                <label class="form-group-label" for="confirm_password">Retype Password:</label>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 20.27c3.53 0 6.82-2.08 9.11-5.68.9-1.41.9-3.78 0-5.19-2.29-3.6-5.58-5.68-9.11-5.68-3.53 0-6.82 2.08-9.11 5.68-.9 1.41-.9 3.78 0 5.19 2.29 3.6 5.58 5.68 9.11 5.68z"/>
                ...
                <div class="form-group js-auth-timezone-container">
                    <label class="form-group-label">Time Zone</label>
                    <select name="timezone" class="form-control select2" data-allow-clear="false" data-dropdown-parent=".js-auth-page-form">
                        <option value="" selected disabled>Select</option>
                            ...
                            <div class="form-group ">
                    <label class="form-group-label" for="referral_code">Referral Code:</label>
                    <input name="referral_code" type="text"
                           class="form-control " id="referral_code"
                           value=""
            ...
            <div class="mr-24">
                <div class="custom-control custom-checkbox">
                    <input type="checkbox" name="term" value="1" id="termCheckbox" class="custom-control-input" >
                    <label class="custom-control__label cursor-pointer" for="termCheckbox">
                        I agree to the
                        <a href="pages/terms.html" target="_blank" class="font-weight-bold text-dark ml-4">terms &amp; rules</a>
                    </label>
                </div>
        ...
        <div class="pl-16">
            <button type="button" class="js-submit-form-btn btn btn-primary btn-lg btn-block mt-24">Sign Up</button>

            <div class="d-flex-center flex-column text-center mt-24">
                <span class="text-gray-500">Already have an account?</span>
                <a href="login.html" class="font-weight-bold text-dark mt-8">Login</a>
            </div>
        </div>
    </form>
...
<!-- Mirrored from www.geic.in/register by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:22:24 GMT -->
</html>
