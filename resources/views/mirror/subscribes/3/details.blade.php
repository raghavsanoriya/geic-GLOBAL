...
<!-- Mirrored from lms.rocket-soft.org/subscribes/3/details by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:36:06 GMT -->
...
<meta property='og:type' content='website'>
    ...
    <title>Subscription Plan Details | Rocket LMS</title>
    ...
    <link rel="stylesheet" href="https://lms.rocket-soft.org/assets/design_1/css/app.min.css">
        ...
        <link rel="stylesheet" href="https://lms.rocket-soft.org/assets/design_1/css/parts/subscribe_details.min.css">
...
<div id="app">
                    ...
                    <div class="d-flex align-items-center">
                        <div class="d-flex-center size-56 bg-gray-200 rounded-circle">
                            <div class="d-flex-center size-40 bg-primary rounded-circle">
                                <img src="https://lms.rocket-soft.org/store/1/default_images/subscribe_packages/subscribe_icon_1.svg" alt="Starter Access" class="img-fluid" height="24px">
                            </div>
                        </div>
                        <div class="ml-8">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 22c5.5 0 10-4.5 10-10S17.5 2 12 2 2 6.5 2 12s4.5 10 10 10zM8 12h8M12 16V8"/>
                        ...
                        <div class="col-12 col-lg-4 mt-12 mt-lg-0 d-lg-flex align-items-lg-center justify-content-lg-end">
                            <form action="https://lms.rocket-soft.org/panel/financial/pay-subscribes" method="post" class="">
                                <input type="hidden" name="_token" value="KkDAnXKdDFkgpTFwX3uTuPHuAseZywMbZmqb7QZE">
