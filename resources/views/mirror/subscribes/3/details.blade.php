...
<!-- Mirrored from www.geic.in/subscribes/3/details by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:36:06 GMT -->
...
<!-- Open Graph -->
<meta property='og:title' content='Subscription Plan Details'>
<meta name='twitter:card' content='summary'>
<meta name='twitter:title' content='Subscription Plan Details'>
...
<meta property='og:type' content='website'>
    ...
    <title>Subscription Plan Details | Trans Globe Indore LMS</title>
    ...
    <link rel="stylesheet" href="https://www.geic.in/assets/design_1/css/app.min.css">
        ...
        <link rel="stylesheet" href="https://www.geic.in/assets/design_1/css/parts/subscribe_details.min.css">
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
        ...
        <div class="d-flex-center flex-column text-center">
            <h1 class="font-32 font-weight-bold">Subscription Plan Details</h1>
            <p class="mt-8 font-16 text-gray-500">View all content available with this subscription plan</p>
        </div>
    ...
    <div class="position-relative bg-primary p-4 rounded-16 z-index-2">
        <div class="px-4 py-8">
            <h4 class="font-14 font-weight-bold text-white">Plan Overview</h4>
        </div>
                    ...
                    <div class="d-flex align-items-center">
                        <div class="d-flex-center size-56 bg-gray-200 rounded-circle">
                            <div class="d-flex-center size-40 bg-primary rounded-circle">
                                <img src="https://www.geic.in/store/1/default_images/subscribe_packages/subscribe_icon_1.svg" alt="Starter Access" class="img-fluid" height="24px">
                            </div>
                        </div>
                        <div class="ml-8">
                            <h5 class="font-14 font-weight-bold">Starter Access</h5>
                            <p class="font-12 text-gray-500 mt-4">Ideal for beginners to start learning</p>
                        </div>
                    </div>
                </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
                                ...
                                <div class="ml-8">
                                    ...
                                    <span class="d-block font-14 font-weight-bold text-gray-500 mt-4">15 Days</span>
                                </div>
                            </div>
                        </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 22c5.5 0 10-4.5 10-10S17.5 2 12 2 2 6.5 2 12s4.5 10 10 10zM8 12h8M12 16V8"/>
                                ...
                                <div class="ml-8">
                                    <span class="d-block font-12 text-gray-400">Number of Subscribes</span>
                                    <span class="d-block font-14 font-weight-bold text-gray-500 mt-4">100</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-lg-4 mt-12 mt-lg-0 d-lg-flex align-items-lg-center justify-content-lg-end">
                            <form action="https://www.geic.in/panel/financial/pay-subscribes" method="post" class="">
                                <input type="hidden" name="_token" value="KkDAnXKdDFkgpTFwX3uTuPHuAseZywMbZmqb7QZE">
                                <input name="amount" value="20" type="hidden">
                                <input name="id" value="3" type="hidden">

                                <div class="d-flex align-items-center gap-8 w-100">
                                    <button type="submit" class="btn btn-primary btn-lg flex-1 ">Purchase</button>
            ...
            <div class="mt-16 pt-16 px-16 border-top-gray-200">
                                    <h4 class="font-16">Unlimited Content</h4>
                    <p class="mt-4 font-12 text-gray-500">This plan allows you to subscribe to all courses and bundles.</p>
                            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="mt-40">
                <h2 class="font-16">Recommended Courses</h2>
                <p class="mt-4 text-gray-500">Subscribe to the following content or explore more based on your plan access</p>
            </div>
