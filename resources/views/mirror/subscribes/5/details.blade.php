...
<!-- Mirrored from www.geic.in/subscribes/5/details by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:36:06 GMT -->
...
<div id="app">
                    ...
                    <div class="d-flex align-items-center">
                        <div class="d-flex-center size-56 bg-gray-200 rounded-circle">
                            <div class="d-flex-center size-40 bg-primary rounded-circle">
                                <img src="https://www.geic.in/store/1/default_images/subscribe_packages/subscribe_icon_3.svg" alt="Elite Mastery" class="img-fluid" height="24px">
                            </div>
                        </div>
                        <div class="ml-8">
                            <h5 class="font-14 font-weight-bold">Elite Mastery</h5>
                            <p class="font-12 text-gray-500 mt-4">Exclusive access for expert users</p>
                        </div>
                    </div>
                </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
                                ...
                                <div class="ml-8">
                                    ...
                                    <span class="d-block font-14 font-weight-bold text-gray-500 mt-4">30 Days</span>
                                </div>
                            </div>
                        </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 22c5.5 0 10-4.5 10-10S17.5 2 12 2 2 6.5 2 12s4.5 10 10 10zM8 12h8M12 16V8"/>
                                ...
                                <div class="ml-8">
                                    ...
                                    <span class="d-block font-14 font-weight-bold text-gray-500 mt-4">400</span>
                                </div>
                            </div>
                        </div>
