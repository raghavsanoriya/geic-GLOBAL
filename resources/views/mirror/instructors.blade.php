...
<!-- Mirrored from www.geic.in/instructors by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:36:14 GMT -->
...
<meta name='robots' content="index, follow, all">
    ...
    <meta name="description" content="Instructors Page Description">
    <meta property="og:description" content="Instructors Page Description">
    <meta name='twitter:description' content='Instructors Page Description'>
...
<meta property='og:type' content='website'>
    ...
    <title>Instructors | Trans Globe Indore LMS</title>
    ...
    <link rel="stylesheet" href="assets/design_1/css/app.min.css">
        ...
        <link rel="stylesheet" href="assets/design_1/css/parts/instructors_lists.min.css">
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
        ...
        <section class="instructors-lists-hero position-relative">
            ...
            <img src="store/1/themes/general/instructors_background.jpg" class="img-cover" alt="Instructors"/>
        </section>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
</svg>                <span class="">Instructors</span>
            </div>

            <h1 class="font-24 font-weight-bold mt-12">Instructors</h1>
            <div class="font-12 text-gray-500 mt-8">Explore all instructors in one place and find the right one for you</div>
        </div>

                    <div class="instructors-lists-header__overlay-img">
                <img src="store/1/themes/general/instructors_overlay.png" alt="Overlay Image" class="img-cover">
            </div>
            </div>
</div>
        ...
        <form action="https://www.geic.in/instructors" class="js-get-view-data-by-timeout-change container" data-container-id="listsContainer">
    ...
    <div class="position-relative z-index-2 d-flex flex-column flex-lg-row align-items-lg-center justify-content-lg-between bg-white p-12 rounded-24">
        <div class="form-group mb-0 d-flex align-items-center">
            ...
            <div class="">
                <label class="cursor-pointer" for="top_filter_available_for_meetings">Show Only Available Instructors</label>
            </div>
        </div>
...
<div class="position-relative instructors-lists-filters mt-28">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
            ...
            <div id="leftFiltersOtherOptions" class="accordion__collapse show pt-0 mt-0 border-0" role="tabpanel">
                                    <div class="custom-control custom-checkbox mt-16">
                        <input type="checkbox" name="meeting_options[]" value="instructor_with_courses" id="filter_meeting_options_instructor_with_courses" class="custom-control-input">
                        <label class="custom-control__label cursor-pointer" for="filter_meeting_options_instructor_with_courses">Instructor with Courses</label>
                    </div>
                                    <div class="custom-control custom-checkbox mt-12">
                        <input type="checkbox" name="meeting_options[]" value="verified_instructors_only" id="filter_meeting_options_verified_instructors_only" class="custom-control-input">
                        <label class="custom-control__label cursor-pointer" for="filter_meeting_options_verified_instructors_only">Verified Instructors Only</label>
                    </div>
                            </div>
        </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
            ...
            <div id="leftFiltersOrganization" class="accordion__collapse show pt-0 mt-0 border-0" role="tabpanel">
                <div class="form-group mb-0 mt-24">
                    <label class="form-group-label">Instructor Organization</label>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <div class="d-flex flex-column gap-24 py-20 pl-24 pr-8">
                            <a href="login.html" target="_blank" class="" data-tippy-content="Reserve a Meeting">
                    <svg width="24px" height="24px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  <path d="M17.08 14.15c-2.79-1.86-7.34-1.86-10.15 0-1.27.85-1.97 2-1.97 3.23s.7 2.37 1.96 3.21C8.32 21.53 10.16 22 12 22c1.84 0 3.68-.47 5.08-1.41 1.26-.85 1.96-1.99 1.96-3.23-.01-1.23-.7-2.37-1.96-3.21z"/>
    ...
    <div class="position-relative z-index-2 d-flex align-items-start bg-white p-16 rounded-32">
        <a href="users/ricardo-dave/profile" class="flex-1">
            <div class="d-flex align-items-center bg-gray-100 p-24 rounded-24 w-100">
                <div class="position-relative size-64 rounded-circle bg-gray-100">
                    ...
                    <div class="instructor-card__rate d-flex-center gap-4 text-center bg-white p-4 pr-8 rounded-32">
                        <svg width="14px" height="14px" class="icons text-warning" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
</svg>                        <span class="font-12 font-weight-bold text-dark">4.58</span>
                    </div>

                                    </div>

                <div class="ml-12">
                    <h6 class="font-16 text-dark">Ricardo Dave</h6>
                    <div class="font-14 mt-8 text-gray-500">Data Analyst at Microsoft</div>
                </div>
            </div>
        </a>
  ...
  <path d="M11.5 11.38a1.88 1.88 0 100-3.76 1.88 1.88 0 000 3.76zM21.65 6.17c-.41-.21-1.27-.45-2.44.37l-1.48 1.04c.01.14.02.27.02.42v8c0 .15-.02.28-.02.42l1.48 1.04c.62.44 1.16.58 1.59.58.37 0 .66-.1.85-.2.41-.21 1.1-.78 1.1-2.21V8.38c0-1.43-.69-2-1.1-2.21z"/>
            ...
            <a href="users/ricardo-dave/profile" target="_blank" class="" data-tippy-content="View Profile">
                <svg width="24px" height="24px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M12 2C9.38 2 7.25 4.13 7.25 6.75c0 2.57 2.01 4.65 4.63 4.74.08-.01.16-.01.22 0h.07a4.738 4.738 0 004.58-4.74C16.75 4.13 14.62 2 12 2z" opacity=".4"/>
  <path d="M17.08 14.15c-2.79-1.86-7.34-1.86-10.15 0-1.27.85-1.97 2-1.97 3.23s.7 2.37 1.96 3.21C8.32 21.53 10.16 22 12 22c1.84 0 3.68-.47 5.08-1.41 1.26-.85 1.96-1.99 1.96-3.23-.01-1.23-.7-2.37-1.96-3.21z"/>
</svg>            </a>
...
<!-- Mirrored from www.geic.in/instructors by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:36:16 GMT -->
</html>
