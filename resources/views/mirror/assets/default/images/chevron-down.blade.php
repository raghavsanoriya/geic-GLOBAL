...
<meta property='og:type' content='website'>
    ...
    <title>Page Not Found | Trans Globe Indore LMS</title>
    ...
    <link rel="stylesheet" href="/assets/design_1/css/app.min.css">
        ...
        <link rel="stylesheet" href="/assets/design_1/css/parts/system_status_pages.min.css">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
                ...
                <div class="col-6 col-lg-5 mt-12 mt-lg-0">
                                            <div class="d-flex align-items-center gap-16 gap-lg-32">
                                                            ...
                                                            <a href="/jobs" class="text-dark">Jobs</a>
                                                    </div>
                                    </div>
            ...
            <div class="col-12 col-lg-8">
                <div class="system-status-page-section position-relative">
                    ...
                    <div class="position-relative d-flex-center flex-column bg-white rounded-32 p-24 pt-64 p-lg-40 text-center z-index-2">
                                ...
                                <img src="/store/1/themes/general/error_pages/warning_floating.png" alt="Right Floating Image" class="img-cover">
                            </div>

                                                    <div class="system-status-page-image">
                                <img src="/store/1/themes/general/error_pages/404_error.svg" alt="Page Not Found" class="img-cover">
                            </div>

                                                    <h1 class="font-16 font-weight-bold mt-16">Page Not Found</h1>

                                                    <p class="font-14 text-gray-500 mt-4">The page you're looking for doesn't exist or was removed...</p>

                                                    <a href="/" class="btn btn-primary btn-lg mt-24">Back to Home</a>
