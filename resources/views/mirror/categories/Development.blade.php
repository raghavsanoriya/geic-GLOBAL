...
<!-- Mirrored from www.geic.in/categories/Development by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:22:24 GMT -->
...
<div id="app">
                ...
                <div class="position-relative d-flex align-items-start bg-white rounded-32 z-index-2">
                    <div class="d-flex flex-column p-32">
                        <div class="d-flex-center size-64 rounded-12 " style="background-color: #f4dbb9">
                            <img src="../store/1/default_images/categories_icons/icon2/development_icon2.svg" alt="Development" class="img-fluid" width="32px" height="32px">
                        </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
                        ...
                        <h1 class="font-24 font-weight-bold mt-12">Development</h1>
                        <div class="font-12 text-gray-500 mt-8">Learn to build websites, apps, and software with hands-on coding lessons from expert instructors</div>
                    </div>

                    <div class="courses-lists-header__overlay-img">
                        <img src="../store/1/default_images/categories_icons/icon2/development_overlay.png" alt="Development" class="img-cover">
                    </div>
                </div>
            </div>
        </div>
        ...
        <form action="https://www.geic.in/categories/Development" class="js-get-view-data-by-timeout-change container mt-24" data-container-id="listsContainer">
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
                ...
                <div class="col-12 col-lg-9 mt-4">
                    <div id="listsContainer" class="" data-body=".js-lists-body" data-view-data-path="/categories/Development">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
                        ...
                        <div id="pagination" class="js-ajax-pagination" data-container-id="listsContainer" data-container-items=".js-lists-body">
                            ...
                            <h3 class="font-14">About Development Courses</h3>
                            <div class="mt-12 text-gray-500">Launch your tech career with our in-depth development courses covering programming languages, frameworks, and software engineering principles. From beginner to advanced levels, our curriculum is designed by industry experts to provide practical, job-ready skills. Work on real projects, build a portfolio, and learn best practices used by top tech companies. Whether you're interested in web development, mobile apps, or software engineering, we have the perfect learning path for you. Start coding today and open doors to exciting opportunities in the tech industry.</div>
                        </section>
                                    </div>
            </div>
        </form>
...
<!-- Mirrored from www.geic.in/categories/Development by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:23:00 GMT -->
</html>
