...
<!-- Mirrored from www.geic.in/categories/Development/Mobile-Development by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:23:01 GMT -->
...
<div id="app">
                ...
                <div class="position-relative d-flex align-items-start bg-white rounded-32 z-index-2">
                    <div class="d-flex flex-column p-32">
                        <div class="d-flex-center size-64 rounded-12 " style="background-color: #f4dbb9">
                            <img src="../../store/1/default_images/categories_icons/icon2/mobile_development_icon2.svg" alt="Mobile Development" class="img-fluid" width="32px" height="32px">
                        </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
                        ...
                        <h1 class="font-24 font-weight-bold mt-12">Mobile Development</h1>
                        <div class="font-12 text-gray-500 mt-8">Build powerful Android and iOS apps using modern tools, frameworks, and hands-on mobile projects</div>
                    </div>

                    <div class="courses-lists-header__overlay-img">
                        <img src="../../store/1/default_images/categories_icons/icon2/mobile_development_overlay.png" alt="Mobile Development" class="img-cover">
                    </div>
                </div>
            </div>
        </div>
        ...
        <form action="https://www.geic.in/categories/Development/Mobile-Development" class="js-get-view-data-by-timeout-change container mt-24" data-container-id="listsContainer">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
            ...
            <div id="leftFiltersTypes" class="accordion__collapse show pt-0 mt-0 border-0" role="tabpanel">
                    ...
                    <div class="accordion__title d-flex align-items-center justify-content-between">
                        <div class="font-14 font-weight-bold text-dark cursor-pointer" href="#filters_id_1817" data-parent="#leftFiltersAccordion" role="button" data-toggle="collapse">
                            Level
                        </div>

                        <span class="collapse-arrow-icon d-flex cursor-pointer" href="#filters_id_1817" data-parent="#leftFiltersAccordion" role="button" data-toggle="collapse">
                            <svg width="16" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>                        </span>
                    </div>

                    <div id="filters_id_1817" class="accordion__collapse pt-0 mt-0 border-0" role="tabpanel">
                                                    <div class="custom-control custom-checkbox mt-16">
                                <input type="checkbox" name="filter_option[]" value="9150" id="filter_option_id_9150" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9150">Beginner</label>
                            </div>
                                                    <div class="custom-control custom-checkbox mt-12">
                                <input type="checkbox" name="filter_option[]" value="9151" id="filter_option_id_9151" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9151">Intermediate</label>
                            </div>
                                                    <div class="custom-control custom-checkbox mt-12">
                                <input type="checkbox" name="filter_option[]" value="9152" id="filter_option_id_9152" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9152">Expert</label>
                            </div>
                                            </div>
                </div>
                            <div class="accordion card-before-line card-before-line__4-12 p-16 border-bottom-gray-100">
                    <div class="accordion__title d-flex align-items-center justify-content-between">
                        <div class="font-14 font-weight-bold text-dark cursor-pointer" href="#filters_id_1832" data-parent="#leftFiltersAccordion" role="button" data-toggle="collapse">
                            Language
                        </div>

                        <span class="collapse-arrow-icon d-flex cursor-pointer" href="#filters_id_1832" data-parent="#leftFiltersAccordion" role="button" data-toggle="collapse">
                            <svg width="16" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>                        </span>
                    </div>

                    <div id="filters_id_1832" class="accordion__collapse pt-0 mt-0 border-0" role="tabpanel">
                                                    <div class="custom-control custom-checkbox mt-16">
                                <input type="checkbox" name="filter_option[]" value="9221" id="filter_option_id_9221" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9221">English</label>
                            </div>
                                                    <div class="custom-control custom-checkbox mt-12">
                                <input type="checkbox" name="filter_option[]" value="9223" id="filter_option_id_9223" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9223">Español</label>
                            </div>
                                                    <div class="custom-control custom-checkbox mt-12">
                                <input type="checkbox" name="filter_option[]" value="9222" id="filter_option_id_9222" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9222">Português</label>
                            </div>
                                                    <div class="custom-control custom-checkbox mt-12">
                                <input type="checkbox" name="filter_option[]" value="9224" id="filter_option_id_9224" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9224">हिन्</label>
                            </div>
                                                    <div class="custom-control custom-checkbox mt-12">
                                <input type="checkbox" name="filter_option[]" value="9225" id="filter_option_id_9225" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9225">العربية</label>
                            </div>
                                            </div>
                </div>
                            <div class="accordion card-before-line card-before-line__4-12 p-16 border-bottom-gray-100">
                    <div class="accordion__title d-flex align-items-center justify-content-between">
                        <div class="font-14 font-weight-bold text-dark cursor-pointer" href="#filters_id_1846" data-parent="#leftFiltersAccordion" role="button" data-toggle="collapse">
                            Topic
                        </div>

                        <span class="collapse-arrow-icon d-flex cursor-pointer" href="#filters_id_1846" data-parent="#leftFiltersAccordion" role="button" data-toggle="collapse">
                            <svg width="16" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>                        </span>
                    </div>

                    <div id="filters_id_1846" class="accordion__collapse pt-0 mt-0 border-0" role="tabpanel">
                                                    <div class="custom-control custom-checkbox mt-16">
                                <input type="checkbox" name="filter_option[]" value="9284" id="filter_option_id_9284" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9284">Android Development</label>
                            </div>
                                                    <div class="custom-control custom-checkbox mt-12">
                                <input type="checkbox" name="filter_option[]" value="9285" id="filter_option_id_9285" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9285">iOS Development</label>
                            </div>
                                                    <div class="custom-control custom-checkbox mt-12">
                                <input type="checkbox" name="filter_option[]" value="9286" id="filter_option_id_9286" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9286">Google Flutter</label>
                            </div>
                                                    <div class="custom-control custom-checkbox mt-12">
                                <input type="checkbox" name="filter_option[]" value="9287" id="filter_option_id_9287" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9287">React NativeKotlin</label>
                            </div>
                                            </div>
                </div>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
                ...
                <div class="col-12 col-lg-9 mt-4">
                    <div id="listsContainer" class="" data-body=".js-lists-body" data-view-data-path="/categories/Development/Mobile-Development">
                        ...
                        <div id="pagination" class="js-ajax-pagination" data-container-id="listsContainer" data-container-items=".js-lists-body">
                            ...
                            <h3 class="font-14">About Mobile Development Courses</h3>
                            <div class="mt-12 text-gray-500">Create innovative mobile applications with our expert-led courses in iOS and Android development. Learn to use modern tools like Swift, Kotlin, and React Native to build functional, user-friendly apps. Our curriculum covers everything from UI design to backend integration and app store deployment. Work on real projects that demonstrate your skills to potential employers or clients. Whether you're a beginner or experienced developer, our courses will help you master mobile technologies and tap into the booming app market.</div>
                        </section>
                                    </div>
            </div>
        </form>
