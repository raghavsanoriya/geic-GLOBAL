...
<!-- Mirrored from lms.rocket-soft.org/categories/Development/Web-Development by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:23:00 GMT -->
...
<div id="app">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
                                            ...
                                            <ul class="header-1-dropdown-menu__sub-menu py-12">
                                                            <li class="">
                                    <a href="Web-Development.html" class="d-flex align-items-center w-100 px-16 py-8">
                                        <div class="d-flex align-items-center w-100">
                                            ...
                                            <span class="">Web Development</span>
                                                            ...
                                                            <li class="">
                                    <a href="Mobile-Development.html" class="d-flex align-items-center w-100 px-16 py-8">
                                        <div class="d-flex align-items-center w-100">
                                            ...
                                            <span class="">Mobile Development</span>
                                                            ...
                                                            <li class="">
                                    <a href="Game-Development.html" class="d-flex align-items-center w-100 px-16 py-8">
                                        <div class="d-flex align-items-center w-100">
            ...
            <div class="courses-lists-header position-relative">
                ...
                <div class="position-relative d-flex align-items-start bg-white rounded-32 z-index-2">
                    <div class="d-flex flex-column p-32">
                        <div class="d-flex-center size-64 rounded-12 " style="background-color: #f4dbb9">
                            <img src="../../store/1/default_images/categories_icons/icon2/web_development_icon2.svg" alt="Web Development" class="img-fluid" width="32px" height="32px">
                        </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
                        ...
                        <h1 class="font-24 font-weight-bold mt-12">Web Development</h1>
                        <div class="font-12 text-gray-500 mt-8">Master front-end and back-end skills to create dynamic, responsive, and modern websites from scratch</div>
                    </div>

                    <div class="courses-lists-header__overlay-img">
                        <img src="../../store/1/default_images/categories_icons/icon2/web_development_overlay.png" alt="Web Development" class="img-cover">
                    </div>
                </div>
            </div>
        </div>
        ...
        <form action="https://lms.rocket-soft.org/categories/Development/Web-Development" class="js-get-view-data-by-timeout-change container mt-24" data-container-id="listsContainer">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
            ...
            <div id="leftFiltersTypes" class="accordion__collapse show pt-0 mt-0 border-0" role="tabpanel">
                    ...
                    <div class="accordion__title d-flex align-items-center justify-content-between">
                        <div class="font-14 font-weight-bold text-dark cursor-pointer" href="#filters_id_1816" data-parent="#leftFiltersAccordion" role="button" data-toggle="collapse">
                            Level
                        </div>

                        <span class="collapse-arrow-icon d-flex cursor-pointer" href="#filters_id_1816" data-parent="#leftFiltersAccordion" role="button" data-toggle="collapse">
                            <svg width="16" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>                        </span>
                    </div>

                    <div id="filters_id_1816" class="accordion__collapse pt-0 mt-0 border-0" role="tabpanel">
                                                    <div class="custom-control custom-checkbox mt-16">
                                <input type="checkbox" name="filter_option[]" value="9147" id="filter_option_id_9147" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9147">Beginner</label>
                            </div>
                                                    <div class="custom-control custom-checkbox mt-12">
                                <input type="checkbox" name="filter_option[]" value="9148" id="filter_option_id_9148" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9148">Intermediate</label>
                            </div>
                                                    <div class="custom-control custom-checkbox mt-12">
                                <input type="checkbox" name="filter_option[]" value="9149" id="filter_option_id_9149" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9149">Expert</label>
                            </div>
                                            </div>
                </div>
                            <div class="accordion card-before-line card-before-line__4-12 p-16 border-bottom-gray-100">
                    <div class="accordion__title d-flex align-items-center justify-content-between">
                        <div class="font-14 font-weight-bold text-dark cursor-pointer" href="#filters_id_1831" data-parent="#leftFiltersAccordion" role="button" data-toggle="collapse">
                            Language
                        </div>

                        <span class="collapse-arrow-icon d-flex cursor-pointer" href="#filters_id_1831" data-parent="#leftFiltersAccordion" role="button" data-toggle="collapse">
                            <svg width="16" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>                        </span>
                    </div>

                    <div id="filters_id_1831" class="accordion__collapse pt-0 mt-0 border-0" role="tabpanel">
                                                    <div class="custom-control custom-checkbox mt-16">
                                <input type="checkbox" name="filter_option[]" value="9216" id="filter_option_id_9216" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9216">English</label>
                            </div>
                                                    <div class="custom-control custom-checkbox mt-12">
                                <input type="checkbox" name="filter_option[]" value="9218" id="filter_option_id_9218" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9218">Español</label>
                            </div>
                                                    <div class="custom-control custom-checkbox mt-12">
                                <input type="checkbox" name="filter_option[]" value="9217" id="filter_option_id_9217" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9217">Português</label>
                            </div>
                                                    <div class="custom-control custom-checkbox mt-12">
                                <input type="checkbox" name="filter_option[]" value="9219" id="filter_option_id_9219" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9219">हिन्</label>
                            </div>
                                                    <div class="custom-control custom-checkbox mt-12">
                                <input type="checkbox" name="filter_option[]" value="9220" id="filter_option_id_9220" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9220">العربية</label>
                            </div>
                                            </div>
                </div>
                            <div class="accordion card-before-line card-before-line__4-12 p-16 border-bottom-gray-100">
                    <div class="accordion__title d-flex align-items-center justify-content-between">
                        <div class="font-14 font-weight-bold text-dark cursor-pointer" href="#filters_id_1845" data-parent="#leftFiltersAccordion" role="button" data-toggle="collapse">
                            Topic
                        </div>

                        <span class="collapse-arrow-icon d-flex cursor-pointer" href="#filters_id_1845" data-parent="#leftFiltersAccordion" role="button" data-toggle="collapse">
                            <svg width="16" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>                        </span>
                    </div>

                    <div id="filters_id_1845" class="accordion__collapse pt-0 mt-0 border-0" role="tabpanel">
                                                    <div class="custom-control custom-checkbox mt-16">
                                <input type="checkbox" name="filter_option[]" value="9279" id="filter_option_id_9279" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9279">HTML</label>
                            </div>
                                                    <div class="custom-control custom-checkbox mt-12">
                                <input type="checkbox" name="filter_option[]" value="9280" id="filter_option_id_9280" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9280">CSS</label>
                            </div>
                                                    <div class="custom-control custom-checkbox mt-12">
                                <input type="checkbox" name="filter_option[]" value="9281" id="filter_option_id_9281" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9281">PHP</label>
                            </div>
                                                    <div class="custom-control custom-checkbox mt-12">
                                <input type="checkbox" name="filter_option[]" value="9282" id="filter_option_id_9282" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9282">JavaScript</label>
                            </div>
                                                    <div class="custom-control custom-checkbox mt-12">
                                <input type="checkbox" name="filter_option[]" value="9283" id="filter_option_id_9283" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9283">Laravel</label>
                            </div>
                                            </div>
                </div>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
                ...
                <div class="col-12 col-lg-9 mt-4">
                    <div id="listsContainer" class="" data-body=".js-lists-body" data-view-data-path="/categories/Development/Web-Development">
                        <div class="js-lists-body row">
                                                            <div class="col-12 col-md-6 col-lg-4 mt-24">
        <a href="../../course/Backend-Development-with-Node-js.html" class="text-decoration-none d-block">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-24">
        <a href="../../course/Mobile-App-Development-with-React-Native.html" class="text-decoration-none d-block">
    <div class="course-grid-card-1 position-relative">
        <div class="course-grid-card-1__mask"></div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-24">
        <a href="../../course/Python-for-Data-Science.html" class="text-decoration-none d-block">
    <div class="course-grid-card-1 position-relative">
        <div class="course-grid-card-1__mask"></div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-24">
        <a href="../../course/Full-Stack-JavaScript-Development.html" class="text-decoration-none d-block">
    <div class="course-grid-card-1 position-relative">
        <div class="course-grid-card-1__mask"></div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-24">
        <a href="../../course/Learn-and-Understand-AngularJS.html" class="text-decoration-none d-block">
    <div class="course-grid-card-1 position-relative">
        <div class="course-grid-card-1__mask"></div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
                        ...
                        <div id="pagination" class="js-ajax-pagination" data-container-id="listsContainer" data-container-items=".js-lists-body">
                            ...
                            <h3 class="font-14">About Web Development Courses</h3>
                            <div class="mt-12 text-gray-500">Build professional websites and applications with our complete web development curriculum covering HTML, CSS, JavaScript, and popular frameworks. Learn responsive design, backend development, and deployment strategies from experienced developers. Our project-based approach ensures you gain practical skills while building a portfolio of real work. Whether you're changing careers or upgrading your skills, we provide the training and support to succeed in this high-demand field. Start your journey to becoming a full-stack developer today with our comprehensive courses.</div>
                        </section>
                                    </div>
            </div>
        </form>
