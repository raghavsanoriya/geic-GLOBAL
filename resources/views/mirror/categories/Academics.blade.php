...
<!-- Mirrored from www.geic.in/categories/Academics by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:23:27 GMT -->
...
<div id="app">
                ...
                <div class="position-relative d-flex align-items-start bg-white rounded-32 z-index-2">
                    <div class="d-flex flex-column p-32">
                        <div class="d-flex-center size-64 rounded-12 " style="background-color: #f8ddac">
                            <img src="../store/1/default_images/categories_icons/icon2/academics_icon2.svg" alt="Academics" class="img-fluid" width="32px" height="32px">
                        </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
                        ...
                        <h1 class="font-24 font-weight-bold mt-12">Academics</h1>
                        <div class="font-12 text-gray-500 mt-8">Strengthen your academic knowledge across subjects with expert-led lessons, practice exercises, and clear explanations</div>
                    </div>

                    <div class="courses-lists-header__overlay-img">
                        <img src="../store/1/default_images/categories_icons/icon2/academics_overlay.png" alt="Academics" class="img-cover">
                    </div>
                </div>
            </div>
        </div>
        ...
        <form action="https://www.geic.in/categories/Academics" class="js-get-view-data-by-timeout-change container mt-24" data-container-id="listsContainer">
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
                ...
                <div class="col-12 col-lg-9 mt-4">
                    <div id="listsContainer" class="" data-body=".js-lists-body" data-view-data-path="/categories/Academics">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
                        ...
                        <div id="pagination" class="js-ajax-pagination" data-container-id="listsContainer" data-container-items=".js-lists-body">
                            ...
                            <h3 class="font-14">About Academic Courses</h3>
                            <div class="mt-12 text-gray-500">Enhance your academic performance with our carefully curated courses designed by experienced educators. Covering a wide range of subjects from mathematics to literature, our programs offer structured learning paths with interactive content and personalized feedback. Perfect for students looking to supplement their school curriculum or adults pursuing lifelong learning. Access high-quality educational resources anytime, anywhere, and track your progress with our intuitive learning platform. Invest in your intellectual growth today and achieve your academic goals with confidence.</div>
                        </section>
                                    </div>
            </div>
        </form>
...
<!-- Mirrored from www.geic.in/categories/Academics by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:23:34 GMT -->
</html>
