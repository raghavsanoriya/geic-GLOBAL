...
<!-- Mirrored from www.geic.in/categories/Business/Business-Strategy by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:23:23 GMT -->
...
<div id="app">
                ...
                <div class="position-relative d-flex align-items-start bg-white rounded-32 z-index-2">
                    <div class="d-flex flex-column p-32">
                        <div class="d-flex-center size-64 rounded-12 " style="background-color: #accef8">
                            <img src="../../store/1/default_images/categories_icons/icon2/strategy_icon2.svg" alt="Business Strategy" class="img-fluid" width="32px" height="32px">
                        </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
                        ...
                        <h1 class="font-24 font-weight-bold mt-12">Business Strategy</h1>
                        <div class="font-12 text-gray-500 mt-8">Learn to analyze markets, set goals, and craft strategic plans that drive sustainable business growth</div>
                    </div>

                    <div class="courses-lists-header__overlay-img">
                        <img src="../../store/1/default_images/categories_icons/icon2/strategy_overlay.png" alt="Business Strategy" class="img-cover">
                    </div>
                </div>
            </div>
        </div>
        ...
        <form action="https://www.geic.in/categories/Business/Business-Strategy" class="js-get-view-data-by-timeout-change container mt-24" data-container-id="listsContainer">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
            ...
            <div id="leftFiltersTypes" class="accordion__collapse show pt-0 mt-0 border-0" role="tabpanel">
                    ...
                    <div class="accordion__title d-flex align-items-center justify-content-between">
                        <div class="font-14 font-weight-bold text-dark cursor-pointer" href="#filters_id_1815" data-parent="#leftFiltersAccordion" role="button" data-toggle="collapse">
                            Level
                        </div>

                        <span class="collapse-arrow-icon d-flex cursor-pointer" href="#filters_id_1815" data-parent="#leftFiltersAccordion" role="button" data-toggle="collapse">
                            <svg width="16" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>                        </span>
                    </div>

                    <div id="filters_id_1815" class="accordion__collapse pt-0 mt-0 border-0" role="tabpanel">
                                                    <div class="custom-control custom-checkbox mt-16">
                                <input type="checkbox" name="filter_option[]" value="9144" id="filter_option_id_9144" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9144">Beginner</label>
                            </div>
                                                    <div class="custom-control custom-checkbox mt-12">
                                <input type="checkbox" name="filter_option[]" value="9145" id="filter_option_id_9145" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9145">Intermediate</label>
                            </div>
                                                    <div class="custom-control custom-checkbox mt-12">
                                <input type="checkbox" name="filter_option[]" value="9146" id="filter_option_id_9146" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9146">Expert</label>
                            </div>
                                            </div>
                </div>
                            <div class="accordion card-before-line card-before-line__4-12 p-16 border-bottom-gray-100">
                    <div class="accordion__title d-flex align-items-center justify-content-between">
                        <div class="font-14 font-weight-bold text-dark cursor-pointer" href="#filters_id_1830" data-parent="#leftFiltersAccordion" role="button" data-toggle="collapse">
                            Language
                        </div>

                        <span class="collapse-arrow-icon d-flex cursor-pointer" href="#filters_id_1830" data-parent="#leftFiltersAccordion" role="button" data-toggle="collapse">
                            <svg width="16" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>                        </span>
                    </div>

                    <div id="filters_id_1830" class="accordion__collapse pt-0 mt-0 border-0" role="tabpanel">
                                                    <div class="custom-control custom-checkbox mt-16">
                                <input type="checkbox" name="filter_option[]" value="9211" id="filter_option_id_9211" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9211">English</label>
                            </div>
                                                    <div class="custom-control custom-checkbox mt-12">
                                <input type="checkbox" name="filter_option[]" value="9213" id="filter_option_id_9213" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9213">Español</label>
                            </div>
                                                    <div class="custom-control custom-checkbox mt-12">
                                <input type="checkbox" name="filter_option[]" value="9212" id="filter_option_id_9212" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9212">Português</label>
                            </div>
                                                    <div class="custom-control custom-checkbox mt-12">
                                <input type="checkbox" name="filter_option[]" value="9214" id="filter_option_id_9214" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9214">हिन्</label>
                            </div>
                                                    <div class="custom-control custom-checkbox mt-12">
                                <input type="checkbox" name="filter_option[]" value="9215" id="filter_option_id_9215" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9215">العربية</label>
                            </div>
                                            </div>
                </div>
                            <div class="accordion card-before-line card-before-line__4-12 p-16 border-bottom-gray-100">
                    <div class="accordion__title d-flex align-items-center justify-content-between">
                        <div class="font-14 font-weight-bold text-dark cursor-pointer" href="#filters_id_1844" data-parent="#leftFiltersAccordion" role="button" data-toggle="collapse">
                            Topic
                        </div>

                        <span class="collapse-arrow-icon d-flex cursor-pointer" href="#filters_id_1844" data-parent="#leftFiltersAccordion" role="button" data-toggle="collapse">
                            <svg width="16" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>                        </span>
                    </div>

                    <div id="filters_id_1844" class="accordion__collapse pt-0 mt-0 border-0" role="tabpanel">
                                                    <div class="custom-control custom-checkbox mt-16">
                                <input type="checkbox" name="filter_option[]" value="9275" id="filter_option_id_9275" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9275">Business Strategy</label>
                            </div>
                                                    <div class="custom-control custom-checkbox mt-12">
                                <input type="checkbox" name="filter_option[]" value="9276" id="filter_option_id_9276" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9276">Strategic Planning</label>
                            </div>
                                                    <div class="custom-control custom-checkbox mt-12">
                                <input type="checkbox" name="filter_option[]" value="9277" id="filter_option_id_9277" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9277">Marketing Strategy</label>
                            </div>
                                                    <div class="custom-control custom-checkbox mt-12">
                                <input type="checkbox" name="filter_option[]" value="9278" id="filter_option_id_9278" class="custom-control-input">
                                <label class="custom-control__label cursor-pointer" for="filter_option_id_9278">Innovation</label>
                            </div>
                                            </div>
                </div>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
                ...
                <div class="col-12 col-lg-9 mt-4">
                    <div id="listsContainer" class="" data-body=".js-lists-body" data-view-data-path="/categories/Business/Business-Strategy">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
                        ...
                        <div id="pagination" class="js-ajax-pagination" data-container-id="listsContainer" data-container-items=".js-lists-body">
                            ...
                            <h3 class="font-14">About Business Strategy Courses</h3>
                            <div class="mt-12 text-gray-500">Develop the strategic thinking skills needed to guide organizations to long-term success with our expert-led courses. Learn competitive analysis, strategic planning, and execution frameworks used by top companies. Our case-study based approach provides practical insights into real business challenges and solutions. Whether you're an entrepreneur, executive, or consultant, these courses will enhance your ability to make data-driven decisions and create sustainable competitive advantages. Gain the strategic mindset that separates successful leaders from the rest.</div>
                        </section>
                                    </div>
            </div>
        </form>
...
<!-- Mirrored from www.geic.in/categories/Business/Business-Strategy by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:23:24 GMT -->
</html>
