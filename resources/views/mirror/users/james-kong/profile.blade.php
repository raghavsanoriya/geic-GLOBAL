...
<!-- Mirrored from lms.rocket-soft.org/users/james-kong/profile by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:36:14 GMT -->
...
<!-- Open Graph -->
<meta property='og:title' content='James Kong Profile'>
<meta name='twitter:card' content='summary'>
<meta name='twitter:title' content='James Kong Profile'>
...
<meta property='og:type' content='website'>
    ...
    <title>James Kong Profile | Rocket LMS</title>
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
        ...
        <img src="https://lms.rocket-soft.org/store/3/17.jpg" class="img-cover" alt=""/>
    </div>
    ...
    <div class="d-flex-center flex-column text-center px-16">
        ...
        <h4 class="mt-16 font-16 font-weight-bold">James Kong</h4>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
        ...
        <div class="d-flex align-items-center gap-12 mt-16 w-100">
            <button type="button" id="followToggle" data-user-id="james-kong" class="btn btn-primary btn-lg flex-1">
                                    Follow
                            </button>
    ...
    <div class="pt-24 mt-24 px-16 border-top-gray-200">
        ...
        <div class="text-center text-gray-500 mb-8">Member Since Aug 2020</div>
                ...
                <h5 class="font-14 font-weight-bold text-warning">The user is temporarily unavailable.</h5>
                                    ...
                                    <p class="mt-8 font-12 text-warning opacity-75">I will not be available for 2 weeks until  end of January due to a business trip.</p>
                            </div>
...
<div class="row">
            ...
            <div class="mt-12 text-gray-500">James Kong is a sound and communication expert. His vision is for a world that listens consciously and speaks powerfully.<br />
<br />
Julian is author of the books How to be Heard: Secrets for Powerful Speaking and Listening and Sound Business. <br />
<br />
His five TED talks about sound and communication have been watched over 90 million times and his latest talk, How to speak so that people want to listen, is the sixth most watched TED talk of all time. <br />
<br />
James is a media commentator on speaking and listening skills, and has been featured by the likes of TIME Magazine, The Economist, The BBC, and The Times. <br />
<br />
James's company, The Sound Agency, works with major brands worldwide to improve the way they sound. Their pioneering methods have improved customer happiness, raised sales, and even lowered crime rates, and their work has made headlines internationally.</div>
        </div>
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
                    ...
                    <div class="ml-8 text-gray-500">Associate of Applied Business from Stanford University</div>
                </div>
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
                    ...
                    <div class="ml-8 text-gray-500">Bachelor of Science in Business from Harvard University</div>
                </div>
                            <div class="profile-education-card d-flex align-items-center mt-16">
                    <div class="d-flex-center size-40 rounded-12 bg-gray-100">
                        <svg width="24px" height="24px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
                    ...
                    <div class="ml-8 text-gray-500">Master of Computational Finance from University of Chicago</div>
                </div>
                    </div>
  ...
  <path d="M20.5 12.3l-.15.09a17.037 17.037 0 01-5.79 2.08c-.08.96-.5 2.06-2.69 2.06s-2.61-1.09-2.69-2.04c-1.91-.3-3.79-.93-5.5-1.88-.15-.08-.3-.16-.44-.25-.36-.2-.7-.42-1.03-.64-.02-.01-.04-.03-.05-.04l.61 6.51c.21 1.99 1.03 4.04 5.43 4.04h7.62c4.4 0 5.22-2.05 5.43-4.05l.63-6.78a.12.12 0 01-.05.05c-.43.31-.87.6-1.33.85z" opacity=".4"/>
                    ...
                    <div class="ml-8 text-gray-500">Five-time TED speaker</div>
                </div>
                    </div>
            ...
            <div class="d-flex align-items-center mt-8 gap-12 flex-wrap">
                                    <div class="bg-gray-100 p-10 rounded-8 font-12 text-gray-500">Science</div>
        ...
        <a href="https://lms.rocket-soft.org/course/Learn-and-Understand-AngularJS" class="text-decoration-none d-block">
    <div class="course-grid-card-1 position-relative">
        ...
        <div class="position-relative z-index-2">
            <div class="course-grid-card-1__image bg-gray-200">
                                <img src="https://lms.rocket-soft.org/store/3/Learn and Understand AngularJS.jpg" class="img-cover" alt="Learn and Understand AngularJS">
            </div>

            <div class="course-grid-card-1__body d-flex flex-column py-12">
                <div class="d-flex flex-column px-12 w-100 h-100 mb-16">
                    <h3 class="course-title font-16 font-weight-bold text-dark">Learn and Understand AngularJS</h3>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
                    ...
                    <div class="d-flex align-items-center mt-auto">
                        <div class="size-32 rounded-circle">
                            <img src="https://lms.rocket-soft.org/store/3/setting/avatar.jpg" class="img-cover rounded-circle" alt="James Kong">
                        </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="course-grid-card-1 position-relative">
        ...
        <div class="position-relative z-index-2">
            <div class="course-grid-card-1__image bg-gray-200">
                                <img src="https://lms.rocket-soft.org/store/864/couple-listening-music.jpg" class="img-cover" alt="Active Listening: You Can Be a Great Listener">
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-16">
        <a href="https://lms.rocket-soft.org/course/Design-Systems-Workshop" class="text-decoration-none d-block">
    <div class="course-grid-card-1 position-relative">
        <div class="course-grid-card-1__mask"></div>

        <div class="position-relative z-index-2">
            <div class="course-grid-card-1__image bg-gray-200">
                                <img src="https://lms.rocket-soft.org/store/1/default_images/courses/course5.jpg" class="img-cover" alt="Design Systems Workshop">
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-16">
        <a href="https://lms.rocket-soft.org/course/Full-Stack-JavaScript-Development" class="text-decoration-none d-block">
    <div class="course-grid-card-1 position-relative">
        <div class="course-grid-card-1__mask"></div>

        <div class="position-relative z-index-2">
            <div class="course-grid-card-1__image bg-gray-200">
                                <img src="https://lms.rocket-soft.org/store/1/default_images/courses/course9.jpg" class="img-cover" alt="Full Stack JavaScript Development">
            </div>

            <div class="course-grid-card-1__body d-flex flex-column py-12">
                <div class="d-flex flex-column px-12 w-100 h-100 mb-16">
                    <h3 class="course-title font-16 font-weight-bold text-dark">Full Stack JavaScript Development</h3>
    ...
    <div class="position-relative bg-white p-12 rounded-24 border-gray-200 z-index-3">
        <div class="row">
            <div class="col-12 col-lg-7 d-flex align-items-lg-center">
                <a href="https://lms.rocket-soft.org/forums/Digital-Marketing/topics/Marketing-Agent-wanted/posts" class="text-dark">
  ...
  <path d="M14.56 13.89c-.06 0-.12-.01-.19-.02l-2.91-.74a.75.75 0 01.37-1.45l2.91.74c.4.1.64.51.54.91-.08.34-.38.56-.72.56z"/>
                ...
                <div class="ml-12 d-flex flex-column h-100 w-100">
                    <a href="https://lms.rocket-soft.org/forums/Digital-Marketing/topics/Marketing-Agent-wanted/posts" class="text-dark font-14">
                        <h4 class="font-16 font-weight-bold">Marketing Agent wanted</h4>
                    </a>

                    <p class="forum-topic-card__desc mt-8 font-14 text-gray-500 mb-8">I am looking for an experience and successful Marketing agent to work for me in order to increase my product sales which mostly include houses and furniture. If you are interested contact me on chat ...</p>
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-auto pb-8">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ml-8">
                                <a href="https://lms.rocket-soft.org/users/james-kong/profile" target="_blank" class="text-dark">
                                    <h4 class="font-14 font-weight-bold text-dark">James Kong</h4>
                                </a>
                                <span class="d-block font-12 text-gray-500">21 Jun 2022 01:50</span>
                            </div>
                        </div>
            ...
            <div class="col-12 col-lg-5 mt-20 mt-lg-0">
                <div class="d-flex flex-column w-100 h-100 rounded-12 bg-gray-100 p-16">
                    ...
                    <a href="https://lms.rocket-soft.org/forums/Digital-Marketing/topics/Marketing-Agent-wanted/posts" class="">
                        <div class="d-flex align-items-center justify-content-between px-12 rounded-8 bg-white mt-auto py-12">
                                    ...
                                    <div class="d-flex align-items-center mt-8">
                                        ...
                                        <div class="ml-8">
                                            <h4 class="font-14 font-weight-bold text-dark">Linda Anderson</h4>
                                            <span class="d-block font-12 text-gray-500 mt-4">21 Jun 2022 01:50</span>
                                        </div>
                                    </div>
                                </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
    ...
    <p class="mt-4 font-14 text-gray-500">No meetings found for this user.</p>
  ...
  <path d="M20.5 12.3l-.15.09a17.037 17.037 0 01-5.79 2.08c-.08.96-.5 2.06-2.69 2.06s-2.61-1.09-2.69-2.04c-1.91-.3-3.79-.93-5.5-1.88-.15-.08-.3-.16-.44-.25-.36-.2-.7-.42-1.03-.64-.02-.01-.04-.03-.05-.04l.61 6.51c.21 1.99 1.03 4.04 5.43 4.04h7.62c4.4 0 5.22-2.05 5.43-4.05l.63-6.78a.12.12 0 01-.05.05c-.43.31-.87.6-1.33.85z" opacity=".4"/>
            ...
            <div class="d-flex-center size-64">
                <img src="https://lms.rocket-soft.org/store/1/default_images/courses/icons/course_icon25.svg" alt="Product Manager" class="img-fluid">
            </div>
        </div>

        <a href="https://lms.rocket-soft.org/jobs/product-manager" class="">
        ...
        <a href="https://lms.rocket-soft.org/users/james-kong/profile" class="d-flex align-items-center my-16 text-dark">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center gap-4 font-12 text-gray-500">
                    ...
                    <span class="">Remote</span>
                            ...
                            <a href="https://lms.rocket-soft.org/jobs/product-manager" class="btn btn-primary gap-4">
