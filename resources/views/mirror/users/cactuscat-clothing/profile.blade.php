...
<!-- Mirrored from www.geic.in/users/cactuscat-clothing/profile by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:36:17 GMT -->
...
<meta property='og:type' content='website'>
    ...
    <title>Cactuscat Clothing Profile | Trans Globe Indore LMS</title>
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
        ...
        <img src="https://www.geic.in/store/859/8.png" class="img-cover" alt=""/>
    </div>
    ...
    <div class="d-flex-center flex-column text-center px-16">
        ...
        <div class="profile-avatar-card size-80 rounded-circle mt-32">
            <img src="https://www.geic.in/store/859/setting/avatar.jpg" alt="Cactuscat Clothing" class="img-cover rounded-circle">
...
<div class="row">
    ...
    <p class="mt-4 font-14 text-gray-500">This instructor has not published any courses yet. You can check back later or explore other instructors.</p>
                                        ...
                                        <div class="no-result default-no-result d-flex-center flex-column bg-white rounded-16 py-120 px-32 mt-20 text-center mt-0">
    <div class="no-result-logo ">
        <img src="https://www.geic.in/assets/design_1/img/no-result/profile_instructors.svg" alt="This user has no instructors." class="img-cover">
    </div>
