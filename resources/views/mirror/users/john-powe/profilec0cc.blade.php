...
<!-- Mirrored from lms.rocket-soft.org/users/john-powe/profile?tab=appointments by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:36:18 GMT -->
...
<!-- Open Graph -->
<meta property='og:title' content='John Powe Profile'>
<meta name='twitter:card' content='summary'>
<meta name='twitter:title' content='John Powe Profile'>
...
<meta property='og:type' content='website'>
    ...
    <title>John Powe Profile | Rocket LMS</title>
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
        ...
        <img src="https://lms.rocket-soft.org/store/923/14.jpg" class="img-cover" alt=""/>
    </div>
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <h4 class="mt-16 font-16 font-weight-bold">John Powe</h4>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
        ...
        <div class="d-flex align-items-center gap-12 mt-16 w-100">
            <button type="button" id="followToggle" data-user-id="john-powe" class="btn btn-primary btn-lg flex-1">
                                    Follow
                            </button>
  ...
  <path d="M22 7.81v.05H2v-.05c0-.51.04-1 .13-1.45h5.64V2h1.5v4.36h5.46V2h1.5v4.36h5.64c.09.45.13.94.13 1.45zM14.44 12.72l-2.08-1.2c-.77-.44-1.51-.5-2.09-.17-.58.33-.9 1.01-.9 1.89v2.4c0 .88.32 1.56.9 1.89.25.14.53.21.82.21.4 0 .83-.13 1.27-.38l2.08-1.2c.77-.44 1.19-1.06 1.19-1.73 0-.67-.43-1.26-1.19-1.71z"/>
        ...
        <div class="font-16 font-weight-bold mt-4">3</div>
    </div>
...
<div class="row">
            ...
            <div class="mt-12 text-gray-500">Hello! I am John Powe; let me welcome you on this platform. I have created unique courses on different subjects including Business, marketing, Sales, Psychology, Copywriting, Social media marketing and a lot more. I have vast knowledge about business planning, marketing strategies, sales and management.<br />
<br />
I am a Gold Medalist Student of my time. With the passage of time, I have done different courses including IELTS, Color Therapy, Cognitive behavior Therapy, Nebosh etc.<br />
<br />
I always try to learn new things and like to travel. Learning new skills and exploring new fields is my passion. I am a full time Udemy instructor so I am always there to support and help you if you find any kind of difficulty.<br />
<br />
I try to make my courses as simple and informative as possible. My courses are mostly 1 to 2 hours of length, to the point and cover most important information regarding the respective subject so that you can learn the best possible knowledge in shortest possible time.<br />
<br />
I hope you will learn new things from my courses. Feel free to contact me if you have any questions. Thanks I wish you all the success and happiness in the world. Best of luck</div>
        </div>
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
                    ...
                    <div class="ml-8 text-gray-500">Associate of Business Administration from Imperial College London</div>
                </div>
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
                    ...
                    <div class="ml-8 text-gray-500">Bachelor of International Business Economics from University of Cambridge</div>
                </div>
                            <div class="profile-education-card d-flex align-items-center mt-16">
                    <div class="d-flex-center size-40 rounded-12 bg-gray-100">
                        <svg width="24px" height="24px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
                    ...
                    <div class="ml-8 text-gray-500">Master of Business Administration from King&#039;s College London</div>
                </div>
                    </div>
  ...
  <path d="M20.5 12.3l-.15.09a17.037 17.037 0 01-5.79 2.08c-.08.96-.5 2.06-2.69 2.06s-2.61-1.09-2.69-2.04c-1.91-.3-3.79-.93-5.5-1.88-.15-.08-.3-.16-.44-.25-.36-.2-.7-.42-1.03-.64-.02-.01-.04-.03-.05-.04l.61 6.51c.21 1.99 1.03 4.04 5.43 4.04h7.62c4.4 0 5.22-2.05 5.43-4.05l.63-6.78a.12.12 0 01-.05.05c-.43.31-.87.6-1.33.85z" opacity=".4"/>
                    ...
                    <div class="ml-8 text-gray-500">marketing strategies at Microlab 2010-2015</div>
                </div>
                    </div>
            ...
            <div class="d-flex align-items-center mt-8 gap-12 flex-wrap">
                                    <div class="bg-gray-100 p-10 rounded-8 font-12 text-gray-500">Lifestyle</div>
                                    <div class="bg-gray-100 p-10 rounded-8 font-12 text-gray-500">Management</div>
                                    <div class="bg-gray-100 p-10 rounded-8 font-12 text-gray-500">Business Strategy</div>
                            </div>
        </div>
    </div>
                                </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-16">
        <a href="https://lms.rocket-soft.org/course/Mobile-UI-Design-Patterns" class="text-decoration-none d-block">
    <div class="course-grid-card-1 position-relative">
        <div class="course-grid-card-1__mask"></div>

        <div class="position-relative z-index-2">
            <div class="course-grid-card-1__image bg-gray-200">
                                <img src="https://lms.rocket-soft.org/store/1/default_images/courses/course4.jpg" class="img-cover" alt="Mobile UI Design Patterns">
            </div>

            <div class="course-grid-card-1__body d-flex flex-column py-12">
                <div class="d-flex flex-column px-12 w-100 h-100 mb-16">
                    <h3 class="course-title font-16 font-weight-bold text-dark">Mobile UI Design Patterns</h3>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <p class="mt-4 font-14 text-gray-500">No products found for this user.</p>
    ...
    <div class="position-relative bg-white p-12 rounded-24 border-gray-200 z-index-3">
        <div class="row">
            <div class="col-12 col-lg-7 d-flex align-items-lg-center">
                <a href="https://lms.rocket-soft.org/forums/Advertising/topics/How-to-greatly-reduce-or-eliminate-networked-advertising/posts" class="text-dark">
  ...
  <path d="M14.56 13.89c-.06 0-.12-.01-.19-.02l-2.91-.74a.75.75 0 01.37-1.45l2.91.74c.4.1.64.51.54.91-.08.34-.38.56-.72.56z"/>
                ...
                <div class="ml-12 d-flex flex-column h-100 w-100">
                    <a href="https://lms.rocket-soft.org/forums/Advertising/topics/How-to-greatly-reduce-or-eliminate-networked-advertising/posts" class="text-dark font-14">
                        <h4 class="font-16 font-weight-bold">How to reduce networked advertising</h4>
                    </a>

                    <p class="forum-topic-card__desc mt-8 font-14 text-gray-500 mb-8">We hear over and over about the evil of networked advertising on mainland, about how it is the bane of mainlanders existence, about how it should be eliminated now and forever.But how?We hear that ...</p>
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-auto pb-8">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ml-8">
                                <a href="https://lms.rocket-soft.org/users/john-powe/profile" target="_blank" class="text-dark">
                                    <h4 class="font-14 font-weight-bold text-dark">John Powe</h4>
                                </a>
                                <span class="d-block font-12 text-gray-500">21 Jun 2022 01:40</span>
                            </div>
                        </div>
            ...
            <div class="col-12 col-lg-5 mt-20 mt-lg-0">
                <div class="d-flex flex-column w-100 h-100 rounded-12 bg-gray-100 p-16">
                    ...
                    <a href="https://lms.rocket-soft.org/forums/Advertising/topics/How-to-greatly-reduce-or-eliminate-networked-advertising/posts" class="">
                        <div class="d-flex align-items-center justify-content-between px-12 rounded-8 bg-white mt-auto py-12">
                                    ...
                                    <div class="d-flex align-items-center mt-8">
                                        ...
                                        <div class="ml-8">
                                            <h4 class="font-14 font-weight-bold text-dark">James Kong</h4>
                                            <span class="d-block font-12 text-gray-500 mt-4">21 Jun 2022 01:44</span>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="position-relative d-flex-center flex-column text-center bg-white rounded-16 border-gray-200 p-16 pt-32 z-index-2 h-100 w-100">
                    ...
                    <div class="mt-8 font-12 text-gray-500">Has 2 to 5 Topics</div>
                                ...
                                <div class="custom-tabs-content px-16 active" id="reserveMeetingTab">
                                    <form action="https://lms.rocket-soft.org/users/john-powe/meetings/overview" method="get">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
        ...
        <div class="ml-8">
            ...
            <div class="font-14 font-weight-bold text-gray-500 mt-4">24 Aug 2026 09:00PM-10:00PM</div>
        </div>
    </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M10.498 13.14a2.64 2.64 0 100-5.28 2.64 2.64 0 000 5.28zM4.78 8.3v4.4M16.222 8.3v4.4"/>
        ...
        <div class="ml-8">
            ...
            <div class="d-flex align-items-center font-14 font-weight-bold text-gray-500 mt-4">
                                                            <span class="font-12 font-weight-500 text-decoration-line-through">$100</span>
  ...
  <path stroke-width="1.5" d="M3.62 8.49c1.97-8.66 14.8-8.65 16.76.01 1.15 5.08-2.01 9.38-4.78 12.04a5.193 5.193 0 01-7.21 0c-2.76-2.66-5.92-6.97-4.77-12.05z"/>
        ...
        <div class="ml-8">
            ...
            <div class="d-flex align-items-center font-14 font-weight-bold text-gray-500 mt-4">
                                                            <span class="font-12 font-weight-500 text-decoration-line-through">$200</span>
                        <span class="ml-4">$180</span>
                                                </div>
        </div>
    </div>
  ...
  <path d="M8.5 15c-.13 0-.26-.03-.38-.08s-.23-.12-.33-.21c-.09-.1-.16-.21-.21-.33A.995.995 0 017.5 14c0-.13.03-.26.08-.38s.12-.23.21-.33c.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.09.1.16.21.21.33.05.12.08.25.08.38s-.03.26-.08.38-.12.23-.21.33c-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08zM12 15c-.13 0-.26-.03-.38-.08s-.23-.12-.33-.21c-.18-.19-.29-.45-.29-.71 0-.26.11-.52.29-.71.1-.09.21-.16.33-.21.24-.11.52-.11.76 0 .12.05.23.12.33.21.18.19.29.45.29.71 0 .26-.11.52-.29.71-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08zM8.5 18.5c-.13 0-.26-.03-.38-.08s-.23-.12-.33-.21c-.18-.19-.29-.45-.29-.71 0-.26.11-.52.29-.71.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.18.19.29.45.29.71 0 .26-.11.52-.29.71-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08z"/>
    ...
    <div class="js-times-container d-none flex-column w-100 h-100" data-user="john-powe">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="meeting-package-grid-card-1__contents position-relative z-index-3 bg-white rounded-16 py-16">
        ...
        <div class="px-16">
                    ...
                    <img src="https://lms.rocket-soft.org/store/1/default_images/meeting_packages/package2.svg" alt="Expert Coaching Package" class="img-fluid">
                </div>
            
            <h3 class="font-16 mt-12">Expert Coaching Package</h3>
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <a href="https://lms.rocket-soft.org/users/john-powe/profile" target="_blank" class="">
                <div class="d-flex align-items-center mt-16">
                    <div class="size-32 bg-gray-100 rounded-circle">
                        <img src="https://lms.rocket-soft.org/store/923/setting/avatar.jpg" alt="John Powe" class="img-cover rounded-circle">
                    </div>
                    <div class="ml-4">
                        <h5 class="font-12 text-dark">John Powe</h5>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
        ...
        <div class="d-flex align-items-center justify-content-between mt-16 pt-16 px-16 border-top-gray-200">
            <div class="d-flex align-items-center gap-4 font-16 font-weight-bold text-primary">
                            ...
                            <div class="js-meeting-package-add-to-cart d-flex cursor-pointer" data-package="7">
                    <div class="d-flex align-items-center gap-8 ">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M14.43 5.93L20.5 12l-6.07 6.07M3.5 12h16.83"/>
    ...
    <div class="meeting-package-grid-card-1__contents position-relative z-index-3 bg-white rounded-16 py-16">
        ...
        <div class="px-16">
                            ...
                            <div class="d-flex-center size-48">
                    <img src="https://lms.rocket-soft.org/store/1/default_images/meeting_packages/package1.svg" alt="Premium Coaching Package" class="img-fluid">
                </div>
            
            <h3 class="font-16 mt-12">Premium Coaching Package</h3>
        ...
        <div class="d-flex align-items-center justify-content-between mt-16 pt-16 px-16 border-top-gray-200">
            <div class="d-flex align-items-center gap-4 font-16 font-weight-bold text-primary">
                        ...
                        <span class="font-14 font-weight-400 text-gray-500 text-decoration-line-through">$200</span>
                            ...
                            <div class="js-meeting-package-add-to-cart d-flex cursor-pointer" data-package="8">
                    <div class="d-flex align-items-center gap-8 ">
                        <span class="text-gray-500">Buy Package</span>
                        <svg width="24px" height="24px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M14.43 5.93L20.5 12l-6.07 6.07M3.5 12h16.83"/>
                                        ...
                                        <div class="no-result default-no-result d-flex-center flex-column bg-white rounded-16 py-120 px-32 mt-20 text-center mt-0">
    <div class="no-result-logo ">
        <img src="https://lms.rocket-soft.org/assets/design_1/img/no-result/profile_events.svg" alt="update.user_profile_not_have_events" class="img-cover">
    </div>

    <h3 class="font-16 font-weight-bold mt-16">update.user_profile_not_have_events</h3>
    <p class="mt-4 font-14 text-gray-500">update.user_profile_not_have_events_hint</p>
  ...
  <path d="M20.5 12.3l-.15.09a17.037 17.037 0 01-5.79 2.08c-.08.96-.5 2.06-2.69 2.06s-2.61-1.09-2.69-2.04c-1.91-.3-3.79-.93-5.5-1.88-.15-.08-.3-.16-.44-.25-.36-.2-.7-.42-1.03-.64-.02-.01-.04-.03-.05-.04l.61 6.51c.21 1.99 1.03 4.04 5.43 4.04h7.62c4.4 0 5.22-2.05 5.43-4.05l.63-6.78a.12.12 0 01-.05.05c-.43.31-.87.6-1.33.85z" opacity=".4"/>
            ...
            <div class="d-flex-center size-64">
                <img src="https://lms.rocket-soft.org/store/1/default_images/courses/icons/course_icon26.svg" alt="Marketing Manager" class="img-fluid">
            </div>
        </div>

        <a href="https://lms.rocket-soft.org/jobs/marketing-manager" class="">
        ...
        <a href="https://lms.rocket-soft.org/users/john-powe/profile" class="d-flex align-items-center my-16 text-dark">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center gap-4 font-12 text-gray-500">
                    ...
                    <span class="">Hybrid</span>
                            ...
                            <a href="https://lms.rocket-soft.org/jobs/marketing-manager" class="btn btn-primary gap-4">
