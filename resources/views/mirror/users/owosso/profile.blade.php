...
<!-- Mirrored from www.geic.in/users/owosso/profile by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:36:17 GMT -->
...
<!-- Open Graph -->
<meta property='og:title' content='Owosso Profile'>
<meta name='twitter:card' content='summary'>
<meta name='twitter:title' content='Owosso Profile'>
...
<meta property='og:type' content='website'>
    ...
    <title>Owosso Profile | Trans Globe Indore LMS</title>
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
        ...
        <img src="https://www.geic.in/store/863/2.png" class="img-cover" alt=""/>
    </div>
    ...
    <div class="d-flex-center flex-column text-center px-16">
        ...
        <div class="profile-avatar-card size-80 rounded-circle mt-32">
            <img src="https://www.geic.in/store/863/setting/avatar.jpg" alt="Owosso" class="img-cover rounded-circle">

                    </div>

        <h4 class="mt-16 font-16 font-weight-bold">Owosso</h4>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
        ...
        <div class="d-flex align-items-center gap-12 mt-16 w-100">
            <button type="button" id="followToggle" data-user-id="owosso" class="btn btn-primary btn-lg flex-1">
                                    Follow
                            </button>
...
<div class="row">
            ...
            <div class="mt-12 text-gray-500">Dear students,<br />
<br />
WR Training is a group of professional engineers from various disciplines (chemical, petrochemical, mechanical, electrical…) providing academic and industrial online courses.<br />
<br />
Whether you’re trying to learn and discover a new scientific or engineering topic from scratch, or want to refresh your memory on something you’ve learnt in the past, you’ve come to the right place.<br />
<br />
WR Training exists to help you succeed in your academic and professional life. Our goal is to spread the knowledge and promote science.<br />
<br />
The courses, you are about to enroll in, were undertaken to give you a clear view of scientific and engineering topics through detailed examples using hands on demo and provide numerous problems with their solutions. You can also use these courses as a review for taking exams or as a vehicle for self-instruction.<br />
<br />
Our training methodology was designed to enable individual self paced e-learning.<br />
<br />
Each course has been undertaken to teach a specific skill.<br />
<br />
Our courses can be watched 24/7 wherever you are. You can also view them on mobile devices with the Udemy mobile app.<br />
<br />
We are active online instructors and we will be here for you every step of the way. If you have questions about the course content, you can always post your questions or send us a private message. It will be our pleasure to provide assistance and answer your questions.<br />
<br />
So with no further ado, go ahead, select the course suitable for you, click the enroll button and we'll see you in the first section !<br />
<br />
WR Training<br />
<br />
Spread the wings of your knowledge</div>
        </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 mt-16">
    <a href="https://www.geic.in/users/jessica-wray/profile" class="text-dark w-100">
        <div class="profile-instructor-card position-relative w-100 mb-8">
            ...
            <div class="position-relative d-flex align-items-center bg-white p-16 rounded-16 border-gray-200 z-index-2 w-100 h-100">
                ...
                <div class="ml-12">
                    <h3 class="font-14 font-weight-bold text-dark">Jessica Wray</h3>

                    <div class="mt-4 font-12 text-gray-500">2 Courses</div>
                </div>
            </div>
    ...
    <p class="mt-4 font-14 text-gray-500">No topics found for this user.</p>
                ...
                <div class="position-relative d-flex-center flex-column text-center bg-white rounded-16 border-gray-200 p-16 pt-32 z-index-2 h-100 w-100">
                    <div class="d-flex-center size-64 rounded-16 bg-gray-100">
                        <img src="https://www.geic.in/store/1/default_images/badges/courses1.svg" class="img-fluid" alt="Junior Vendor">
                    </div>

                    <div class="mt-12 font-14 font-weight-bold ">Junior Vendor</div>

                    <div class="mt-8 font-12 text-gray-500">Has 1 Class</div>
                </div>
            </div>
                    <div class="profile-badge-card position-relative mb-8">
                <div class="profile-badge-card__mask"></div>
