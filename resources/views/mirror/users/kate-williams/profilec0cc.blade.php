...
<!-- Mirrored from lms.rocket-soft.org/users/kate-williams/profile?tab=appointments by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:36:18 GMT -->
...
<!-- Open Graph -->
<meta property='og:title' content='Kate Williams Profile'>
<meta name='twitter:card' content='summary'>
<meta name='twitter:title' content='Kate Williams Profile'>
...
<meta property='og:type' content='website'>
    ...
    <title>Kate Williams Profile | Rocket LMS</title>
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
        ...
        <img src="https://lms.rocket-soft.org/store/929/15.jpg" class="img-cover" alt=""/>
    </div>
    ...
    <div class="d-flex-center flex-column text-center px-16">
        ...
        <h4 class="mt-16 font-16 font-weight-bold">Kate Williams</h4>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
        ...
        <div class="d-flex align-items-center gap-12 mt-16 w-100">
            <button type="button" id="followToggle" data-user-id="kate-williams" class="btn btn-primary btn-lg flex-1">
                                    Follow
                            </button>
...
<div class="row">
            ...
            <div class="mt-12 text-gray-500">"Short courses for busy managers"<br />
<br />
Hi there, my name is Kate Williams and I've been managing projects and virtual teams for the past 10+ years.<br />
<br />
I'm currently a Director at Cisco Systems,* where I lead Project and Program Management teams on delivering complex projects for Cisco's customers.<br />
<br />
Previously, I was a manager at Ernst & Young, where I analyzed failing projects at Fortune 500 companies, and recommended solutions to fix them.  <br />
<br />
I was also a research assistant at Harvard University, where I studied issues related to virtual teams. <br />
<br />
I'm an Amazon bestselling author of 4 books about team management (including "Influencing Virtual Teams," "Don't Reply All," "Project Kickoff," and "Effective Delegation of Authority"), and I hold the PMP, CSM and ITIL certifications.<br />
<br />
Most managers don't have a lot of time to watch lengthy courses (that are usually full of fluff). So I focus on creating short courses that help busy managers become more effective leaders, without wasting their time.<br />
<br />
I have published courses about Writing Better Emails, Delegating Effectively, Leading Virtual Meetings, and Managing and Influencing Virtual Teams.</div>
        </div>
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
                    ...
                    <div class="ml-8 text-gray-500">Associate of Applied Business from University of Leeds</div>
                </div>
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
                    ...
                    <div class="ml-8 text-gray-500">Bachelor of Management and Organizational Studies from University of Sheffield</div>
                </div>
                            <div class="profile-education-card d-flex align-items-center mt-16">
                    <div class="d-flex-center size-40 rounded-12 bg-gray-100">
                        <svg width="24px" height="24px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
                    ...
                    <div class="ml-8 text-gray-500">Master of Management from Durham University</div>
                </div>
                    </div>
  ...
  <path d="M20.5 12.3l-.15.09a17.037 17.037 0 01-5.79 2.08c-.08.96-.5 2.06-2.69 2.06s-2.61-1.09-2.69-2.04c-1.91-.3-3.79-.93-5.5-1.88-.15-.08-.3-.16-.44-.25-.36-.2-.7-.42-1.03-.64-.02-.01-.04-.03-.05-.04l.61 6.51c.21 1.99 1.03 4.04 5.43 4.04h7.62c4.4 0 5.22-2.05 5.43-4.05l.63-6.78a.12.12 0 01-.05.05c-.43.31-.87.6-1.33.85z" opacity=".4"/>
                    ...
                    <div class="ml-8 text-gray-500">Director at Cisco Systems 2015 - 2021</div>
                </div>
                            <div class="profile-education-card d-flex align-items-center mt-16">
                    <div class="d-flex-center size-40 rounded-12 bg-gray-100">
                        <svg width="24px" height="24px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  <path d="M20.5 12.3l-.15.09a17.037 17.037 0 01-5.79 2.08c-.08.96-.5 2.06-2.69 2.06s-2.61-1.09-2.69-2.04c-1.91-.3-3.79-.93-5.5-1.88-.15-.08-.3-.16-.44-.25-.36-.2-.7-.42-1.03-.64-.02-.01-.04-.03-.05-.04l.61 6.51c.21 1.99 1.03 4.04 5.43 4.04h7.62c4.4 0 5.22-2.05 5.43-4.05l.63-6.78a.12.12 0 01-.05.05c-.43.31-.87.6-1.33.85z" opacity=".4"/>
                    ...
                    <div class="ml-8 text-gray-500">research assistant at Harvard University 2010 - 2019</div>
                </div>
                            <div class="profile-education-card d-flex align-items-center mt-16">
                    <div class="d-flex-center size-40 rounded-12 bg-gray-100">
                        <svg width="24px" height="24px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  <path d="M20.5 12.3l-.15.09a17.037 17.037 0 01-5.79 2.08c-.08.96-.5 2.06-2.69 2.06s-2.61-1.09-2.69-2.04c-1.91-.3-3.79-.93-5.5-1.88-.15-.08-.3-.16-.44-.25-.36-.2-.7-.42-1.03-.64-.02-.01-.04-.03-.05-.04l.61 6.51c.21 1.99 1.03 4.04 5.43 4.04h7.62c4.4 0 5.22-2.05 5.43-4.05l.63-6.78a.12.12 0 01-.05.05c-.43.31-.87.6-1.33.85z" opacity=".4"/>
                    ...
                    <div class="ml-8 text-gray-500">Amazon bestselling author</div>
                </div>
                    </div>
            ...
            <div class="d-flex align-items-center mt-8 gap-12 flex-wrap">
                                    ...
                                    <div class="bg-gray-100 p-10 rounded-8 font-12 text-gray-500">Communications</div>
        ...
        <a href="https://lms.rocket-soft.org/course/How-to-Manage-Your-Virtual-Team" class="text-decoration-none d-block">
    <div class="course-grid-card-1 position-relative">
        ...
        <div class="position-relative z-index-2">
            <div class="course-grid-card-1__image bg-gray-200">
                                <img src="https://lms.rocket-soft.org/store/929/How to Manage &amp; Influence Your Virtual Team.jpg" class="img-cover" alt="How to Manage Your Virtual Team">
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-16">
        <a href="https://lms.rocket-soft.org/course/The-Future-of-Energy" class="text-decoration-none d-block">
    <div class="course-grid-card-1 position-relative">
        <div class="course-grid-card-1__mask"></div>
  ...
  <path d="M15 16c-.56 0-1.01-.45-1.01-1s.45-1 1-1 1 .45 1 1-.44 1-.99 1zM9.01 10C8.45 10 8 9.55 8 9s.45-1 1-1 1 .45 1 1-.44 1-.99 1zM9 15.75c-.19 0-.38-.07-.53-.22a.755.755 0 010-1.06l6-6c.29-.29.77-.29 1.06 0 .29.29.29.77 0 1.06l-6 6c-.15.15-.34.22-.53.22z"/>
                                ...
                                <img src="https://lms.rocket-soft.org/store/929/The Future of Energy.jpg" class="img-cover" alt="The Future of Energy">
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-16">
        <a href="https://lms.rocket-soft.org/course/New-Update-Features" class="text-decoration-none d-block">
    <div class="course-grid-card-1 position-relative">
        <div class="course-grid-card-1__mask"></div>

        <div class="position-relative z-index-2">
            <div class="course-grid-card-1__image bg-gray-200">
                                <img src="https://lms.rocket-soft.org/store/929/update_1.6.jpg" class="img-cover" alt="New Update Features">
            </div>

            <div class="course-grid-card-1__body d-flex flex-column py-12">
                <div class="d-flex flex-column px-12 w-100 h-100 mb-16">
                    <h3 class="course-title font-16 font-weight-bold text-dark">New Update Features</h3>
                    ...
                    <div class="d-flex align-items-center mt-auto">
                        ...
                        <div class="d-flex flex-column ml-4">
                            <div class="font-14 font-weight-bold text-dark">Kate Williams</div>
                                                            ...
                                                            <div class="d-inline-flex align-items-center gap-4 mt-2 font-12 text-gray-500">
                                    <span class="">in</span>
                                    <div class="font-14 text-gray-500 text-ellipsis">Language</div>
                                </div>
                                                    </div>
                    </div>
                </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-16">
        <a href="https://lms.rocket-soft.org/course/UX-Research-and-User-Testing" class="text-decoration-none d-block">
    <div class="course-grid-card-1 position-relative">
        <div class="course-grid-card-1__mask"></div>

        <div class="position-relative z-index-2">
            <div class="course-grid-card-1__image bg-gray-200">
                                <img src="https://lms.rocket-soft.org/store/1/default_images/courses/course3.jpg" class="img-cover" alt="UX Research and User Testing">
            </div>

            <div class="course-grid-card-1__body d-flex flex-column py-12">
                <div class="d-flex flex-column px-12 w-100 h-100 mb-16">
                    <h3 class="course-title font-16 font-weight-bold text-dark">UX Research and User Testing</h3>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-16">
        <a href="https://lms.rocket-soft.org/course/Backend-Development-with-Node-js" class="text-decoration-none d-block">
    <div class="course-grid-card-1 position-relative">
        <div class="course-grid-card-1__mask"></div>

        <div class="position-relative z-index-2">
            <div class="course-grid-card-1__image bg-gray-200">
                                <img src="https://lms.rocket-soft.org/store/1/default_images/courses/course12.jpg" class="img-cover" alt="Backend Development with Node.js">
            </div>

            <div class="course-grid-card-1__body d-flex flex-column py-12">
                <div class="d-flex flex-column px-12 w-100 h-100 mb-16">
                    <h3 class="course-title font-16 font-weight-bold text-dark">Backend Development with Node.js</h3>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <p class="mt-4 font-14 text-gray-500">No topics found for this user.</p>
                ...
                <div class="position-relative d-flex-center flex-column text-center bg-white rounded-16 border-gray-200 p-16 pt-32 z-index-2 h-100 w-100">
                    ...
                    <div class="mt-8 font-12 text-gray-500">Classes Sales from 3 to 9</div>
                </div>
            </div>
                    <div class="profile-badge-card position-relative mb-8">
                <div class="profile-badge-card__mask"></div>
                ...
                <div class="position-relative d-flex-center flex-column text-center bg-white rounded-16 border-gray-200 p-16 pt-32 z-index-2 h-100 w-100">
                    <div class="d-flex-center size-64 rounded-16 bg-gray-100">
                        <img src="https://lms.rocket-soft.org/store/1/default_images/badges/support2.svg" class="img-fluid" alt="Amazing Support">
                    </div>

                    <div class="mt-12 font-14 font-weight-bold ">Amazing Support</div>

                    <div class="mt-8 font-12 text-gray-500">Support Rating from 3 to 4</div>
                </div>
            </div>
            </div>
                                ...
                                <div class="custom-tabs-content px-16 active" id="reserveMeetingTab">
                                    <form action="https://lms.rocket-soft.org/users/kate-williams/meetings/overview" method="get">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
        ...
        <div class="ml-8">
            ...
            <div class="font-14 font-weight-bold text-gray-500 mt-4">24 Aug 2026 06:00PM-07:30PM</div>
        </div>
    </div>
  ...
  <path d="M8.5 15c-.13 0-.26-.03-.38-.08s-.23-.12-.33-.21c-.09-.1-.16-.21-.21-.33A.995.995 0 017.5 14c0-.13.03-.26.08-.38s.12-.23.21-.33c.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.09.1.16.21.21.33.05.12.08.25.08.38s-.03.26-.08.38-.12.23-.21.33c-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08zM12 15c-.13 0-.26-.03-.38-.08s-.23-.12-.33-.21c-.18-.19-.29-.45-.29-.71 0-.26.11-.52.29-.71.1-.09.21-.16.33-.21.24-.11.52-.11.76 0 .12.05.23.12.33.21.18.19.29.45.29.71 0 .26-.11.52-.29.71-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08zM8.5 18.5c-.13 0-.26-.03-.38-.08s-.23-.12-.33-.21c-.18-.19-.29-.45-.29-.71 0-.26.11-.52.29-.71.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.18.19.29.45.29.71 0 .26-.11.52-.29.71-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08z"/>
    ...
    <div class="js-times-container d-none flex-column w-100 h-100" data-user="kate-williams">
  ...
  <path d="M20.5 12.3l-.15.09a17.037 17.037 0 01-5.79 2.08c-.08.96-.5 2.06-2.69 2.06s-2.61-1.09-2.69-2.04c-1.91-.3-3.79-.93-5.5-1.88-.15-.08-.3-.16-.44-.25-.36-.2-.7-.42-1.03-.64-.02-.01-.04-.03-.05-.04l.61 6.51c.21 1.99 1.03 4.04 5.43 4.04h7.62c4.4 0 5.22-2.05 5.43-4.05l.63-6.78a.12.12 0 01-.05.05c-.43.31-.87.6-1.33.85z" opacity=".4"/>
            ...
            <div class="d-flex-center size-64">
                <img src="https://lms.rocket-soft.org/store/1/default_images/courses/icons/course_icon19.svg" alt="Data Scientist" class="img-fluid">
            </div>
        </div>

        <a href="https://lms.rocket-soft.org/jobs/data-scientist" class="">
        ...
        <a href="https://lms.rocket-soft.org/users/kate-williams/profile" class="d-flex align-items-center my-16 text-dark">
  ...
  <path d="M20.5 12.3l-.15.09a17.037 17.037 0 01-5.79 2.08c-.08.96-.5 2.06-2.69 2.06s-2.61-1.09-2.69-2.04c-1.91-.3-3.79-.93-5.5-1.88-.15-.08-.3-.16-.44-.25-.36-.2-.7-.42-1.03-.64-.02-.01-.04-.03-.05-.04l.61 6.51c.21 1.99 1.03 4.04 5.43 4.04h7.62c4.4 0 5.22-2.05 5.43-4.05l.63-6.78a.12.12 0 01-.05.05c-.43.31-.87.6-1.33.85z" opacity=".4"/>
            ...
            <div class="d-flex-center size-64">
                <img src="https://lms.rocket-soft.org/store/1/default_images/courses/icons/course_icon1.svg" alt="DevOps Engineer" class="img-fluid">
            </div>
        </div>

        <a href="https://lms.rocket-soft.org/jobs/devops-engineer" class="">
            <h3 class="font-16 mt-16 text-ellipsis text-dark">DevOps Engineer</h3>
        </a>
        ...
        <div class="mt-16 text-gray-500">We are looking for a skilled DevOps Engineer.</div>
            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center gap-4 font-12 text-gray-500">
                    ...
                    <span class="">Hybrid</span>
                            ...
                            <a href="https://lms.rocket-soft.org/jobs/devops-engineer" class="btn btn-primary gap-4">
