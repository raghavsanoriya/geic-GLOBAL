...
<!-- Mirrored from lms.rocket-soft.org/users/robert-ransdell/profile?tab=appointments by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:36:18 GMT -->
...
<!-- Open Graph -->
<meta property='og:title' content='Robert Ransdell Profile'>
<meta name='twitter:card' content='summary'>
<meta name='twitter:title' content='Robert Ransdell Profile'>
...
<meta property='og:type' content='website'>
    ...
    <title>Robert Ransdell Profile | Rocket LMS</title>
    ...
    <link rel="stylesheet" href="https://lms.rocket-soft.org/assets/design_1/css/app.min.css">
        ...
        <link rel="stylesheet" href="https://lms.rocket-soft.org/assets/design_1/css/parts/profile.min.css">
            <link rel="stylesheet" href="https://lms.rocket-soft.org/assets/design_1/css/parts/course_cards/grid_card_1.min.css">
                <link rel="stylesheet" href="https://lms.rocket-soft.org/assets/design_1/css/parts/product_cards/grid_card_1.min.css">
                <link rel="stylesheet" href="https://lms.rocket-soft.org/assets/design_1/css/parts/topic_cards/card_1.min.css">
        <link rel="stylesheet" href="https://lms.rocket-soft.org/assets/design_1/css/parts/instructor_discounts.min.css">
            <link rel="stylesheet" href="https://lms.rocket-soft.org/assets/design_1/css/parts/meeting_package_cards/grid_card_1.min.css">
                <link rel="stylesheet" href="https://lms.rocket-soft.org/assets/design_1/css/parts/event_cards/grid_card_1.min.css">
                <link rel="stylesheet" href="https://lms.rocket-soft.org/assets/design_1/css/parts/job_cards/grid_card_1.min.css">
            <link rel="stylesheet" href="https://lms.rocket-soft.org/assets/default/vendors/persian-datepicker/persian-datepicker.min.css"/>

        <link rel="stylesheet" href="https://lms.rocket-soft.org/assets/design_1/css/parts/profile_reserve_meeting.min.css">
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
        ...
        <img src="https://lms.rocket-soft.org/store/1015/6.jpg" class="img-cover" alt=""/>
    </div>
    ...
    <div class="d-flex-center flex-column text-center px-16">
        ...
        <div class="profile-avatar-card size-80 rounded-circle mt-32">
            <img src="https://lms.rocket-soft.org/store/1015/setting/avatar.jpg" alt="Robert Ransdell" class="img-cover rounded-circle">
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <h4 class="mt-16 font-16 font-weight-bold">Robert Ransdell</h4>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
        ...
        <div class="profile-followers-card position-relative d-flex align-items-center justify-content-around mt-16 w-100">
            <div class="flex-1 text-center">
                <span class="js-user-profile-followers-count d-block font-14 font-weight-bold">1</span>
                <span class="d-block mt-4 font-12 text-gray-500">Followers</span>
            </div>

            <div class="flex-1 text-center">
                <span class="d-block font-14 font-weight-bold">0</span>
                <span class="d-block mt-4 font-12 text-gray-500">Following</span>
            </div>
        </div>

        <div class="d-flex align-items-center gap-12 mt-16 w-100">
            <button type="button" id="followToggle" data-user-id="robert-ransdell" class="btn btn-primary btn-lg flex-1">
                                    Follow
                            </button>
    ...
    <div class="pt-24 mt-24 px-16 border-top-gray-200">
        ...
        <div class="text-center text-gray-500 mb-8">Member Since Jun 2021</div>
                    ...
                    <div class="profile-card-has-mask position-relative bg-white pt-24 pb-20 rounded-24">
                        <div class="custom-tabs">
                            ...
                            <div class="profile-tabs-items d-flex align-items-center gap-16 gap-lg-32 border-bottom-gray-200 px-24">
                                <div class="navbar-item d-flex-center pb-12 cursor-pointer font-12 font-weight-bold " data-tab-toggle data-tab-href="#aboutTab">
                                    <svg width="16px" height="16px" class="icons" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12.16 10.87c-.1-.01-.22-.01-.33 0a4.42 4.42 0 01-4.27-4.43C7.56 3.99 9.54 2 12 2a4.435 4.435 0 01.16 8.87zM7.16 14.56c-2.42 1.62-2.42 4.26 0 5.87 2.75 1.84 7.26 1.84 10.01 0 2.42-1.62 2.42-4.26 0-5.87-2.74-1.83-7.25-1.83-10.01 0z"/>
</svg>                                    <span class="ml-4">About</span>
                                </div>

                                <div class="navbar-item d-flex-center pb-12 cursor-pointer font-12 font-weight-bold " data-tab-toggle data-tab-href="#coursesTab">
                                    <svg width="16px" height="16px" class="icons" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
...
</svg>                                    <span class="ml-4">Courses</span>
                                </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.06 19.39c-.62.42-1.4.77-2.35 1.08l-1.58.52c-3.97 1.28-6.06.21-7.35-3.76L2.5 13.28c-1.28-3.97-.22-6.07 3.75-7.35l1.58-.52c.41-.13.8-.24 1.17-.31-.3.61-.54 1.35-.74 2.2l-.98 4.19c-.98 4.18.31 6.24 4.48 7.23l1.68.4c.58.14 1.12.23 1.62.27zM12.64 8.53l4.85 1.23M11.66 12.4l2.9.74"/>
                                ...
                                <div class="navbar-item d-flex-center pb-12 cursor-pointer font-12 font-weight-bold " data-tab-toggle data-tab-href="#forumTab">
                                    <svg width="16px" height="16px" class="icons" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
...
</svg>                                    <span class="ml-4">Forum</span>
                                </div>

                                <div class="navbar-item d-flex-center pb-12 cursor-pointer font-12 font-weight-bold " data-tab-toggle data-tab-href="#badgesTab">
                                    <svg width="16px" height="16px" class="icons" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
...
</svg>                                    <span class="ml-4">Badges</span>
                                </div>

                                <div class="navbar-item d-flex-center pb-12 cursor-pointer font-12 font-weight-bold active" data-tab-toggle data-tab-href="#reserveMeetingTab">
                                    <svg width="16px" height="16px" class="icons" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
...
</svg>                                    <span class="ml-4">Reserve a Meeting</span>
                                </div>

                                                                    <div class="navbar-item d-flex-center pb-12 cursor-pointer font-12 font-weight-bold " data-tab-toggle data-tab-href="#eventsTab">
                                        <svg width="16px" height="16px" class="icons" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8 2v3M16 2v3M3.5 9.09h17M21 8.5V17c0 3-1.5 5-5 5H8c-3.5 0-5-2-5-5V8.5c0-3 1.5-5 5-5h8c3.5 0 5 2 5 5z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
...
</svg>                                        <span class="ml-4">Jobs</span>
                                    </div>
                                                            </div>

                            <div class="custom-tabs-body">

                                <div class="custom-tabs-content px-16  " id="aboutTab">
  ...
  <path d="M18.38 12.84v4.93c0 1.27-.99 2.63-2.18 3.03l-3.19 1.06c-.56.19-1.47.19-2.02 0L7.8 20.8c-1.2-.4-2.18-1.76-2.18-3.03l.01-4.93 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88z" opacity=".4"/>
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
</svg>        <div class="font-14 text-gray-500 mt-8">Student</div>
        <div class="font-16 font-weight-bold mt-4">7</div>
    </div>
...
</svg>        <div class="font-14 text-gray-500 mt-8">Courses</div>
        <div class="font-16 font-weight-bold mt-4">6</div>
    </div>
...
</svg>        <div class="font-14 text-gray-500 mt-8">Articles</div>
        <div class="font-16 font-weight-bold mt-4">5</div>
    </div>
...
</svg>        <div class="font-14 text-gray-500 mt-8">Meetings</div>
        <div class="font-16 font-weight-bold mt-4">2</div>
    </div>
...
<div class="row">
            ...
            <h4 class="font-16 font-weight-bold">About Me</h4>
            <div class="mt-12 text-gray-500">Robert started his career as a Unix and Linux System Engineer in 1999. Since that time he has utilized his Linux skills at companies such as Xerox, UPS, Hewlett-Packard, and Amazon.com. Additionally, he has acted as a technical consultant and independent contractor for small businesses and Fortune 500 companies.<br />
<br />
Robert has professional experience with CentOS, RedHat Enterprise Linux, SUSE Linux Enterprise Server, and Ubuntu. He has used several Linux distributions on personal projects including Debian, Slackware, CrunchBang, and others. In addition to Linux, Jason has experience supporting proprietary Unix operating systems including AIX, HP-UX, and Solaris.<br />
<br />
He enjoys teaching others how to use and exploit the power of the Linux operating system. He is also the author of the books "Linux for Beginners" and "Command Line Kung Fu."</div>
        </div>
    
    
            <div class="col-12 col-md-6 mt-24">
            <h4 class="font-16 font-weight-bold">Education</h4>

                            <div class="profile-education-card d-flex align-items-center mt-12">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
                    ...
                    <div class="ml-8 text-gray-500">Red Hat Certified Engineer (RHCE)</div>
                </div>
                            <div class="profile-education-card d-flex align-items-center mt-16">
                    <div class="d-flex-center size-40 rounded-12 bg-gray-100">
                        <svg width="24px" height="24px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M18.38 12.84v4.93c0 1.27-.99 2.63-2.18 3.03l-3.19 1.06c-.56.19-1.47.19-2.02 0L7.8 20.8c-1.2-.4-2.18-1.76-2.18-3.03l.01-4.93 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88z" opacity=".4"/>
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
</svg>                    </div>
                    <div class="ml-8 text-gray-500">AWS Certified DevOps Engineer - Professional</div>
                </div>
                            <div class="profile-education-card d-flex align-items-center mt-16">
                    <div class="d-flex-center size-40 rounded-12 bg-gray-100">
                        <svg width="24px" height="24px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
                    ...
                    <div class="ml-8 text-gray-500">Linux Foundation Certified System Administrator</div>
                </div>
                            <div class="profile-education-card d-flex align-items-center mt-16">
                    <div class="d-flex-center size-40 rounded-12 bg-gray-100">
                        <svg width="24px" height="24px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
                    ...
                    <div class="ml-8 text-gray-500">Master of Science in Information Systems (MSIS) from University of Sydney</div>
                </div>
                    </div>
    
            <div class="col-12 col-md-6 mt-24">
            <h4 class="font-16 font-weight-bold">Experiences</h4>
  ...
  <path d="M20.5 12.3l-.15.09a17.037 17.037 0 01-5.79 2.08c-.08.96-.5 2.06-2.69 2.06s-2.61-1.09-2.69-2.04c-1.91-.3-3.79-.93-5.5-1.88-.15-.08-.3-.16-.44-.25-.36-.2-.7-.42-1.03-.64-.02-.01-.04-.03-.05-.04l.61 6.51c.21 1.99 1.03 4.04 5.43 4.04h7.62c4.4 0 5.22-2.05 5.43-4.05l.63-6.78a.12.12 0 01-.05.05c-.43.31-.87.6-1.33.85z" opacity=".4"/>
                    ...
                    <div class="ml-8 text-gray-500">supporting proprietary Unix operating systems including AIX, HP-UX, and Solaris.</div>
                </div>
                            <div class="profile-education-card d-flex align-items-center mt-16">
                    <div class="d-flex-center size-40 rounded-12 bg-gray-100">
                        <svg width="24px" height="24px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  <path d="M20.5 12.3l-.15.09a17.037 17.037 0 01-5.79 2.08c-.08.96-.5 2.06-2.69 2.06s-2.61-1.09-2.69-2.04c-1.91-.3-3.79-.93-5.5-1.88-.15-.08-.3-.16-.44-.25-.36-.2-.7-.42-1.03-.64-.02-.01-.04-.03-.05-.04l.61 6.51c.21 1.99 1.03 4.04 5.43 4.04h7.62c4.4 0 5.22-2.05 5.43-4.05l.63-6.78a.12.12 0 01-.05.05c-.43.31-.87.6-1.33.85z" opacity=".4"/>
                    ...
                    <div class="ml-8 text-gray-500">10 years of experience working with Linux systems</div>
                </div>
                    </div>
            ...
            <div class="d-flex align-items-center mt-8 gap-12 flex-wrap">
                                    <div class="bg-gray-100 p-10 rounded-8 font-12 text-gray-500">Management</div>
                                    <div class="bg-gray-100 p-10 rounded-8 font-12 text-gray-500">Web Development</div>
                                    <div class="bg-gray-100 p-10 rounded-8 font-12 text-gray-500">Mobile Development</div>
                            </div>
        </div>
    </div>
                                </div>
    ...
    <div class="course-grid-card-1 position-relative">
        ...
        <div class="position-relative z-index-2">
            <div class="course-grid-card-1__image bg-gray-200">
                                <img src="https://lms.rocket-soft.org/store/1015/The Professional Guitar Masterclass.jpg" class="img-cover" alt="New Learning Page">
            </div>
  ...
  <path d="M15 16c-.56 0-1.01-.45-1.01-1s.45-1 1-1 1 .45 1 1-.44 1-.99 1zM9.01 10C8.45 10 8 9.55 8 9s.45-1 1-1 1 .45 1 1-.44 1-.99 1zM9 15.75c-.19 0-.38-.07-.53-.22a.755.755 0 010-1.06l6-6c.29-.29.77-.29 1.06 0 .29.29.29.77 0 1.06l-6 6c-.15.15-.34.22-.53.22z"/>
                                ...
                                <img src="https://lms.rocket-soft.org/store/1015/Excel from Beginner to Advanced.jpg" class="img-cover" alt="Excel from Beginner to Advanced">
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-16">
        <a href="https://lms.rocket-soft.org/course/Learn-Linux-in-5-Days" class="text-decoration-none d-block">
    <div class="course-grid-card-1 position-relative">
        <div class="course-grid-card-1__mask"></div>

        <div class="position-relative z-index-2">
            <div class="course-grid-card-1__image bg-gray-200">
                                <img src="https://lms.rocket-soft.org/store/1015/hero (6).jpg" class="img-cover" alt="Learn Linux in 5 Days">
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="course-grid-card-1 position-relative">
        ...
        <div class="position-relative z-index-2">
            <div class="course-grid-card-1__image bg-gray-200">
                                <img src="https://lms.rocket-soft.org/store/1015/new_live_system.jpg" class="img-cover" alt="New In-App Live System">
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-16">
        <a href="https://lms.rocket-soft.org/course/UI-UX-Design-Fundamentals" class="text-decoration-none d-block">
    <div class="course-grid-card-1 position-relative">
        <div class="course-grid-card-1__mask"></div>

        <div class="position-relative z-index-2">
            <div class="course-grid-card-1__image bg-gray-200">
                                <img src="https://lms.rocket-soft.org/store/1/default_images/courses/course1.jpg" class="img-cover" alt="UI/UX Design Fundamentals">
            </div>

            <div class="course-grid-card-1__body d-flex flex-column py-12">
                <div class="d-flex flex-column px-12 w-100 h-100 mb-16">
                    <h3 class="course-title font-16 font-weight-bold text-dark">UI/UX Design Fundamentals</h3>
                    ...
                    <div class="d-flex align-items-center mt-auto">
                        ...
                        <div class="d-flex flex-column ml-4">
                            <div class="font-14 font-weight-bold text-dark">Robert Ransdell</div>
                                                            ...
                                                            <div class="d-inline-flex align-items-center gap-4 mt-2 font-12 text-gray-500">
                                    <span class="">in</span>
                                    <div class="font-14 text-gray-500 text-ellipsis">Design</div>
                                </div>
                                                    </div>
                    </div>
                </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-16">
        <a href="https://lms.rocket-soft.org/course/Mobile-App-Development-with-React-Native" class="text-decoration-none d-block">
    <div class="course-grid-card-1 position-relative">
        <div class="course-grid-card-1__mask"></div>

        <div class="position-relative z-index-2">
            <div class="course-grid-card-1__image bg-gray-200">
                                <img src="https://lms.rocket-soft.org/store/1/default_images/courses/course11.jpg" class="img-cover" alt="Mobile App Development with React Native">
            </div>

            <div class="course-grid-card-1__body d-flex flex-column py-12">
                <div class="d-flex flex-column px-12 w-100 h-100 mb-16">
                    <h3 class="course-title font-16 font-weight-bold text-dark">Mobile App Development with React Native</h3>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
        ...
        <a href="https://lms.rocket-soft.org/products/Business-Software" class="text-decoration-none d-block">
    <div class="product-card position-relative">
        ...
        <div class="position-relative d-flex p-12 rounded-16 bg-white z-index-2">
            <div class="product-card__image rounded-16">
                <img src="https://lms.rocket-soft.org/store/1/default_images/store/products/software.jpg" class="img-cover rounded-16" alt="Business Software">
            </div>
            ...
            <div class="product-card__content ml-12 flex-1 d-flex flex-column">
                ...
                <div class="d-flex align-items-center my-16" onclick="event.stopPropagation()">
                    <a href="https://lms.rocket-soft.org/users/robert-ransdell/profile" target="_blank" class="size-32 rounded-circle" onclick="event.stopPropagation()">
                        <img src="https://lms.rocket-soft.org/store/1015/setting/avatar.jpg" class="img-cover rounded-circle" alt="Robert Ransdell">
                    </a>

                    <div class="d-flex flex-column ml-4">
                        <a href="https://lms.rocket-soft.org/users/robert-ransdell/profile" target="_blank" class="font-14 font-weight-bold text-dark" onclick="event.stopPropagation()">Robert Ransdell</a>

                                                    <div class="d-inline-flex align-items-center gap-4 mt-2 font-14 text-gray-500">
                                <span class="">in</span>
                                <a href="https://lms.rocket-soft.org/products?category_id=3" target="_blank" class="font-14 text-gray-500 text-ellipsis" onclick="event.stopPropagation()">E-books</a>
                            </div>
                                            </div>
                </div>
                ...
                <div class="mt-auto d-flex align-items-center justify-content-between">
                    ...
                    <div class="">
                        <a href="https://lms.rocket-soft.org/products/Business-Software" class="text-decoration-none">
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
                    ...
                    <span class="ml-4 text-gray-500 font-14">(1)</span>
                                            ...
                                            <div class="d-flex align-items-center font-16 font-weight-bold text-primary">
                            <a href="https://lms.rocket-soft.org/products/Business-Software" class="text-decoration-none text-primary">
    ...
    <div class="col-12 col-lg-6 mt-16">
        <a href="https://lms.rocket-soft.org/products/Painting-tools" class="text-decoration-none d-block">
    <div class="product-card position-relative">
        <div class="product-card__mask"></div>

        <div class="position-relative d-flex p-12 rounded-16 bg-white z-index-2">
            <div class="product-card__image rounded-16">
                <img src="https://lms.rocket-soft.org/store/1/default_images/store/products/painting.jpg" class="img-cover rounded-16" alt="Painting tools">
            </div>
            ...
            <div class="product-card__content ml-12 flex-1 d-flex flex-column">
                ...
                <div class="d-flex align-items-center my-16" onclick="event.stopPropagation()">
                    ...
                    <div class="d-flex flex-column ml-4">
                        <a href="https://lms.rocket-soft.org/users/robert-ransdell/profile" target="_blank" class="font-14 font-weight-bold text-dark" onclick="event.stopPropagation()">Robert Ransdell</a>
                                                    ...
                                                    <div class="d-inline-flex align-items-center gap-4 mt-2 font-14 text-gray-500">
                                <span class="">in</span>
                                <a href="https://lms.rocket-soft.org/products?category_id=1" target="_blank" class="font-14 text-gray-500 text-ellipsis" onclick="event.stopPropagation()">Design Tools</a>
                            </div>
                                            </div>
                </div>
                ...
                <div class="mt-auto d-flex align-items-center justify-content-between">
                    ...
                    <div class="">
                        <a href="https://lms.rocket-soft.org/products/Painting-tools" class="text-decoration-none">
                            <div class="stars-card d-flex align-items-center ">
                    <span class="stars-card__item active">
                <svg width="14px" height="14px" class="icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
                    ...
                    <span class="ml-4 text-gray-500 font-14">(1)</span>
                                            ...
                                            <div class="d-flex align-items-center font-16 font-weight-bold text-primary">
                            <a href="https://lms.rocket-soft.org/products/Painting-tools" class="text-decoration-none text-primary">
    ...
    <p class="mt-4 font-14 text-gray-500">No posts found for this user.</p>
        ...
        <div class="mt-24 profile-forum-topic">
    ...
    <div class="position-relative bg-white p-12 rounded-24 border-gray-200 z-index-3">
        <div class="row">
            <div class="col-12 col-lg-7 d-flex align-items-lg-center">
                <a href="https://lms.rocket-soft.org/forums/Travel/topics/test/posts" class="text-dark">
                    <div class="forum-topic-card__image rounded-12 bg-gray-100 d-flex-center border-gray-300 border-dashed">
                                                    <svg width="64px" height="64px" class="icons text-info" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M21.66 10.44l-.98 4.18c-.84 3.61-2.5 5.07-5.62 4.77-.5-.04-1.04-.13-1.62-.27l-1.68-.4c-4.17-.99-5.46-3.05-4.48-7.23l.98-4.19c.2-.85.44-1.59.74-2.2 1.17-2.42 3.16-3.07 6.5-2.28l1.67.39c4.19.98 5.47 3.05 4.49 7.23z" opacity=".4"/>
  <path d="M15.06 19.39c-.62.42-1.4.77-2.35 1.08l-1.58.52c-3.97 1.28-6.06.21-7.35-3.76L2.5 13.28c-1.28-3.97-.22-6.07 3.75-7.35l1.58-.52c.41-.13.8-.24 1.17-.31-.3.61-.54 1.35-.74 2.2l-.98 4.19c-.98 4.18.31 6.24 4.48 7.23l1.68.4c.58.14 1.12.23 1.62.27zM17.49 10.51c-.06 0-.12-.01-.19-.02l-4.85-1.23a.75.75 0 01.37-1.45l4.85 1.23a.748.748 0 01-.18 1.47z"/>
  <path d="M14.56 13.89c-.06 0-.12-.01-.19-.02l-2.91-.74a.75.75 0 01.37-1.45l2.91.74c.4.1.64.51.54.91-.08.34-.38.56-.72.56z"/>
</svg>                                            </div>
                ...
                <div class="ml-12 d-flex flex-column h-100 w-100">
                    <a href="https://lms.rocket-soft.org/forums/Travel/topics/test/posts" class="text-dark font-14">
                        <h4 class="font-16 font-weight-bold">Bar Train Tour on Heterocera</h4>
                    </a>

                    <p class="forum-topic-card__desc mt-8 font-14 text-gray-500 mb-8">Dear Second Life residents and friends,I am pleased to announce a unique way to travel and explore the continent of Heterocera by train.The Bellisserian Bureau for Bureaucracy, the Embassies of ...</p>
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-auto pb-8">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ml-8">
                                <a href="https://lms.rocket-soft.org/users/robert-ransdell/profile" target="_blank" class="text-dark">
                                    <h4 class="font-14 font-weight-bold text-dark">Robert Ransdell</h4>
                                </a>
                                <span class="d-block font-12 text-gray-500">20 Jun 2022 05:18</span>
                            </div>
                        </div>
            ...
            <div class="col-12 col-lg-5 mt-20 mt-lg-0">
                <div class="d-flex flex-column w-100 h-100 rounded-12 bg-gray-100 p-16">
                    <div class="d-flex align-items-center mb-16">
                        <div class="">
                            <span class="d-block font-12 text-gray-500">Replies</span>
                            <span class="d-block font-14 font-weight-bold mt-4">1</span>
                        </div>

                        <div class="mx-20 mx-lg-40">
                            <span class="d-block font-12 text-gray-500">Likes</span>
                            <span class="d-block font-14 font-weight-bold mt-4">0</span>
                        </div>

                        <div class="">
                            <span class="d-block font-12 text-gray-500">Active Users</span>
                            <span class="d-block font-14 font-weight-bold mt-4">2</span>
                        </div>
                    </div>


                    <a href="https://lms.rocket-soft.org/forums/Travel/topics/test/posts" class="">
                        <div class="d-flex align-items-center justify-content-between px-12 rounded-8 bg-white mt-auto py-12">
                                                            <div class="">
                                    <span class="d-block font-12 text-gray-500">Last Activity</span>

                                    <div class="d-flex align-items-center mt-8">
                                        <div class="size-40 rounded-circle">
                                            <img src="https://lms.rocket-soft.org/store/929/setting/avatar.jpg" alt="Kate Williams" class="img-cover rounded-circle">
                                        </div>

                                        <div class="ml-8">
                                            <h4 class="font-14 font-weight-bold text-dark">Kate Williams</h4>
                                            <span class="d-block font-12 text-gray-500 mt-4">20 Jun 2022 05:53</span>
                                        </div>
                                    </div>
                                </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
    ...
    <div class="position-relative bg-white p-12 rounded-24 border-gray-200 z-index-3">
        <div class="row">
            <div class="col-12 col-lg-7 d-flex align-items-lg-center">
                <a href="https://lms.rocket-soft.org/forums/Public-Relations/topics/What-do-you-think-of-Mark-Zuckerberg/posts" class="text-dark">
                    <div class="forum-topic-card__image rounded-12 bg-gray-100 d-flex-center border-gray-300 border-dashed">
                                                    <svg width="64px" height="64px" class="icons text-info" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M21.66 10.44l-.98 4.18c-.84 3.61-2.5 5.07-5.62 4.77-.5-.04-1.04-.13-1.62-.27l-1.68-.4c-4.17-.99-5.46-3.05-4.48-7.23l.98-4.19c.2-.85.44-1.59.74-2.2 1.17-2.42 3.16-3.07 6.5-2.28l1.67.39c4.19.98 5.47 3.05 4.49 7.23z" opacity=".4"/>
  <path d="M15.06 19.39c-.62.42-1.4.77-2.35 1.08l-1.58.52c-3.97 1.28-6.06.21-7.35-3.76L2.5 13.28c-1.28-3.97-.22-6.07 3.75-7.35l1.58-.52c.41-.13.8-.24 1.17-.31-.3.61-.54 1.35-.74 2.2l-.98 4.19c-.98 4.18.31 6.24 4.48 7.23l1.68.4c.58.14 1.12.23 1.62.27zM17.49 10.51c-.06 0-.12-.01-.19-.02l-4.85-1.23a.75.75 0 01.37-1.45l4.85 1.23a.748.748 0 01-.18 1.47z"/>
  <path d="M14.56 13.89c-.06 0-.12-.01-.19-.02l-2.91-.74a.75.75 0 01.37-1.45l2.91.74c.4.1.64.51.54.91-.08.34-.38.56-.72.56z"/>
                ...
                <div class="ml-12 d-flex flex-column h-100 w-100">
                    <a href="https://lms.rocket-soft.org/forums/Public-Relations/topics/What-do-you-think-of-Mark-Zuckerberg/posts" class="text-dark font-14">
                        <h4 class="font-16 font-weight-bold">What do you think of Mark Zuckerberg?</h4>
                    </a>

                    <p class="forum-topic-card__desc mt-8 font-14 text-gray-500 mb-8">I&#039;ll start this discussion by saying I think the way he got his start was kinda sleazy...he made a website comparing the looks of his college classmates. That site was the precursor to his most famous ...</p>
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-auto pb-8">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ml-8">
                                ...
                                <span class="d-block font-12 text-gray-500">20 Jun 2022 05:11</span>
                            </div>
                        </div>
            ...
            <div class="col-12 col-lg-5 mt-20 mt-lg-0">
                <div class="d-flex flex-column w-100 h-100 rounded-12 bg-gray-100 p-16">
                    ...
                    <a href="https://lms.rocket-soft.org/forums/Public-Relations/topics/What-do-you-think-of-Mark-Zuckerberg/posts" class="">
                        <div class="d-flex align-items-center justify-content-between px-12 rounded-8 bg-white mt-auto py-12">
                                                            <div class="">
                                    <span class="d-block font-12 text-gray-500">Last Activity</span>
                                    ...
                                    <div class="d-flex align-items-center mt-8">
                                        <div class="size-40 rounded-circle">
                                            <img src="https://lms.rocket-soft.org/store/930/setting/avatar.jpg" alt="Jade Harrison" class="img-cover rounded-circle">
                                        </div>

                                        <div class="ml-8">
                                            <h4 class="font-14 font-weight-bold text-dark">Jade Harrison</h4>
                                            <span class="d-block font-12 text-gray-500 mt-4">21 Jun 2022 00:45</span>
                                        </div>
                                    </div>
                                </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
                                ...
                                <div class="custom-tabs-content px-16 " id="badgesTab">
                ...
                <div class="position-relative d-flex-center flex-column text-center bg-white rounded-16 border-gray-200 p-16 pt-32 z-index-2 h-100 w-100">
                    ...
                    <div class="mt-8 font-12 text-gray-500">Old Membership</div>
                </div>
            </div>
                    <div class="profile-badge-card position-relative mb-8">
                <div class="profile-badge-card__mask"></div>
                ...
                <div class="position-relative d-flex-center flex-column text-center bg-white rounded-16 border-gray-200 p-16 pt-32 z-index-2 h-100 w-100">
                    ...
                    <div class="mt-8 font-12 text-gray-500">Has 3 to 6 Classes</div>
                </div>
            </div>
                    <div class="profile-badge-card position-relative mb-8">
                <div class="profile-badge-card__mask"></div>
                ...
                <div class="position-relative d-flex-center flex-column text-center bg-white rounded-16 border-gray-200 p-16 pt-32 z-index-2 h-100 w-100">
                    ...
                    <div class="mt-8 font-12 text-gray-500">Classes Rating from 4 to 5</div>
                </div>
            </div>
                    <div class="profile-badge-card position-relative mb-8">
                <div class="profile-badge-card__mask"></div>
                ...
                <div class="position-relative d-flex-center flex-column text-center bg-white rounded-16 border-gray-200 p-16 pt-32 z-index-2 h-100 w-100">
                    <div class="d-flex-center size-64 rounded-16 bg-gray-100">
                        <img src="https://lms.rocket-soft.org/store/1/default_images/badges/sales3.svg" class="img-fluid" alt="King Seller">
                    </div>

                    <div class="mt-12 font-14 font-weight-bold ">King Seller</div>

                    <div class="mt-8 font-12 text-gray-500">Classes Sales from 10 to 20</div>
                </div>
            </div>
                    <div class="profile-badge-card position-relative mb-8">
                <div class="profile-badge-card__mask"></div>
                ...
                <div class="position-relative d-flex-center flex-column text-center bg-white rounded-16 border-gray-200 p-16 pt-32 z-index-2 h-100 w-100">
                    ...
                    <div class="mt-8 font-12 text-gray-500">Support Rating from 4 to 5</div>
                </div>
            </div>
                    <div class="profile-badge-card position-relative mb-8">
                <div class="profile-badge-card__mask"></div>
                ...
                <div class="position-relative d-flex-center flex-column text-center bg-white rounded-16 border-gray-200 p-16 pt-32 z-index-2 h-100 w-100">
                    <div class="d-flex-center size-64 rounded-16 bg-gray-100">
                        <img src="https://lms.rocket-soft.org/store/1/default_images/badges/forum1.svg" class="img-fluid" alt="Forums Top User">
                    </div>

                    <div class="mt-12 font-14 font-weight-bold ">Forums Top User</div>

                    <div class="mt-8 font-12 text-gray-500">Has 2 to 5 Topics</div>
                </div>
            </div>
            </div>
                                ...
                                <div class="custom-tabs-content px-16 active" id="reserveMeetingTab">
                                    <form action="https://lms.rocket-soft.org/users/robert-ransdell/meetings/overview" method="get">

        <div class="mt-16 text-gray-500">Please choose a day and time from the calendar to proceed with booking.</div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
        ...
        <div class="ml-8">
            <div class="font-12 text-gray-500">Nearest Time</div>
            <div class="font-14 font-weight-bold text-gray-500 mt-4">24 Aug 2026</div>
        </div>
    </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M22.301 10.92v5.15c0 3.08-1.76 4.4-4.4 4.4h-8.79c-.74 0-1.41-.1-1.99-.32-1.19-.44-2-1.35-2.29-2.81.4.09.83.13 1.28.13h8.79c2.64 0 4.4-1.32 4.4-4.4V7.92c0-.47-.04-.89-.12-1.28 1.9.4 3.12 1.74 3.12 4.28z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M10.498 13.14a2.64 2.64 0 100-5.28 2.64 2.64 0 000 5.28zM4.78 8.3v4.4M16.222 8.3v4.4"/>
</svg>        </div>

        <div class="ml-8">
            <div class="font-12 text-gray-500">Hourly Charge</div>
  ...
  <path stroke-width="1.5" d="M3.62 8.49c1.97-8.66 14.8-8.65 16.76.01 1.15 5.08-2.01 9.38-4.78 12.04a5.193 5.193 0 01-7.21 0c-2.76-2.66-5.92-6.97-4.77-12.05z"/>
        ...
        <div class="ml-8">
            <div class="font-12 text-gray-500">In-Person Charge</div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9.16 10.87c-.1-.01-.22-.01-.33 0a4.42 4.42 0 01-4.27-4.43C4.56 3.99 6.54 2 9 2a4.435 4.435 0 01.16 8.87zM16.41 4c1.94 0 3.5 1.57 3.5 3.5 0 1.89-1.5 3.43-3.37 3.5a1.13 1.13 0 00-.26 0M4.16 14.56c-2.42 1.62-2.42 4.26 0 5.87 2.75 1.84 7.26 1.84 10.01 0 2.42-1.62 2.42-4.26 0-5.87-2.74-1.83-7.25-1.83-10.01 0zM18.34 20c.72-.15 1.4-.44 1.96-.87 1.56-1.17 1.56-3.1 0-4.27-.55-.42-1.22-.7-1.93-.86"/>
        ...
        <div class="ml-8">
            <div class="font-12 text-gray-500">Group Meeting Charge</div>
        ...
        <div class="row mt-16">
            <div class="col-12 col-lg-5">
                <div class="profile-reserve-meeting position-relative">
  ...
  <path d="M8.5 15c-.13 0-.26-.03-.38-.08s-.23-.12-.33-.21c-.09-.1-.16-.21-.21-.33A.995.995 0 017.5 14c0-.13.03-.26.08-.38s.12-.23.21-.33c.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.09.1.16.21.21.33.05.12.08.25.08.38s-.03.26-.08.38-.12.23-.21.33c-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08zM12 15c-.13 0-.26-.03-.38-.08s-.23-.12-.33-.21c-.18-.19-.29-.45-.29-.71 0-.26.11-.52.29-.71.1-.09.21-.16.33-.21.24-.11.52-.11.76 0 .12.05.23.12.33.21.18.19.29.45.29.71 0 .26-.11.52-.29.71-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08zM8.5 18.5c-.13 0-.26-.03-.38-.08s-.23-.12-.33-.21c-.18-.19-.29-.45-.29-.71 0-.26.11-.52.29-.71.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.18.19.29.45.29.71 0 .26-.11.52-.29.71-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08z"/>
        ...
        <h3 class="font-16 font-weight-bold mt-12">Select a Date</h3>
        <p class="mt-4 font-12 text-gray-500">Select a date from the calendar to book a meeting</p>
    </div>


    <div class="js-times-container d-none flex-column w-100 h-100" data-user="robert-ransdell">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
            ...
            <div class="ml-4 font-weight-bold">Available times for <span class="js-selected-date"></span></div>
        </div>

        <div class="js-loading-img d-none align-items-center justify-content-center h-75">
            <img src="https://lms.rocket-soft.org/assets/default/img/loading.gif" width="80" height="80">
        </div>
        ...
        <div class="js-times-body d-flex flex-column flex-1">
            ...
            <div class="js-reserve-btn d-none mt-auto">
                <button type="button" class="js-proceed-to-booking-btn btn btn-lg btn-primary btn-block">Proceed with Booking</button>
            </div>
            ...
            <div class="">
            <div class="instructor-discount-card d-flex align-items-center justify-content-between user-profile-discount-card mt-16 ">
        <div class="d-flex align-items-center flex-1 h-100">
            <div class="instructor-discount-card__code form-group mb-0 d-flex align-items-center justify-content-center py-16 pr-14 pr-lg-20">
                <span class="font-16 font-weight-bold">BLK10</span>

                <button type="button" class="js-copy-input btn-transparent d-flex ml-4" data-tippy-content="copy" data-copy-text="copy" data-done-text="copied">
                    <svg width="16px" height="16px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17 13.4v3c0 4-1.6 5.6-5.6 5.6H7.6c-4 0-5.6-1.6-5.6-5.6v-3.8C2 8.6 3.6 7 7.6 7h3"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17 13.4h-3.2c-2.4 0-3.2-.8-3.2-3.2V7l6.4 6.4zM11.6 2h4M7 5c0-1.66 1.34-3 3-3h2.62M22 8v6.19c0 1.55-1.26 2.81-2.81 2.81M22 8h-3c-2.25 0-3-.75-3-3V2l6 6z"/>
</svg>                </button>
                <input type="hidden" class="form-control" readonly value="BLK10">
            </div>

            <div class="p-16 px-lg-20 py-lg-16">
                <h4 class="font-14">Black Firday Offer</h4>
                <p class="mt-4 font-12 text-gray-500">Buy now with a special offer</p>
            </div>
        </div>
        ...
        <div class="instructor-discount-card__icon-svg d-flex-center h-100">
            ...
            <div class="mt-16 ">
            <h4 class="font-16">Meeting Packages</h4>
            <p class="font-12 text-gray-500 mt-4">Book several sessions within one package</p>
        </div>

        <div class="row">
            <div class="card-with-border col-12 col-md-6 col-lg-4 mt-12">
    ...
    <div class="meeting-package-grid-card-1__contents position-relative z-index-3 bg-white rounded-16 py-16">
        ...
        <div class="px-16">
                    ...
                    <img src="https://lms.rocket-soft.org/store/1/default_images/meeting_packages/package8.svg" alt="Goal-Focused Coaching Package" class="img-fluid">
                </div>
            
            <h3 class="font-16 mt-12">Goal-Focused Coaching Package</h3>
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <span class="text-gray-500">Live Sessions</span>
                </div>
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <span class="font-weight-bold">6:00</span>
                    <span class="text-gray-500">Meeting Slots</span>
                </div>
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <span class="text-gray-500">Month Validity</span>
                </div>
            </div>

            
            <a href="https://lms.rocket-soft.org/users/robert-ransdell/profile" target="_blank" class="">
                <div class="d-flex align-items-center mt-16">
                    <div class="size-32 bg-gray-100 rounded-circle">
                        <img src="https://lms.rocket-soft.org/store/1015/setting/avatar.jpg" alt="Robert Ransdell" class="img-cover rounded-circle">
                    </div>
                    <div class="ml-4">
                        <h5 class="font-12 text-dark">Robert Ransdell</h5>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
        ...
        <div class="d-flex align-items-center justify-content-between mt-16 pt-16 px-16 border-top-gray-200">
            <div class="d-flex align-items-center gap-4 font-16 font-weight-bold text-primary">
                            ...
                            <div class="js-meeting-package-add-to-cart d-flex cursor-pointer" data-package="1">
                    <div class="d-flex align-items-center gap-8 ">
                        <span class="text-gray-500">Buy Package</span>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M14.43 5.93L20.5 12l-6.07 6.07M3.5 12h16.83"/>
    ...
    <div class="meeting-package-grid-card-1__contents position-relative z-index-3 bg-white rounded-16 py-16">
        ...
        <div class="px-16">
                            ...
                            <div class="d-flex-center size-48">
                    <img src="https://lms.rocket-soft.org/store/1/default_images/meeting_packages/package7.svg" alt="Skill-Building Package" class="img-fluid">
                </div>
            
            <h3 class="font-16 mt-12">Skill-Building Package</h3>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
        ...
        <div class="d-flex align-items-center justify-content-between mt-16 pt-16 px-16 border-top-gray-200">
            <div class="d-flex align-items-center gap-4 font-16 font-weight-bold text-primary">
                                            ...
                                            <span class="">$160</span>
                        <span class="font-14 font-weight-400 text-gray-500 text-decoration-line-through">$200</span>
                                                </div>


                            <div class="js-meeting-package-add-to-cart d-flex cursor-pointer" data-package="2">
                    <div class="d-flex align-items-center gap-8 ">
                        <span class="text-gray-500">Buy Package</span>
                        <svg width="24px" height="24px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M14.43 5.93L20.5 12l-6.07 6.07M3.5 12h16.83"/>
    ...
    <div class="meeting-package-grid-card-1__contents position-relative z-index-3 bg-white rounded-16 py-16">
        ...
        <div class="px-16">
                            ...
                            <div class="d-flex-center size-48">
                    <img src="https://lms.rocket-soft.org/store/1/default_images/meeting_packages/package6.svg" alt="Consultation Package" class="img-fluid">
                </div>
            
            <h3 class="font-16 mt-12">Consultation Package</h3>
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <span class="font-weight-bold">1:30</span>
                    <span class="text-gray-500">Meeting Slots</span>
                </div>
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <span class="text-gray-500">Day Validity</span>
                </div>
            </div>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
        ...
        <div class="d-flex align-items-center justify-content-between mt-16 pt-16 px-16 border-top-gray-200">
            <div class="d-flex align-items-center gap-4 font-16 font-weight-bold text-primary">
                            ...
                            <div class="js-meeting-package-add-to-cart d-flex cursor-pointer" data-package="3">
                    <div class="d-flex align-items-center gap-8 ">
                        <span class="text-gray-500">Buy Package</span>
                        <svg width="24px" height="24px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M14.43 5.93L20.5 12l-6.07 6.07M3.5 12h16.83"/>
        ...
        <a href="https://lms.rocket-soft.org/events/devops-ci-cd-automation" class="text-decoration-none d-block">
    <div class="event-grid-card-1 position-relative bg-gray-100 rounded-16">
        <img src="https://lms.rocket-soft.org/store/1/default_images/events/thumbnails/event1.jpg" alt="DevOps and CI/CD Automation for Modern Teams" class="img-cover rounded-16">
  ...
  <path d="M19 15c-2.21 0-4 1.79-4 4 0 .75.21 1.46.58 2.06A3.97 3.97 0 0019 23c1.46 0 2.73-.78 3.42-1.94.37-.6.58-1.31.58-2.06 0-2.21-1.79-4-4-4zm2.07 3.57l-2.13 1.97c-.14.13-.33.2-.51.2-.19 0-.38-.07-.53-.22l-.99-.99a.754.754 0 010-1.06c.29-.29.77-.29 1.06 0l.48.48 1.6-1.48c.3-.28.78-.26 1.06.04s.26.77-.04 1.06zM8.5 15c-.26 0-.52-.11-.71-.29-.18-.19-.29-.45-.29-.71 0-.26.11-.52.29-.71.23-.23.58-.34.91-.27.06.01.12.03.18.06.06.02.12.05.18.09l.15.12c.18.19.29.45.29.71 0 .26-.11.52-.29.71l-.15.12c-.06.04-.12.07-.18.09-.06.03-.12.05-.18.06-.07.01-.14.02-.2.02zM12 15c-.26 0-.52-.11-.71-.29-.18-.19-.29-.45-.29-.71 0-.26.11-.52.29-.71.38-.37 1.05-.37 1.42 0 .18.19.29.45.29.71 0 .26-.11.52-.29.71-.19.18-.45.29-.71.29zM8.5 18.5c-.26 0-.52-.11-.71-.29-.18-.19-.29-.45-.29-.71 0-.26.11-.52.29-.71.1-.09.2-.16.33-.21.37-.16.81-.07 1.09.21.18.19.29.45.29.71 0 .26-.11.52-.29.71-.19.18-.45.29-.71.29z"/>
</svg>            <span class="ml-4 font-12 text-white">Ongoing</span>
        </div>
    </div>

        
        <div class="event-grid-card-1__contents bg-white d-flex flex-column p-12 rounded-8">
            <h3 class="event-grid-card-1__contents-title font-14 text-dark">DevOps and CI/CD Automation for Modern Teams</h3>
            ...
            <div class="d-flex align-items-center mt-auto ">
                ...
                <div class="ml-8">
                    <h6 class="font-12 font-weight-bold text-dark">Robert Ransdell</h6>
                    <p class="mt-2 font-12 text-gray-500">in Business Strategy</p>
                </div>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8 2v3M16 2v3M3.5 9.09h17M21 8.5V17c0 3-1.5 5-5 5H8c-3.5 0-5-2-5-5V8.5c0-3 1.5-5 5-5h8c3.5 0 5 2 5 5z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
</svg>                        <span class="ml-2 font-12 text-gray-500">June 30</span>
                    </div>
    ...
    <div class="col-12 col-lg-4 mt-16">
        <a href="https://lms.rocket-soft.org/events/blockchain-crypto-development" class="text-decoration-none d-block">
    <div class="event-grid-card-1 position-relative bg-gray-100 rounded-16">
        <img src="https://lms.rocket-soft.org/store/1/default_images/events/thumbnails/event2.jpg" alt="Blockchain and Crypto Development for Applications" class="img-cover rounded-16">
...
</svg>            <span class="ml-4 font-12 text-white">Completed</span>
        </div>
    </div>

        
        <div class="event-grid-card-1__contents bg-white d-flex flex-column p-12 rounded-8">
            <h3 class="event-grid-card-1__contents-title font-14 text-dark">Blockchain and Crypto Development for Applications</h3>
            ...
            <div class="d-flex align-items-center mt-auto ">
                ...
                <div class="ml-8">
                    <h6 class="font-12 font-weight-bold text-dark">Robert Ransdell</h6>
                    <p class="mt-2 font-12 text-gray-500">in Marketing</p>
                </div>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8 2v3M16 2v3M3.5 9.09h17M21 8.5V17c0 3-1.5 5-5 5H8c-3.5 0-5-2-5-5V8.5c0-3 1.5-5 5-5h8c3.5 0 5 2 5 5z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
</svg>                        <span class="ml-2 font-12 text-gray-500">June 12</span>
                    </div>
    ...
    <div class="col-12 col-lg-4 mt-16">
        <a href="https://lms.rocket-soft.org/events/cloud-computing-aws-azure" class="text-decoration-none d-block">
    <div class="event-grid-card-1 position-relative bg-gray-100 rounded-16">
        <img src="https://lms.rocket-soft.org/store/1/default_images/events/thumbnails/event3.jpg" alt="Cloud Computing Fundamentals for Modern IT Professionals" class="img-cover rounded-16">
  ...
  <path d="M20 9.84c.55 0 1 .45 1 1V17c0 3-1.5 5-5 5H8c-3.5 0-5-2-5-5v-6.16c0-.55.45-1 1-1h16z" opacity=".4"/>
  <path d="M8.5 15c-.13 0-.26-.03-.38-.08s-.23-.12-.33-.21c-.09-.1-.16-.21-.21-.33A.995.995 0 017.5 14c0-.13.03-.26.08-.38s.12-.23.21-.33c.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.09.1.16.21.21.33.05.12.08.25.08.38s-.03.26-.08.38-.12.23-.21.33c-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08zM12 15c-.13 0-.26-.03-.38-.08s-.23-.12-.33-.21c-.18-.19-.29-.45-.29-.71 0-.26.11-.52.29-.71.1-.09.21-.16.33-.21.24-.11.52-.11.76 0 .12.05.23.12.33.21.18.19.29.45.29.71 0 .26-.11.52-.29.71-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08zM8.5 18.5c-.13 0-.26-.03-.38-.08s-.23-.12-.33-.21c-.18-.19-.29-.45-.29-.71 0-.26.11-.52.29-.71.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.18.19.29.45.29.71 0 .26-.11.52-.29.71-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08z"/>
</svg>            <span class="ml-4 font-12 text-white">Scheduled</span>
        </div>
    </div>

        
        <div class="event-grid-card-1__contents bg-white d-flex flex-column p-12 rounded-8">
            <h3 class="event-grid-card-1__contents-title font-14 text-dark">Cloud Computing Fundamentals for Modern IT Professionals</h3>
            ...
            <div class="d-flex align-items-center mt-auto ">
                ...
                <div class="ml-8">
                    <h6 class="font-12 font-weight-bold text-dark">Robert Ransdell</h6>
                    <p class="mt-2 font-12 text-gray-500">in Web Development</p>
                </div>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8 2v3M16 2v3M3.5 9.09h17M21 8.5V17c0 3-1.5 5-5 5H8c-3.5 0-5-2-5-5V8.5c0-3 1.5-5 5-5h8c3.5 0 5 2 5 5z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
</svg>                        <span class="ml-2 font-12 text-gray-500">September 10</span>
                    </div>
    ...
    <div class="col-12 col-lg-4 mt-16">
        <a href="https://lms.rocket-soft.org/events/digital-marketing-mastery" class="text-decoration-none d-block">
    <div class="event-grid-card-1 position-relative bg-gray-100 rounded-16">
        <img src="https://lms.rocket-soft.org/store/1/default_images/events/thumbnails/event4.jpg" alt="Digital Marketing Mastery for High-Impact Growth" class="img-cover rounded-16">
  ...
  <path d="M10.58 15.58a.75.75 0 01-.53-.22l-2.83-2.83a.754.754 0 010-1.06c.29-.29.77-.29 1.06 0l2.3 2.3 5.14-5.14c.29-.29.77-.29 1.06 0 .29.29.29.77 0 1.06l-5.67 5.67a.75.75 0 01-.53.22z"/>
        ...
        <div class="event-grid-card-1__contents bg-white d-flex flex-column p-12 rounded-8">
            <h3 class="event-grid-card-1__contents-title font-14 text-dark">Digital Marketing Mastery for High-Impact Growth</h3>
            ...
            <div class="d-flex align-items-center mt-auto ">
                ...
                <div class="ml-8">
                    <h6 class="font-12 font-weight-bold text-dark">Robert Ransdell</h6>
                    <p class="mt-2 font-12 text-gray-500">in Beauty &amp; Makeup</p>
                </div>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8 2v3M16 2v3M3.5 9.09h17M21 8.5V17c0 3-1.5 5-5 5H8c-3.5 0-5-2-5-5V8.5c0-3 1.5-5 5-5h8c3.5 0 5 2 5 5z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
</svg>                        <span class="ml-2 font-12 text-gray-500">May 15</span>
                    </div>
  ...
  <path d="M20.5 12.3l-.15.09a17.037 17.037 0 01-5.79 2.08c-.08.96-.5 2.06-2.69 2.06s-2.61-1.09-2.69-2.04c-1.91-.3-3.79-.93-5.5-1.88-.15-.08-.3-.16-.44-.25-.36-.2-.7-.42-1.03-.64-.02-.01-.04-.03-.05-.04l.61 6.51c.21 1.99 1.03 4.04 5.43 4.04h7.62c4.4 0 5.22-2.05 5.43-4.05l.63-6.78a.12.12 0 01-.05.05c-.43.31-.87.6-1.33.85z" opacity=".4"/>
            ...
            <div class="d-flex-center size-64">
                <img src="https://lms.rocket-soft.org/store/1/default_images/courses/icons/course_icon28.svg" alt="Backend Engineer" class="img-fluid">
            </div>
        </div>

        <a href="https://lms.rocket-soft.org/jobs/backend-engineer" class="">
        ...
        <a href="https://lms.rocket-soft.org/users/robert-ransdell/profile" class="d-flex align-items-center my-16 text-dark">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center gap-4 font-12 text-gray-500">
                    ...
                    <span class="">Hybrid</span>
                            ...
                            <a href="https://lms.rocket-soft.org/jobs/backend-engineer" class="btn btn-primary gap-4">
  ...
  <path d="M20.5 12.3l-.15.09a17.037 17.037 0 01-5.79 2.08c-.08.96-.5 2.06-2.69 2.06s-2.61-1.09-2.69-2.04c-1.91-.3-3.79-.93-5.5-1.88-.15-.08-.3-.16-.44-.25-.36-.2-.7-.42-1.03-.64-.02-.01-.04-.03-.05-.04l.61 6.51c.21 1.99 1.03 4.04 5.43 4.04h7.62c4.4 0 5.22-2.05 5.43-4.05l.63-6.78a.12.12 0 01-.05.05c-.43.31-.87.6-1.33.85z" opacity=".4"/>
            ...
            <div class="d-flex-center size-64">
                <img src="https://lms.rocket-soft.org/store/1/default_images/courses/icons/course_icon2.svg" alt="System Administrator" class="img-fluid">
            </div>
        </div>

        <a href="https://lms.rocket-soft.org/jobs/system-administrator" class="">
            <h3 class="font-16 mt-16 text-ellipsis text-dark">System Administrator</h3>
        </a>
        ...
        <div class="mt-16 text-gray-500">We are looking for a skilled System Administrator.</div>
...
<script defer src="https://lms.rocket-soft.org/assets/design_1/js/parts/content_delete.min.js"></script>
    ...
    <script>
        ...
        var sendMessageLang = 'Send Message';
        var reservedLang = 'Reserved';
        var messageSuccessSentLang = 'Message sent successfully.';
    </script>
    ...
    <script src="https://lms.rocket-soft.org/assets/design_1/js/parts/profile.min.js"></script>
        ...
        <script src="https://lms.rocket-soft.org/assets/default/vendors/persian-datepicker/persian-date.js"></script>
        <script src="https://lms.rocket-soft.org/assets/default/vendors/persian-datepicker/persian-datepicker.js"></script>
        ...
        <script>
            ...
            var nextBtnIcon = ``;
            var prevBtnIcon = ``;
            var availableDays = [7,1,2,3,4,5,6];
        </script>

        <script src="https://lms.rocket-soft.org/assets/design_1/js/parts/profile_reserve_meeting.min.js"></script>
