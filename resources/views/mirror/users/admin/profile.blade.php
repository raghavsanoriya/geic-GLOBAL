...
<!-- Mirrored from lms.rocket-soft.org/users/admin/profile by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:35:47 GMT -->
...
<!-- Open Graph -->
<meta property='og:title' content='Admin Profile'>
<meta name='twitter:card' content='summary'>
<meta name='twitter:title' content='Admin Profile'>
...
<meta property='og:type' content='website'>
    ...
    <title>Admin Profile | Rocket LMS</title>
    ...
    <link rel="stylesheet" href="https://lms.rocket-soft.org/assets/design_1/css/app.min.css">
        ...
        <link rel="stylesheet" href="https://lms.rocket-soft.org/assets/design_1/css/parts/profile.min.css">
            <link rel="stylesheet" href="https://lms.rocket-soft.org/assets/design_1/css/parts/product_cards/grid_card_1.min.css">
                <link rel="stylesheet" href="https://lms.rocket-soft.org/assets/design_1/css/parts/post_cards/grid_card_1.min.css">
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
        ...
        <img src="https://lms.rocket-soft.org/store/1/themes/general/user_profile_background.jpg" class="img-cover" alt=""/>
    </div>
    ...
    <div class="d-flex-center flex-column text-center px-16">
        ...
        <div class="profile-avatar-card size-80 rounded-circle mt-32">
            <img src="https://lms.rocket-soft.org/store/1/default_images/admin-avatar.jpg" alt="Admin" class="img-cover rounded-circle">
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <h4 class="mt-16 font-16 font-weight-bold">Admin</h4>
        ...
        <div class="d-flex align-items-center gap-12 mt-16 w-100">
            <button type="button" id="followToggle" data-user-id="admin" class="btn btn-primary btn-lg flex-1">
                                    Follow
                            </button>
...
<div class="row">
    ...
    <div class="no-result-logo ">
        <img src="https://lms.rocket-soft.org/assets/design_1/img/no-result/profile_courses.svg" alt="This instructor has no published courses." class="img-cover">
    </div>

    <h3 class="font-16 font-weight-bold mt-16">This instructor has no published courses.</h3>
    <p class="mt-4 font-14 text-gray-500">This instructor has not published any courses yet. You can check back later or explore other instructors.</p>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
    ...
    <a href="https://lms.rocket-soft.org/blog/3-Laws-to-Become-a-Straight-A-Student">
        <div class="post-card__image position-relative w-100 rounded-16 bg-gray-100">
            <img src="https://lms.rocket-soft.org/store/1/default_images/blogs/blog1.jpg" class="img-cover rounded-16" alt="How to Start Freelancing with No Experience or Clients Today">
        ...
        <div class="post-card__body d-flex flex-column position-relative bg-white rounded-16 border-gray-200 z-index-2">
            <div class="p-12 mb-16">
                ...
                <div class="d-flex align-items-center mt-16">
                    ...
                    <div class="ml-4">
                        <a href="https://lms.rocket-soft.org/users/admin/profile" target="_blank" class="font-14 font-weight-bold text-dark">Admin</a>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.996 11h.01M11.995 11h.01M7.995 11h.008"/>
    ...
    <p class="mt-4 font-14 text-gray-500">No job listings are available for this user</p>
