...
<!-- Mirrored from lms.rocket-soft.org/users/affogato-media/profile by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:36:17 GMT -->
...
<!-- Open Graph -->
<meta property='og:title' content='Affogato Media Profile'>
<meta name='twitter:card' content='summary'>
<meta name='twitter:title' content='Affogato Media Profile'>
...
<meta property='og:type' content='website'>
    ...
    <title>Affogato Media Profile | Rocket LMS</title>
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
        ...
        <img src="https://lms.rocket-soft.org/store/864/20.jpg" class="img-cover" alt=""/>
    </div>
    ...
    <div class="d-flex-center flex-column text-center px-16">
        ...
        <div class="profile-avatar-card size-80 rounded-circle mt-32">
            <img src="https://lms.rocket-soft.org/store/864/setting/avatar.jpg" alt="Affogato Media" class="img-cover rounded-circle">

                    </div>

        <h4 class="mt-16 font-16 font-weight-bold">Affogato Media</h4>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
        ...
        <div class="d-flex align-items-center gap-12 mt-16 w-100">
            <button type="button" id="followToggle" data-user-id="affogato-media" class="btn btn-primary btn-lg flex-1">
                                    Follow
                            </button>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M9.75 14.45v-1.2c0-1.54 1.09-2.17 2.42-1.4l1.04.6 1.04.6c1.33.77 1.33 2.03 0 2.8l-1.04.6-1.04.6c-1.33.77-2.42.14-2.42-1.4v-1.2 0z"/>
                                                                    ...
                                                                    <div class="navbar-item d-flex-center pb-12 cursor-pointer font-12 font-weight-bold " data-tab-toggle data-tab-href="#instructorsTab">
                                        <svg width="16px" height="16px" class="icons" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
...
<div class="row">
            ...
            <div class="mt-12 text-gray-500">Learn creative skills, from absolute beginner to advanced mastery. <br />
<br />
Video School exists to help you succeed in life. Each course has been hand-tailored to teach a specific skill from photography and video to art, design and business.<br />
<br />
Whether you’re trying to learn a new skill from scratch, or want to refresh your memory on something you’ve learned in the past, you’ve come to the right place.<br />
<br />
Education makes the world a better place. Make your world better with new skills!<br />
<br />
Our courses can be watched 24/7 wherever you are. Most are fully downloadable so you can take them with you.<br />
<br />
All courses have a 30-day money-back guarantee so that you can check it out, make sure it’s the right course for you, and get a refund if it’s not!</div>
        </div>
            ...
            <div class="d-flex align-items-center mt-8 gap-12 flex-wrap">
                                    ...
                                    <div class="bg-gray-100 p-10 rounded-8 font-12 text-gray-500">Math</div>
                                    <div class="bg-gray-100 p-10 rounded-8 font-12 text-gray-500">Science</div>
                                    <div class="bg-gray-100 p-10 rounded-8 font-12 text-gray-500">Language</div>
                            </div>
        </div>
    </div>
                                </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-16">
        <a href="https://lms.rocket-soft.org/course/Figma-for-UI-UX-Designers" class="text-decoration-none d-block">
    <div class="course-grid-card-1 position-relative">
        <div class="course-grid-card-1__mask"></div>

        <div class="position-relative z-index-2">
            <div class="course-grid-card-1__image bg-gray-200">
                                <img src="https://lms.rocket-soft.org/store/1/default_images/courses/course7.jpg" class="img-cover" alt="Figma for UI/UX Designers">
            </div>
            ...
            <div class="course-grid-card-1__body d-flex flex-column py-12">
                <div class="d-flex flex-column px-12 w-100 h-100 mb-16">
                    ...
                    <div class="d-flex align-items-center mt-auto">
                        <div class="size-32 rounded-circle">
                            <img src="https://lms.rocket-soft.org/store/864/setting/avatar.jpg" class="img-cover rounded-circle" alt="Affogato Media">
                        </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 mt-16">
    <a href="https://lms.rocket-soft.org/users/james-kong/profile" class="text-dark w-100">
        <div class="profile-instructor-card position-relative w-100 mb-8">
            ...
            <div class="position-relative d-flex align-items-center bg-white p-16 rounded-16 border-gray-200 z-index-2 w-100 h-100">
                ...
                <div class="ml-12">
                    <h3 class="font-14 font-weight-bold text-dark">James Kong</h3>

                    <div class="mt-4 font-12 text-gray-500">3 Courses</div>
                </div>
            </div>
  ...
  <path d="M20.5 12.3l-.15.09a17.037 17.037 0 01-5.79 2.08c-.08.96-.5 2.06-2.69 2.06s-2.61-1.09-2.69-2.04c-1.91-.3-3.79-.93-5.5-1.88-.15-.08-.3-.16-.44-.25-.36-.2-.7-.42-1.03-.64-.02-.01-.04-.03-.05-.04l.61 6.51c.21 1.99 1.03 4.04 5.43 4.04h7.62c4.4 0 5.22-2.05 5.43-4.05l.63-6.78a.12.12 0 01-.05.05c-.43.31-.87.6-1.33.85z" opacity=".4"/>
            ...
            <div class="d-flex-center size-64">
                <img src="https://lms.rocket-soft.org/store/1/default_images/courses/icons/course_icon23.svg" alt="HR Specialist" class="img-fluid">
            </div>
        </div>

        <a href="https://lms.rocket-soft.org/jobs/hr-specialist" class="">
        ...
        <a href="https://lms.rocket-soft.org/users/affogato-media/profile" class="d-flex align-items-center my-16 text-dark">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center gap-4 font-12 text-gray-500">
                    ...
                    <span class="">Hybrid</span>
                            ...
                            <a href="https://lms.rocket-soft.org/jobs/hr-specialist" class="btn btn-primary gap-4">
