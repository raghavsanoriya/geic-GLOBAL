...
<!-- Mirrored from lms.rocket-soft.org/users/techdecomposed/profile by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:36:17 GMT -->
...
<!-- Open Graph -->
<meta property='og:title' content='Tech Decomposed Profile'>
<meta name='twitter:card' content='summary'>
<meta name='twitter:title' content='Tech Decomposed Profile'>
...
<meta property='og:type' content='website'>
    ...
    <title>Tech Decomposed Profile | Rocket LMS</title>
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
        ...
        <img src="https://lms.rocket-soft.org/store/868/6.jpg" class="img-cover" alt=""/>
    </div>
    ...
    <div class="d-flex-center flex-column text-center px-16">
        ...
        <div class="profile-avatar-card size-80 rounded-circle mt-32">
            <img src="https://lms.rocket-soft.org/store/868/setting/avatar.jpg" alt="Tech Decomposed" class="img-cover rounded-circle">

                    </div>

        <h4 class="mt-16 font-16 font-weight-bold">Tech Decomposed</h4>
        ...
        <div class="d-flex align-items-center gap-12 mt-16 w-100">
            <button type="button" id="followToggle" data-user-id="techdecomposed" class="btn btn-primary btn-lg flex-1">
                                    Follow
                            </button>
...
<div class="row">
            ...
            <div class="mt-12 text-gray-500">Hi, my name is Gregory Caremans. I'm the founder of the award-winning TechDecomposed.<br />
I'm a psychologist with a Master in communication, specialized in the Neurocognitive and Behavioral Approach. I'm the former Director of the Institute of Neurocognitivism in Brussels (Belgium).<br />
With the TechDecomposed we've specialized in writing and producing high quality brain-related content. Mostly, we create online courses. I'm very proud to say that we have a partnership with The Economist where they offer our courses to their readers. Our courses were also featured in the magazine Entrepreneur and CNN. And I was invited to give my first TEDx Talk in December of 2018.</div>
        </div>
    ...
    <a href="https://lms.rocket-soft.org/users/kate-williams/profile" class="text-dark w-100">
        <div class="profile-instructor-card position-relative w-100 mb-8">
            ...
            <div class="position-relative d-flex align-items-center bg-white p-16 rounded-16 border-gray-200 z-index-2 w-100 h-100">
                ...
                <div class="ml-12">
                    <h3 class="font-14 font-weight-bold text-dark">Kate Williams</h3>

                    <div class="mt-4 font-12 text-gray-500">5 Courses</div>
                </div>
            </div>
