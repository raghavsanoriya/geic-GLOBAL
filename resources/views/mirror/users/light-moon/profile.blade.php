...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <h4 class="mt-16 font-16 font-weight-bold">Light Moon</h4>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
        ...
        <div class="d-flex align-items-center gap-12 mt-16 w-100">
            <button type="button" id="followToggle" data-user-id="light-moon" class="btn btn-primary btn-lg flex-1">
                                    Follow
                            </button>
...
<div class="row">
            ...
            <div class="mt-12 text-gray-500">The Light Moon Academy was created by Tim Buchalka, a software developer with 35 years experience, who is also an instructor on Udemy, with over 1.22M+ students in his courses on Java, Python, Android, C#  and the Spring framework. <br />
<br />
The Academy’s goal in the next three years, is to teach one million people to learn how to program.<br />
<br />
Apart from Tim’s own courses, which are all available here, we are working with the very best teachers, creating courses to teach the essential skills required by developers, at all levels.<br />
<br />
One other important philosophy is that our courses are taught by real professionals; software developers with real and substantial experience in the industry, who are also great teachers.  All our instructors are experienced, software developers!<br />
<br />
Our team is busy creating new courses right now.<br />
<br />
    ...
    <a href="https://lms.rocket-soft.org/users/robert-ransdell/profile" class="text-dark w-100">
        <div class="profile-instructor-card position-relative w-100 mb-8">
            ...
            <div class="position-relative d-flex align-items-center bg-white p-16 rounded-16 border-gray-200 z-index-2 w-100 h-100">
                ...
                <div class="ml-12">
                    <h3 class="font-14 font-weight-bold text-dark">Robert Ransdell</h3>

                    <div class="mt-4 font-12 text-gray-500">6 Courses</div>
                </div>
            </div>
    ...
    <a href="https://lms.rocket-soft.org/users/john-powe/profile" class="text-dark w-100">
        <div class="profile-instructor-card position-relative w-100 mb-8">
            ...
            <div class="position-relative d-flex align-items-center bg-white p-16 rounded-16 border-gray-200 z-index-2 w-100 h-100">
                ...
                <div class="ml-12">
                    <h3 class="font-14 font-weight-bold text-dark">John Powe</h3>

                    <div class="mt-4 font-12 text-gray-500">1 Courses</div>
                </div>
            </div>
