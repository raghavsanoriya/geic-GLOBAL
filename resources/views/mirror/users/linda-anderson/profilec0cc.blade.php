...
<!-- Mirrored from www.geic.in/users/linda-anderson/profile?tab=appointments by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:36:18 GMT -->
...
<meta property='og:type' content='website'>
    ...
    <title>Linda Anderson Profile | Trans Globe Indore LMS</title>
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
        ...
        <img src="https://www.geic.in/store/934/2.jpg" class="img-cover" alt=""/>
    </div>
    ...
    <div class="d-flex-center flex-column text-center px-16">
        ...
        <div class="profile-avatar-card size-80 rounded-circle mt-32">
            <img src="https://www.geic.in/store/934/setting/avatar.jpg" alt="Linda Anderson" class="img-cover rounded-circle">
...
When not at my computer, I am often riding my motorbike through the wonderful countryside of the UK and Europe.</div>
  ...
  <path d="M20.5 12.3l-.15.09a17.037 17.037 0 01-5.79 2.08c-.08.96-.5 2.06-2.69 2.06s-2.61-1.09-2.69-2.04c-1.91-.3-3.79-.93-5.5-1.88-.15-.08-.3-.16-.44-.25-.36-.2-.7-.42-1.03-.64-.02-.01-.04-.03-.05-.04l.61 6.51c.21 1.99 1.03 4.04 5.43 4.04h7.62c4.4 0 5.22-2.05 5.43-4.05l.63-6.78a.12.12 0 01-.05.05c-.43.31-.87.6-1.33.85z" opacity=".4"/>
        ...
        <a href="https://www.geic.in/course/Learn-Python-Programming" class="text-decoration-none d-block">
    <div class="course-grid-card-1 position-relative">
        ...
        <div class="position-relative z-index-2">
            <div class="course-grid-card-1__image bg-gray-200">
                                <img src="https://www.geic.in/store/934/Python for Beginners.jpg" class="img-cover" alt="Learn Python Programming">
            </div>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
                    ...
                    <div class="d-flex align-items-center mt-auto">
                        <div class="size-32 rounded-circle">
                            <img src="https://www.geic.in/store/934/setting/avatar.jpg" class="img-cover rounded-circle" alt="Linda Anderson">
                        </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-16">
        <a href="https://www.geic.in/course/Web-Design-for-Beginners" class="text-decoration-none d-block">
    <div class="course-grid-card-1 position-relative">
        <div class="course-grid-card-1__mask"></div>

        <div class="position-relative z-index-2">
            <div class="course-grid-card-1__image bg-gray-200">
                                <img src="https://www.geic.in/store/4/Web Design for Beginners.jpg" class="img-cover" alt="Web Design for Beginners">
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-16">
        <a href="https://www.geic.in/course/Advanced-UI-Design-Masterclass" class="text-decoration-none d-block">
    <div class="course-grid-card-1 position-relative">
        <div class="course-grid-card-1__mask"></div>

        <div class="position-relative z-index-2">
            <div class="course-grid-card-1__image bg-gray-200">
                                <img src="https://www.geic.in/store/1/default_images/courses/course2.jpg" class="img-cover" alt="Advanced UI Design Masterclass">
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-16">
        <a href="https://www.geic.in/course/Python-for-Data-Science" class="text-decoration-none d-block">
    <div class="course-grid-card-1 position-relative">
        <div class="course-grid-card-1__mask"></div>

        <div class="position-relative z-index-2">
            <div class="course-grid-card-1__image bg-gray-200">
                                <img src="https://www.geic.in/store/1/default_images/courses/course10.jpg" class="img-cover" alt="Python for Data Science">
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
        ...
        <a href="https://www.geic.in/products/Advanced-microscope" class="text-decoration-none d-block">
    <div class="product-card position-relative">
        ...
        <div class="position-relative d-flex p-12 rounded-16 bg-white z-index-2">
            <div class="product-card__image rounded-16">
                <img src="https://www.geic.in/store/1/default_images/store/products/microscope.jpg" class="img-cover rounded-16" alt="Advanced microscope">
            </div>
            ...
            <div class="product-card__content ml-12 flex-1 d-flex flex-column">
                ...
                <div class="d-flex align-items-center my-16" onclick="event.stopPropagation()">
                    <a href="https://www.geic.in/users/linda-anderson/profile" target="_blank" class="size-32 rounded-circle" onclick="event.stopPropagation()">
                        <img src="https://www.geic.in/store/934/setting/avatar.jpg" class="img-cover rounded-circle" alt="Linda Anderson">
                    </a>

                    <div class="d-flex flex-column ml-4">
                        <a href="https://www.geic.in/users/linda-anderson/profile" target="_blank" class="font-14 font-weight-bold text-dark" onclick="event.stopPropagation()">Linda Anderson</a>
                ...
                <div class="mt-auto d-flex align-items-center justify-content-between">
                    ...
                    <div class="">
                        <a href="https://www.geic.in/products/Advanced-microscope" class="text-decoration-none">
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
                    ...
                    <span class="ml-4 text-gray-500 font-14">(1)</span>
                                            ...
                                            <div class="d-flex align-items-center font-16 font-weight-bold text-primary">
                            <a href="https://www.geic.in/products/Advanced-microscope" class="text-decoration-none text-primary">
    ...
    <p class="mt-4 font-14 text-gray-500">No topics found for this user.</p>
                ...
                <div class="position-relative d-flex-center flex-column text-center bg-white rounded-16 border-gray-200 p-16 pt-32 z-index-2 h-100 w-100">
                    <div class="d-flex-center size-64 rounded-16 bg-gray-100">
                        <img src="https://www.geic.in/store/1/default_images/badges/sales1.svg" class="img-fluid" alt="Best Seller">
                    </div>
                ...
                <div class="position-relative d-flex-center flex-column text-center bg-white rounded-16 border-gray-200 p-16 pt-32 z-index-2 h-100 w-100">
                    ...
                    <div class="mt-8 font-12 text-gray-500">Support Rating from 4 to 5</div>
                                ...
                                <div class="custom-tabs-content px-16 active" id="reserveMeetingTab">
                                    <form action="https://www.geic.in/users/linda-anderson/meetings/overview" method="get">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="meeting-package-grid-card-1__contents position-relative z-index-3 bg-white rounded-16 py-16">
        ...
        <div class="px-16">
                    ...
                    <img src="https://www.geic.in/store/1/default_images/meeting_packages/package5.svg" alt="Coaching Package" class="img-fluid">
                </div>
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <a href="https://www.geic.in/users/linda-anderson/profile" target="_blank" class="">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M14.43 5.93L20.5 12l-6.07 6.07M3.5 12h16.83"/>
    ...
    <div class="meeting-package-grid-card-1__contents position-relative z-index-3 bg-white rounded-16 py-16">
        ...
        <div class="px-16">
                            ...
                            <div class="d-flex-center size-48">
                    <img src="https://www.geic.in/store/1/default_images/meeting_packages/package4.svg" alt="Progress Review Package" class="img-fluid">
                </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M14.43 5.93L20.5 12l-6.07 6.07M3.5 12h16.83"/>
    ...
    <div class="meeting-package-grid-card-1__contents position-relative z-index-3 bg-white rounded-16 py-16">
        ...
        <div class="px-16">
                            ...
                            <div class="d-flex-center size-48">
                    <img src="https://www.geic.in/store/1/default_images/meeting_packages/package3.svg" alt="Skill Enhancement Package" class="img-fluid">
                </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M14.43 5.93L20.5 12l-6.07 6.07M3.5 12h16.83"/>
        ...
        <a href="https://www.geic.in/events/agile-project-management-workshop" class="text-decoration-none d-block">
    <div class="event-grid-card-1 position-relative bg-gray-100 rounded-16">
        <img src="https://www.geic.in/store/1/default_images/events/thumbnails/event8.jpg" alt="Agile Project Management Workshop for High-Performing Teams" class="img-cover rounded-16">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
    ...
    <div class="col-12 col-lg-4 mt-16">
        <a href="https://www.geic.in/events/ui-ux-design-fundamentals" class="text-decoration-none d-block">
    <div class="event-grid-card-1 position-relative bg-gray-100 rounded-16">
        <img src="https://www.geic.in/store/1/default_images/events/thumbnails/event9.jpg" alt="UI/UX Design Fundamentals for Engaging Digital Experiences" class="img-cover rounded-16">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
    ...
    <div class="col-12 col-lg-4 mt-16">
        <a href="https://www.geic.in/events/python-data-science-masterclass" class="text-decoration-none d-block">
    <div class="event-grid-card-1 position-relative bg-gray-100 rounded-16">
        <img src="https://www.geic.in/store/1/default_images/events/thumbnails/event10.jpg" alt="Python Data Science Masterclass for Practical Insights" class="img-cover rounded-16">
  ...
  <path d="M12 12.26H9c-.41 0-.75.34-.75.75s.34.75.75.75h3c.41 0 .75-.34.75-.75s-.34-.75-.75-.75zM9 9.76h3c.41 0 .75-.34.75-.75s-.34-.75-.75-.75H9c-.41 0-.75.34-.75.75s.34.75.75.75zM5.97 8.01c-.56 0-1 .45-1 1s.45 1 1 1 1-.45 1-1-.45-1-1-1zM5.97 12.01c-.56 0-1 .45-1 1s.45 1 1 1 1-.45 1-1-.45-1-1-1z"/>
            ...
            <div class="d-flex-center size-64">
                <img src="https://www.geic.in/store/1/default_images/courses/icons/course_icon29.svg" alt="UI/UX Designer" class="img-fluid">
            </div>
        </div>

        <a href="https://www.geic.in/jobs/ui-ux-designer" class="">
        ...
        <a href="https://www.geic.in/users/linda-anderson/profile" class="d-flex align-items-center my-16 text-dark">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center gap-4 font-12 text-gray-500">
                    ...
                    <span class="">Remote</span>
                            ...
                            <a href="https://www.geic.in/jobs/ui-ux-designer" class="btn btn-primary gap-4">
  ...
  <path d="M21.09 6.98c-.85-.94-2.26-1.41-4.33-1.41h-.24v-.04c0-1.68 0-3.76-3.76-3.76h-1.52c-3.76 0-3.76 2.08-3.76 3.76v.04h-.24c-2.07 0-3.49.47-4.33 1.41-.99 1.11-.96 2.58-.86 3.59l.01.07.09 1.05c.01.01.03.02.05.03.34.22.67.44 1.03.64.14.09.29.17.44.25 1.13.62 2.34 1.11 3.58 1.45A4.755 4.755 0 0012 18.75c2.62 0 4.75-2.13 4.75-4.75v-.04c1.26-.38 2.47-.91 3.6-1.57.06-.03.1-.06.15-.09.46-.25.9-.54 1.32-.84.01-.01.03-.03.04-.05l.04-.36.05-.47c.01-.06.01-.11.02-.18.08-1 .06-2.38-.88-3.42zM8.91 5.53c0-1.7 0-2.34 2.33-2.34h1.52c2.33 0 2.33.64 2.33 2.34v.04H8.91v-.04zM12 17.25a3.25 3.25 0 01-3.22-2.84c-.02-.13-.03-.27-.03-.41 0-1.79 1.46-3.25 3.25-3.25s3.25 1.46 3.25 3.25c0 .12-.01.23-.02.34v.01a3.258 3.258 0 01-3.23 2.9z"/>
            ...
            <div class="d-flex-center size-64">
                <img src="https://www.geic.in/store/1/default_images/courses/icons/course_icon3.svg" alt="Content Writer" class="img-fluid">
            </div>
        </div>

        <a href="https://www.geic.in/jobs/content-writer" class="">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center gap-4 font-12 text-gray-500">
                    ...
                    <span class="">Remote</span>
                            ...
                            <a href="https://www.geic.in/jobs/content-writer" class="btn btn-primary gap-4">
                    <span class="">Apply</span>
                    <svg width="16px" height="16px" class="icons" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M14.43 5.93L20.5 12l-6.07 6.07M3.5 12h16.83"/>
</svg>                </a>
