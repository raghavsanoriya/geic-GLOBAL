...
<!-- Mirrored from lms.rocket-soft.org/products?category_id=1 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:36:00 GMT -->
    ...
    <div id="leftFiltersAccordion" class="position-relative card-before-line card-before-line__4-12 bg-white py-16 rounded-24 z-index-2">
        <div class="font-14 font-weight-bold text-dark px-16">
            Store Categories
                                    ...
                                    <div class="js-get-view-data-by-tab mt-16 px-16 cursor-pointer font-weight-bold active" data-filter-name="category_id" data-filter-value="1" data-container-id="listsContainer">Design Tools</div>
