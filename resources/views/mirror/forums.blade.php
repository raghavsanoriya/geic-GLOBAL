...
<!-- Mirrored from lms.rocket-soft.org/forums by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:24:59 GMT -->
...
<meta name='robots' content="NOODP, nofollow, noindex">
    ...
    <meta name="description" content="Forums Description">
    <meta property="og:description" content="Forums Description">
    <meta name='twitter:description' content='Forums Description'>
...
<meta property='og:type' content='website'>
    ...
    <link rel="stylesheet" href="https://lms.rocket-soft.org/assets/design_1/css/app.min.css">
        ...
        <link rel="stylesheet" href="https://lms.rocket-soft.org/assets/default/vendors/swiper/swiper-bundle.min.css">
    <link rel="stylesheet" href="https://lms.rocket-soft.org/assets/design_1/css/parts/forum.min.css">
...
<div id="app">
    ...
    <div class="row">
        <div class="col-12 col-lg-6 position-relative mt-100">
            ...
            <div class="forum-hero-circles circle-1"></div>
                     ...
                     style="color: #3fcd82; border-color: #3fcd82"
                >
                    <span class="forum-extra-badge__mask" style="background-color: #3fcd82"></span>
                    <span class="z-index-2">Forum</span>
                </div>
            
                            <h1 class="forum-hero-title mt-8">Your Learning Community Starts Here</h1>
            
                            <div class="mt-20 font-16 text-gray-500">Access a dedicated space for questions, answers, and peer support. Stay connected, solve doubts, and enrich your learning journey collaboratively</div>
            
                            <div class="forum-hero-search-box bg-white p-12 mt-20 rounded-16">
                    <form action="https://lms.rocket-soft.org/forums/search" method="get">
                        <div class="form-group d-flex align-items-center m-0">
                            <input type="text" name="search" class="form-control border-0 bg-white flex-1" placeholder="Search Discussions..."/>
        ...
        <div class="col-12 col-lg-6 mt-40 mt-lg-0 position-relative">
                    ...
                    <img src="https://lms.rocket-soft.org/store/1/default_images/forums/forum_hero.png" alt="Forum" class="img-cover">
                </div>
  ...
  <path d="M21.98 6.79v4c0 2.94-1.35 4.52-4.04 4.75.03-.24.04-.49.04-.75v-4c0-3.19-1.6-4.79-4.79-4.79h-6.4c-.26 0-.51.01-.75.04C6.27 3.35 7.86 2 10.79 2h6.4c3.19 0 4.79 1.6 4.79 4.79z"/>
</svg>                    <span class="ml-8 font-14 text-gray-500">Communicate with other users and share your knowledge.</span>
                </div>

                <div class="d-flex align-items-center gap-20 mt-16">

                                                                        <div class="size-48 rounded-circle">
                                <img src="https://lms.rocket-soft.org/store/3/setting/avatar.jpg" alt="James Kong" class="img-cover rounded-circle">
                            </div>
                                                    <div class="size-48 rounded-circle">
                                <img src="https://lms.rocket-soft.org/store/859/setting/avatar.jpg" alt="Cactuscat Clothing" class="img-cover rounded-circle">
                            </div>
                                                    <div class="size-48 rounded-circle">
                                <img src="https://lms.rocket-soft.org/store/923/setting/avatar.jpg" alt="John Powe" class="img-cover rounded-circle">
                            </div>
                                                    <div class="size-48 rounded-circle">
                                ...
                                <img src="https://lms.rocket-soft.org/store/930/setting/avatar.jpg" alt="Jade Harrison" class="img-cover rounded-circle">
                                                    ...
                                                    <div class="size-48 rounded-circle">
                                <img src="https://lms.rocket-soft.org/store/995/setting/avatar.jpg" alt="Camelia Schofield" class="img-cover rounded-circle">
                            </div>
                                                    <div class="size-48 rounded-circle">
                                <img src="https://lms.rocket-soft.org/store/1015/setting/avatar.jpg" alt="Robert Ransdell" class="img-cover rounded-circle">
                            </div>
                                                    <div class="size-48 rounded-circle">
                                <img src="https://lms.rocket-soft.org/store/1016/setting/avatar.jpg" alt="Ricardo Dave" class="img-cover rounded-circle">
                            </div>
                                                    <div class="size-48 rounded-circle">
                                <img src="https://lms.rocket-soft.org/store/1017/setting/avatar.jpg" alt="Alex Pmelaa" class="img-cover rounded-circle">
                            </div>
        ...
        <div class="col-12 col-lg-6 mt-16 mt-lg-0">
            <div class="d-flex align-items-center justify-content-between gap-24 p-32 rounded-12 bg-gray-100">
                <div class="">
                    <span class="d-block font-24 font-weight-bold text-dark">8</span>
                    <span class="d-block font-14 text-gray-500">Forums</span>
                </div>

                <div class="">
                    <span class="d-block font-24 font-weight-bold text-dark">10</span>
                    <span class="d-block font-14 text-gray-500">Forum Topics</span>
                </div>

                <div class="">
                    <span class="d-block font-24 font-weight-bold text-dark">19</span>
                    <span class="d-block font-14 text-gray-500">Forum Posts</span>
                </div>

                <div class="">
                    <span class="d-block font-24 font-weight-bold text-dark">13</span>
                    <span class="d-block font-14 text-gray-500">Members</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="forum-revolver__slider-infinite d-flex align-items-center gap-32 flex-wrap">
                ...
                >
                    <div class="swiper-wrapper">
                                    ...
                                    <a href="https://lms.rocket-soft.org/forums/Beauty-Makeup/topics" target="_blank" class="font-24 font-weight-bold text-white">Beauty and Makeup</a>

                                    <div class="size-24">
                                                                                    <img src="https://lms.rocket-soft.org/store/1/default_images/forums/forum_separator.svg" alt="Separator Image" class="img-cover">
                                                                            </div>
                                </div>
                                                                                                                <div class="swiper-slide">
                                    <a href="https://lms.rocket-soft.org/forums/Food-Beverage/topics" target="_blank" class="font-24 font-weight-bold text-white">Food and Beverage</a>
                                    ...
                                    <div class="size-24">
                                                                                    <img src="https://lms.rocket-soft.org/store/1/default_images/forums/forum_separator.svg" alt="Separator Image" class="img-cover">
                                                                                                                ...
                                                                                                                <div class="swiper-slide">
                                    <a href="https://lms.rocket-soft.org/forums/Travel/topics" target="_blank" class="font-24 font-weight-bold text-white">Travel</a>
                                    ...
                                    <div class="size-24">
                                                                                    <img src="https://lms.rocket-soft.org/store/1/default_images/forums/forum_separator.svg" alt="Separator Image" class="img-cover">
                                                                                                                ...
                                                                                                                <div class="swiper-slide">
                                    <a href="https://lms.rocket-soft.org/forums/Music/topics" target="_blank" class="font-24 font-weight-bold text-white">Music</a>
                                    ...
                                    <div class="size-24">
                                                                                    <img src="https://lms.rocket-soft.org/store/1/default_images/forums/forum_separator.svg" alt="Separator Image" class="img-cover">
                                                                                                                ...
                                                                                                                <div class="swiper-slide">
                                    <a href="https://lms.rocket-soft.org/forums/Digital-Marketing/topics" target="_blank" class="font-24 font-weight-bold text-white">Digital Marketing</a>
                                    ...
                                    <div class="size-24">
                                                                                    <img src="https://lms.rocket-soft.org/store/1/default_images/forums/forum_separator.svg" alt="Separator Image" class="img-cover">
                                                                                                                ...
                                                                                                                <div class="swiper-slide">
                                    <a href="https://lms.rocket-soft.org/forums/Public-Relations/topics" target="_blank" class="font-24 font-weight-bold text-white">Public Relations</a>
                                    ...
                                    <div class="size-24">
                                                                                    <img src="https://lms.rocket-soft.org/store/1/default_images/forums/forum_separator.svg" alt="Separator Image" class="img-cover">
                                                                                                                ...
                                                                                                                <div class="swiper-slide">
                                    <a href="https://lms.rocket-soft.org/forums/Advertising/topics" target="_blank" class="font-24 font-weight-bold text-white">Advertising</a>
                                    ...
                                    <div class="size-24">
                                                                                    <img src="https://lms.rocket-soft.org/store/1/default_images/forums/forum_separator.svg" alt="Separator Image" class="img-cover">
                                                                                                                ...
                                                                                                                <div class="swiper-slide">
                                    <a href="https://lms.rocket-soft.org/forums/Social-Media/topics" target="_blank" class="font-24 font-weight-bold text-white">Social Media</a>
    ...
    <div class="d-flex-center flex-column text-center">
        <h2 class="font-32 font-weight-bold">Featured Topics</h2>
        <p class="mt-4 text-gray-500">Browse various forums and get involved.</p>
    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-lg-8">
                ...
                <div class="position-relative z-index-2">
                                            <div class="forum-featured-topic-card position-relative ">
                            ...
                            <div class="d-flex align-items-center position-relative p-16 rounded-24 bg-white z-index-2">
                                <div class="card-icon d-flex-center size-88 rounded-16 bg-gray-100">
                                    <img src="https://lms.rocket-soft.org/store/1/default_images/forums/icons/featured_forum1.svg" alt="What is social media?" class="img-cover rounded-16">
                                </div>

                                <div class="ml-12">
                                    <a href="https://lms.rocket-soft.org/forums/Social-Media/topics/What-is-social-media/posts" class="">
                                        <h4 class="font-16 font-weight-bold text-dark">What is social media?</h4>
                                    </a>

                                    <p class="mt-4 font-14 text-gray-500">Social media is a collective term for websites and applications that focus on communication, community-based input, interaction, content-sharing and ...</p>
                                    ...
                                    <div class="d-flex align-items-center mt-16">
                                        ...
                                        <div class="text-gray-500 font-14">Created By <span class="font-weight-bold">Camelia Schofield</span></div>

                                    </div>
                                </div>
                            </div>
                        </div>
                                            <div class="forum-featured-topic-card position-relative mt-32">
                            <div class="forum-featured-topic-card__mask"></div>

                            <div class="d-flex align-items-center position-relative p-16 rounded-24 bg-white z-index-2">
                                <div class="card-icon d-flex-center size-88 rounded-16 bg-gray-100">
                                    <img src="https://lms.rocket-soft.org/store/1/default_images/forums/icons/featured_forum2.svg" alt="How do you put a Group Link in a note card" class="img-cover rounded-16">
                                </div>

                                <div class="ml-12">
                                    <a href="https://lms.rocket-soft.org/forums/Music/topics/How-do-you-put-a-Group-Link-in-a-note-card/posts" class="">
                                        <h4 class="font-16 font-weight-bold text-dark">How do you put a Group Link in a note card</h4>
                                    </a>

                                    <p class="mt-4 font-14 text-gray-500">I want to create a note card that lists clickable LMs (EASY to do) to the 14 music hangouts (nearly all are open stage/decks, 6 to 8 have regular weekly events) in my ...</p>
                                    ...
                                    <div class="d-flex align-items-center mt-16">
                                        ...
                                        <div class="text-gray-500 font-14">Created By <span class="font-weight-bold">Jessica B. Gray</span></div>
                            ...
                            <div class="d-flex align-items-center position-relative p-16 rounded-24 bg-white z-index-2">
                                <div class="card-icon d-flex-center size-88 rounded-16 bg-gray-100">
                                    <img src="https://lms.rocket-soft.org/store/1/default_images/forums/icons/featured_forum3.svg" alt="The best texture quality settings for makeup" class="img-cover rounded-16">
                                </div>

                                <div class="ml-12">
                                    <a href="https://lms.rocket-soft.org/forums/Beauty-Makeup/topics/The-best-texture-quality-settings-for-makeup/posts" class="">
                                        <h4 class="font-16 font-weight-bold text-dark">The best texture quality settings for makeup</h4>
                                    </a>

                                    <p class="mt-4 font-14 text-gray-500">Hello everyone ❣️ I don't know if I'm at the right place for my question, but I hope so... 😅In your opinion, what is the best size, dpi and the rest of the ...</p>
                                    ...
                                    <div class="d-flex align-items-center mt-16">
                                                                                    ...
                                                                                    <div class="d-flex align-items-center overlay-avatars overlay-avatars-12 mr-8">
                                                                                                    <div class="overlay-avatars__item size-28 rounded-circle border-2 border-white">
                                                        <img src="https://lms.rocket-soft.org/store/870/setting/avatar.jpg" alt="Jessica Wray" class="img-cover rounded-circle">
                                                    </div>
                                                                                                    <div class="overlay-avatars__item size-28 rounded-circle border-2 border-white">
                                                        <img src="https://lms.rocket-soft.org/store/929/setting/avatar.jpg" alt="Kate Williams" class="img-cover rounded-circle">
                                                    </div>
                                        ...
                                        <div class="text-gray-500 font-14">Created By <span class="font-weight-bold">Jade Harrison</span></div>
                            ...
                            <div class="d-flex align-items-center position-relative p-16 rounded-24 bg-white z-index-2">
                                <div class="card-icon d-flex-center size-88 rounded-16 bg-gray-100">
                                    <img src="https://lms.rocket-soft.org/store/1/default_images/forums/icons/featured_forum4.svg" alt="What favorite food and or beverage do you enjoy" class="img-cover rounded-16">
                                </div>

                                <div class="ml-12">
                                    <a href="https://lms.rocket-soft.org/forums/Food-Beverage/topics/What-favorite-food-and-or-beverage-do-you-enjoy/posts" class="">
                                        <h4 class="font-16 font-weight-bold text-dark">What favorite food and or beverage do you enjoy</h4>
                                    </a>

                                    <p class="mt-4 font-14 text-gray-500">I am amazed&nbsp; and thankful to SL for all the wonderful things and ability to reach&nbsp; out to others in so many different places all over the world. That being ...</p>
                                    ...
                                    <div class="d-flex align-items-center mt-16">
                                                                                    ...
                                                                                    <div class="d-flex align-items-center overlay-avatars overlay-avatars-12 mr-8">
                                                                                                    <div class="overlay-avatars__item size-28 rounded-circle border-2 border-white">
                                                        <img src="https://lms.rocket-soft.org/store/996/setting/avatar.jpg" alt="Jessica B. Gray" class="img-cover rounded-circle">
                                                    </div>
                                                                                                    <div class="overlay-avatars__item size-28 rounded-circle border-2 border-white">
                                                        <img src="https://lms.rocket-soft.org/store/1015/setting/avatar.jpg" alt="Robert Ransdell" class="img-cover rounded-circle">
                                                    </div>
                ...
                <img src="https://lms.rocket-soft.org/store/1/default_images/forums/icons/forum_floating_1.png" alt="Featured Topics - Left Floating Image" class="img-fluid">
            </div>
        
                    <div class="forum-featured-topics-right-float-image">
                <img src="https://lms.rocket-soft.org/store/1/default_images/forums/icons/forum_floating_2.png" alt="Featured Topics - Right Floating Image" class="img-fluid">
            </div>
                    ...
                    <div class="container mt-64">
    <div class="d-flex-center flex-column text-center">
        <h2 class="font-32 font-weight-bold">Forums</h2>
        <p class="mt-4 text-gray-500">Browse various forums and get involved.</p>
    </div>

            <div class="forum-card position-relative mt-24">
            <div class="forum-card__mask"></div>

            <div class="position-relative card-before-line bg-white rounded-24 py-16 px-8 z-index-2">
                <a href="https://lms.rocket-soft.org/forums/Lifestyle/topics" class="text-dark">
                    <h3 class="font-16 font-weight-bold text-dark">Lifestyle</h3>
                </a>
    ...
    <div class="col-8 col-lg-5">
        <div class="d-flex align-items-center">
            <a href="https://lms.rocket-soft.org/forums/Beauty-Makeup/topics" class="text-dark">
                <div class="size-48 rounded-12 bg-gray-100">
                    <img src="https://lms.rocket-soft.org/store/1/default_images/forums/icons/makeup.png" alt="Beauty &amp; Makeup" class="img-cover">
                </div>
            </a>

            <div class="ml-12">
                <a href="https://lms.rocket-soft.org/forums/Beauty-Makeup/topics" class="text-dark">
                    <h4 class="font-16 font-weight-bold text-dark">Beauty &amp; Makeup</h4>
                </a>

                <p class="mt-8 font-14 text-gray-500">How to create your natural skincare perfect</p>
            </div>
        </div>
    </div>
    ...
    <div class="col-4 col-lg-3 d-flex align-items-center justify-content-end justify-content-lg-center">
        <div class="d-flex-center gap-20 gap-lg-48">
            <div class="forum-card-stats-item d-flex-center flex-column text-gray-500">
                ...
                <span class="font-12 mt-4">topics</span>
            </div>

            <div class="forum-card-stats-item d-flex-center flex-column text-gray-500">
                <span class="font-14 font-weight-bold">2</span>
                <span class="font-12 mt-4">posts</span>
            </div>
        </div>
    </div>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="ml-8 text-gray-500">
                    <a href="https://lms.rocket-soft.org/forums/Beauty-Makeup/topics/The-best-texture-quality-settings-for-makeup/posts" class="d-block text-dark">
                        <span class="d-block font-14">The best texture quality ...</span>
                    </a>

                    <div class="d-flex align-items-center text-gray-500 mt-4 font-12">
                        <span class="font-weight-bold">Jade Harrison</span>
                        <span class="ml-4">on 21 Jun 2022 01:53</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-8 col-lg-5">
        <div class="d-flex align-items-center">
            <a href="https://lms.rocket-soft.org/forums/Food-Beverage/topics" class="text-dark">
                <div class="size-48 rounded-12 bg-gray-100">
                    <img src="https://lms.rocket-soft.org/store/1/default_images/forums/icons/donut.png" alt="Food &amp; Beverage" class="img-cover">
                </div>
            </a>

            <div class="ml-12">
                <a href="https://lms.rocket-soft.org/forums/Food-Beverage/topics" class="text-dark">
                    <h4 class="font-16 font-weight-bold text-dark">Food &amp; Beverage</h4>
                </a>

                <p class="mt-8 font-14 text-gray-500">A practical forum to take your cooking skills from dull to delicious</p>
            </div>
        </div>
    </div>
    ...
    <div class="col-4 col-lg-3 d-flex align-items-center justify-content-end justify-content-lg-center">
        <div class="d-flex-center gap-20 gap-lg-48">
            ...
            <div class="forum-card-stats-item d-flex-center flex-column text-gray-500">
                <span class="font-14 font-weight-bold">3</span>
                <span class="font-12 mt-4">posts</span>
            </div>
        </div>
    </div>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="ml-8 text-gray-500">
                    <a href="https://lms.rocket-soft.org/forums/Food-Beverage/topics/What-favorite-food-and-or-beverage-do-you-enjoy/posts" class="d-block text-dark">
                        <span class="d-block font-14">What favorite food and or ...</span>
                    </a>

                    <div class="d-flex align-items-center text-gray-500 mt-4 font-12">
                        <span class="font-weight-bold">Camelia Schofield</span>
                        <span class="ml-4">on 21 Jun 2022 01:59</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-8 col-lg-5">
        <div class="d-flex align-items-center">
            <a href="https://lms.rocket-soft.org/forums/Travel/topics" class="text-dark">
                <div class="size-48 rounded-12 bg-gray-100">
                    <img src="https://lms.rocket-soft.org/store/1/default_images/forums/icons/airplane.png" alt="Travel" class="img-cover">
                </div>
            </a>

            <div class="ml-12">
                <a href="https://lms.rocket-soft.org/forums/Travel/topics" class="text-dark">
                    <h4 class="font-16 font-weight-bold text-dark">Travel</h4>
                </a>

                <p class="mt-8 font-14 text-gray-500">How You Can Afford a Life of Travel and Adventure!</p>
            </div>
        </div>
    </div>
    ...
    <div class="col-4 col-lg-3 d-flex align-items-center justify-content-end justify-content-lg-center">
        <div class="d-flex-center gap-20 gap-lg-48">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="ml-8 text-gray-500">
                    <a href="https://lms.rocket-soft.org/forums/Travel/topics/Trying-to-Find-a-Water-to-Land-Race/posts" class="d-block text-dark">
                        <span class="d-block font-14">Trying to Find a ...</span>
                    </a>

                    <div class="d-flex align-items-center text-gray-500 mt-4 font-12">
                        <span class="font-weight-bold">Alex Pmelaa</span>
                        <span class="ml-4">on 21 Jun 2022 00:50</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="forum-card position-relative mt-32">
            <div class="forum-card__mask"></div>

            <div class="position-relative card-before-line bg-white rounded-24 py-16 px-8 z-index-2">
                <a href="https://lms.rocket-soft.org/forums/Music/topics" class="text-dark">
                    <h3 class="font-16 font-weight-bold text-dark">Music</h3>
                </a>
    ...
    <div class="col-8 col-lg-5">
        <div class="d-flex align-items-center">
            <a href="https://lms.rocket-soft.org/forums/Music/topics" class="text-dark">
                <div class="size-48 rounded-12 bg-gray-100">
                    <img src="https://lms.rocket-soft.org/store/1/default_images/forums/icons/love-song.png" alt="Music" class="img-cover">
                </div>
            </a>

            <div class="ml-12">
                <a href="https://lms.rocket-soft.org/forums/Music/topics" class="text-dark">
                    <h4 class="font-16 font-weight-bold text-dark">Music</h4>
                </a>

                <p class="mt-8 font-14 text-gray-500">Discuss music with The World&#039;s Top instructors</p>
            </div>
        </div>
    </div>
    ...
    <div class="col-4 col-lg-3 d-flex align-items-center justify-content-end justify-content-lg-center">
        <div class="d-flex-center gap-20 gap-lg-48">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="ml-8 text-gray-500">
                    <a href="https://lms.rocket-soft.org/forums/Music/topics/How-do-you-put-a-Group-Link-in-a-note-card/posts" class="d-block text-dark">
                        <span class="d-block font-14">How do you put a Group ...</span>
                    </a>

                    <div class="d-flex align-items-center text-gray-500 mt-4 font-12">
                        <span class="font-weight-bold">Jessica B. Gray</span>
                        <span class="ml-4">on 21 Jun 2022 01:31</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="position-relative card-before-line bg-white rounded-24 py-16 px-8 z-index-2">
                <a href="https://lms.rocket-soft.org/forums/Marketing/topics" class="text-dark">
                    <h3 class="font-16 font-weight-bold text-dark">Marketing</h3>
                </a>
    ...
    <div class="col-8 col-lg-5">
        <div class="d-flex align-items-center">
            <a href="https://lms.rocket-soft.org/forums/Digital-Marketing/topics" class="text-dark">
                <div class="size-48 rounded-12 bg-gray-100">
                    <img src="https://lms.rocket-soft.org/store/1/default_images/forums/icons/digital-marketing.png" alt="Digital Marketing" class="img-cover">
                </div>
            </a>

            <div class="ml-12">
                <a href="https://lms.rocket-soft.org/forums/Digital-Marketing/topics" class="text-dark">
                    <h4 class="font-16 font-weight-bold text-dark">Digital Marketing</h4>
                </a>

                <p class="mt-8 font-14 text-gray-500">Master Digital Marketing Strategy</p>
            </div>
        </div>
    </div>
    ...
    <div class="col-4 col-lg-3 d-flex align-items-center justify-content-end justify-content-lg-center">
        <div class="d-flex-center gap-20 gap-lg-48">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="ml-8 text-gray-500">
                    <a href="https://lms.rocket-soft.org/forums/Digital-Marketing/topics/Marketing-Agent-wanted/posts" class="d-block text-dark">
                        <span class="d-block font-14">Marketing Agent wanted</span>
                    </a>

                    <div class="d-flex align-items-center text-gray-500 mt-4 font-12">
                        <span class="font-weight-bold">James Kong</span>
                        <span class="ml-4">on 21 Jun 2022 01:50</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-8 col-lg-5">
        <div class="d-flex align-items-center">
            <a href="https://lms.rocket-soft.org/forums/Public-Relations/topics" class="text-dark">
                <div class="size-48 rounded-12 bg-gray-100">
                    <img src="https://lms.rocket-soft.org/store/1/default_images/forums/icons/security.png" alt="Public Relations" class="img-cover">
                </div>
            </a>

            <div class="ml-12">
                <a href="https://lms.rocket-soft.org/forums/Public-Relations/topics" class="text-dark">
                    <h4 class="font-16 font-weight-bold text-dark">Public Relations</h4>
                </a>

                <p class="mt-8 font-14 text-gray-500">Everything you need to know to be successful at PR</p>
            </div>
        </div>
    </div>
    ...
    <div class="col-4 col-lg-3 d-flex align-items-center justify-content-end justify-content-lg-center">
        <div class="d-flex-center gap-20 gap-lg-48">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="ml-8 text-gray-500">
                    <a href="https://lms.rocket-soft.org/forums/Public-Relations/topics/What-do-you-think-of-Mark-Zuckerberg/posts" class="d-block text-dark">
                        <span class="d-block font-14">What do you think of Mark ...</span>
                    </a>

                    <div class="d-flex align-items-center text-gray-500 mt-4 font-12">
                        <span class="font-weight-bold">Robert Ransdell</span>
                        <span class="ml-4">on 20 Jun 2022 05:11</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-8 col-lg-5">
        <div class="d-flex align-items-center">
            <a href="https://lms.rocket-soft.org/forums/Advertising/topics" class="text-dark">
                <div class="size-48 rounded-12 bg-gray-100">
                    <img src="https://lms.rocket-soft.org/store/1/default_images/forums/icons/ads.png" alt="Advertising" class="img-cover">
                </div>
            </a>

            <div class="ml-12">
                <a href="https://lms.rocket-soft.org/forums/Advertising/topics" class="text-dark">
                    <h4 class="font-16 font-weight-bold text-dark">Advertising</h4>
                </a>

                <p class="mt-8 font-14 text-gray-500">Learn the inner workings of a massive digital industry</p>
            </div>
        </div>
    </div>
    ...
    <div class="col-4 col-lg-3 d-flex align-items-center justify-content-end justify-content-lg-center">
        <div class="d-flex-center gap-20 gap-lg-48">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="ml-8 text-gray-500">
                    <a href="https://lms.rocket-soft.org/forums/Advertising/topics/How-to-greatly-reduce-or-eliminate-networked-advertising/posts" class="d-block text-dark">
                        <span class="d-block font-14">How to reduce networked ...</span>
                    </a>

                    <div class="d-flex align-items-center text-gray-500 mt-4 font-12">
                        <span class="font-weight-bold">John Powe</span>
                        <span class="ml-4">on 21 Jun 2022 01:40</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-8 col-lg-5">
        <div class="d-flex align-items-center">
            <a href="https://lms.rocket-soft.org/forums/Social-Media/topics" class="text-dark">
                <div class="size-48 rounded-12 bg-gray-100">
                    <img src="https://lms.rocket-soft.org/store/1/default_images/forums/icons/twitter.png" alt="Social Media" class="img-cover">
                </div>
            </a>

            <div class="ml-12">
                <a href="https://lms.rocket-soft.org/forums/Social-Media/topics" class="text-dark">
                    <h4 class="font-16 font-weight-bold text-dark">Social Media</h4>
                </a>

                <p class="mt-8 font-14 text-gray-500">MASTER online marketing on Twitter, Pinterest, Instagram</p>
            </div>
        </div>
    </div>
    ...
    <div class="col-4 col-lg-3 d-flex align-items-center justify-content-end justify-content-lg-center">
        <div class="d-flex-center gap-20 gap-lg-48">
            ...
            <div class="forum-card-stats-item d-flex-center flex-column text-gray-500">
                <span class="font-14 font-weight-bold">5</span>
                <span class="font-12 mt-4">posts</span>
            </div>
        </div>
    </div>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="ml-8 text-gray-500">
                    <a href="https://lms.rocket-soft.org/forums/Social-Media/topics/What-is-social-media/posts" class="d-block text-dark">
                        <span class="d-block font-14">What is social media?</span>
                    </a>

                    <div class="d-flex align-items-center text-gray-500 mt-4 font-12">
                        <span class="font-weight-bold">Camelia Schofield</span>
                        <span class="ml-4">on 24 Jun 2022 16:11</span>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="container mt-64">
    <div class="d-flex-center flex-column text-center">
        <h2 class="font-32 font-weight-bold">Recommended Topics</h2>
        <p class="mt-4 text-gray-500">Explore trending topics, share insights, and join popular discussions.</p>
    </div>
                ...
                <div class="bg-white py-20 rounded-24">
                    <div class="d-flex-center flex-column text-center px-16">
                        <div class="forum-recommended-topics__image d-flex-center size-124 rounded-8">
                            <img src="https://lms.rocket-soft.org/store/1/default_images/forums/icons/recommended_topic_1.png" alt="Time Management" class="img-fluid">
                        </div>

                        <h3 class="font-20 mt-16">Time Management</h3>

                        <div class="mt-8 font-16 text-gray-500">Learn to prioritize tasks, set goals, and boost productivity daily</div>
                    </div>

                    <div class="mt-12 border-top-gray-100"></div>

                                            <a href="https://lms.rocket-soft.org/forums/Travel/topics/test/posts" class="d-flex align-items-center text-dark font-14 mt-16 px-16">
                            <div class="d-flex-center size-24 rounded-circle border-gray-100">
                                <svg width="14px" height="14px" class="icons text-primary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
</svg>                            </div>
                            <span class="ml-8">Bar Train Tour on Heterocera</span>
                        </a>
                                            <a href="https://lms.rocket-soft.org/forums/Travel/topics/Trying-to-Find-a-Water-to-Land-Race/posts" class="d-flex align-items-center text-dark font-14 mt-16 px-16">
                            <div class="d-flex-center size-24 rounded-circle border-gray-100">
                                <svg width="14px" height="14px" class="icons text-primary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
</svg>                            </div>
                            <span class="ml-8">Trying to Find a Water-to-Land ...</span>
                        </a>
                                            <a href="https://lms.rocket-soft.org/forums/Digital-Marketing/topics/Marketing-Agent-wanted/posts" class="d-flex align-items-center text-dark font-14 mt-16 px-16">
                            <div class="d-flex-center size-24 rounded-circle border-gray-100">
                                <svg width="14px" height="14px" class="icons text-primary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
</svg>                            </div>
                            <span class="ml-8">Marketing Agent wanted</span>
                        </a>
                                            <a href="https://lms.rocket-soft.org/forums/Food-Beverage/topics/What-favorite-food-and-or-beverage-do-you-enjoy/posts" class="d-flex align-items-center text-dark font-14 mt-16 px-16">
                            <div class="d-flex-center size-24 rounded-circle border-gray-100">
                                <svg width="14px" height="14px" class="icons text-primary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
</svg>                            </div>
                            <span class="ml-8">What favorite food and or beverage ...</span>
                        </a>
                                            <a href="https://lms.rocket-soft.org/forums/Social-Media/topics/What-is-social-media/posts" class="d-flex align-items-center text-dark font-14 mt-16 px-16">
                            <div class="d-flex-center size-24 rounded-circle border-gray-100">
                                <svg width="14px" height="14px" class="icons text-primary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
</svg>                            </div>
                            <span class="ml-8">What is social media?</span>
                        </a>
                                    </div>
            </div>
                    <div class="col-12 col-md-6 col-lg-3 mt-44">
                <div class="bg-white py-20 rounded-24">
                    <div class="d-flex-center flex-column text-center px-16">
                        <div class="forum-recommended-topics__image d-flex-center size-124 rounded-8">
                            <img src="https://lms.rocket-soft.org/store/1/default_images/forums/icons/recommended_topic_2.png" alt="Financial Management" class="img-fluid">
                        </div>

                        <h3 class="font-20 mt-16">Financial Management</h3>

                        <div class="mt-8 font-16 text-gray-500">Master budgeting, saving, and investing to manage money wisely</div>
                    </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
                            ...
                            <span class="ml-8">What favorite food and or beverage ...</span>
                                            ...
                                            <a href="https://lms.rocket-soft.org/forums/Social-Media/topics/Looking-for-friends-but-im-also-really-really-shy/posts" class="d-flex align-items-center text-dark font-14 mt-16 px-16">
                            <div class="d-flex-center size-24 rounded-circle border-gray-100">
                                <svg width="14px" height="14px" class="icons text-primary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
</svg>                            </div>
                            <span class="ml-8">Looking for friends but, im shy</span>
                        </a>
                                            <a href="https://lms.rocket-soft.org/forums/Travel/topics/test/posts" class="d-flex align-items-center text-dark font-14 mt-16 px-16">
                            <div class="d-flex-center size-24 rounded-circle border-gray-100">
                                <svg width="14px" height="14px" class="icons text-primary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
                ...
                <div class="bg-white py-20 rounded-24">
                    <div class="d-flex-center flex-column text-center px-16">
                        <div class="forum-recommended-topics__image d-flex-center size-124 rounded-8">
                            <img src="https://lms.rocket-soft.org/store/1/default_images/forums/icons/recommended_topic_3.png" alt="Marketing Strategy" class="img-fluid">
                        </div>

                        <h3 class="font-20 mt-16">Marketing Strategy</h3>

                        <div class="mt-8 font-16 text-gray-500">Learn to plan, execute, and optimize campaigns for business growth</div>
                    </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
                            ...
                            <span class="ml-8">Marketing Agent wanted</span>
                                            ...
                                            <a href="https://lms.rocket-soft.org/forums/Beauty-Makeup/topics/The-best-texture-quality-settings-for-makeup/posts" class="d-flex align-items-center text-dark font-14 mt-16 px-16">
                            <div class="d-flex-center size-24 rounded-circle border-gray-100">
                                <svg width="14px" height="14px" class="icons text-primary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
</svg>                            </div>
                            <span class="ml-8">The best texture quality settings ...</span>
                        </a>
                                            <a href="https://lms.rocket-soft.org/forums/Food-Beverage/topics/What-favorite-food-and-or-beverage-do-you-enjoy/posts" class="d-flex align-items-center text-dark font-14 mt-16 px-16">
                            <div class="d-flex-center size-24 rounded-circle border-gray-100">
                                <svg width="14px" height="14px" class="icons text-primary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
                ...
                <div class="bg-white py-20 rounded-24">
                    <div class="d-flex-center flex-column text-center px-16">
                        <div class="forum-recommended-topics__image d-flex-center size-124 rounded-8">
                            <img src="https://lms.rocket-soft.org/store/1/default_images/forums/icons/recommended_topic_4.png" alt="Task Management" class="img-fluid">
                        </div>

                        <h3 class="font-20 mt-16">Task Management</h3>

                        <div class="mt-8 font-16 text-gray-500">Organize, prioritize, and track tasks to boost daily productivity efficiently</div>
                    </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
        ...
        <div class="forum-cta-section position-relative d-flex flex-column flex-lg-row align-items-start gap-24 px-24 px-lg-48 rounded-32 section_bg">
            <div class="forum-cta-section__content flex-1 py-48 pr-lg-48">
                    ...
                    >
                        <span class="forum-extra-badge__mask" style="background-color: #3fcd82"></span>
                        <span class="z-index-2">Communicate Now!</span>
                    </div>
                
                                    <h1 class="forum-hero-title mt-8">Share What You Know!</h1>
                
                                    <div class="mt-20 font-16 text-gray-500">Be part of a thriving learning community. Ask questions, share ideas, and connect with fellow learners to expand your knowledge beyond the classroom experience.</div>
                
                <div class="d-flex flex-column flex-lg-row align-items-lg-center mt-20 gap-24">
                                            <a href="https://lms.rocket-soft.org/forums/create-topic" class="btn btn-primary btn-xlg">
                            Create a Topic
                        </a>
                    
                                            <a href="https://lms.rocket-soft.org/forums" class="btn bg-transparent btn-xlg border-gray-200 text-gray-500">
                            Explore Forums
                        </a>
                                    </div>
            </div>
                    ...
                    <img src="https://lms.rocket-soft.org/store/1/default_images/forums/forum_cta_image.png" alt="Call-To-Action Section" class="img-cover">
                </div>
                    </div>
    </div>
...
<script defer src="https://lms.rocket-soft.org/assets/design_1/js/parts/content_delete.min.js"></script>
    ...
    <script src="https://lms.rocket-soft.org/assets/default/vendors/swiper/swiper-bundle.min.js"></script>
    <script src="https://lms.rocket-soft.org/assets/design_1/js/parts/swiper_slider.min.js"></script>
