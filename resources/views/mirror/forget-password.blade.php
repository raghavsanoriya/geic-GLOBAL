...
<!-- Mirrored from lms.rocket-soft.org/forget-password by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:38:09 GMT -->
...
<meta property='og:type' content='website'>
    ...
    <title>Password Recovery | Rocket LMS</title>
    ...
    <link rel="stylesheet" href="https://lms.rocket-soft.org/assets/design_1/css/parts/auth/theme_1.min.css">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
                    ...
                    <div class="position-relative bg-white rounded-32 p-16 z-index-2">
                        <div class="row">
                            <div class="col-12 col-lg-6">
                                    ...
                                    <form method="Post" action="https://lms.rocket-soft.org/forget-password" class="js-auth-page-form">
        <input type="hidden" name="_token" value="KkDAnXKdDFkgpTFwX3uTuPHuAseZywMbZmqb7QZE">

        <div class="pl-16 pt-16">
            <div class="font-16 font-weight-bold">Forgot your password? 🤔</div>
            <h1 class="font-24 mt-4 mb-32">Reset your password</h1>

            <div class="bg-gray-100 p-12 rounded-16 border-gray-300 mt-24 text-gray-500 mb-28">
                Enter your email or phone number. We’ll send reset instructions.
            </div>
    ...
    <div class="register-mobile-form-group position-relative ">
        ...
        <div class="row">
            ...
            <button type="button" class="js-submit-form-btn btn btn-primary btn-lg btn-block mt-24">Reset Password</button>
            ...
            <div class="d-flex-center flex-column text-center mt-24">
                ...
                <div class="d-flex align-items-center mt-12">
                    <a href="https://lms.rocket-soft.org/login" class="font-weight-bold text-dark  mr-16 pr-16  border-right-gray-300">Login</a>

                    <a href="https://lms.rocket-soft.org/register" class="font-weight-bold text-dark">Sign Up</a>
                </div>
            </div>
        </div>
    </form>
                            ...
                            <div class="col-12 col-lg-6 d-none d-lg-block">
                                <div class="auth-slider-container w-100 rounded-16 bg-gray-100"  style="background-image: url('https://lms.rocket-soft.org/store/1/themes/general/authentication_background.svg')" >
            ...
            >
                <div class="swiper-wrapper py-0 ">
                            ...
                            <div class="d-flex-center flex-column text-center h-90 p-16">
                                        ...
                                        <img src="https://lms.rocket-soft.org/store/1/themes/general/authentication_slide1.png" alt="image" class="img-fluid">
                                    </div>
                            ...
                            <div class="d-flex-center flex-column text-center h-90 p-16">
                                                                    <div class="auth-slider-image d-flex-center">
                                        <img src="https://lms.rocket-soft.org/store/1/themes/general/authentication_slide2.png" alt="image" class="img-fluid">
                                    </div>
                            ...
                            <div class="d-flex-center flex-column text-center h-90 p-16">
                                                                    <div class="auth-slider-image d-flex-center">
                                        <img src="https://lms.rocket-soft.org/store/1/themes/general/authentication_slide3.png" alt="image" class="img-fluid">
                                    </div>
...
<script defer src="https://lms.rocket-soft.org/assets/design_1/js/parts/content_delete.min.js"></script>
    ...
    <script>
        var waitLang = "Wait!";
        var pleaseWaitUntilTimeOverLang = "Please wait for the timer to finish";
    </script>

    <script src="https://lms.rocket-soft.org/assets/default/vendors/jquery.simple.timer/jquery.simple.timer.js"></script>
    ...
    <script src="https://lms.rocket-soft.org/assets/design_1/js/parts/auth_theme_1.min.js"></script>
