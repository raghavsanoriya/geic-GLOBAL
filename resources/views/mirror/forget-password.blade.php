...
<!-- Mirrored from www.geic.in/forget-password by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:38:09 GMT -->
...
<meta property='og:type' content='website'>
    ...
    <title>Password Recovery | Trans Globe Indore LMS</title>
    ...
    <link rel="stylesheet" href="https://www.geic.in/assets/design_1/css/parts/auth/theme_1.min.css">
                    ...
                    <div class="position-relative bg-white rounded-32 p-16 z-index-2">
                        <div class="row">
                            <div class="col-12 col-lg-6">
                                    ...
                                    <form method="Post" action="https://www.geic.in/forget-password" class="js-auth-page-form">
        <input type="hidden" name="_token" value="KkDAnXKdDFkgpTFwX3uTuPHuAseZywMbZmqb7QZE">
        ...
        <div class="row">
            ...
            <div class="d-flex-center flex-column text-center mt-24">
                ...
                <div class="d-flex align-items-center mt-12">
                    <a href="https://www.geic.in/login" class="font-weight-bold text-dark  mr-16 pr-16  border-right-gray-300">Login</a>

                    <a href="https://www.geic.in/register" class="font-weight-bold text-dark">Sign Up</a>
                </div>
            </div>
        </div>
    </form>
                            ...
                            <div class="col-12 col-lg-6 d-none d-lg-block">
                                <div class="auth-slider-container w-100 rounded-16 bg-gray-100"  style="background-image: url('https://www.geic.in/store/1/themes/general/authentication_background.svg')" >
            ...
            >
                <div class="swiper-wrapper py-0 ">
                            ...
                            <div class="d-flex-center flex-column text-center h-90 p-16">
                                        ...
                                        <img src="https://www.geic.in/store/1/themes/general/authentication_slide1.png" alt="image" class="img-fluid">
                                    </div>
                            ...
                            <div class="d-flex-center flex-column text-center h-90 p-16">
                                                                    <div class="auth-slider-image d-flex-center">
                                        <img src="https://www.geic.in/store/1/themes/general/authentication_slide2.png" alt="image" class="img-fluid">
                                    </div>
                            ...
                            <div class="d-flex-center flex-column text-center h-90 p-16">
                                                                    <div class="auth-slider-image d-flex-center">
                                        <img src="https://www.geic.in/store/1/themes/general/authentication_slide3.png" alt="image" class="img-fluid">
                                    </div>
...
<script defer src="https://www.geic.in/assets/design_1/js/parts/content_delete.min.js"></script>
    ...
    <script src="https://www.geic.in/assets/default/vendors/jquery.simple.timer/jquery.simple.timer.js"></script>
    ...
    <script src="https://www.geic.in/assets/design_1/js/parts/auth_theme_1.min.js"></script>
