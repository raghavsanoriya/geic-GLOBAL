...
<!-- Mirrored from lms.rocket-soft.org/events by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:24:59 GMT -->
...
<meta property='og:type' content='website'>
    ...
    <link rel="stylesheet" href="https://lms.rocket-soft.org/assets/design_1/css/parts/events_lists.min.css">
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
        ...
        <section class="events-lists-hero position-relative">
            ...
            <img src="https://lms.rocket-soft.org/store/1/themes/general/events_background.jpg" class="img-cover" alt="Events"/>
        </section>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
</svg>                            <span class="">Events</span>
                        </div>

                        <h1 class="font-24 font-weight-bold mt-12">Events</h1>
                        <div class="font-12 text-gray-500 mt-8">Discover high-quality events tailored to support your growth in knowledge and expertise</div>
                    </div>

                                            <div class="events-lists-header__overlay-img">
                            <img src="https://lms.rocket-soft.org/store/1/themes/general/events_overlay.png" alt="Events" class="img-cover">
                        </div>
                                    </div>
            </div>
        </div>
        ...
        <form action="https://lms.rocket-soft.org/events" class="js-get-view-data-by-timeout-change container mt-24" data-container-id="listsContainer">
            
            <div class="position-relative events-lists-filters">
    <div class="events-lists-filters__mask"></div>
    ...
    <div class="position-relative d-flex flex-column flex-lg-row align-items-lg-center justify-content-lg-between gap-20 bg-white px-24 py-12 rounded-24 z-index-2">
        <div class="d-flex align-items-center flex-wrap gap-48">
                    ...
                    <div class="custom-switch mr-8">
                        <input id="top_filter_not_conducted" type="checkbox" name="not_conducted" value="on" class="custom-control-input">
                        <label class="custom-control-label cursor-pointer" for="top_filter_not_conducted"></label>
                    </div>

                    <div class="">
                        <label class="cursor-pointer" for="top_filter_not_conducted">Not Conducted</label>
                    </div>
                </div>
                            <div class="form-group mb-0 d-flex align-items-center">
                    <div class="custom-switch mr-8">
        ...
        <div class="d-flex align-items-center gap-16">
            ...
            <div class="events-lists-sort-input form-group  mb-0">
                <select name="sort" class="form-control select2" data-minimum-results-for-search="Infinity">
                    <option disabled selected>Sort By</option>
                    <option value="">All</option>

                                            <option value="newest" >Newest</option>
                                            <option value="highest_base_price" >Highest Base Price</option>
                                            <option value="lowest_base_price" >Lowest Base Price</option>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
                        ...
                        <div id="leftFiltersCategory528" class="accordion__collapse pt-0 mt-0 border-0 " role="tabpanel">
                            <div class="pl-8">
...
<div class="position-relative events-lists-filters mt-28">
    <div class="events-lists-filters__mask"></div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
            ...
            <div id="leftFiltersTypes" class="accordion__collapse show pt-0 mt-0 border-0" role="tabpanel">
                        ...
                        <input type="checkbox" name="types[]" value="in_person" id="filter_type_in_person" class="custom-control-input">
                        <label class="custom-control__label cursor-pointer" for="filter_type_in_person">In-person</label>
                    </div>
                                    <div class="custom-control custom-checkbox mt-12">
                        <input type="checkbox" name="types[]" value="online" id="filter_type_online" class="custom-control-input">
                        <label class="custom-control__label cursor-pointer" for="filter_type_online">Online</label>
                    </div>
                            </div>
        </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
            ...
            <div id="leftFiltersMoreOptions" class="accordion__collapse show pt-0 mt-0 border-0" role="tabpanel">
                                    <div class="custom-control custom-checkbox mt-16">
                        <input type="checkbox" name="more_options[]" value="supported_events" id="filter_more_option_supported_events" class="custom-control-input">
                        <label class="custom-control__label cursor-pointer" for="filter_more_option_supported_events">Supported Events</label>
                    </div>
                                    <div class="custom-control custom-checkbox mt-12">
                        <input type="checkbox" name="more_options[]" value="certificate_included" id="filter_more_option_certificate_included" class="custom-control-input">
                        <label class="custom-control__label cursor-pointer" for="filter_more_option_certificate_included">Certificate Included</label>
                    </div>
                                    <div class="custom-control custom-checkbox mt-12">
                        <input type="checkbox" name="more_options[]" value="point_events" id="filter_more_option_point_events" class="custom-control-input">
                        <label class="custom-control__label cursor-pointer" for="filter_more_option_point_events">Point Events</label>
                    </div>
                            </div>
        </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
            ...
            <div id="leftFiltersPrices" class="accordion__collapse show pt-0 mt-0 border-0" role="tabpanel">
                ...
                <div class="d-flex align-items-center mt-16">
                    ...
                    <div class="mx-4"></div>
                    <div class="form-group mb-0">
                        <input type="tel" readonly value="$195" class="js-filters-max-price form-control input-xs bg-white text-center text-gray-500">
                    </div>
                </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
            ...
            <div id="leftFiltersInstructor" class="accordion__collapse show pt-0 mt-0 border-0" role="tabpanel">
                ...
                <div class="col-12 col-lg-9 mt-4">
                    <div id="listsContainer" class="" data-body=".js-lists-body" data-view-data-path="/events">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M15 19.92L8.48 13.4c-.77-.77-.77-2.03 0-2.8L15 4.08"/>
                                                            ...
                                                            <li class="page-item"><a class="page-link" href="https://lms.rocket-soft.org/events?page=2">2</a></li>
                            
                                                                                                    
            
                            <li class="page-item">
                    <a class="page-link" href="https://lms.rocket-soft.org/events?page=2" rel="next" aria-label="Next &raquo;">
                        <svg width="14px" height="14px" class="icons" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
</svg>                    </a>
                </li>
...
<script defer src="https://lms.rocket-soft.org/assets/design_1/js/parts/content_delete.min.js"></script>
    ...
    <script src="https://lms.rocket-soft.org/assets/design_1/js/parts/events_lists.min.js"></script>
