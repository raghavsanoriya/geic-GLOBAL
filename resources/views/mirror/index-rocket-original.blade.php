    ...
    <link rel="stylesheet" href="assets/design_1/landing_builder/front.min.css">
        <link rel="stylesheet" href="assets/design_1/landing_builder/components/two_columns_hero.min.css">
            ...
            <link rel="stylesheet" href="assets/design_1/landing_builder/components/sliding_testimonials_2_rows.min.css">
                ...
                <link rel="stylesheet" href="assets/design_1/css/parts/upcoming_course_cards/grid_card_1.min.css">
                <link rel="stylesheet" href="assets/design_1/css/parts/course_cards/grid_card_1.min.css">
                <link rel="stylesheet" href="assets/design_1/css/parts/course_cards/grid_card_1.min.css">
                <link rel="stylesheet" href="assets/design_1/css/parts/product_cards/grid_card_1.min.css">
...
<div id="app">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M14.43 5.93L20.5 12l-6.07 6.07M3.5 12h16.83"/>
                            ...
                            <div class="d-inline-flex align-items-center gap-12 font-64">
                                        ...
                                        >Learning</div>
                                                            ...
                                                            <span class="mt-4 text-dark">With Top Tutors Worldwide</span>
                                                    </h1>
  ...
  <path d="M11.5 11.38a1.88 1.88 0 100-3.76 1.88 1.88 0 000 3.76zM21.65 6.17c-.41-.21-1.27-.45-2.44.37l-1.48 1.04c.01.14.02.27.02.42v8c0 .15-.02.28-.02.42l1.48 1.04c.62.44 1.16.58 1.59.58.37 0 .66-.1.85-.2.41-.21 1.1-.78 1.1-2.21V8.38c0-1.43-.69-2-1.1-2.21z"/>
                            ...
                            <div class="d-inline-flex align-items-center gap-8 mt-40 mt-lg-80 p-12 rounded-32 bg-gray-400-20 backdrop-filter-blur-2">
                                                ...
                                                <img src="store/landing_builder/landing_1/1/ZNzOr_Group_2038.png" alt="avatar" class="img-cover rounded-circle">
                                            </div>
                                                                                    <div class="overlay-avatars__item size-40 rounded-circle border-0">
                                                <img src="store/landing_builder/landing_1/1/MB7pW_Group_2039.png" alt="avatar" class="img-cover rounded-circle">
                                            </div>
                                                                                    <div class="overlay-avatars__item size-40 rounded-circle border-0">
                                                <img src="store/landing_builder/landing_1/1/boqCl_Group_2044.png" alt="avatar" class="img-cover rounded-circle">
                                            </div>
                                                                                    <div class="overlay-avatars__item size-40 rounded-circle border-0">
                                                <img src="store/landing_builder/landing_1/1/U70f5_Group_2045.png" alt="avatar" class="img-cover rounded-circle">
                                            </div>
                                                                                    <div class="overlay-avatars__item size-40 rounded-circle border-0">
...
</svg>                                                                                    <svg width="16px" height="16px" class="icons text-warning" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
</svg>                                                                                    <svg width="16px" height="16px" class="icons text-warning" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
</svg>                                                                                    <svg width="16px" height="16px" class="icons text-warning" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
                                                                            ...
                                                                            <h5 class="font-14 mt-4 text-dark mr-8">Trusted by 2,500+ Successful Students</h5>
                                                                    </div>
                            </div>
                        </a>
                                    </div>
                ...
                <div class="row ">
                                ...
                                <div class="statistic-col col-6 col-lg-3 ">
                                    <div class="d-flex align-items-center gap-12">
                                                ...
                                                <svg width="32px" height="32px" class="icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  <path d="M12.5 10.42v6c.46.61 1.18 1 2 1 1.39 0 2.51-1.12 2.51-2.5v-3.49l-4.04-.9-.47-.11zM21.99 14.87c-.07-.98-.37-1.65-.83-2.11-.09-.09-.19-.17-.29-.24 0 0-.01 0-.01-.01-.39-.25-.84-.42-1.33-.52l-2.04-.46-.48-.11v3.5a2.5 2.5 0 002.5 2.5A2.5 2.5 0 0022 15.06v-.01c0-.06-.01-.12-.01-.18z"/>
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="font-14 text-gray-500">Flexible Learning Schedule</span>
                        </div>
                                            <div class="d-flex align-items-center gap-4 mt-12">
                            <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-success">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                            <span class="font-14 text-gray-500">Affordable Course Prices</span>
                        </div>
                                            <div class="d-flex align-items-center gap-4 mt-12">
                            <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-success">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                            <span class="font-14 text-gray-500">Expert Instructor Access</span>
                        </div>
                                            <div class="d-flex align-items-center gap-4 mt-12">
                            <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-success">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <div class="row">
                                            ...
                                            <div class="features-4x-section__card-item position-relative">
                                                ...
                                                <div class="position-relative z-index-2 bg-white rounded-24 p-24 w-100 h-100">
                                                    <div class="d-flex-center size-64 rounded-12 bg-primary-20 text-primary">
                                                                                                                    <svg width="32px" height="32px" class="icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  <path d="M14.35 2h-4.7c-1.04 0-1.89.84-1.89 1.88v.94c0 1.04.84 1.88 1.88 1.88h4.71c1.04 0 1.88-.84 1.88-1.88v-.94C16.24 2.84 15.39 2 14.35 2zM10.81 16.95c-.19 0-.38-.07-.53-.22l-1.5-1.5a.754.754 0 010-1.06c.29-.29.77-.29 1.06 0l.97.97 3.47-3.47c.29-.29.77-.29 1.06 0 .29.29.29.77 0 1.06l-4 4c-.14.15-.34.22-.53.22z"/>
                                                    ...
                                                    <h4 class="mt-24 font-24 text-dark">Smart Quizzes Tool</h4>

                                                                                                            <p class="mt-12 font-16 text-gray-500">Test knowledge instantly with interactive quizzes designed to boost understanding and track progress effectively.</p>
                                                                                                    </div>
                                            </div>
                                            ...
                                            <div class="features-4x-section__card-item position-relative">
                                                <div class="features-4x-section__card-item-mask"></div>
                                                <div class="position-relative z-index-2 bg-white rounded-24 p-24 w-100 h-100">
                                                    <div class="d-flex-center size-64 rounded-12 bg-accent-20 text-accent">
                                                                                                                    <svg width="32px" height="32px" class="icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  <path d="M6.19 7.64l1.39-.81 2.74-1.58.13-.08c.88-.51 2.22-.51 3.1 0l.13.08 2.74 1.58 1.39.8V5.49c0-2.25-1.24-3.49-3.49-3.49H9.67C7.42 2 6.19 3.24 6.19 5.49v2.15zM14.84 13.34l-.62.76c-.1.11-.17.33-.16.48l.06.98c.04.6-.39.91-.95.69l-.91-.36a.92.92 0 00-.52 0l-.91.36c-.56.22-.99-.09-.95-.69l.06-.98a.751.751 0 00-.16-.48l-.62-.76c-.39-.46-.22-.97.36-1.12l.95-.24c.15-.04.33-.18.41-.31l.53-.82c.33-.51.85-.51 1.18 0l.53.82c.08.13.26.27.41.31l.95.24c.58.15.75.66.36 1.12z"/>
                                                    ...
                                                    <h4 class="mt-24 font-24 text-dark">Verified Course Certificates</h4>

                                                                                                            <p class="mt-12 font-16 text-gray-500">Earn official certificates upon completion to showcase skills and add credibility to your portfolio.</p>
                                                                                                    </div>
                                            </div>
                                            ...
                                            <div class="features-4x-section__card-item position-relative">
                                                <div class="features-4x-section__card-item-mask"></div>
                                                <div class="position-relative z-index-2 bg-white rounded-24 p-24 w-100 h-100">
                                                    <div class="d-flex-center size-64 rounded-12 bg-warning-20 text-warning">
                                                                                                                    <svg width="32px" height="32px" class="icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  <path d="M15.8 2.21c-.41-.41-1.12-.13-1.12.44v3.49c0 1.46 1.24 2.67 2.75 2.67.95.01 2.27.01 3.4.01.57 0 .87-.67.47-1.07-1.44-1.45-4.02-4.06-5.5-5.54zM13.5 13.75h-6c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h6c.41 0 .75.34.75.75s-.34.75-.75.75zM11.5 17.75h-4c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h4c.41 0 .75.34.75.75s-.34.75-.75.75z"/>
                                                    ...
                                                    <h4 class="mt-24 font-24 text-dark">Practical Course Assignments</h4>

                                                                                                            <p class="mt-12 font-16 text-gray-500">Apply what you learn with real assignments that reinforce skills and deepen your practical knowledge.</p>
                                                                                                    </div>
                                            </div>
                                            ...
                                            <div class="features-4x-section__card-item position-relative">
                                                <div class="features-4x-section__card-item-mask"></div>
                                                <div class="position-relative z-index-2 bg-white rounded-24 p-24 w-100 h-100">
                                                    <div class="d-flex-center size-64 rounded-12 bg-success-20 text-success">
                                                                                                                    <svg width="32px" height="32px" class="icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  <path d="M12 12.11c-.41 0-.75-.34-.75-.75v-.21c0-1.16.85-1.73 1.17-1.95.37-.25.49-.42.49-.68 0-.5-.41-.91-.91-.91s-.91.41-.91.91c0 .41-.34.75-.75.75s-.75-.34-.75-.75c0-1.33 1.08-2.41 2.41-2.41s2.41 1.08 2.41 2.41c0 1.14-.84 1.71-1.15 1.92-.39.26-.51.43-.51.71v.21c0 .42-.34.75-.75.75zM12 14.6a.749.749 0 11-.002-1.498A.749.749 0 0112 14.6z"/>
                                                    ...
                                                    <h4 class="mt-24 font-24 text-dark">Dedicated Student Support</h4>

                                                                                                            <p class="mt-12 font-16 text-gray-500">Get help anytime with responsive support, ensuring a smooth and guided learning experience for everyone.</p>
                                                                                                    </div>
                                            </div>
        ...
        <div class="container">
            ...
            <div class="featured-courses-section__item-card-course-box d-flex flex-column bg-white rounded-16 p-16 text-left">
                <a href="course/Health-And-Fitness-Masterclass.html" class="text-decoration-none">
                    <h3 class="font-24 text-dark">Health And Fitness Masterclass</h3>
                </a>

                <div class="stars-card d-flex align-items-center mt-16">
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
                ...
                <div class="d-flex align-items-center gap-8 mt-16">
                    <a href="users/jessica-wray/profile.html" target="_blank" class="size-48 rounded-circle bg-gray-100">
                        <img src="store/870/setting/avatar.jpg" alt="Jessica Wray" class="img-cover rounded-circle">
                    </a>
                    <div class="">
                        <a href="users/jessica-wray/profile.html" target="_blank" class="">
                            <h5 class="font-16 text-dark">Jessica Wray</h5>
                        </a>

                        <div class="d-inline-flex align-items-center gap-4 mt-2 font-14 text-gray-500">
                            <span class="">in</span>
                            <a href="categories/Health-and-Fitness.html" target="_blank" class="font-14 text-gray-500">Health &amp; Fitness</a>
                        </div>
                    </div>
                </div>
                ...
                <a href="course/Health-And-Fitness-Masterclass.html" class="text-decoration-none">
                    <div class="featured-courses-section__item-card-course-box-description p-16 mt-16 rounded-16 border-gray-100" style="cursor: pointer;">
                        <div class="text-gray-500 font-16">Transform your lifestyle with this all-in-one masterclass. Learn effective workouts, balanced nutrition, and wellness habits guided by experts. Perfect for all fitness levels, this course helps you build strength, improve energy, and achieve long-term health goals.</div>

                                                    <div class="mt-16">
                                <h4 class="font-16 text-dark">This Course Includes:</h4>

                                                                    <div class="d-flex align-items-center mt-12">
                                        <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-success">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                                        <span class="ml-4 font-14 text-gray-500">Personalized workout plans</span>
                                    </div>
                                                                    <div class="d-flex align-items-center mt-12">
                                        <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-success">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                                        <span class="ml-4 font-14 text-gray-500">Nutrition and meal guidance</span>
                                    </div>
                                                                    <div class="d-flex align-items-center mt-12">
                                        <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-success">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                                        <span class="ml-4 font-14 text-gray-500">Daily fitness challenges</span>
                                    </div>
                                                                    <div class="d-flex align-items-center mt-12">
                                        <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-success">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                                        <span class="ml-4 font-14 text-gray-500">Expert wellness coaching</span>
                                    </div>
                                                                    <div class="d-flex align-items-center mt-12">
                                        <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-success">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                                        <span class="ml-4 font-14 text-gray-500">Progress tracking tools</span>
                                    </div>
                                                            </div>
                                            </div>
                </a>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
</svg>                            <span class="ml-4vfont-16">1:00 Hours</span>
                        </div>
                    </a>
            ...
            <div class="featured-courses-section__item-card-course-box d-flex flex-column bg-white rounded-16 p-16 text-left">
                <a href="course/Become-a-Product-Manager.html" class="text-decoration-none">
                    <h3 class="font-24 text-dark">Become a Product Manager</h3>
                </a>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
                ...
                <div class="d-flex align-items-center gap-8 mt-16">
                    <a href="users/ricardo-dave/profile" target="_blank" class="size-48 rounded-circle bg-gray-100">
                        <img src="store/1016/setting/avatar.jpg" alt="Ricardo Dave" class="img-cover rounded-circle">
                    </a>
                    <div class="">
                        <a href="users/ricardo-dave/profile" target="_blank" class="">
                            <h5 class="font-16 text-dark">Ricardo Dave</h5>
                        </a>

                        <div class="d-inline-flex align-items-center gap-4 mt-2 font-14 text-gray-500">
                            <span class="">in</span>
                            <a href="categories/Business/Business-Strategy.html" target="_blank" class="font-14 text-gray-500">Business Strategy</a>
                        </div>
                    </div>
                </div>
                ...
                <a href="course/Become-a-Product-Manager.html" class="text-decoration-none">
                    <div class="featured-courses-section__item-card-course-box-description p-16 mt-16 rounded-16 border-gray-100" style="cursor: pointer;">
                        <div class="text-gray-500 font-16">Gain essential skills to lead product development from idea to launch. Learn market research, roadmap planning, user experience, and team collaboration to confidently manage successful products in any industry. No prior experience required.</div>
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        ...
                                        <span class="ml-4 font-14 text-gray-500">Product lifecycle management essentials</span>
                                    </div>
                                                                    <div class="d-flex align-items-center mt-12">
                                        <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-success">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                                        <span class="ml-4 font-14 text-gray-500">Building effective product roadmaps</span>
                                    </div>
                                                                    <div class="d-flex align-items-center mt-12">
                                        <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-success">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                                        <span class="ml-4 font-14 text-gray-500">Conducting user and market research</span>
                                    </div>
                                                                    <div class="d-flex align-items-center mt-12">
                                        <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-success">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                                        <span class="ml-4 font-14 text-gray-500">Leading cross-functional product teams</span>
                                    </div>
                                                                    <div class="d-flex align-items-center mt-12">
                                        <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-success">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                                        <span class="ml-4 font-14 text-gray-500">Defining and prioritizing product features</span>
                                    </div>
                                                            </div>
                                            </div>
                </a>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M22 12c0 5.52-4.48 10-10 10S2 17.52 2 12 6.48 2 12 2s10 4.48 10 10z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
</svg>                            <span class="ml-4vfont-16">2:30 Hours</span>
                        </div>
                    </a>
                    ...
                    <div class="position-relative d-flex" style="height: 80px">
                        ...
                        <div class="trending-categories-section position-relative" >
        ...
        <div class="container position-relative">
            ...
            <div class="d-flex-center flex-column text-center">
                            ...
                            <div class="row">
                                    ...
                                    <a href="categories/Business/Management.html" target="_blank">
                                        <div class="trending-categories-section__item-card position-relative">
                                            ...
                                            <div class="position-relative bg-white p-16 rounded-24 z-index-2">
                                                <div class="d-inline-flex-center size-48 rounded-circle " style="background-color: #b3d5ff">
                                                    <img src="store/1/default_images/trend_categories_icons/management.svg" alt="Management" class="img-fluid" width="24px" height="24px">
                                                </div>

                                                <h4 class="mt-16 font-20 text-dark">Management</h4>
                                                <div class="mt-8 font-16 text-gray-500">2 Courses</div>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                                    ...
                                    <a href="categories/Business/Business-Strategy.html" target="_blank">
                                        <div class="trending-categories-section__item-card position-relative">
                                            ...
                                            <div class="position-relative bg-white p-16 rounded-24 z-index-2">
                                                <div class="d-inline-flex-center size-48 rounded-circle " style="background-color: #ffd0cd">
                                                    <img src="store/1/default_images/trend_categories_icons/business.svg" alt="Business Strategy" class="img-fluid" width="24px" height="24px">
                                                </div>

                                                <h4 class="mt-16 font-20 text-dark">Business Strategy</h4>
                                                <div class="mt-8 font-16 text-gray-500">2 Courses</div>
                                            </div>
                                        </div>
                                    </a>
                                    ...
                                    <a href="categories/Lifestyles/Lifestyle.html" target="_blank">
                                        <div class="trending-categories-section__item-card position-relative">
                                            ...
                                            <div class="position-relative bg-white p-16 rounded-24 z-index-2">
                                                <div class="d-inline-flex-center size-48 rounded-circle " style="background-color: #ffe4b3">
                                                    <img src="store/1/default_images/trend_categories_icons/lifestyle.svg" alt="Lifestyle" class="img-fluid" width="24px" height="24px">
                                                </div>

                                                <h4 class="mt-16 font-20 text-dark">Lifestyle</h4>
                                                <div class="mt-8 font-16 text-gray-500">3 Courses</div>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                                    ...
                                    <a href="categories/Health-and-Fitness.html" target="_blank">
                                        <div class="trending-categories-section__item-card position-relative">
                                            ...
                                            <div class="position-relative bg-white p-16 rounded-24 z-index-2">
                                                <div class="d-inline-flex-center size-48 rounded-circle " style="background-color: #c6f1da">
                                                    <img src="store/1/default_images/trend_categories_icons/health.svg" alt="Health &amp; Fitness" class="img-fluid" width="24px" height="24px">
                                                </div>

                                                <h4 class="mt-16 font-20 text-dark">Health &amp; Fitness</h4>
                                                <div class="mt-8 font-16 text-gray-500">1 Courses</div>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                                    ...
                                    <a href="categories/Academics/Science.html" target="_blank">
                                        <div class="trending-categories-section__item-card position-relative">
                                            ...
                                            <div class="position-relative bg-white p-16 rounded-24 z-index-2">
                                                <div class="d-inline-flex-center size-48 rounded-circle " style="background-color: #c1c1c1">
                                                    <img src="store/1/default_images/trend_categories_icons/science.svg" alt="Science" class="img-fluid" width="24px" height="24px">
                                                </div>

                                                <h4 class="mt-16 font-20 text-dark">Science</h4>
                                                <div class="mt-8 font-16 text-gray-500">1 Courses</div>
                                            </div>
                                        </div>
                                    </a>
                                    ...
                                    <a href="categories/Design.html" target="_blank">
                                        <div class="trending-categories-section__item-card position-relative">
                                            ...
                                            <div class="position-relative bg-white p-16 rounded-24 z-index-2">
                                                <div class="d-inline-flex-center size-48 rounded-circle " style="background-color: #eadaff">
                                                    <img src="store/1/default_images/trend_categories_icons/design.svg" alt="Design" class="img-fluid" width="24px" height="24px">
                                                </div>

                                                <h4 class="mt-16 font-20 text-dark">Design</h4>
                                                <div class="mt-8 font-16 text-gray-500">9 Courses</div>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                                    ...
                                    <a href="categories/Development/Web-Development.html" target="_blank">
                                        <div class="trending-categories-section__item-card position-relative">
                                            ...
                                            <div class="position-relative bg-white p-16 rounded-24 z-index-2">
                                                <div class="d-inline-flex-center size-48 rounded-circle " style="background-color: #ffd0db">
                                                    <img src="store/1/default_images/trend_categories_icons/development.svg" alt="Web Development" class="img-fluid" width="24px" height="24px">
                                                </div>

                                                <h4 class="mt-16 font-20 text-dark">Web Development</h4>
                                                <div class="mt-8 font-16 text-gray-500">7 Courses</div>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                                    ...
                                    <a href="categories/Marketing.html" target="_blank">
                                        <div class="trending-categories-section__item-card position-relative">
                                            ...
                                            <div class="position-relative bg-white p-16 rounded-24 z-index-2">
                                                <div class="d-inline-flex-center size-48 rounded-circle " style="background-color: #99dfff">
                                                    <img src="store/1/default_images/trend_categories_icons/marketing.svg" alt="Marketing" class="img-fluid" width="24px" height="24px">
                                                </div>

                                                <h4 class="mt-16 font-20 text-dark">Marketing</h4>
                                                <div class="mt-8 font-16 text-gray-500">0 Courses</div>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                    ...
                    <div class="position-relative d-flex" style="height: 100px">
                        ...
                        <div class="container">
            <div class="best-selling-courses-section position-relative"  style="background-image: url(store/landing_builder/landing_1/5/topselling_background_pVh.png)" >
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="course-grid-card-1 position-relative">
        ...
        <div class="position-relative z-index-2">
            <div class="course-grid-card-1__image bg-gray-200">
                                <img src="store/1016/1.jpg" class="img-cover" alt="Become a Product Manager">
            </div>

            <div class="course-grid-card-1__body d-flex flex-column py-12">
                <div class="d-flex flex-column px-12 w-100 h-100 mb-16">
                    <h3 class="course-title font-16 font-weight-bold text-dark">Become a Product Manager</h3>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
                    ...
                    <div class="d-flex align-items-center mt-auto">
                        <div class="size-32 rounded-circle">
                            <img src="store/1016/setting/avatar.jpg" class="img-cover rounded-circle" alt="Ricardo Dave">
                        </div>

                        <div class="d-flex flex-column ml-4">
                            <div class="font-14 font-weight-bold text-dark">Ricardo Dave</div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="col-12 col-md-6 col-lg-3 mt-24 ">
        <a href="course/Excel-from-Beginner-to-Advanced.html" class="text-decoration-none d-block">
    <div class="course-grid-card-1 position-relative">
        <div class="course-grid-card-1__mask"></div>
  ...
  <path d="M15 16c-.56 0-1.01-.45-1.01-1s.45-1 1-1 1 .45 1 1-.44 1-.99 1zM9.01 10C8.45 10 8 9.55 8 9s.45-1 1-1 1 .45 1 1-.44 1-.99 1zM9 15.75c-.19 0-.38-.07-.53-.22a.755.755 0 010-1.06l6-6c.29-.29.77-.29 1.06 0 .29.29.29.77 0 1.06l-6 6c-.15.15-.34.22-.53.22z"/>
                                ...
                                <img src="store/1015/Excel%20from%20Beginner%20to%20Advanced.jpg" class="img-cover" alt="Excel from Beginner to Advanced">
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
                        ...
                        <div class="container">
            <div class="best-rated-courses-section position-relative"  style="background-image: url(store/landing_builder/landing_1/9/topselling_background_xZD.png)" >
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="col-12 col-md-6 col-lg-3 mt-24">
        <a href="course/Effective-Time-Management.html" class="text-decoration-none d-block">
    <div class="course-grid-card-1 position-relative">
        <div class="course-grid-card-1__mask"></div>

        <div class="position-relative z-index-2">
            <div class="course-grid-card-1__image bg-gray-200">
                                <img src="store/867/Effective%20Time%20Management.jpg" class="img-cover" alt="Effective Time Management">
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="col-12 col-md-6 col-lg-3 mt-24">
        <a href="course/How-to-Travel-Around-the-World.html" class="text-decoration-none d-block">
    <div class="course-grid-card-1 position-relative">
        <div class="course-grid-card-1__mask"></div>

        <div class="position-relative z-index-2">
            <div class="course-grid-card-1__image bg-gray-200">
                                <img src="store/867/How%20to%20Travel%20Around%20the%20World%20on%20a%20Budget.jpg" class="img-cover" alt="How to Travel Around the World">
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
                        ...
                        <div class="position-relative d-flex" style="height: 20px">
  ...
  <path d="M21.61 9.17v5.66c0 1.38-.99 3.06-2.2 3.73l-5.34 2.96c-.57.32-1.32.48-2.07.48v-9.58l9.04-5.23c.35.64.57 1.34.57 1.98z"/>
        ...
        <a href="bundles/Become-a-Probability-%26-Statistics-Master.html" class="text-decoration-none d-block">
<div class="bundle-card position-relative">
        <div class="bundle-card__image bg-gray-200 rounded-16">
            <img src="store/1/default_images/bundles/bundle4.jpg" class="img-cover rounded-16" alt="Become a Probability &amp; Statistics Master">
        </div>

    <div class="bundle-card__content d-flex flex-column rounded-16 p-16 bg-white">
            <h3 class="bundle-card__title font-16 text-dark">Become a Probability &amp; Statistics Master</h3>

            <div>
                <a href="bundles/Become-a-Probability-%26-Statistics-Master.html" class="text-decoration-none">
                        </a>
            </div>

            <div class="d-flex align-items-center mt-28 mb-20" onclick="event.stopPropagation()">
                <a href="users/kate-williams/profile.html" target="_blank" class="size-32 rounded-circle" onclick="event.stopPropagation()">
                    <img src="store/929/setting/avatar.jpg" class="img-cover rounded-circle" alt="Kate Williams">
                </a>

            <div class="d-flex flex-column ml-4">
                    <a href="users/kate-williams/profile.html" target="_blank" class="font-14 font-weight-bold text-dark" onclick="event.stopPropagation()">Kate Williams</a>

                                    <div class="d-inline-flex align-items-center gap-4 mt-2 font-14 text-gray-500">
                        <span class="">in</span>
                            <a href="categories/Academics/Science.html" target="_blank" class="font-12 text-gray-500 text-ellipsis" onclick="event.stopPropagation()">Science</a>
                    </div>
                            </div>
        </div>
        ...
        <div class="d-flex align-items-center justify-content-between mt-auto">
            <div class="d-flex align-items-center">
                    <a href="bundles/Become-a-Probability-%26-Statistics-Master.html" class="d-flex align-items-center text-decoration-none" style="color: inherit;">
                <svg width="16px" height="16px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M9.75 14.45v-1.2c0-1.54 1.09-2.17 2.42-1.4l1.04.6 1.04.6c1.33.77 1.33 2.03 0 2.8l-1.04.6-1.04.6c-1.33.77-2.42.14-2.42-1.4v-1.2 0z"/>
</svg>                <span class="ml-4 font-14 text-gray-500">2 Courses</span>
                    </a>
            </div>

            <div class="d-flex align-items-center font-16 font-weight-bold text-primary">
                    <a href="bundles/Become-a-Probability-%26-Statistics-Master.html" class="text-decoration-none text-primary">
                <span class="">$25</span>
                            </a>
                </div>
            </div>
    ...
    <div class="col-12 col-lg-6 mt-24">
        <a href="bundles/Microsoft-Office-Beginner-to-Expert-Bundle.html" class="text-decoration-none d-block">
<div class="bundle-card position-relative">
        <div class="bundle-card__image bg-gray-200 rounded-16">
            <img src="store/1/default_images/bundles/Mask%20group.jpg" class="img-cover rounded-16" alt="Microsoft Office Beginner to Expert Bundle">
        </div>

    <div class="bundle-card__content d-flex flex-column rounded-16 p-16 bg-white">
            <h3 class="bundle-card__title font-16 text-dark">Microsoft Office Beginner to Expert Bundle</h3>

            <div>
                <a href="bundles/Microsoft-Office-Beginner-to-Expert-Bundle.html" class="text-decoration-none">
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
            ...
            <div class="d-flex align-items-center mt-28 mb-20" onclick="event.stopPropagation()">
                <a href="users/robert-ransdell/profile.html" target="_blank" class="size-32 rounded-circle" onclick="event.stopPropagation()">
                    <img src="store/1015/setting/avatar.jpg" class="img-cover rounded-circle" alt="Robert Ransdell">
                </a>

            <div class="d-flex flex-column ml-4">
                    <a href="users/robert-ransdell/profile.html" target="_blank" class="font-14 font-weight-bold text-dark" onclick="event.stopPropagation()">Robert Ransdell</a>

                                    <div class="d-inline-flex align-items-center gap-4 mt-2 font-14 text-gray-500">
                        <span class="">in</span>
                            <a href="categories/Business/Management.html" target="_blank" class="font-12 text-gray-500 text-ellipsis" onclick="event.stopPropagation()">Management</a>
                    </div>
                            </div>
        </div>
        ...
        <div class="d-flex align-items-center justify-content-between mt-auto">
            <div class="d-flex align-items-center">
                    <a href="bundles/Microsoft-Office-Beginner-to-Expert-Bundle.html" class="d-flex align-items-center text-decoration-none" style="color: inherit;">
                <svg width="16px" height="16px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M22 15V9c0-5-2-7-7-7H9C4 2 2 4 2 9v6c0 5 2 7 7 7h6c5 0 7-2 7-7zM2.52 7.11h18.96M8.52 2.11v4.86M15.48 2.11v4.41"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M9.75 14.45v-1.2c0-1.54 1.09-2.17 2.42-1.4l1.04.6 1.04.6c1.33.77 1.33 2.03 0 2.8l-1.04.6-1.04.6c-1.33.77-2.42.14-2.42-1.4v-1.2 0z"/>
</svg>                <span class="ml-4 font-14 text-gray-500">4 Courses</span>
                    </a>
            </div>

            <div class="d-flex align-items-center font-16 font-weight-bold text-primary">
                    <a href="bundles/Microsoft-Office-Beginner-to-Expert-Bundle.html" class="text-decoration-none text-primary">
                <span class="">$50</span>
                            </a>
                </div>
            </div>
    ...
    <div class="col-12 col-lg-6 mt-24">
        <a href="bundles/A-Z-Web-Programming.html" class="text-decoration-none d-block">
<div class="bundle-card position-relative">
        <div class="bundle-card__image bg-gray-200 rounded-16">
            <img src="store/1/default_images/bundles/bundle2.jpg" class="img-cover rounded-16" alt="A-Z Web Programming">
        </div>

    <div class="bundle-card__content d-flex flex-column rounded-16 p-16 bg-white">
            <h3 class="bundle-card__title font-16 text-dark">A-Z Web Programming</h3>

            <div>
                <a href="bundles/A-Z-Web-Programming.html" class="text-decoration-none">
        <div class="stars-card d-flex align-items-center mt-8">
                    <span class="stars-card__item active">
                <svg width="14px" height="14px" class="icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
            ...
            <div class="d-flex align-items-center mt-28 mb-20" onclick="event.stopPropagation()">
                <a href="users/linda-anderson/profile.html" target="_blank" class="size-32 rounded-circle" onclick="event.stopPropagation()">
                    <img src="store/934/setting/avatar.jpg" class="img-cover rounded-circle" alt="Linda Anderson">
                </a>

            <div class="d-flex flex-column ml-4">
                    <a href="users/linda-anderson/profile.html" target="_blank" class="font-14 font-weight-bold text-dark" onclick="event.stopPropagation()">Linda Anderson</a>

                                    <div class="d-inline-flex align-items-center gap-4 mt-2 font-14 text-gray-500">
                        <span class="">in</span>
                            <a href="categories/Development/Web-Development.html" target="_blank" class="font-12 text-gray-500 text-ellipsis" onclick="event.stopPropagation()">Web Development</a>
                    </div>
                            </div>
        </div>
        ...
        <div class="d-flex align-items-center justify-content-between mt-auto">
            <div class="d-flex align-items-center">
                    <a href="bundles/A-Z-Web-Programming.html" class="d-flex align-items-center text-decoration-none" style="color: inherit;">
                <svg width="16px" height="16px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M22 15V9c0-5-2-7-7-7H9C4 2 2 4 2 9v6c0 5 2 7 7 7h6c5 0 7-2 7-7zM2.52 7.11h18.96M8.52 2.11v4.86M15.48 2.11v4.41"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M9.75 14.45v-1.2c0-1.54 1.09-2.17 2.42-1.4l1.04.6 1.04.6c1.33.77 1.33 2.03 0 2.8l-1.04.6-1.04.6c-1.33.77-2.42.14-2.42-1.4v-1.2 0z"/>
</svg>                <span class="ml-4 font-14 text-gray-500">2 Courses</span>
            ...
            <div class="d-flex align-items-center font-16 font-weight-bold text-primary">
                    <a href="bundles/A-Z-Web-Programming.html" class="text-decoration-none text-primary">
                <span class="">$8</span>
                            </a>
                </div>
            </div>
    ...
    <div class="col-12 col-lg-6 mt-24">
        <a href="bundles/Solar-Energy-Design-Course-From-Zero-To-Hero.html" class="text-decoration-none d-block">
<div class="bundle-card position-relative">
        <div class="bundle-card__image bg-gray-200 rounded-16">
            <img src="store/1/default_images/bundles/bundle1.jpg" class="img-cover rounded-16" alt="Solar Energy Design Course From Zero To Hero">
        </div>

    <div class="bundle-card__content d-flex flex-column rounded-16 p-16 bg-white">
            <h3 class="bundle-card__title font-16 text-dark">Solar Energy Design Course From Zero To Hero</h3>

            <div>
                <a href="bundles/Solar-Energy-Design-Course-From-Zero-To-Hero.html" class="text-decoration-none">
        <div class="stars-card d-flex align-items-center mt-8">
                    <span class="stars-card__item active">
                <svg width="14px" height="14px" class="icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
        ...
        <div class="d-flex align-items-center justify-content-between mt-auto">
            <div class="d-flex align-items-center">
                    <a href="bundles/Solar-Energy-Design-Course-From-Zero-To-Hero.html" class="d-flex align-items-center text-decoration-none" style="color: inherit;">
                <svg width="16px" height="16px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M22 15V9c0-5-2-7-7-7H9C4 2 2 4 2 9v6c0 5 2 7 7 7h6c5 0 7-2 7-7zM2.52 7.11h18.96M8.52 2.11v4.86M15.48 2.11v4.41"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M9.75 14.45v-1.2c0-1.54 1.09-2.17 2.42-1.4l1.04.6 1.04.6c1.33.77 1.33 2.03 0 2.8l-1.04.6-1.04.6c-1.33.77-2.42.14-2.42-1.4v-1.2 0z"/>
</svg>                <span class="ml-4 font-14 text-gray-500">2 Courses</span>
            ...
            <div class="d-flex align-items-center font-16 font-weight-bold text-primary">
                    <a href="bundles/Solar-Energy-Design-Course-From-Zero-To-Hero.html" class="text-decoration-none text-primary">
                <span class="">$25</span>
                            </a>
                </div>
            </div>
                        ...
                        <div class="links-and-titles-slider-1-row-section position-relative ">
...
>
    <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                    <a href="categories/Development.html" target="_blank" class="marquee-item">Development</a>
  ...
  <path d="M20.97 8H3.03l1.76-3.96C5.26 3 6 2.15 7.7 2.15h8.6c1.7 0 2.44.85 2.91 1.89L20.97 8z" opacity=".4"/>
                                                ...
                                                <div class="swiper-slide">
                    <a href="categories/Development/Web-Development.html" target="_blank" class="marquee-item">Web Development</a>
  ...
  <path d="M20.97 8H3.03l1.76-3.96C5.26 3 6 2.15 7.7 2.15h8.6c1.7 0 2.44.85 2.91 1.89L20.97 8z" opacity=".4"/>
                                                ...
                                                <div class="swiper-slide">
                    <a href="categories/Development/Mobile-Development.html" target="_blank" class="marquee-item">Mobile Development</a>
  ...
  <path d="M20.97 8H3.03l1.76-3.96C5.26 3 6 2.15 7.7 2.15h8.6c1.7 0 2.44.85 2.91 1.89L20.97 8z" opacity=".4"/>
                                                ...
                                                <div class="swiper-slide">
                    <a href="categories/Development/Game-Development.html" target="_blank" class="marquee-item">Game Development</a>
  ...
  <path d="M20.97 8H3.03l1.76-3.96C5.26 3 6 2.15 7.7 2.15h8.6c1.7 0 2.44.85 2.91 1.89L20.97 8z" opacity=".4"/>
                                                ...
                                                <div class="swiper-slide">
                    <a href="categories/Business.html" target="_blank" class="marquee-item">Business</a>
  ...
  <path d="M20.97 8H3.03l1.76-3.96C5.26 3 6 2.15 7.7 2.15h8.6c1.7 0 2.44.85 2.91 1.89L20.97 8z" opacity=".4"/>
                                                ...
                                                <div class="swiper-slide">
                    <a href="categories/Business/Management.html" target="_blank" class="marquee-item">Management</a>
  ...
  <path d="M20.97 8H3.03l1.76-3.96C5.26 3 6 2.15 7.7 2.15h8.6c1.7 0 2.44.85 2.91 1.89L20.97 8z" opacity=".4"/>
                                                ...
                                                <div class="swiper-slide">
                    <a href="categories/Business/Communications.html" target="_blank" class="marquee-item">Communications</a>
  ...
  <path d="M20.97 8H3.03l1.76-3.96C5.26 3 6 2.15 7.7 2.15h8.6c1.7 0 2.44.85 2.91 1.89L20.97 8z" opacity=".4"/>
                                                ...
                                                <div class="swiper-slide">
                    <a href="categories/Business/Business-Strategy.html" target="_blank" class="marquee-item">Strategy</a>
  ...
  <path d="M20.97 8H3.03l1.76-3.96C5.26 3 6 2.15 7.7 2.15h8.6c1.7 0 2.44.85 2.91 1.89L20.97 8z" opacity=".4"/>
                                                ...
                                                <div class="swiper-slide">
                    <a href="categories/Marketing.html" target="_blank" class="marquee-item">Marketing</a>
  ...
  <path d="M20.97 8H3.03l1.76-3.96C5.26 3 6 2.15 7.7 2.15h8.6c1.7 0 2.44.85 2.91 1.89L20.97 8z" opacity=".4"/>
                                                ...
                                                <div class="swiper-slide">
                    <a href="categories/Lifestyles.html" target="_blank" class="marquee-item">Lifestyle</a>
  ...
  <path d="M20.97 8H3.03l1.76-3.96C5.26 3 6 2.15 7.7 2.15h8.6c1.7 0 2.44.85 2.91 1.89L20.97 8z" opacity=".4"/>
                                                ...
                                                <div class="swiper-slide">
                    <a href="categories/Health-and-Fitness.html" target="_blank" class="marquee-item">Health</a>
  ...
  <path d="M20.97 8H3.03l1.76-3.96C5.26 3 6 2.15 7.7 2.15h8.6c1.7 0 2.44.85 2.91 1.89L20.97 8z" opacity=".4"/>
                                                ...
                                                <div class="swiper-slide">
                    <a href="categories/Academics.html" target="_blank" class="marquee-item">Academics</a>
  ...
  <path d="M20.97 8H3.03l1.76-3.96C5.26 3 6 2.15 7.7 2.15h8.6c1.7 0 2.44.85 2.91 1.89L20.97 8z" opacity=".4"/>
                                                ...
                                                <div class="swiper-slide">
                    <a href="categories/Design.html" target="_blank" class="marquee-item">Design</a>
  ...
  <path d="M20.97 8H3.03l1.76-3.96C5.26 3 6 2.15 7.7 2.15h8.6c1.7 0 2.44.85 2.91 1.89L20.97 8z" opacity=".4"/>
                    ...
                    <div class="position-relative d-flex" style="height: 80px">
                        ...
                        <div class="container">
            <div class="upcoming-courses-section position-relative "  style="background-image: url(store/landing_builder/landing_13/389/upcoming_bg_lMn.svg)" >
        ...
        <a href="upcoming_courses/laravel-advanced-course.html" target="_blank" class="text-decoration-none d-block">
<div class="upcoming-course-card position-relative">
    <div class="upcoming-course-card__image position-relative rounded-16 bg-gray-100">
        <img src="store/1/default_images/upcoming/upcoming4.jpg" alt="" class="img-cover rounded-16">
        ...
        <div class="bottom-content px-12">
                    ...
                    <svg width="16px" height="16px" class="icons text-success" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
        ...
        <div class="upcoming-course-card__content d-flex flex-column bg-white py-12 rounded-16">
                ...
                <div class="d-flex flex-column ml-4">
                        <a href="users/kate-williams/profile.html" target="_blank" class="font-14 font-weight-bold text-dark" onclick="event.stopPropagation()">Kate Williams</a>
                                            ...
                                            <div class="d-inline-flex align-items-center gap-4 mt-2 font-14 text-gray-500">
                            <span class="">in</span>
                                <a href="categories/Development/Web-Development.html" target="_blank" class="font-14 text-gray-500 text-ellipsis" onclick="event.stopPropagation()">Web Development</a>
                        </div>
                                    </div>
            </div>
            ...
            <div class="d-flex align-items-center justify-content-between mt-auto pt-12 px-12 border-top-gray-100">
                <div class="d-flex align-items-center font-16 font-weight-bold text-primary">
                        <a href="upcoming_courses/laravel-advanced-course.html" target="_blank" class="text-decoration-none text-primary">
                    <span class="">$90</span>
                        </a>
                </div>

                <div class="d-flex align-items-center font-14 text-gray-500">
                        <a href="upcoming_courses/laravel-advanced-course.html" target="_blank" class="text-decoration-none d-flex align-items-center" style="color: inherit;">
                    <svg width="16px" height="16px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M22 12c0 5.52-4.48 10-10 10S2 17.52 2 12 6.48 2 12 2s10 4.48 10 10z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
</svg>                    <span class="ml-4">8:00</span>
                    <span class="ml-4">Hours</span>
                        </a>
                    </div>
                </div>
    ...
    <div class="col-12 col-md-6 col-lg-3 mt-28">
        <a href="upcoming_courses/Web-Design-for-Beginners.html" target="_blank" class="text-decoration-none d-block">
<div class="upcoming-course-card position-relative">
    <div class="upcoming-course-card__image position-relative rounded-16 bg-gray-100">
        <img src="store/1/default_images/upcoming/upcoming1.jpg" alt="" class="img-cover rounded-16">
        ...
        <div class="upcoming-course-card__content d-flex flex-column bg-white py-12 rounded-16">
                ...
                <div class="d-flex flex-column ml-4">
                        <a href="users/linda-anderson/profile.html" target="_blank" class="font-14 font-weight-bold text-dark" onclick="event.stopPropagation()">Linda Anderson</a>
                                            ...
                                            <div class="d-inline-flex align-items-center gap-4 mt-2 font-14 text-gray-500">
                            <span class="">in</span>
                                <a href="categories/Design.html" target="_blank" class="font-14 text-gray-500 text-ellipsis" onclick="event.stopPropagation()">Design</a>
                        </div>
                                    </div>
            </div>
            ...
            <div class="d-flex align-items-center justify-content-between mt-auto pt-12 px-12 border-top-gray-100">
                <div class="d-flex align-items-center font-16 font-weight-bold text-primary">
                        <a href="upcoming_courses/Web-Design-for-Beginners.html" target="_blank" class="text-decoration-none text-primary">
                    <span class="">$10</span>
                        </a>
                </div>

                <div class="d-flex align-items-center font-14 text-gray-500">
                        <a href="upcoming_courses/Web-Design-for-Beginners.html" target="_blank" class="text-decoration-none d-flex align-items-center" style="color: inherit;">
                    <svg width="16px" height="16px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M22 12c0 5.52-4.48 10-10 10S2 17.52 2 12 6.48 2 12 2s10 4.48 10 10z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
</svg>                    <span class="ml-4">3:30</span>
    ...
    <div class="col-12 col-md-6 col-lg-3 mt-28">
        <a href="upcoming_courses/Digital-Photography.html" target="_blank" class="text-decoration-none d-block">
<div class="upcoming-course-card position-relative">
    <div class="upcoming-course-card__image position-relative rounded-16 bg-gray-100">
        <img src="store/1/default_images/upcoming/upcoming3.jpg" alt="" class="img-cover rounded-16">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
    ...
    <div class="upcoming-course-card__body position-relative px-12 pb-12">
        <div class="upcoming-course-card__content d-flex flex-column bg-white py-12 rounded-16">
                <div class="d-flex align-items-center mb-16 px-12" onclick="event.stopPropagation()">
                    <a href="users/ricardo-dave/profile" target="_blank" class="size-32 rounded-circle" onclick="event.stopPropagation()">
                    <img src="store/1016/setting/avatar.jpg" class="img-cover rounded-circle" alt="Ricardo Dave">
                    </a>

                <div class="d-flex flex-column ml-4">
                        <a href="users/ricardo-dave/profile" target="_blank" class="font-14 font-weight-bold text-dark" onclick="event.stopPropagation()">Ricardo Dave</a>
            ...
            <div class="d-flex align-items-center justify-content-between mt-auto pt-12 px-12 border-top-gray-100">
                <div class="d-flex align-items-center font-16 font-weight-bold text-primary">
                        <a href="upcoming_courses/Digital-Photography.html" target="_blank" class="text-decoration-none text-primary">
                    <span class="">$50</span>
                        </a>
                </div>

                <div class="d-flex align-items-center font-14 text-gray-500">
                        <a href="upcoming_courses/Digital-Photography.html" target="_blank" class="text-decoration-none d-flex align-items-center" style="color: inherit;">
                    <svg width="16px" height="16px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M22 12c0 5.52-4.48 10-10 10S2 17.52 2 12 6.48 2 12 2s10 4.48 10 10z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
</svg>                    <span class="ml-4">6:00</span>
                    <span class="ml-4">Hours</span>
                        </a>
                    </div>
                </div>
    ...
    <div class="col-12 col-md-6 col-lg-3 mt-28">
        <a href="upcoming_courses/Python-for-Beginners.html" target="_blank" class="text-decoration-none d-block">
<div class="upcoming-course-card position-relative">
    <div class="upcoming-course-card__image position-relative rounded-16 bg-gray-100">
        <img src="store/1/default_images/upcoming/upcoming2.jpg" alt="" class="img-cover rounded-16">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
    ...
    <div class="upcoming-course-card__body position-relative px-12 pb-12">
        <div class="upcoming-course-card__content d-flex flex-column bg-white py-12 rounded-16">
            ...
            <div class="d-flex align-items-center justify-content-between mt-auto pt-12 px-12 border-top-gray-100">
                <div class="d-flex align-items-center font-16 font-weight-bold text-primary">
                        <a href="upcoming_courses/Python-for-Beginners.html" target="_blank" class="text-decoration-none text-primary">
                    <span class="">$100</span>
                        </a>
                </div>

                <div class="d-flex align-items-center font-14 text-gray-500">
                        <a href="upcoming_courses/Python-for-Beginners.html" target="_blank" class="text-decoration-none d-flex align-items-center" style="color: inherit;">
                    <svg width="16px" height="16px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M22 12c0 5.52-4.48 10-10 10S2 17.52 2 12 6.48 2 12 2s10 4.48 10 10z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
                    ...
                    <span class="ml-4">Hours</span>
                        ...
                        <a href="upcoming_courses8676.html?sort=newest" target="_blank" class="btn-flip-effect btn btn-primary btn-xlg gap-8 text-white" data-text="View More">
                                                            <svg width="24px" height="24px" class="icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  <path d="M8.5 15c-.13 0-.26-.03-.38-.08s-.23-.12-.33-.21c-.09-.1-.16-.21-.21-.33A.995.995 0 017.5 14c0-.13.03-.26.08-.38s.12-.23.21-.33c.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.09.1.16.21.21.33.05.12.08.25.08.38s-.03.26-.08.38-.12.23-.21.33c-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08zM12 15c-.13 0-.26-.03-.38-.08s-.23-.12-.33-.21c-.18-.19-.29-.45-.29-.71 0-.26.11-.52.29-.71.1-.09.21-.16.33-.21.24-.11.52-.11.76 0 .12.05.23.12.33.21.18.19.29.45.29.71 0 .26-.11.52-.29.71-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08zM8.5 18.5c-.13 0-.26-.03-.38-.08s-.23-.12-.33-.21c-.18-.19-.29-.45-.29-.71 0-.26.11-.52.29-.71.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.18.19.29.45.29.71 0 .26-.11.52-.29.71-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08z"/>
                        ...
                        <div class="container">
            <div class="discounted-courses-section position-relative "  style="background-image: url(store/landing_builder/landing_13/391/discounted_bg_s3Z.svg)" >
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="col-12 col-md-6 col-lg-3 mt-24">
        <a href="course/The-Future-of-Energy.html" class="text-decoration-none d-block">
    <div class="course-grid-card-1 position-relative">
        <div class="course-grid-card-1__mask"></div>
  ...
  <path d="M3.99 14.66l-1.52-1.52c-.62-.62-.62-1.64 0-2.26l1.52-1.52c.26-.26.47-.77.47-1.13V6.08c0-.88.72-1.6 1.6-1.6h2.15c.36 0 .87-.21 1.13-.47l1.52-1.52c.62-.62 1.64-.62 2.26 0l1.52 1.52c.26.26.77.47 1.13.47h2.15c.88 0 1.6.72 1.6 1.6v2.15c0 .36.21.87.47 1.13l1.52 1.52c.62.62.62 1.64 0 2.26l-1.52 1.52c-.26.26-.47.77-.47 1.13v2.15c0 .88-.72 1.6-1.6 1.6h-2.15c-.36 0-.87.21-1.13.47l-1.52 1.52c-.62.62-1.64.62-2.26 0l-1.52-1.52c-.26-.26-.77-.47-1.13-.47H6.06c-.88 0-1.6-.72-1.6-1.6v-2.15c0-.37-.21-.88-.47-1.13z" opacity=".4"/>
  <path d="M15 16c-.56 0-1.01-.45-1.01-1s.45-1 1-1 1 .45 1 1-.44 1-.99 1zM9.01 10C8.45 10 8 9.55 8 9s.45-1 1-1 1 .45 1 1-.44 1-.99 1zM9 15.75c-.19 0-.38-.07-.53-.22a.755.755 0 010-1.06l6-6c.29-.29.77-.29 1.06 0 .29.29.29.77 0 1.06l-6 6c-.15.15-.34.22-.53.22z"/>
</svg>                        <span class="ml-4 text-white font-12">40% Off</span>
                    </div>
                                <img src="store/929/The%20Future%20of%20Energy.jpg" class="img-cover" alt="The Future of Energy">
            </div>

            <div class="course-grid-card-1__body d-flex flex-column py-12">
                <div class="d-flex flex-column px-12 w-100 h-100 mb-16">
                    <h3 class="course-title font-16 font-weight-bold text-dark">The Future of Energy</h3>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
                    ...
                    <div class="d-flex align-items-center mt-auto">
                        ...
                        <div class="d-flex flex-column ml-4">
                            <div class="font-14 font-weight-bold text-dark">Kate Williams</div>

                                                            <div class="d-inline-flex align-items-center gap-4 mt-2 font-12 text-gray-500">
                                    <span class="">in</span>
                                    <div class="font-14 text-gray-500 text-ellipsis">Science</div>
                                </div>
                                                    </div>
                    </div>
                </div>
                ...
                <div class="d-flex align-items-center justify-content-between mt-auto pt-12 border-top-gray-100 px-12">
                    <div class="d-flex align-items-center font-16 font-weight-bold text-primary">
                                                    <span class="">$36</span>
        <span class="font-14 font-weight-400 text-gray-500 text-decoration-line-through ml-8">$60</span>
                                                    </div>
  ...
  <path d="M10.79 15.17a.75.75 0 01-.53-.22l-2.42-2.42a.754.754 0 010-1.06c.29-.29.77-.29 1.06 0l1.89 1.89 4.3-4.3c.29-.29.77-.29 1.06 0 .29.29.29.77 0 1.06l-4.83 4.83a.75.75 0 01-.53.22z"/>
                        ...
                        <div class="free-courses-section position-relative" style="background-color: var(--secondary); background-image: url(store/landing_builder/landing_13/392/free_courses_bg_4Mq.svg); "v>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="col-12 col-md-6 col-lg-3 mt-28">
        <a href="course/Learn-Linux-in-5-Days.html" class="text-decoration-none d-block">
    <div class="course-grid-card-1 position-relative">
        <div class="course-grid-card-1__mask"></div>

        <div class="position-relative z-index-2">
            <div class="course-grid-card-1__image bg-gray-200">
                                <img src="store/1015/hero%20(6).jpg" class="img-cover" alt="Learn Linux in 5 Days">
            </div>

            <div class="course-grid-card-1__body d-flex flex-column py-12">
                <div class="d-flex flex-column px-12 w-100 h-100 mb-16">
                    <h3 class="course-title font-16 font-weight-bold text-dark">Learn Linux in 5 Days</h3>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="col-12 col-md-6 col-lg-3 mt-28">
        <a href="course/Learn-Python-Programming.html" class="text-decoration-none d-block">
    <div class="course-grid-card-1 position-relative">
        <div class="course-grid-card-1__mask"></div>

        <div class="position-relative z-index-2">
            <div class="course-grid-card-1__image bg-gray-200">
                                <img src="store/934/Python%20for%20Beginners.jpg" class="img-cover" alt="Learn Python Programming">
            </div>
                            ...
                            <div class="col-12 col-md-8 col-lg-6">
                                <div class="d-flex align-items-start justify-content-between gap-40 gap-lg-80">
                                    <div class="">
                                                ...
                                                <svg width="24px" height="24px" class="icons text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M14.43 5.93L20.5 12l-6.07 6.07M3.5 12h16.83"/>
</svg>                                                <span class="btn-flip-effect__text ml-4">Explore Free Courses</span>
                                            </a>
                                                                            </div>

                                                                            <div class="free-courses-section__cta-icon d-flex-center">
                                            <img src="store/landing_builder/landing_13/392/free_courses_overlay_79X.png" alt="icon">
                                        </div>
                                                                    </div>
                            </div>
                        </div>
                        ...
                        <div class="store-products-section position-relative"  style="background-image: url(store/landing_builder/landing_13/394/store_bg_Jpr.svg)" >
            <div class="container position-relative h-100">
                <div class="d-flex-center flex-column text-center">
        ...
        <a href="products/How-to-Do-a-Website-UX-audit-ebook.html" class="text-decoration-none d-block">
    <div class="product-card position-relative">
        ...
        <div class="position-relative d-flex p-12 rounded-16 bg-white z-index-2">
            <div class="product-card__image rounded-16">
                <img src="store/1/default_images/store/products/uxbook.jpg" class="img-cover rounded-16" alt="How to Do a Website UX Audit E-book">
            </div>

            <div class="product-card__content ml-12 flex-1 d-flex flex-column">
                <h3 class="product-card__title font-weight-bold font-16 text-dark">How to Do a Website UX Audit E-book</h3>

                <div class="d-flex align-items-center my-16" onclick="event.stopPropagation()">
                    <a href="users/admin/profile.html" target="_blank" class="size-32 rounded-circle" onclick="event.stopPropagation()">
                        <img src="store/1/default_images/admin-avatar.jpg" class="img-cover rounded-circle" alt="Admin">
                    </a>

                    <div class="d-flex flex-column ml-4">
                        <a href="users/admin/profile.html" target="_blank" class="font-14 font-weight-bold text-dark" onclick="event.stopPropagation()">Admin</a>

                                                    <div class="d-inline-flex align-items-center gap-4 mt-2 font-14 text-gray-500">
                                <span class="">in</span>
                                <a href="productsd7b8.html?category_id=3" target="_blank" class="font-14 text-gray-500 text-ellipsis" onclick="event.stopPropagation()">E-books</a>
                            </div>
                                            </div>
                </div>
                ...
                <div class="mt-auto d-flex align-items-center justify-content-between">
                    ...
                    <div class="">
                        <a href="products/How-to-Do-a-Website-UX-audit-ebook.html" class="text-decoration-none">
                                                    </a>
                    </div>
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-24">
        <a href="products/chat-gpt-ui-ux.html" class="text-decoration-none d-block">
    <div class="product-card position-relative">
        <div class="product-card__mask"></div>

        <div class="position-relative d-flex p-12 rounded-16 bg-white z-index-2">
            <div class="product-card__image rounded-16">
                <img src="store/1/default_images/store/products/book2.jpg" class="img-cover rounded-16" alt="ChatGPT for UI/UX Design E-book">
            </div>

            <div class="product-card__content ml-12 flex-1 d-flex flex-column">
                <h3 class="product-card__title font-weight-bold font-16 text-dark">ChatGPT for UI/UX Design E-book</h3>
                ...
                <div class="mt-auto d-flex align-items-center justify-content-between">
                    ...
                    <div class="">
                        <a href="products/chat-gpt-ui-ux.html" class="text-decoration-none">
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-24">
        <a href="products/ui-ux-playbook.html" class="text-decoration-none d-block">
    <div class="product-card position-relative">
        <div class="product-card__mask"></div>

        <div class="position-relative d-flex p-12 rounded-16 bg-white z-index-2">
            <div class="product-card__image rounded-16">
                <img src="store/1/default_images/store/products/book1.jpg" class="img-cover rounded-16" alt="Practical UI/UX Playbook E-book">
            </div>

            <div class="product-card__content ml-12 flex-1 d-flex flex-column">
                <h3 class="product-card__title font-weight-bold font-16 text-dark">Practical UI/UX Playbook E-book</h3>
                ...
                <div class="mt-auto d-flex align-items-center justify-content-between">
                    ...
                    <div class="">
                        <a href="products/ui-ux-playbook.html" class="text-decoration-none">
                            <div class="stars-card d-flex align-items-center ">
                    <span class="stars-card__item active">
                <svg width="14px" height="14px" class="icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-24">
        <a href="products/Painting-tools.html" class="text-decoration-none d-block">
    <div class="product-card position-relative">
        <div class="product-card__mask"></div>

        <div class="position-relative d-flex p-12 rounded-16 bg-white z-index-2">
            <div class="product-card__image rounded-16">
                <img src="store/1/default_images/store/products/painting.jpg" class="img-cover rounded-16" alt="Painting tools">
            </div>

            <div class="product-card__content ml-12 flex-1 d-flex flex-column">
                <h3 class="product-card__title font-weight-bold font-16 text-dark">Painting tools</h3>
                ...
                <div class="d-flex align-items-center my-16" onclick="event.stopPropagation()">
                    ...
                    <div class="d-flex flex-column ml-4">
                        <a href="users/robert-ransdell/profile.html" target="_blank" class="font-14 font-weight-bold text-dark" onclick="event.stopPropagation()">Robert Ransdell</a>
                                                    ...
                                                    <div class="d-inline-flex align-items-center gap-4 mt-2 font-14 text-gray-500">
                                <span class="">in</span>
                                <a href="productsbaa2.html?category_id=1" target="_blank" class="font-14 text-gray-500 text-ellipsis" onclick="event.stopPropagation()">Design Tools</a>
                            </div>
                                            </div>
                </div>
                ...
                <div class="mt-auto d-flex align-items-center justify-content-between">
                    ...
                    <div class="">
                        <a href="products/Painting-tools.html" class="text-decoration-none">
                            <div class="stars-card d-flex align-items-center ">
                    <span class="stars-card__item active">
                <svg width="14px" height="14px" class="icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-24">
        <a href="products/Advanced-microscope.html" class="text-decoration-none d-block">
    <div class="product-card position-relative">
        <div class="product-card__mask"></div>

        <div class="position-relative d-flex p-12 rounded-16 bg-white z-index-2">
            <div class="product-card__image rounded-16">
                <img src="store/1/default_images/store/products/microscope.jpg" class="img-cover rounded-16" alt="Advanced microscope">
            </div>

            <div class="product-card__content ml-12 flex-1 d-flex flex-column">
                <h3 class="product-card__title font-weight-bold font-16 text-dark">Advanced microscope</h3>
                ...
                <div class="mt-auto d-flex align-items-center justify-content-between">
                    ...
                    <div class="">
                        <a href="products/Advanced-microscope.html" class="text-decoration-none">
                            <div class="stars-card d-flex align-items-center ">
                    <span class="stars-card__item active">
                <svg width="14px" height="14px" class="icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-24">
        <a href="products/Business-Software.html" class="text-decoration-none d-block">
    <div class="product-card position-relative">
        <div class="product-card__mask"></div>

        <div class="position-relative d-flex p-12 rounded-16 bg-white z-index-2">
            <div class="product-card__image rounded-16">
                <img src="store/1/default_images/store/products/software.jpg" class="img-cover rounded-16" alt="Business Software">
            </div>

            <div class="product-card__content ml-12 flex-1 d-flex flex-column">
                <h3 class="product-card__title font-weight-bold font-16 text-dark">Business Software</h3>
                ...
                <div class="mt-auto d-flex align-items-center justify-content-between">
                    ...
                    <div class="">
                        <a href="products/Business-Software.html" class="text-decoration-none">
                            <div class="stars-card d-flex align-items-center ">
                    <span class="stars-card__item active">
                <svg width="14px" height="14px" class="icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
  ...
  <path d="M19.65 10.7H4.36c-.3 0-.61-.01-.9-.08l1.26 7.68C5 20.02 5.75 22 9.08 22h5.61c3.37 0 3.97-1.69 4.33-3.58l1.51-7.8c-.28.06-.58.08-.88.08zm-9.04 6.46c0 .39-.31.7-.7.7-.39 0-.7-.31-.7-.7v-3.3c0-.39.31-.7.7-.7.39 0 .7.31.7.7v3.3zm4.28 0c0 .39-.31.7-.7.7-.39 0-.7-.31-.7-.7v-3.3c0-.39.31-.7.7-.7.39 0 .7.31.7.7v3.3z"/>
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                                ...
                                <span class="font-14 text-gray-500">Flexible payment options</span>
                            </div>
                                                    <div class="d-flex align-items-center gap-4 mt-12">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-success">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
  ...
  <path d="M14.84 8.45l-.62.76c-.1.11-.17.33-.16.48l.06.98c.04.6-.39.91-.95.69l-.91-.36a.92.92 0 00-.52 0l-.91.36c-.56.22-.99-.09-.95-.69l.06-.98a.751.751 0 00-.16-.48l-.62-.76c-.39-.46-.22-.97.36-1.12l.95-.24c.15-.04.33-.18.41-.31l.53-.82c.33-.51.85-.51 1.18 0l.53.82c.08.13.26.27.41.31l.95.24c.58.15.75.66.36 1.12z" opacity=".4"/>
    ...
    <div class="position-relative z-index-2 d-flex flex-column bg-white rounded-24 p-16 pt-32 w-100 h-100">
        ...
        <h3 class="font-20 font-weight-bold mt-16">Starter Access</h3>
        <p class="font-16 text-gray-500 mt-4">Ideal for beginners to start learning</p>

        <div class="mt-20">
                                                <span class="font-44 font-weight-bold text-dark">$20</span>
                                    </div>
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <div class="ml-4 font-16 text-gray-500">15 Days of Subscription</div>
            </li>
  ...
  <path d="M10.79 15.17a.75.75 0 01-.53-.22l-2.42-2.42a.754.754 0 010-1.06c.29-.29.77-.29 1.06 0l1.89 1.89 4.3-4.3c.29-.29.77-.29 1.06 0 .29.29.29.77 0 1.06l-4.83 4.83a.75.75 0 01-.53.22z"/>
        ...
        <h3 class="font-20 font-weight-bold mt-16">Pro Plus</h3>
        <p class="font-16 text-gray-500 mt-4">Advanced tools for serious learners</p>

        <div class="mt-20">
                                                <span class="font-44 font-weight-bold text-dark">$100</span>
                                    </div>
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <div class="ml-4 font-16 text-gray-500">30 Days of Subscription</div>
            </li>
    ...
    <div class="position-relative z-index-2 d-flex flex-column bg-white rounded-24 p-16 pt-32 w-100 h-100">
        ...
        <h3 class="font-20 font-weight-bold mt-16">Elite Mastery</h3>
        <p class="font-16 text-gray-500 mt-4">Exclusive access for expert users</p>

        <div class="mt-20">
                                                <span class="font-44 font-weight-bold text-dark">$50</span>
                                    </div>
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    ...
                                    <span class="font-14 text-gray-500">Flexible Teaching Schedule</span>
                                </div>
                                                            <div class="d-flex align-items-center gap-4 mt-12">
                                    <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-success">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                                    <span class="font-14 text-gray-500">Global Student Reach</span>
                                </div>
                                                            <div class="d-flex align-items-center gap-4 mt-12">
                                    <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-success">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                                    <span class="font-14 text-gray-500">Earn Extra Income</span>
                                </div>
                                                            <div class="d-flex align-items-center gap-4 mt-12">
                                    <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-success">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
  ...
  <path d="M21.3 22c-.18 0-.36-.07-.49-.2l-1.86-1.86a.706.706 0 010-.99c.27-.27.71-.27.99 0l1.86 1.86c.27.27.27.71 0 .99-.14.13-.32.2-.5.2z"/>
            ...
            <div class="cta-card-8-columns-section__bg-mask" style="background-color: var(--primary); background-image: url(store/landing_builder/landing_13/401/forums_section_CyQ.png); "></div>
  ...
  <path d="M8.94 10v5.14c0 .8.88 1.27 1.55.84l.94-.62a1 1 0 011.1 0l.89.6a.997.997 0 001.55-.83V10H8.94z" opacity=".6"/>
    ...
    <div class="position-relative z-index-2 d-flex align-items-start bg-white p-16 rounded-32">
        <a href="users/james-kong/profile.html" class="flex-1">
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
</svg>                        <span class="font-12 font-weight-bold text-dark">3.88</span>
                    </div>

                                    </div>

                <div class="ml-12">
                    <h6 class="font-16 text-dark">James Kong</h6>
                    <div class="font-14 mt-8 text-gray-500">Master Certified Coach</div>
                </div>
            </div>
        </a>
  ...
  <path d="M17.08 14.15c-2.79-1.86-7.34-1.86-10.15 0-1.27.85-1.97 2-1.97 3.23s.7 2.37 1.96 3.21C8.32 21.53 10.16 22 12 22c1.84 0 3.68-.47 5.08-1.41 1.26-.85 1.96-1.99 1.96-3.23-.01-1.23-.7-2.37-1.96-3.21z"/>
    ...
    <div class="position-relative z-index-2 d-flex align-items-start bg-white p-16 rounded-32">
        <a href="users/jessica-wray/profile.html" class="flex-1">
            <div class="d-flex align-items-center bg-gray-100 p-24 rounded-24 w-100">
                <div class="position-relative size-64 rounded-circle bg-gray-100">
                    <img src="store/870/setting/avatar.jpg" alt="Jessica Wray" class="img-cover rounded-circle">
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
                                            ...
                                            <div class="instructor-card__verified-badge d-flex-center rounded-circle size-16 p-2 bg-primary" data-tippy-content="Verified">
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <div class="ml-12">
                    <h6 class="font-16 text-dark">Jessica Wray</h6>
                    <div class="font-14 mt-8 text-gray-500">Network Technician at Cisco</div>
                </div>
            </div>
        </a>
  ...
  <path d="M17.08 14.15c-2.79-1.86-7.34-1.86-10.15 0-1.27.85-1.97 2-1.97 3.23s.7 2.37 1.96 3.21C8.32 21.53 10.16 22 12 22c1.84 0 3.68-.47 5.08-1.41 1.26-.85 1.96-1.99 1.96-3.23-.01-1.23-.7-2.37-1.96-3.21z"/>
    ...
    <div class="position-relative z-index-2 d-flex align-items-start bg-white p-16 rounded-32">
        <a href="users/john-powe/profile.html" class="flex-1">
            <div class="d-flex align-items-center bg-gray-100 p-24 rounded-24 w-100">
                <div class="position-relative size-64 rounded-circle bg-gray-100">
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <div class="ml-12">
                    <h6 class="font-16 text-dark">John Powe</h6>
                    <div class="font-14 mt-8 text-gray-500">IT Director at Cognizant</div>
                </div>
            </div>
        </a>
  ...
  <path d="M17.08 14.15c-2.79-1.86-7.34-1.86-10.15 0-1.27.85-1.97 2-1.97 3.23s.7 2.37 1.96 3.21C8.32 21.53 10.16 22 12 22c1.84 0 3.68-.47 5.08-1.41 1.26-.85 1.96-1.99 1.96-3.23-.01-1.23-.7-2.37-1.96-3.21z"/>
    ...
    <div class="position-relative z-index-2 d-flex align-items-start bg-white p-16 rounded-32">
        <a href="users/kate-williams/profile.html" class="flex-1">
            <div class="d-flex align-items-center bg-gray-100 p-24 rounded-24 w-100">
                <div class="position-relative size-64 rounded-circle bg-gray-100">
                    ...
                    <div class="instructor-card__rate d-flex-center gap-4 text-center bg-white p-4 pr-8 rounded-32">
                        <svg width="14px" height="14px" class="icons text-warning" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
</svg>                        <span class="font-12 font-weight-bold text-dark">3.42</span>
                    </div>

                                    </div>

                <div class="ml-12">
                    <h6 class="font-16 text-dark">Kate Williams</h6>
                    <div class="font-14 mt-8 text-gray-500">Computer Engineer at Oracle</div>
                </div>
            </div>
        </a>
  ...
  <path d="M17.08 14.15c-2.79-1.86-7.34-1.86-10.15 0-1.27.85-1.97 2-1.97 3.23s.7 2.37 1.96 3.21C8.32 21.53 10.16 22 12 22c1.84 0 3.68-.47 5.08-1.41 1.26-.85 1.96-1.99 1.96-3.23-.01-1.23-.7-2.37-1.96-3.21z"/>
    ...
    <div class="position-relative z-index-2 d-flex align-items-start bg-white p-16 rounded-32">
        <a href="users/linda-anderson/profile.html" class="flex-1">
            <div class="d-flex align-items-center bg-gray-100 p-24 rounded-24 w-100">
                <div class="position-relative size-64 rounded-circle bg-gray-100">
                    ...
                    <div class="instructor-card__rate d-flex-center gap-4 text-center bg-white p-4 pr-8 rounded-32">
                        <svg width="14px" height="14px" class="icons text-warning" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
</svg>                        <span class="font-12 font-weight-bold text-dark">4.63</span>
                    </div>

                                    </div>

                <div class="ml-12">
                    <h6 class="font-16 text-dark">Linda Anderson</h6>
                    <div class="font-14 mt-8 text-gray-500">IT Technician at IBM</div>
                </div>
            </div>
        </a>
  ...
  <path d="M17.08 14.15c-2.79-1.86-7.34-1.86-10.15 0-1.27.85-1.97 2-1.97 3.23s.7 2.37 1.96 3.21C8.32 21.53 10.16 22 12 22c1.84 0 3.68-.47 5.08-1.41 1.26-.85 1.96-1.99 1.96-3.23-.01-1.23-.7-2.37-1.96-3.21z"/>
    ...
    <div class="position-relative z-index-2 d-flex align-items-start bg-white p-16 rounded-32">
        <a href="users/robert-ransdell/profile.html" class="flex-1">
            <div class="d-flex align-items-center bg-gray-100 p-24 rounded-24 w-100">
                <div class="position-relative size-64 rounded-circle bg-gray-100">
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <div class="ml-12">
                    <h6 class="font-16 text-dark">Robert Ransdell</h6>
                    <div class="font-14 mt-8 text-gray-500">System Administrator at ...</div>
                </div>
            </div>
        </a>
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
                    ...
                    <div class="organizations-section position-relative"  style="background-image: url(store/landing_builder/landing_13/407/organizations_bg_IVZ.svg)" >
        <div class="container">
            <div class="d-flex-center flex-column text-center">
            ...
            >
                <div class="swiper-wrapper pb-8">
                    <div class="swiper-slide">
        <a href="users/king-pictures/profile.html" class="text-decoration-none d-block">
    <div class="organization-card position-relative ">
        ...
        <div class="position-relative z-index-2 bg-white p-16 rounded-24">
            <div class="d-flex align-items-center p-12">
                <div class="position-relative size-64 rounded-circle bg-gray-100">
                    <img src="store/4/setting/avatar.jpg" alt="King Pictures" class="img-cover rounded-circle">

                                    </div>
                <div class="ml-16">
                    <h6 class="font-16 text-dark">King Pictures</h6>
                    <div class="stars-card d-flex align-items-center ">
                    <span class="stars-card__item active">
                <svg width="14px" height="14px" class="icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
  ...
  <path d="M22 7.81v.05H2v-.05c0-.51.04-1 .13-1.45h5.64V2h1.5v4.36h5.46V2h1.5v4.36h5.64c.09.45.13.94.13 1.45zM14.44 12.72l-2.08-1.2c-.77-.44-1.51-.5-2.09-.17-.58.33-.9 1.01-.9 1.89v2.4c0 .88.32 1.56.9 1.89.25.14.53.21.82.21.4 0 .83-.13 1.27-.38l2.08-1.2c.77-.44 1.19-1.06 1.19-1.73 0-.67-.43-1.26-1.19-1.71z"/>
                        ...
                        <span class="d-block font-14 text-gray-500 mt-4">Courses</span>
                    </div>
                </div>
  ...
  <path d="M20.5 12.3l-.15.09a17.037 17.037 0 01-5.79 2.08c-.08.96-.5 2.06-2.69 2.06s-2.61-1.09-2.69-2.04c-1.91-.3-3.79-.93-5.5-1.88-.15-.08-.3-.16-.44-.25-.36-.2-.7-.42-1.03-.64-.02-.01-.04-.03-.05-.04l.61 6.51c.21 1.99 1.03 4.04 5.43 4.04h7.62c4.4 0 5.22-2.05 5.43-4.05l.63-6.78a.12.12 0 01-.05.05c-.43.31-.87.6-1.33.85z" opacity=".4"/>
                        ...
                        <span class="d-block font-weight-bold text-dark">1</span>
                        <span class="d-block font-14 text-gray-500 mt-4">Instructors</span>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex align-items-center justify-content-between mt-24">
                <div class="">
                    <span class="d-block font-weight-bold text-dark">View Profile</span>
                    <span class="d-block font-14 text-gray-500 mt-2">More Information</span>
                </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M14.43 5.93L20.5 12l-6.07 6.07M3.5 12h16.83"/>
    ...
    <div class="swiper-slide">
        <a href="users/cactuscat-clothing/profile.html" class="text-decoration-none d-block">
    <div class="organization-card position-relative ">
        <div class="organization-card__mask"></div>
        ...
        <div class="position-relative z-index-2 bg-white p-16 rounded-24">
            <div class="d-flex align-items-center p-12">
                <div class="position-relative size-64 rounded-circle bg-gray-100">
                    <img src="store/859/setting/avatar.jpg" alt="Cactuscat Clothing" class="img-cover rounded-circle">

                                    </div>
                <div class="ml-16">
                    <h6 class="font-16 text-dark">Cactuscat Clothing</h6>
                                    </div>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M14.43 5.93L20.5 12l-6.07 6.07M3.5 12h16.83"/>
    ...
    <div class="swiper-slide">
        <a href="users/owosso/profile.html" class="text-decoration-none d-block">
    <div class="organization-card position-relative ">
        <div class="organization-card__mask"></div>
        ...
        <div class="position-relative z-index-2 bg-white p-16 rounded-24">
            <div class="d-flex align-items-center p-12">
                <div class="position-relative size-64 rounded-circle bg-gray-100">
                    <img src="store/863/setting/avatar.jpg" alt="Owosso" class="img-cover rounded-circle">

                                    </div>
                <div class="ml-16">
                    <h6 class="font-16 text-dark">Owosso</h6>
                    <div class="stars-card d-flex align-items-center ">
                    <span class="stars-card__item active">
                <svg width="14px" height="14px" class="icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M14.43 5.93L20.5 12l-6.07 6.07M3.5 12h16.83"/>
    ...
    <div class="swiper-slide">
        <a href="users/affogato-media/profile.html" class="text-decoration-none d-block">
    <div class="organization-card position-relative ">
        <div class="organization-card__mask"></div>
        ...
        <div class="position-relative z-index-2 bg-white p-16 rounded-24">
            <div class="d-flex align-items-center p-12">
                ...
                <div class="ml-16">
                    <h6 class="font-16 text-dark">Affogato Media</h6>
                    <div class="stars-card d-flex align-items-center ">
                    <span class="stars-card__item active">
                <svg width="14px" height="14px" class="icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
  ...
  <path d="M22 7.81v.05H2v-.05c0-.51.04-1 .13-1.45h5.64V2h1.5v4.36h5.46V2h1.5v4.36h5.64c.09.45.13.94.13 1.45zM14.44 12.72l-2.08-1.2c-.77-.44-1.51-.5-2.09-.17-.58.33-.9 1.01-.9 1.89v2.4c0 .88.32 1.56.9 1.89.25.14.53.21.82.21.4 0 .83-.13 1.27-.38l2.08-1.2c.77-.44 1.19-1.06 1.19-1.73 0-.67-.43-1.26-1.19-1.71z"/>
                        ...
                        <span class="d-block font-weight-bold text-dark">2</span>
                        <span class="d-block font-14 text-gray-500 mt-4">Courses</span>
                    </div>
                </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M14.43 5.93L20.5 12l-6.07 6.07M3.5 12h16.83"/>
    ...
    <div class="swiper-slide">
        <a href="users/light-moon/profile.html" class="text-decoration-none d-block">
    <div class="organization-card position-relative ">
        <div class="organization-card__mask"></div>
        ...
        <div class="position-relative z-index-2 bg-white p-16 rounded-24">
            <div class="d-flex align-items-center p-12">
                <div class="position-relative size-64 rounded-circle bg-gray-100">
                    <img src="store/867/setting/avatar.jpg" alt="Light Moon" class="img-cover rounded-circle">

                                            <div class="organization-card__verified-badge d-flex-center rounded-circle size-16 p-2 bg-primary" data-tippy-content="Verified">
                            <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-white">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                        </div>
                ...
                <div class="ml-16">
                    <h6 class="font-16 text-dark">Light Moon</h6>
                    <div class="stars-card d-flex align-items-center ">
                    <span class="stars-card__item active">
                <svg width="14px" height="14px" class="icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
  ...
  <path d="M22 7.81v.05H2v-.05c0-.51.04-1 .13-1.45h5.64V2h1.5v4.36h5.46V2h1.5v4.36h5.64c.09.45.13.94.13 1.45zM14.44 12.72l-2.08-1.2c-.77-.44-1.51-.5-2.09-.17-.58.33-.9 1.01-.9 1.89v2.4c0 .88.32 1.56.9 1.89.25.14.53.21.82.21.4 0 .83-.13 1.27-.38l2.08-1.2c.77-.44 1.19-1.06 1.19-1.73 0-.67-.43-1.26-1.19-1.71z"/>
                        ...
                        <span class="d-block font-weight-bold text-dark">3</span>
                        <span class="d-block font-14 text-gray-500 mt-4">Courses</span>
                    </div>
                </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M14.43 5.93L20.5 12l-6.07 6.07M3.5 12h16.83"/>
    ...
    <div class="swiper-slide">
        <a href="users/techdecomposed/profile.html" class="text-decoration-none d-block">
    <div class="organization-card position-relative ">
        <div class="organization-card__mask"></div>
        ...
        <div class="position-relative z-index-2 bg-white p-16 rounded-24">
            <div class="d-flex align-items-center p-12">
                <div class="position-relative size-64 rounded-circle bg-gray-100">
                    <img src="store/868/setting/avatar.jpg" alt="Tech Decomposed" class="img-cover rounded-circle">

                                    </div>
                <div class="ml-16">
                    <h6 class="font-16 text-dark">Tech Decomposed</h6>
                                    </div>
            </div>
  ...
  <path d="M20.5 12.3l-.15.09a17.037 17.037 0 01-5.79 2.08c-.08.96-.5 2.06-2.69 2.06s-2.61-1.09-2.69-2.04c-1.91-.3-3.79-.93-5.5-1.88-.15-.08-.3-.16-.44-.25-.36-.2-.7-.42-1.03-.64-.02-.01-.04-.03-.05-.04l.61 6.51c.21 1.99 1.03 4.04 5.43 4.04h7.62c4.4 0 5.22-2.05 5.43-4.05l.63-6.78a.12.12 0 01-.05.05c-.43.31-.87.6-1.33.85z" opacity=".4"/>
                    ...
                    <div class="position-relative d-flex" style="height: 40px">
                        ...
                        <div class="meeting-booking-list-section position-relative" style="background-color: var(--primary); background-image: url(store/landing_builder/landing_13/408/meeting_booking_qfK.svg); ">
        <div class="container">
            <div class="d-flex-center flex-column text-center">
                    ...
                    <div class="col-12 col-lg-10">
                        <div class="meeting-booking-list-section__table-container w-100">
                            <table class="meeting-booking-list-section__meetings-table">
                                ...
                                <tr>
                                    <td width="22%"></td>
                                    <td class="text-center">Weekly Hours</td>
                                    <td class="text-center">Total meetings</td>
                                    <td class="text-center">Tutoring Hours</td>
                                    <td class="text-center">Earliest Available Time</td>
                                    <td class="text-center">Hourly Rate</td>
                                    <td></td>
                                </tr>
                                </thead>
                                    ...
                                    <tr>
                                        <td class="text-left">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ml-8">
                                                    <h5 class="font-16">Jessica Wray</h5>
                                    ...
                                    <tr>
                                        <td class="text-left">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ml-8">
                                                    <h5 class="font-16">Kate Williams</h5>
                                                    <div class="stars-card d-flex align-items-center mt-4">
                    <span class="stars-card__item active">
                <svg width="14px" height="14px" class="icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
                                    ...
                                    <tr>
                                        <td class="text-left">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ml-8">
                                                    <h5 class="font-16">Linda Anderson</h5>
                                                    <div class="stars-card d-flex align-items-center mt-4">
                    <span class="stars-card__item active">
                <svg width="14px" height="14px" class="icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
                                    ...
                                    <tr>
                                        <td class="text-left">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ml-8">
                                                    <h5 class="font-16">Robert Ransdell</h5>
                                                    <div class="stars-card d-flex align-items-center mt-4">
                    <span class="stars-card__item active">
                <svg width="14px" height="14px" class="icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
                                    ...
                                    <tr>
                                        <td class="text-left">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ml-8">
                                                    <h5 class="font-16">Ricardo Dave</h5>
                                                    <div class="stars-card d-flex align-items-center mt-4">
                    <span class="stars-card__item active">
                <svg width="14px" height="14px" class="icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M14.43 5.93L20.5 12l-6.07 6.07M3.5 12h16.83"/>
</svg>                                        <span class="btn-flip-effect__text">Instructor Finder</span>
                                    </a>
                                                            </div>

                            <div class="meeting-booking-list-section__cta-image d-flex-center">
                                                                    <img src="store/landing_builder/landing_13/408/meeting_booking_cta_yrt.png" alt="cta image" class="img-fluid">
                                                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="position-relative d-flex" style="height: 80px">
                        ...
                        <section class="jobs-board-section container p-0 position-relative">
  ...
  <path d="M20.5 12.3l-.15.09a17.037 17.037 0 01-5.79 2.08c-.08.96-.5 2.06-2.69 2.06s-2.61-1.09-2.69-2.04c-1.91-.3-3.79-.93-5.5-1.88-.15-.08-.3-.16-.44-.25-.36-.2-.7-.42-1.03-.64-.02-.01-.04-.03-.05-.04l.61 6.51c.21 1.99 1.03 4.04 5.43 4.04h7.62c4.4 0 5.22-2.05 5.43-4.05l.63-6.78a.12.12 0 01-.05.05c-.43.31-.87.6-1.33.85z" opacity=".4"/>
        ...
        <a href="jobs/backend-engineer.html" class="">
            <h3 class="font-16 mt-16 text-ellipsis text-dark">Backend Engineer</h3>
        </a>
        ...
        <a href="users/robert-ransdell/profile.html" class="d-flex align-items-center my-16 text-dark">
            ...
            <div class="ml-8">
                <h5 class="font-12 text-ellipsis">Robert Ransdell</h5>
            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center gap-4 font-12 text-gray-500">
                    ...
                    <span class="">Hybrid</span>
                            ...
                            <a href="jobs/backend-engineer.html" class="btn btn-primary gap-4">
  ...
  <path d="M12 12.26H9c-.41 0-.75.34-.75.75s.34.75.75.75h3c.41 0 .75-.34.75-.75s-.34-.75-.75-.75zM9 9.76h3c.41 0 .75-.34.75-.75s-.34-.75-.75-.75H9c-.41 0-.75.34-.75.75s.34.75.75.75zM5.97 8.01c-.56 0-1 .45-1 1s.45 1 1 1 1-.45 1-1-.45-1-1-1zM5.97 12.01c-.56 0-1 .45-1 1s.45 1 1 1 1-.45 1-1-.45-1-1-1z"/>
        ...
        <a href="jobs/ui-ux-designer.html" class="">
            <h3 class="font-16 mt-16 text-ellipsis text-dark">UI/UX Designer</h3>
        </a>
        ...
        <a href="users/linda-anderson/profile.html" class="d-flex align-items-center my-16 text-dark">
            ...
            <div class="ml-8">
                <h5 class="font-12 text-ellipsis">Linda Anderson</h5>
            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center gap-4 font-12 text-gray-500">
                    ...
                    <span class="">Remote</span>
                            ...
                            <a href="jobs/ui-ux-designer.html" class="btn btn-primary gap-4">
                    <span class="">Apply</span>
                    <svg width="16px" height="16px" class="icons" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M14.43 5.93L20.5 12l-6.07 6.07M3.5 12h16.83"/>
</svg>                </a>
  ...
  <path d="M20.5 12.3l-.15.09a17.037 17.037 0 01-5.79 2.08c-.08.96-.5 2.06-2.69 2.06s-2.61-1.09-2.69-2.04c-1.91-.3-3.79-.93-5.5-1.88-.15-.08-.3-.16-.44-.25-.36-.2-.7-.42-1.03-.64-.02-.01-.04-.03-.05-.04l.61 6.51c.21 1.99 1.03 4.04 5.43 4.04h7.62c4.4 0 5.22-2.05 5.43-4.05l.63-6.78a.12.12 0 01-.05.05c-.43.31-.87.6-1.33.85z" opacity=".4"/>
        ...
        <a href="jobs/data-scientist.html" class="">
            <h3 class="font-16 mt-16 text-ellipsis text-dark">Data Scientist</h3>
        </a>
        ...
        <a href="users/kate-williams/profile.html" class="d-flex align-items-center my-16 text-dark">
            ...
            <div class="ml-8">
                <h5 class="font-12 text-ellipsis">Kate Williams</h5>
  ...
  <path d="M20.5 12.3l-.15.09a17.037 17.037 0 01-5.79 2.08c-.08.96-.5 2.06-2.69 2.06s-2.61-1.09-2.69-2.04c-1.91-.3-3.79-.93-5.5-1.88-.15-.08-.3-.16-.44-.25-.36-.2-.7-.42-1.03-.64-.02-.01-.04-.03-.05-.04l.61 6.51c.21 1.99 1.03 4.04 5.43 4.04h7.62c4.4 0 5.22-2.05 5.43-4.05l.63-6.78a.12.12 0 01-.05.05c-.43.31-.87.6-1.33.85z" opacity=".4"/>
        ...
        <a href="jobs/marketing-manager.html" class="">
            <h3 class="font-16 mt-16 text-ellipsis text-dark">Marketing Manager</h3>
        </a>
        ...
        <a href="users/john-powe/profile.html" class="d-flex align-items-center my-16 text-dark">
            ...
            <div class="ml-8">
                <h5 class="font-12 text-ellipsis">John Powe</h5>
            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center gap-4 font-12 text-gray-500">
                    ...
                    <span class="">Hybrid</span>
                            ...
                            <a href="jobs/marketing-manager.html" class="btn btn-primary gap-4">
                    <span class="">Apply</span>
                    <svg width="16px" height="16px" class="icons" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M14.43 5.93L20.5 12l-6.07 6.07M3.5 12h16.83"/>
</svg>                </a>
  ...
  <path d="M20.5 12.3l-.15.09a17.037 17.037 0 01-5.79 2.08c-.08.96-.5 2.06-2.69 2.06s-2.61-1.09-2.69-2.04c-1.91-.3-3.79-.93-5.5-1.88-.15-.08-.3-.16-.44-.25-.36-.2-.7-.42-1.03-.64-.02-.01-.04-.03-.05-.04l.61 6.51c.21 1.99 1.03 4.04 5.43 4.04h7.62c4.4 0 5.22-2.05 5.43-4.05l.63-6.78a.12.12 0 01-.05.05c-.43.31-.87.6-1.33.85z" opacity=".4"/>
        ...
        <a href="jobs/product-manager.html" class="">
            <h3 class="font-16 mt-16 text-ellipsis text-dark">Product Manager</h3>
        </a>
        ...
        <a href="users/james-kong/profile.html" class="d-flex align-items-center my-16 text-dark">
            ...
            <div class="ml-8">
                <h5 class="font-12 text-ellipsis">James Kong</h5>
            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center gap-4 font-12 text-gray-500">
                    ...
                    <span class="">Remote</span>
                            ...
                            <a href="jobs/product-manager.html" class="btn btn-primary gap-4">
                    <span class="">Apply</span>
                    <svg width="16px" height="16px" class="icons" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M14.43 5.93L20.5 12l-6.07 6.07M3.5 12h16.83"/>
</svg>                </a>
  ...
  <path d="M15 16c-.56 0-1.01-.45-1.01-1s.45-1 1-1 1 .45 1 1-.44 1-.99 1zM9.01 10C8.45 10 8 9.55 8 9s.45-1 1-1 1 .45 1 1-.44 1-.99 1zM9 15.75c-.19 0-.38-.07-.53-.22a.755.755 0 010-1.06l6-6c.29-.29.77-.29 1.06 0 .29.29.29.77 0 1.06l-6 6c-.15.15-.34.22-.53.22z"/>
        ...
        <a href="jobs/sales-representative.html" class="">
            <h3 class="font-16 mt-16 text-ellipsis text-dark">Sales Representative</h3>
        </a>
        ...
        <a href="users/jessica-wray/profile.html" class="d-flex align-items-center my-16 text-dark">
            ...
            <div class="ml-8">
                <h5 class="font-12 text-ellipsis">Jessica Wray</h5>
            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center gap-4 font-12 text-gray-500">
                    ...
                    <span class="">On-site</span>
                            ...
                            <a href="jobs/sales-representative.html" class="btn btn-primary gap-4">
                    <span class="">Apply</span>
                    <svg width="16px" height="16px" class="icons" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M14.43 5.93L20.5 12l-6.07 6.07M3.5 12h16.83"/>
</svg>                </a>
  ...
  <path d="M20.5 12.3l-.15.09a17.037 17.037 0 01-5.79 2.08c-.08.96-.5 2.06-2.69 2.06s-2.61-1.09-2.69-2.04c-1.91-.3-3.79-.93-5.5-1.88-.15-.08-.3-.16-.44-.25-.36-.2-.7-.42-1.03-.64-.02-.01-.04-.03-.05-.04l.61 6.51c.21 1.99 1.03 4.04 5.43 4.04h7.62c4.4 0 5.22-2.05 5.43-4.05l.63-6.78a.12.12 0 01-.05.05c-.43.31-.87.6-1.33.85z" opacity=".4"/>
        ...
        <a href="jobs/hr-specialist.html" class="">
            <h3 class="font-16 mt-16 text-ellipsis text-dark">HR Specialist</h3>
        </a>
        ...
        <a href="users/affogato-media/profile.html" class="d-flex align-items-center my-16 text-dark">
            ...
            <div class="ml-8">
                <h5 class="font-12 text-ellipsis">Affogato Media</h5>
            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center gap-4 font-12 text-gray-500">
                    ...
                    <span class="">Hybrid</span>
                            ...
                            <a href="jobs/hr-specialist.html" class="btn btn-primary gap-4">
                    <span class="">Apply</span>
                    <svg width="16px" height="16px" class="icons" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M14.43 5.93L20.5 12l-6.07 6.07M3.5 12h16.83"/>
</svg>                </a>
  ...
  <path d="M21.09 6.98c-.85-.94-2.26-1.41-4.33-1.41h-.24v-.04c0-1.68 0-3.76-3.76-3.76h-1.52c-3.76 0-3.76 2.08-3.76 3.76v.04h-.24c-2.07 0-3.49.47-4.33 1.41-.99 1.11-.96 2.58-.86 3.59l.01.07.09 1.05c.01.01.03.02.05.03.34.22.67.44 1.03.64.14.09.29.17.44.25 1.13.62 2.34 1.11 3.58 1.45A4.755 4.755 0 0012 18.75c2.62 0 4.75-2.13 4.75-4.75v-.04c1.26-.38 2.47-.91 3.6-1.57.06-.03.1-.06.15-.09.46-.25.9-.54 1.32-.84.01-.01.03-.03.04-.05l.04-.36.05-.47c.01-.06.01-.11.02-.18.08-1 .06-2.38-.88-3.42zM8.91 5.53c0-1.7 0-2.34 2.33-2.34h1.52c2.33 0 2.33.64 2.33 2.34v.04H8.91v-.04zM12 17.25a3.25 3.25 0 01-3.22-2.84c-.02-.13-.03-.27-.03-.41 0-1.79 1.46-3.25 3.25-3.25s3.25 1.46 3.25 3.25c0 .12-.01.23-.02.34v.01a3.258 3.258 0 01-3.23 2.9z"/>
        ...
        <a href="jobs/content-writer.html" class="">
            <h3 class="font-16 mt-16 text-ellipsis text-dark">Content Writer</h3>
        </a>
            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center gap-4 font-12 text-gray-500">
                    ...
                    <span class="">Remote</span>
                            ...
                            <a href="jobs/content-writer.html" class="btn btn-primary gap-4">
                    <span class="">Apply</span>
                    <svg width="16px" height="16px" class="icons" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M14.43 5.93L20.5 12l-6.07 6.07M3.5 12h16.83"/>
</svg>                </a>
                        ...
                        <div class="d-flex flex-column flex-lg-row align-items-lg-center gap-4">
                                    ...
                                    <div class="d-flex-center flex-wrap gap-16 mt-16">
                                                                    ...
                                                                    <div class="jobs-board-section__circle-dot-separator"></div>
                                                                                                                                                <a href="jobs/ui-ux-designer.html" target="_blank" class="font-weight-bold text-gray-500">UI/UX Designer</a>

                                                                    <div class="jobs-board-section__circle-dot-separator"></div>
                                                                                                                                                <a href="jobs/marketing-manager.html" target="_blank" class="font-weight-bold text-gray-500">Marketing Management</a>
  ...
  <path d="M14 10.25H8c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h6c.41 0 .75.34.75.75s-.34.75-.75.75zM11 13.25H8c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h3c.41 0 .75.34.75.75s-.34.75-.75.75zM21.99 18.95c-.33-.61-1.03-.95-1.97-.95-.71 0-1.32.29-1.68.79-.36.5-.44 1.17-.22 1.84.43 1.3 1.18 1.59 1.59 1.64.06.01.12.01.19.01.44 0 1.12-.19 1.78-1.18.53-.77.63-1.54.31-2.15z"/>
    ...
    <div class="position-relative z-index-2 d-flex flex-column bg-white p-12 rounded-24 w-100 h-100">
        <div class="sliding-testimonial-card__comment font-16 p-12 rounded-16 border-gray-100 text-gray-500 mb-12">I signed up for this platform last year, and it’s been an amazing journey of learning and growth. The instructors are very knowledgeable, the course material is up to date, and the quizzes and assignments really help reinforce what you learn. I love how flexible it is; I can study whenever I want. I’ve already completed four courses and can’t wait to enroll in more. Highly recommend this site for anyone serious ...</div>

        <div class="d-flex align-items-center justify-content-between p-4 mt-auto">
            <div class="d-flex align-items-center">
                <div class="size-48 rounded-circle bg-gray-100">
                    <img src="store/1/default_images/testimonials/Group%202043.png" alt="Sarah Mitchell" class="img-cover rounded-circle">
                </div>
                <div class="ml-8">
                    <h5 class="font-16 text-dark">Sarah Mitchell</h5>
                    <p class="mt-2 font-14 text-gray-500">Graphic Designer</p>
                </div>
            </div>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
    ...
    <div class="sliding-testimonial-card-mask"></div>
    <div class="position-relative z-index-2 d-flex flex-column bg-white p-12 rounded-24 w-100 h-100">
        <div class="sliding-testimonial-card__comment font-16 p-12 rounded-16 border-gray-100 text-gray-500 mb-12">Before joining, I was hesitant about online learning. But this platform completely changed my perspective. The video lectures are clear, engaging, and easy to follow. I really appreciate the discussion forums too, where I can ask questions and get help quickly. The certificates have helped me boost my resume, and my confidence has grown a lot. I feel more prepared for new job opportunities now. If you’re considering ...</div>

        <div class="d-flex align-items-center justify-content-between p-4 mt-auto">
            <div class="d-flex align-items-center">
                <div class="size-48 rounded-circle bg-gray-100">
                    <img src="store/1/default_images/testimonials/Group%202038.png" alt="James Carter" class="img-cover rounded-circle">
                </div>
                <div class="ml-8">
                    <h5 class="font-16 text-dark">James Carter</h5>
                    <p class="mt-2 font-14 text-gray-500">Freelance Videographer</p>
                </div>
            </div>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
    ...
    <div class="sliding-testimonial-card-mask"></div>
    <div class="position-relative z-index-2 d-flex flex-column bg-white p-12 rounded-24 w-100 h-100">
        <div class="sliding-testimonial-card__comment font-16 p-12 rounded-16 border-gray-100 text-gray-500 mb-12">As someone with a busy schedule, I needed a flexible learning solution. This platform was exactly what I was looking for. The instructors break down complex topics into manageable lessons, and I can track my progress easily. I especially love the mobile app that lets me learn on the go. I’ve already recommended this site to my friends and colleagues. It’s a smart investment for anyone who wants to keep up with ...</div>

        <div class="d-flex align-items-center justify-content-between p-4 mt-auto">
            <div class="d-flex align-items-center">
                <div class="size-48 rounded-circle bg-gray-100">
                    <img src="store/1/default_images/testimonials/Group%202044.png" alt="Emily Ross" class="img-cover rounded-circle">
                </div>
                <div class="ml-8">
                    <h5 class="font-16 text-dark">Emily Ross</h5>
                    <p class="mt-2 font-14 text-gray-500">Social Media Manager</p>
                </div>
            </div>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
    ...
    <div class="sliding-testimonial-card-mask"></div>
    <div class="position-relative z-index-2 d-flex flex-column bg-white p-12 rounded-24 w-100 h-100">
        <div class="sliding-testimonial-card__comment font-16 p-12 rounded-16 border-gray-100 text-gray-500 mb-12">Taking courses here has been one of my best decisions. The wide variety of subjects means I always find something that fits my interests and career goals. The quizzes and assignments challenge me to apply what I’ve learned, which makes a huge difference. I’ve also interacted with some amazing instructors who genuinely care about their students’ success. If you want to stay ahead in today’s competitive world, I ...</div>

        <div class="d-flex align-items-center justify-content-between p-4 mt-auto">
            <div class="d-flex align-items-center">
                <div class="size-48 rounded-circle bg-gray-100">
                    <img src="store/1/default_images/testimonials/Group%202040.png" alt="Daniel Kim" class="img-cover rounded-circle">
                </div>
                <div class="ml-8">
                    <h5 class="font-16 text-dark">Daniel Kim</h5>
                    <p class="mt-2 font-14 text-gray-500">Architecture Student</p>
                </div>
            </div>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
    ...
    <div class="sliding-testimonial-card-mask"></div>
    <div class="position-relative z-index-2 d-flex flex-column bg-white p-12 rounded-24 w-100 h-100">
        <div class="sliding-testimonial-card__comment font-16 p-12 rounded-16 border-gray-100 text-gray-500 mb-12">I’ve always believed in continuous learning, and this site makes it incredibly easy and accessible. The course bundles offer great value for money, and the discounts during promotions are unbeatable. I enjoy the practical projects included in many courses because they help build a solid portfolio. Plus, earning certificates feels rewarding and keeps me motivated. The customer support is responsive and helpful whenever ...</div>

        <div class="d-flex align-items-center justify-content-between p-4 mt-auto">
            <div class="d-flex align-items-center">
                <div class="size-48 rounded-circle bg-gray-100">
                    <img src="store/1/default_images/testimonials/Group%202049.png" alt="Olivia Bennett" class="img-cover rounded-circle">
                </div>
                <div class="ml-8">
                    <h5 class="font-16 text-dark">Olivia Bennett</h5>
                    <p class="mt-2 font-14 text-gray-500">Event Planner</p>
                </div>
            </div>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
    ...
    <div class="sliding-testimonial-card-mask"></div>
    <div class="position-relative z-index-2 d-flex flex-column bg-white p-12 rounded-24 w-100 h-100">
        <div class="sliding-testimonial-card__comment font-16 p-12 rounded-16 border-gray-100 text-gray-500 mb-12">Learning new skills felt intimidating before, but the supportive community here made a big difference for me. The instructors are approachable and explain concepts in an easy-to-understand way. I appreciate the interactive quizzes, assignments, and real-world projects that push me to practice. The flexible deadlines make it stress-free to learn at my own pace. I’ve even found mentors through the platform who’ve ...</div>

        <div class="d-flex align-items-center justify-content-between p-4 mt-auto">
            <div class="d-flex align-items-center">
                <div class="size-48 rounded-circle bg-gray-100">
                    <img src="store/1/default_images/testimonials/Group%202045.png" alt="Michael Alvarez" class="img-cover rounded-circle">
                </div>
                <div class="ml-8">
                    <h5 class="font-16 text-dark">Michael Alvarez</h5>
                    <p class="mt-2 font-14 text-gray-500">Industrial Engineer</p>
                </div>
            </div>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
    ...
    <div class="sliding-testimonial-card-mask"></div>
    <div class="position-relative z-index-2 d-flex flex-column bg-white p-12 rounded-24 w-100 h-100">
        <div class="sliding-testimonial-card__comment font-16 p-12 rounded-16 border-gray-100 text-gray-500 mb-12">This course marketplace has completely changed my professional life. I wanted to switch careers and needed practical skills fast. The UI/UX design path was exactly what I needed. The step-by-step lessons, downloadable resources, and active discussion boards kept me engaged. Within months, I felt confident enough to take on freelance projects. The certificates I earned really added value to my profile. If you’re serious ...</div>

        <div class="d-flex align-items-center justify-content-between p-4 mt-auto">
            <div class="d-flex align-items-center">
                <div class="size-48 rounded-circle bg-gray-100">
                    <img src="store/1/default_images/testimonials/Group%202051.png" alt="Chloe Martin" class="img-cover rounded-circle">
                </div>
                <div class="ml-8">
                    <h5 class="font-16 text-dark">Chloe Martin</h5>
                    <p class="mt-2 font-14 text-gray-500">Blogger &amp; Content Creator</p>
                </div>
            </div>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
    ...
    <div class="sliding-testimonial-card-mask"></div>
    <div class="position-relative z-index-2 d-flex flex-column bg-white p-12 rounded-24 w-100 h-100">
        <div class="sliding-testimonial-card__comment font-16 p-12 rounded-16 border-gray-100 text-gray-500 mb-12">Enrolling in courses here has been an eye-opening experience. I love that I can access thousands of high-quality lessons from experts around the world. The variety of topics is impressive — from programming to marketing, it’s all here. I also appreciate the lifetime access, so I can revisit content anytime I need a refresher. It’s a great investment for anyone wanting to grow their career, explore new fields, or ...</div>

        <div class="d-flex align-items-center justify-content-between p-4 mt-auto">
            <div class="d-flex align-items-center">
                <div class="size-48 rounded-circle bg-gray-100">
                    <img src="store/1/default_images/testimonials/Group%202046.png" alt="Rohan Kumar" class="img-cover rounded-circle">
                </div>
                <div class="ml-8">
                    <h5 class="font-16 text-dark">Rohan Kumar</h5>
                    <p class="mt-2 font-14 text-gray-500">Marketing Executive</p>
                </div>
            </div>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
    ...
    <div class="sliding-testimonial-card-mask"></div>
    <div class="position-relative z-index-2 d-flex flex-column bg-white p-12 rounded-24 w-100 h-100">
        <div class="sliding-testimonial-card__comment font-16 p-12 rounded-16 border-gray-100 text-gray-500 mb-12">I discovered this platform when I needed help advancing my tech skills. What surprised me most was how interactive and engaging the lessons are. The quizzes and hands-on projects really help solidify what you learn. I also appreciate the clear structure and easy navigation. It feels like having a personal coach guiding me step by step. I’ve already landed a better job because of what I learned here. I’ll definitely ...</div>

        <div class="d-flex align-items-center justify-content-between p-4 mt-auto">
            <div class="d-flex align-items-center">
                <div class="size-48 rounded-circle bg-gray-100">
                    <img src="store/1/default_images/testimonials/Group%202052.png" alt="Jessica Patel" class="img-cover rounded-circle">
                </div>
                <div class="ml-8">
                    <h5 class="font-16 text-dark">Jessica Patel</h5>
                    <p class="mt-2 font-14 text-gray-500">Travel Influencer</p>
                </div>
            </div>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
    ...
    <div class="sliding-testimonial-card-mask"></div>
    <div class="position-relative z-index-2 d-flex flex-column bg-white p-12 rounded-24 w-100 h-100">
        <div class="sliding-testimonial-card__comment font-16 p-12 rounded-16 border-gray-100 text-gray-500 mb-12">This online learning marketplace has everything I need to keep growing my knowledge. The instructors are industry experts who share valuable insights and practical tips. I especially love the certificates, which I’ve added to my LinkedIn profile and resume. They really stand out to employers. The course bundles make it affordable to learn multiple topics at once. I feel more confident tackling new challenges at work ...</div>

        <div class="d-flex align-items-center justify-content-between p-4 mt-auto">
            <div class="d-flex align-items-center">
                <div class="size-48 rounded-circle bg-gray-100">
                    <img src="store/1/default_images/testimonials/Group%202053.png" alt="Ahmed Al-Maktoum" class="img-cover rounded-circle">
                </div>
                <div class="ml-8">
                    <h5 class="font-16 text-dark">Ahmed Al-Maktoum</h5>
                    <p class="mt-2 font-14 text-gray-500">Product Photographer</p>
                </div>
            </div>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
</svg>                                                            <svg width="16px" height="16px" class="icons text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
</svg>                                                            <svg width="16px" height="16px" class="icons text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
</svg>                                                            <svg width="16px" height="16px" class="icons text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
                    ...
                    <div class="blog-section position-relative"  style="background-image: url(store/landing_builder/landing_1/13/blog_background_e5l.png)" >
    ...
    <div class="blog-section__post-card position-relative rounded-24 one-large-col">
        <div class="position-relative h-100">
            <img src="store/1/default_images/blogs/blog5.jpg" alt="How to Set Freelance Rates and Negotiate with Confidence" class="blog-section__post-card-img img-cover rounded-24">
        </div>

        <div class="blog-section__post-card-footer p-16">
            <div class="d-flex flex-column justify-content-end w-100 h-100">
                <h3 class="font-16 text-white">How to Set Freelance Rates and Negotiate with Confidence</h3>
                ...
                <div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-lg-between mt-12">
                    <div class="d-flex align-items-center">
                        <div class="size-36 rounded-circle bg-gray-100">
                            <img src="store/1/default_images/testimonials/staff1.jpg" alt="" class="img-cover rounded-circle">
                        </div>
                        <div class="ml-4">
                            <h5 class="font-14 text-white">George Hamilton</h5>
                            <p class="font-12 text-white mt-2">in Articles</p>
                        </div>
                    </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8 2v3M16 2v3M3.5 9.09h17M21 8.5V17c0 3-1.5 5-5 5H8c-3.5 0-5-2-5-5V8.5c0-3 1.5-5 5-5h8c3.5 0 5 2 5 5z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
</svg>                                <span class="ml-4 font-14 text-white">30 Jun 2021</span>
                            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M22 12c0 5.52-4.48 10-10 10S2 17.52 2 12 6.48 2 12 2s10 4.48 10 10z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
</svg>                                <span class="ml-4 font-14 text-white"></span>
                            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.996 11h.01M11.995 11h.01M7.995 11h.008"/>
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="row">
                                    ...
                                    <a href="blog/How-To-Teach-Your-Kid-Anything-Easily-2.html" class="text-decoration-none d-block">
    <div class="blog-section__post-card position-relative rounded-24 four-small-col">
        <div class="position-relative h-100">
            <img src="store/1/default_images/blogs/blog4.jpg" alt="Mastering Client Communication to Build Long-Term Freelance" class="blog-section__post-card-img img-cover rounded-24">
        </div>

        <div class="blog-section__post-card-footer p-16">
            <div class="d-flex flex-column justify-content-end w-100 h-100">
                <h3 class="font-16 text-white">Mastering Client Communication to Build Long-Term Freelance</h3>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="font-12 text-white mt-2">in Articles</p>
                                                            ...
                                                            <div class="col-6 mt-24">
                                    <a href="blog/How-To-Teach-Your-Kid-Anything-Easily.html" class="text-decoration-none d-block">
    <div class="blog-section__post-card position-relative rounded-24 four-small-col">
        <div class="position-relative h-100">
            <img src="store/1/default_images/blogs/blog3.jpg" alt="Freelancing vs. Full-Time: Which Career Path Suits You Best?" class="blog-section__post-card-img img-cover rounded-24">
        </div>

        <div class="blog-section__post-card-footer p-16">
            <div class="d-flex flex-column justify-content-end w-100 h-100">
                <h3 class="font-16 text-white">Freelancing vs. Full-Time: Which Career Path Suits You Best?</h3>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="font-12 text-white mt-2">in Articles</p>
                                                            ...
                                                            <div class="col-6 mt-24">
                                    <a href="blog/Better-Relationship-Between-You-and-Your-Student-s-Parent.html" class="text-decoration-none d-block">
    <div class="blog-section__post-card position-relative rounded-24 four-small-col">
        <div class="position-relative h-100">
            <img src="store/1/default_images/blogs/blog2.jpg" alt="Top Tools Every Successful Freelancer Uses to Stay Productive" class="blog-section__post-card-img img-cover rounded-24">
        </div>

        <div class="blog-section__post-card-footer p-16">
            <div class="d-flex flex-column justify-content-end w-100 h-100">
                <h3 class="font-16 text-white">Top Tools Every Successful Freelancer Uses to Stay Productive</h3>
                ...
                <div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-lg-between mt-12">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ml-4">
                            <h5 class="font-14 text-white">George Hamilton</h5>
                            <p class="font-12 text-white mt-2">in News</p>
                        </div>
                    </div>
                                                            ...
                                                            <div class="col-6 mt-24">
                                    <a href="blog/3-Laws-to-Become-a-Straight-A-Student.html" class="text-decoration-none d-block">
    <div class="blog-section__post-card position-relative rounded-24 four-small-col">
        <div class="position-relative h-100">
            <img src="store/1/default_images/blogs/blog1.jpg" alt="How to Start Freelancing with No Experience or Clients Today" class="blog-section__post-card-img img-cover rounded-24">
        </div>

        <div class="blog-section__post-card-footer p-16">
            <div class="d-flex flex-column justify-content-end w-100 h-100">
                <h3 class="font-16 text-white">How to Start Freelancing with No Experience or Clients Today</h3>

                <div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-lg-between mt-12">
                    <div class="d-flex align-items-center">
                        <div class="size-36 rounded-circle bg-gray-100">
                            <img src="store/1/default_images/admin-avatar.jpg" alt="" class="img-cover rounded-circle">
                        </div>
                        <div class="ml-4">
                            <h5 class="font-14 text-white">Admin</h5>
                            <p class="font-12 text-white mt-2">in Events</p>
                        </div>
                    </div>
