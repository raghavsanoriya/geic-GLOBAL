    ...
    <section class="sp-hero">
        <div class="sp-wrap">
            <div class="sp-hero__shell">
                <img class="sp-hero__image" src="{{ asset('assets/transglobe/destinations/australia-detail-hero.jpg') }}" alt="Students exploring overseas education opportunities" fetchpriority="high" width="1600" height="900">
                ...
                <div class="sp-hero__content"><span class="sp-hero__pill">Trans Globe Indore scholarships</span><h1>Fund your future, <span>without the guesswork.</span></h1><p>Studying abroad does not have to feel out of reach. Discover scholarship opportunities that match your profile, then apply with a clear, well-prepared plan.</p><div class="sp-hero__actions"><a href="{{ url('/#contact') }}" class="sp-button">Get free scholarship counselling <span aria-hidden="true">→</span></a><a href="#destinations" class="sp-button sp-button--ghost">Explore destinations</a></div></div>
            </div>
