...
<!-- Mirrored from lms.rocket-soft.org/instructor-finder/wizard by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:36:06 GMT -->
...
<meta name='robots' content="NOODP, nofollow, noindex">
    ...
    <meta name="description" content="Tutor Finder Wizard Description">
    <meta property="og:description" content="Tutor Finder Wizard Description">
    <meta name='twitter:description' content='Tutor Finder Wizard Description'>
...
<!-- Open Graph -->
<meta property='og:title' content='Instructor finder wizard'>
<meta name='twitter:card' content='summary'>
<meta name='twitter:title' content='Instructor finder wizard'>
...
<meta property='og:type' content='website'>
    ...
    <title>Instructor finder wizard | Rocket LMS</title>
    ...
    <link rel="stylesheet" href="https://lms.rocket-soft.org/assets/design_1/css/app.min.css">
        ...
        <link rel="stylesheet" href="https://lms.rocket-soft.org/assets/vendors/leaflet/leaflet.css">
    <link rel="stylesheet" href="https://lms.rocket-soft.org/assets/design_1/css/parts/instructor_finder.min.css">
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-lg-8">
                ...
                <div class="d-flex-center flex-column text-center">
                    <h1 class="font-32 font-weight-bold">Tutor Finder</h1>
                    <p class="mt-8 font-16 text-gray-500">Easily find instructors based on various criteria.</p>
                </div>

                <form id="instructorFinderWizardForm" action="https://lms.rocket-soft.org/instructor-finder/wizard?" method="get">
    ...
    <div class="d-inline-flex-center py-4 px-8 bg-gray-100 rounded-32 text-gray-500">Step 1/4</div>
    <h3 class="mt-8 font-24 font-weight-bold">Tutoring Subject 🎓</h3>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M5.63 13.08l-.01 4.69c0 1.27.98 2.63 2.18 3.03l3.19 1.06c.55.18 1.46.18 2.02 0l3.19-1.06c1.2-.4 2.18-1.76 2.18-3.03v-4.64M21.4 15V9"/>
    ...
    <div class="mt-32 text-gray-500">Which meeting type do you prefer?</div>
        ...
        <select name="category_id" class="form-control select2 ">
            <option value="">Select a Category</option>
                                    ...
                                    <div class="mt-16 d-flex align-items-center gap-12">
                                        ...
                                        <button type="button" class="js-next-btn btn btn-primary btn-lg ml-10">Next</button>
                                    </div>
                            ...
                            <div class="col-12 col-md-6 mt-24 mt-md-0">
                                ...
                                <div class="instructor-finder-wizard__images-card bg-gray-100 rounded-16">
                                                                            <img src="https://lms.rocket-soft.org/store/1/default_images/tutor_finder/tutorfinder_step1_background.jpg" alt="Main Image" class="img-cover rounded-16">
                                    
                                                                            <div class="wizard-overlay-image d-flex-center">
                                            <img src="https://lms.rocket-soft.org/store/1/default_images/tutor_finder/tutorfinder_step1_overlay.png" alt="Overlay Image" class="img-fluid">
                                        </div>
                                                                    </div>
...
<script defer src="https://lms.rocket-soft.org/assets/design_1/js/parts/content_delete.min.js"></script>
    ...
    <script src="https://lms.rocket-soft.org/assets/vendors/leaflet/leaflet.min.js"></script>
    <script src="https://lms.rocket-soft.org/assets/design_1/js/parts/leaflet_map.min.js"></script>
    <script src="https://lms.rocket-soft.org/assets/design_1/js/parts/get_regions.min.js"></script>
    <script src="https://lms.rocket-soft.org/assets/design_1/js/parts/range_slider_helpers.min.js"></script>

    <script src="https://lms.rocket-soft.org/assets/design_1/js/parts/instructor_finder_wizard.min.js"></script>
...
<!-- Mirrored from lms.rocket-soft.org/instructor-finder/wizard by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:36:07 GMT -->
</html>
