...
<!-- Mirrored from lms.rocket-soft.org/upcoming_courses/Digital-Photography by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:33:58 GMT -->
...
<meta name='robots' content="index, follow, all">
    ...
    <meta name="description" content="Learn how to take stunning photographs by mastering both the technical and creative sides of digital photography.">
    <meta property="og:description" content="Learn how to take stunning photographs by mastering both the technical and creative sides of digital photography.">
    <meta name='twitter:description' content='Learn how to take stunning photographs by mastering both the technical and creative sides of digital photography.'>
...
<meta property='og:type' content='website'>
    ...
    <title>Digital Photography | Rocket LMS</title>
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
    ...
    <img src="../store/1016/1_c.jpg" class="course-hero__cover-img img-cover rounded-32" alt="Digital Photography"/>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
        ...
        <div class="d-flex align-items-center flex-wrap gap-12 mt-4">
            <h1 class="course-hero__title font-32 font-weight-bold text-white text-ellipsis">Digital Photography</h1>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12.16 10.87c-.1-.01-.22-.01-.33 0a4.42 4.42 0 01-4.27-4.43C7.56 3.99 9.54 2 12 2a4.435 4.435 0 01.16 8.87zM7.16 14.56c-2.42 1.62-2.42 4.26 0 5.87 2.75 1.84 7.26 1.84 10.01 0 2.42-1.62 2.42-4.26 0-5.87-2.74-1.83-7.25-1.83-10.01 0z"/>
                ...
                <a href="../users/ricardo-dave/profile" target="_blank" class="text-white font-14 font-weight-bold">Ricardo Dave</a>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.06 19.39c-.62.42-1.4.77-2.35 1.08l-1.58.52c-3.97 1.28-6.06.21-7.35-3.76L2.5 13.28c-1.28-3.97-.22-6.07 3.75-7.35l1.58-.52c.41-.13.8-.24 1.17-.31-.3.61-.54 1.35-.74 2.2l-.98 4.19c-.98 4.18.31 6.24 4.48 7.23l1.68.4c.58.14 1.12.23 1.62.27zM12.64 8.53l4.85 1.23M11.66 12.4l2.9.74"/>
</svg>                    <span class="mx-4 font-weight-bold">70</span>
                ...
                <div class="ml-8">
                    <span class="d-block font-14 font-weight-bold text-white">3 Users</span>
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">How to hold your camera correctly, which helps you to get sharp photos every time.</span>
                        </div>
                                            <div class="d-flex align-items-center p-16 rounded-8 bg-white">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Which lenses to use for which photos, so that you can best capture a specific subject or scene.</span>
                        </div>
                                            <div class="d-flex align-items-center p-16 rounded-8 bg-white">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">Why and when you should support your camera on tripods and bean bags.</span>
                        </div>
                                            <div class="d-flex align-items-center p-16 rounded-8 bg-white">
                            <div class="size-16">
                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" fill="none" width="16px" height="16px" class="icons text-primary">
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">How to take photos in diffused light on overcast days.</span>
                        </div>
                                    </div>
            </div>
        </div>
            ...
            <div class="course-description mt-12 text-gray-500 line-height-1-5">
                <p>This course is divided into two broad components: first, we cover all the technical aspects, like camera equipment and support, as well as the camera's most important settings. After that we look at the artistic side of photography, which focuses on light, composition, and creativity.</p><p><br></p><p>It has been structured in such a way that you won't ever feel overwhelmed by technical jargon, complicated camera functions or obscure principles. The aim is to keep everything as clear and simple as possible, and this was achieved by tackling each important photographic element separately in short and concise lectures that last between 2 and 5 minutes each. The majority of lectures consist of both teacher-style video clips (where I explain a setting, principle or tip) and slides, both of which contain photographic examples and audio (where I interpret each photographic example).</p>
            </div>
        </div>
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">You need a Canon or Nikon DSLR camera (the kind that has interchangable lenses) - any model will do.</span>
                        </div>
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="flex-1 ml-4 font-14 text-gray-500">You don&#039;t need any prior photographic experience.</span>
                        </div>
                                    </div>
...
<div class="js-reply-to-comment-html d-none">
  ...
  <path d="M12 2C6.49 2 2 6.49 2 12s4.49 10 10 10 10-4.49 10-10S17.51 2 12 2zm-.75 6c0-.41.34-.75.75-.75s.75.34.75.75v5c0 .41-.34.75-.75.75s-.75-.34-.75-.75V8zm1.67 8.38c-.05.13-.12.23-.21.33-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08s-.26-.03-.38-.08-.23-.12-.33-.21c-.09-.1-.16-.2-.21-.33A.995.995 0 0111 16c0-.13.03-.26.08-.38s.12-.23.21-.33c.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.09.1.16.21.21.33.05.12.08.25.08.38s-.03.26-.08.38z"/>
    ...
    <div class="position-relative bg-white rounded-24 pb-24 z-index-2">
        ...
        <div class="course-right-side__thumbnail position-relative bg-gray-200">
            <img src="../store/1/default_images/upcoming/upcoming3.jpg" class="img-cover" alt="Digital Photography">

                    </div>

        <div class="px-16 mt-16">
                                                <a href="../login.html" class="btn btn-lg btn-primary btn-block">Follow Course</a>
                                    </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M22 12.86c0 2.29-1.18 4.32-3 5.6l-1.34 2.95c-.31.67-1.21.8-1.68.23l-1.48-1.78c-2.42 0-4.58-1.07-5.93-2.74L9.5 16c4.14 0 7.5-3.13 7.5-7 0-1.05-.25-2.04-.7-2.93 3.27.75 5.7 3.51 5.7 6.79zM7 9h5"/>
            ...
            <div class="d-flex align-items-center justify-content-around mt-16 p-12 rounded-12 border-dashed border-gray-200">
                                    <a href="https://calendar.google.com/calendar/render?action=TEMPLATE&amp;dates=20240120T160000/20240120T160000&amp;ctz=UTC&amp;text=Digital+Photography" target="_blank" class="d-flex-center flex-column text-gray-500 font-12">
                        <svg width="20px" height="20px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12.62 20.81c-.34.12-.9.12-1.24 0C8.48 19.82 2 15.69 2 8.69 2 5.6 4.49 3.1 7.56 3.1c1.82 0 3.43.88 4.44 2.24a5.53 5.53 0 014.44-2.24C19.51 3.1 22 5.6 22 8.69c0 7-6.48 11.13-9.38 12.12z"/>
                ...
                <div class="js-share-course d-flex-center flex-column text-gray-500 font-12 cursor-pointer" data-path="/upcoming_courses/Digital-Photography/share-modal">
                    <svg width="20px" height="20px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16.96 6.17c2 1.39 3.38 3.6 3.66 6.15M3.49 12.37a8.601 8.601 0 013.6-6.15M8.19 20.94c1.16.59 2.48.92 3.87.92 1.34 0 2.6-.3 3.73-.85M12.06 7.7a2.78 2.78 0 100-5.56 2.78 2.78 0 000 5.56zM4.83 19.92a2.78 2.78 0 100-5.56 2.78 2.78 0 000 5.56zM19.17 19.92a2.78 2.78 0 100-5.56 2.78 2.78 0 000 5.56z"/>
            ...
            <div class="mt-24 text-center">
                <button type="button" class="js-report-course font-12 text-gray-500 btn-transparent" data-path="/upcoming_courses/Digital-Photography/report-modal">Report Content</button>
            </div>
...
<div class="course-right-side-section position-relative mt-28">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 22h6c5 0 7-2 7-7V9c0-5-2-7-7-7H9C4 2 2 4 2 9v6c0 5 2 7 7 7z"/>
            ...
            <div class="upcoming-right-side-progress d-flex rounded-4 bg-gray-100 mt-12">
                <span class="h-100 rounded-4 bg-success " style="width: 50%"></span>
            </div>
    ...
    <div class="course-right-side-section position-relative mt-28">
        ...
        <div class="position-relative card-before-line bg-white rounded-24 p-16 z-index-2">
            ...
            <div class="d-flex gap-12 flex-wrap mt-16">
                                    <a href="../tags/upcoming-courses/Photography.html" target="_blank" class="d-flex-center p-10 rounded-8 bg-gray-100 font-12 text-gray-500 text-center">Photography</a>
                                    <a href="../tags/upcoming-courses/Digital%2bPhotography.html" target="_blank" class="d-flex-center p-10 rounded-8 bg-gray-100 font-12 text-gray-500 text-center">Digital Photography</a>
                            </div>
        </div>
    </div>
    ...
    <div class="container d-flex flex-column flex-lg-row align-items-lg-center justify-content-lg-between h-100">
        <div class="d-flex align-items-center mb-16 mb-lg-0">
            <div class="course-bottom-fixed-card__course-img rounded-8">
                <img src="../store/1/default_images/upcoming/upcoming3.jpg" class="img-cover rounded-8" alt="Digital Photography">
            </div>
            <div class="ml-8">
                <div class="font-12 text-gray-500">You are viewing</div>
                <div class="mt-4 font-14 font-weight-bold">Digital Photography</div>
            </div>
        </div>

                                    <a href="../login.html" class="btn btn-lg btn-primary">Follow Course</a>
...
<!-- Mirrored from lms.rocket-soft.org/upcoming_courses/Digital-Photography by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:34:10 GMT -->
</html>
