...
<meta name='robots' content="index, follow, all">
    ...
    <meta name="description" content="Tutor Finder Description">
    <meta property="og:description" content="Tutor Finder Description">
    <meta name='twitter:description' content='Tutor Finder Description'>
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
                    ...
                    <div class="ml-8">
                        <h1 class="font-24 font-weight-bold">Instructors</h1>
                        <p class="mt-4 font-12 text-gray-500">Explore instructor profiles and book your sessions.</p>
                    </div>
                </div>
    ...
    <div class="d-flex flex-wrap align-items-center gap-20 gap-lg-48 px-12 py-10">
        ...
        <div class="form-group d-flex align-items-center mb-0">
            <div class="custom-switch mr-8">
                <input id="available_for_meetings" type="checkbox" name="available_for_meetings" class="custom-control-input" >
                <label class="custom-control-label cursor-pointer" for="available_for_meetings"></label>
            </div>

            <div class="">
                <label class="cursor-pointer" for="available_for_meetings">Available for Meetings</label>
            </div>
        </div>
        ...
        <div class="form-group d-flex align-items-center mb-0">
            <div class="custom-switch mr-8">
                <input id="free_meetings" type="checkbox" name="free_meetings" class="custom-control-input" >
                <label class="custom-control-label cursor-pointer" for="free_meetings"></label>
            </div>

            <div class="">
                <label class="cursor-pointer" for="free_meetings">Free Meetings</label>
            </div>
        </div>

        <div class="form-group d-flex align-items-center mb-0">
            <div class="custom-switch mr-8">
                <input id="discount" type="checkbox" name="discount" class="custom-control-input" >
                <label class="custom-control-label cursor-pointer" for="discount"></label>
            </div>

            <div class="">
                <label class="cursor-pointer" for="discount">Discount</label>
            </div>
        </div>
    ...
    <a href="users/ricardo-dave/profile" class="text-decoration-none d-flex flex-column flex-1 h-100" target="_blank">
        <div class="d-flex align-items-center justify-content-between mb-16">
            <div class="d-flex align-items-center">
                ...
                <div class="ml-8">
                    <h6 class="font-16 font-weight-bold text-dark">Ricardo Dave</h6>
                    <p class="mt-4 font-14 text-gray-500">Data Analyst at Microsoft</p>
                </div>
            </div>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
        ...
        <div class="mb-16 font-14 text-gray-500">Ricardo dave has a BS and MS in Mechanical Engineering from Santa Clara University and years of experience as a professional instructor and trainer for Data Science and programming. He has publications and patents in various fields such as microfluidics, materials science, and data science technologies. Over the course of his career he has developed a skill set in analyzing ...</div>

                    <div class="d-flex align-items-center flex-wrap gap-12 mb-16">
                                                            <div class="d-flex-center p-10 rounded-8 bg-gray-100 text-center font-14 text-gray-500">Design</div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
                ...
                <div class="ml-8">
                    <div class="font-12 text-gray-400">Member Since</div>
                    <div class="font-14 font-weight-bold text-gray-500">27 Jun 2021</div>
                </div>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M9.75 14.45v-1.2c0-1.54 1.09-2.17 2.42-1.4l1.04.6 1.04.6c1.33.77 1.33 2.03 0 2.8l-1.04.6-1.04.6c-1.33.77-2.42.14-2.42-1.4v-1.2 0z"/>
                ...
                <div class="ml-8">
                    <div class="font-12 text-gray-400">Courses</div>
                    <div class="font-14 font-weight-bold text-gray-500">2</div>
                </div>
            </div>
            ...
            <div class="d-flex align-items-center">
                <div class="d-flex-center size-40 rounded-circle bg-gray-100">
                    <svg width="20px" height="20px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M20 12.2v1.7c0 3.15-1.8 4.5-4.5 4.5h-9c-2.7 0-4.5-1.35-4.5-4.5V8.5C2 5.35 3.8 4 6.5 4h2.7c-.13.38-.2.8-.2 1.25v3.9c0 .97.32 1.79.89 2.36.57.57 1.39.89 2.36.89v1.39c0 .51.58.82 1.01.54l2.89-1.93h2.6c.45 0 .87-.07 1.25-.2z"/>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M18.495 7.25h.01M15.696 7.25h.009M12.895 7.25h.01"/>
                ...
                <div class="ml-8">
                    <div class="font-12 text-gray-400">Total meetings</div>
                    <div class="font-14 font-weight-bold text-gray-500">0</div>
                </div>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
                ...
                <div class="ml-8">
                    <div class="font-12 text-gray-400">Tutoring Hours</div>
                    <div class="font-14 font-weight-bold text-gray-500">0</div>
                </div>
            </div>
        </div>
  ...
  <path d="M15.44 8a.749.749 0 11-.003-1.498A.749.749 0 0115.44 8zM18.25 8a.749.749 0 11-.002-1.498A.749.749 0 0118.25 8zM12.62 8a.749.749 0 11-.003-1.498A.749.749 0 0112.62 8z"/>
                ...
                <div class="font-14 font-weight-bold mt-12">Book a Meeting</div>

                                    <div class="d-flex align-items-center mt-12">
                        <span class="font-16 font-weight-bold text-primary">$60</span>
  ...
  <path d="M12 2C9.38 2 7.25 4.13 7.25 6.75c0 2.57 2.01 4.65 4.63 4.74.08-.01.16-.01.22 0h.07a4.738 4.738 0 004.58-4.74C16.75 4.13 14.62 2 12 2zM17.08 14.149c-2.79-1.86-7.34-1.86-10.15 0-1.27.85-1.97 2-1.97 3.23s.7 2.37 1.96 3.21c1.4.94 3.24 1.41 5.08 1.41 1.84 0 3.68-.47 5.08-1.41 1.26-.85 1.96-1.99 1.96-3.23-.01-1.23-.7-2.37-1.96-3.21z"/>
                    ...
                    <a href="users/ricardo-dave/profilec0cc.html?tab=appointments" class="d-flex-center size-36 rounded-circle bg-primary" target="_blank" data-tippy-content="Book a Meeting">
  ...
  <path d="M16.75 3.56V2c0-.41-.34-.75-.75-.75s-.75.34-.75.75v1.5h-6.5V2c0-.41-.34-.75-.75-.75s-.75.34-.75.75v1.56c-2.7.25-4.01 1.86-4.21 4.25-.02.29.22.53.5.53h16.92c.29 0 .53-.25.5-.53-.2-2.39-1.51-4-4.21-4.25zM20 9.84H4c-.55 0-1 .45-1 1V17c0 3 1.5 5 5 5h8c3.5 0 5-2 5-5v-6.16c0-.55-.45-1-1-1zM9.21 18.21c-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08s-.26-.03-.38-.08-.23-.12-.33-.21c-.18-.19-.29-.45-.29-.71 0-.26.11-.52.29-.71.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.18.19.29.45.29.71 0 .26-.11.52-.29.71zm.21-3.83c-.05.12-.12.23-.21.33-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08s-.26-.03-.38-.08-.23-.12-.33-.21c-.09-.1-.16-.21-.21-.33A.995.995 0 017.5 14c0-.13.03-.26.08-.38s.12-.23.21-.33c.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.09.1.16.21.21.33.05.12.08.25.08.38s-.03.26-.08.38zm3.29.33c-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08s-.26-.03-.38-.08-.23-.12-.33-.21c-.18-.19-.29-.45-.29-.71 0-.26.11-.52.29-.71.1-.09.21-.16.33-.21.24-.11.52-.11.76 0 .12.05.23.12.33.21.18.19.29.45.29.71 0 .26-.11.52-.29.71z"/>
                                                            ...
                                                            <div class="instructor-finder__user-card d-flex align-items-start flex-column flex-lg-row gap-24 bg-white p-16 rounded-24 mb-20">
    <a href="users/robert-ransdell/profile.html" class="text-decoration-none d-flex flex-column flex-1 h-100" target="_blank">
        <div class="d-flex align-items-center justify-content-between mb-16">
            <div class="d-flex align-items-center">
                <div class="position-relative size-64 rounded-circle bg-gray-100">
                    <img src="store/1015/setting/avatar.jpg" alt="Robert Ransdell" class="img-cover rounded-circle">

                                            <div class="instructor-finder__user-card-verified-badge d-flex-center rounded-circle size-16 p-2 bg-primary" data-tippy-content="Verified">
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <div class="ml-8">
                    <h6 class="font-16 font-weight-bold text-dark">Robert Ransdell</h6>
                    <p class="mt-4 font-14 text-gray-500">System Administrator at Amazon</p>
                </div>
            </div>
...
Robert has professional experience with CentOS, RedHat ...</div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M9.75 14.45v-1.2c0-1.54 1.09-2.17 2.42-1.4l1.04.6 1.04.6c1.33.77 1.33 2.03 0 2.8l-1.04.6-1.04.6c-1.33.77-2.42.14-2.42-1.4v-1.2 0z"/>
                ...
                <div class="ml-8">
                    <div class="font-12 text-gray-400">Courses</div>
                    <div class="font-14 font-weight-bold text-gray-500">7</div>
                </div>
            </div>
  ...
  <path d="M15.44 8a.749.749 0 11-.003-1.498A.749.749 0 0115.44 8zM18.25 8a.749.749 0 11-.002-1.498A.749.749 0 0118.25 8zM12.62 8a.749.749 0 11-.003-1.498A.749.749 0 0112.62 8z"/>
                ...
                <div class="font-14 font-weight-bold mt-12">Book a Meeting</div>
                                    ...
                                    <div class="d-flex align-items-center mt-12">
                        <span class="font-16 font-weight-bold text-primary">$100</span>
                        <span class="font-14 text-gray-500">/Hour</span>
                    </div>
  ...
  <path d="M12 2C9.38 2 7.25 4.13 7.25 6.75c0 2.57 2.01 4.65 4.63 4.74.08-.01.16-.01.22 0h.07a4.738 4.738 0 004.58-4.74C16.75 4.13 14.62 2 12 2zM17.08 14.149c-2.79-1.86-7.34-1.86-10.15 0-1.27.85-1.97 2-1.97 3.23s.7 2.37 1.96 3.21c1.4.94 3.24 1.41 5.08 1.41 1.84 0 3.68-.47 5.08-1.41 1.26-.85 1.96-1.99 1.96-3.23-.01-1.23-.7-2.37-1.96-3.21z"/>
                    ...
                    <a href="users/robert-ransdell/profilec0cc.html?tab=appointments" class="d-flex-center size-36 rounded-circle bg-primary" target="_blank" data-tippy-content="Book a Meeting">
                        <svg width="20px" height="20px" class="icons text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M16.75 3.56V2c0-.41-.34-.75-.75-.75s-.75.34-.75.75v1.5h-6.5V2c0-.41-.34-.75-.75-.75s-.75.34-.75.75v1.56c-2.7.25-4.01 1.86-4.21 4.25-.02.29.22.53.5.53h16.92c.29 0 .53-.25.5-.53-.2-2.39-1.51-4-4.21-4.25zM20 9.84H4c-.55 0-1 .45-1 1V17c0 3 1.5 5 5 5h8c3.5 0 5-2 5-5v-6.16c0-.55-.45-1-1-1zM9.21 18.21c-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08s-.26-.03-.38-.08-.23-.12-.33-.21c-.18-.19-.29-.45-.29-.71 0-.26.11-.52.29-.71.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.18.19.29.45.29.71 0 .26-.11.52-.29.71zm.21-3.83c-.05.12-.12.23-.21.33-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08s-.26-.03-.38-.08-.23-.12-.33-.21c-.09-.1-.16-.21-.21-.33A.995.995 0 017.5 14c0-.13.03-.26.08-.38s.12-.23.21-.33c.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.09.1.16.21.21.33.05.12.08.25.08.38s-.03.26-.08.38zm3.29.33c-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08s-.26-.03-.38-.08-.23-.12-.33-.21c-.18-.19-.29-.45-.29-.71 0-.26.11-.52.29-.71.1-.09.21-.16.33-.21.24-.11.52-.11.76 0 .12.05.23.12.33.21.18.19.29.45.29.71 0 .26-.11.52-.29.71z"/>
</svg>                    </a>
                </div>
                                                            ...
                                                            <div class="instructor-finder__user-card d-flex align-items-start flex-column flex-lg-row gap-24 bg-white p-16 rounded-24 mb-20">
    <a href="users/linda-anderson/profile.html" class="text-decoration-none d-flex flex-column flex-1 h-100" target="_blank">
        <div class="d-flex align-items-center justify-content-between mb-16">
            <div class="d-flex align-items-center">
                <div class="position-relative size-64 rounded-circle bg-gray-100">
                    <img src="store/934/setting/avatar.jpg" alt="Linda Anderson" class="img-cover rounded-circle">
                ...
                <div class="ml-8">
                    <h6 class="font-16 font-weight-bold text-dark">Linda Anderson</h6>
                    <p class="mt-4 font-14 text-gray-500">IT Technician at IBM</p>
                </div>
            </div>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
        ...
        <div class="mb-16 font-14 text-gray-500">I am a programmer with over 12 years&#039; experience gained in a range of industries, the last 16 with IBM.
...
The first program I sold controlled stock ...</div>

                    <div class="d-flex align-items-center flex-wrap gap-12 mb-16">
                                                            <div class="d-flex-center p-10 rounded-8 bg-gray-100 text-center font-14 text-gray-500">Marketing</div>
                                                                                <div class="d-flex-center p-10 rounded-8 bg-gray-100 text-center font-14 text-gray-500">Web Development</div>
                                                                                <div class="d-flex-center p-10 rounded-8 bg-gray-100 text-center font-14 text-gray-500">Mobile Development</div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
                ...
                <div class="ml-8">
                    <div class="font-12 text-gray-400">Member Since</div>
                    <div class="font-14 font-weight-bold text-gray-500">7 Feb 2021</div>
                </div>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M9.75 14.45v-1.2c0-1.54 1.09-2.17 2.42-1.4l1.04.6 1.04.6c1.33.77 1.33 2.03 0 2.8l-1.04.6-1.04.6c-1.33.77-2.42.14-2.42-1.4v-1.2 0z"/>
                ...
                <div class="ml-8">
                    <div class="font-12 text-gray-400">Courses</div>
                    <div class="font-14 font-weight-bold text-gray-500">4</div>
                </div>
            </div>
  ...
  <path d="M12 2C9.38 2 7.25 4.13 7.25 6.75c0 2.57 2.01 4.65 4.63 4.74.08-.01.16-.01.22 0h.07a4.738 4.738 0 004.58-4.74C16.75 4.13 14.62 2 12 2zM17.08 14.149c-2.79-1.86-7.34-1.86-10.15 0-1.27.85-1.97 2-1.97 3.23s.7 2.37 1.96 3.21c1.4.94 3.24 1.41 5.08 1.41 1.84 0 3.68-.47 5.08-1.41 1.26-.85 1.96-1.99 1.96-3.23-.01-1.23-.7-2.37-1.96-3.21z"/>
                    ...
                    <a href="users/linda-anderson/profilec0cc.html?tab=appointments" class="d-flex-center size-36 rounded-circle bg-primary" target="_blank" data-tippy-content="Book a Meeting">
                        <svg width="20px" height="20px" class="icons text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M16.75 3.56V2c0-.41-.34-.75-.75-.75s-.75.34-.75.75v1.5h-6.5V2c0-.41-.34-.75-.75-.75s-.75.34-.75.75v1.56c-2.7.25-4.01 1.86-4.21 4.25-.02.29.22.53.5.53h16.92c.29 0 .53-.25.5-.53-.2-2.39-1.51-4-4.21-4.25zM20 9.84H4c-.55 0-1 .45-1 1V17c0 3 1.5 5 5 5h8c3.5 0 5-2 5-5v-6.16c0-.55-.45-1-1-1zM9.21 18.21c-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08s-.26-.03-.38-.08-.23-.12-.33-.21c-.18-.19-.29-.45-.29-.71 0-.26.11-.52.29-.71.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.18.19.29.45.29.71 0 .26-.11.52-.29.71zm.21-3.83c-.05.12-.12.23-.21.33-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08s-.26-.03-.38-.08-.23-.12-.33-.21c-.09-.1-.16-.21-.21-.33A.995.995 0 017.5 14c0-.13.03-.26.08-.38s.12-.23.21-.33c.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.09.1.16.21.21.33.05.12.08.25.08.38s-.03.26-.08.38zm3.29.33c-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08s-.26-.03-.38-.08-.23-.12-.33-.21c-.18-.19-.29-.45-.29-.71 0-.26.11-.52.29-.71.1-.09.21-.16.33-.21.24-.11.52-.11.76 0 .12.05.23.12.33.21.18.19.29.45.29.71 0 .26-.11.52-.29.71z"/>
</svg>                    </a>
                </div>
                                                            ...
                                                            <div class="instructor-finder__user-card d-flex align-items-start flex-column flex-lg-row gap-24 bg-white p-16 rounded-24 mb-20">
    <a href="users/kate-williams/profile.html" class="text-decoration-none d-flex flex-column flex-1 h-100" target="_blank">
        <div class="d-flex align-items-center justify-content-between mb-16">
            <div class="d-flex align-items-center">
                <div class="position-relative size-64 rounded-circle bg-gray-100">
                    <img src="store/929/setting/avatar.jpg" alt="Kate Williams" class="img-cover rounded-circle">
                ...
                <div class="ml-8">
                    <h6 class="font-16 font-weight-bold text-dark">Kate Williams</h6>
                    <p class="mt-4 font-14 text-gray-500">Computer Engineer at Oracle</p>
                </div>
            </div>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
        ...
        <div class="mb-16 font-14 text-gray-500">&quot;Short courses for busy managers&quot;
...
Previously, I was a manager at Ernst &amp; Young, where I analyzed failing projects ...</div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
                ...
                <div class="ml-8">
                    <div class="font-12 text-gray-400">Member Since</div>
                    <div class="font-14 font-weight-bold text-gray-500">15 Nov 2020</div>
                </div>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M9.75 14.45v-1.2c0-1.54 1.09-2.17 2.42-1.4l1.04.6 1.04.6c1.33.77 1.33 2.03 0 2.8l-1.04.6-1.04.6c-1.33.77-2.42.14-2.42-1.4v-1.2 0z"/>
                ...
                <div class="ml-8">
                    <div class="font-12 text-gray-400">Courses</div>
                    <div class="font-14 font-weight-bold text-gray-500">5</div>
                </div>
            </div>
  ...
  <path d="M15.44 8a.749.749 0 11-.003-1.498A.749.749 0 0115.44 8zM18.25 8a.749.749 0 11-.002-1.498A.749.749 0 0118.25 8zM12.62 8a.749.749 0 11-.003-1.498A.749.749 0 0112.62 8z"/>
                ...
                <div class="font-14 font-weight-bold mt-12">Book a Meeting</div>
                                    ...
                                    <div class="d-flex align-items-center mt-12">
                        <span class="font-16 font-weight-bold text-primary">$200</span>
                        <span class="font-14 text-gray-500">/Hour</span>
                    </div>
  ...
  <path d="M12 2C9.38 2 7.25 4.13 7.25 6.75c0 2.57 2.01 4.65 4.63 4.74.08-.01.16-.01.22 0h.07a4.738 4.738 0 004.58-4.74C16.75 4.13 14.62 2 12 2zM17.08 14.149c-2.79-1.86-7.34-1.86-10.15 0-1.27.85-1.97 2-1.97 3.23s.7 2.37 1.96 3.21c1.4.94 3.24 1.41 5.08 1.41 1.84 0 3.68-.47 5.08-1.41 1.26-.85 1.96-1.99 1.96-3.23-.01-1.23-.7-2.37-1.96-3.21z"/>
                    ...
                    <a href="users/kate-williams/profilec0cc.html?tab=appointments" class="d-flex-center size-36 rounded-circle bg-primary" target="_blank" data-tippy-content="Book a Meeting">
                        <svg width="20px" height="20px" class="icons text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M16.75 3.56V2c0-.41-.34-.75-.75-.75s-.75.34-.75.75v1.5h-6.5V2c0-.41-.34-.75-.75-.75s-.75.34-.75.75v1.56c-2.7.25-4.01 1.86-4.21 4.25-.02.29.22.53.5.53h16.92c.29 0 .53-.25.5-.53-.2-2.39-1.51-4-4.21-4.25zM20 9.84H4c-.55 0-1 .45-1 1V17c0 3 1.5 5 5 5h8c3.5 0 5-2 5-5v-6.16c0-.55-.45-1-1-1zM9.21 18.21c-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08s-.26-.03-.38-.08-.23-.12-.33-.21c-.18-.19-.29-.45-.29-.71 0-.26.11-.52.29-.71.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.18.19.29.45.29.71 0 .26-.11.52-.29.71zm.21-3.83c-.05.12-.12.23-.21.33-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08s-.26-.03-.38-.08-.23-.12-.33-.21c-.09-.1-.16-.21-.21-.33A.995.995 0 017.5 14c0-.13.03-.26.08-.38s.12-.23.21-.33c.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.09.1.16.21.21.33.05.12.08.25.08.38s-.03.26-.08.38zm3.29.33c-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08s-.26-.03-.38-.08-.23-.12-.33-.21c-.18-.19-.29-.45-.29-.71 0-.26.11-.52.29-.71.1-.09.21-.16.33-.21.24-.11.52-.11.76 0 .12.05.23.12.33.21.18.19.29.45.29.71 0 .26-.11.52-.29.71z"/>
</svg>                    </a>
                </div>
                                                            ...
                                                            <div class="instructor-finder__user-card d-flex align-items-start flex-column flex-lg-row gap-24 bg-white p-16 rounded-24 mb-20">
    <a href="users/john-powe/profile.html" class="text-decoration-none d-flex flex-column flex-1 h-100" target="_blank">
        <div class="d-flex align-items-center justify-content-between mb-16">
            <div class="d-flex align-items-center">
                <div class="position-relative size-64 rounded-circle bg-gray-100">
                    <img src="store/923/setting/avatar.jpg" alt="John Powe" class="img-cover rounded-circle">
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <div class="ml-8">
                    <h6 class="font-16 font-weight-bold text-dark">John Powe</h6>
                    <p class="mt-4 font-14 text-gray-500">IT Director at Cognizant</p>
                </div>
            </div>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
        ...
        <div class="mb-16 font-14 text-gray-500">Hello! I am John Powe; let me welcome you on this platform. I have created unique courses on different subjects including Business, marketing, Sales, Psychology, Copywriting, Social media marketing and a lot more. I have vast knowledge about business planning, marketing strategies, sales and management.

I am a Gold Medalist Student of my time. With the passage of time, I ...</div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
                ...
                <div class="ml-8">
                    <div class="font-12 text-gray-400">Member Since</div>
                    <div class="font-14 font-weight-bold text-gray-500">4 Nov 2020</div>
                </div>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M9.75 14.45v-1.2c0-1.54 1.09-2.17 2.42-1.4l1.04.6 1.04.6c1.33.77 1.33 2.03 0 2.8l-1.04.6-1.04.6c-1.33.77-2.42.14-2.42-1.4v-1.2 0z"/>
                ...
                <div class="ml-8">
                    <div class="font-12 text-gray-400">Courses</div>
                    <div class="font-14 font-weight-bold text-gray-500">3</div>
                </div>
            </div>
  ...
  <path d="M15.44 8a.749.749 0 11-.003-1.498A.749.749 0 0115.44 8zM18.25 8a.749.749 0 11-.002-1.498A.749.749 0 0118.25 8zM12.62 8a.749.749 0 11-.003-1.498A.749.749 0 0112.62 8z"/>
                ...
                <div class="font-14 font-weight-bold mt-12">Book a Meeting</div>
                                    ...
                                    <div class="d-flex align-items-center mt-12">
                        <span class="font-16 font-weight-bold text-primary">$90</span>
                        <span class="font-14 text-gray-500">/Hour</span>
                    </div>
  ...
  <path d="M12 2C9.38 2 7.25 4.13 7.25 6.75c0 2.57 2.01 4.65 4.63 4.74.08-.01.16-.01.22 0h.07a4.738 4.738 0 004.58-4.74C16.75 4.13 14.62 2 12 2zM17.08 14.149c-2.79-1.86-7.34-1.86-10.15 0-1.27.85-1.97 2-1.97 3.23s.7 2.37 1.96 3.21c1.4.94 3.24 1.41 5.08 1.41 1.84 0 3.68-.47 5.08-1.41 1.26-.85 1.96-1.99 1.96-3.23-.01-1.23-.7-2.37-1.96-3.21z"/>
                    ...
                    <a href="users/john-powe/profilec0cc.html?tab=appointments" class="d-flex-center size-36 rounded-circle bg-primary" target="_blank" data-tippy-content="Book a Meeting">
                        <svg width="20px" height="20px" class="icons text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M16.75 3.56V2c0-.41-.34-.75-.75-.75s-.75.34-.75.75v1.5h-6.5V2c0-.41-.34-.75-.75-.75s-.75.34-.75.75v1.56c-2.7.25-4.01 1.86-4.21 4.25-.02.29.22.53.5.53h16.92c.29 0 .53-.25.5-.53-.2-2.39-1.51-4-4.21-4.25zM20 9.84H4c-.55 0-1 .45-1 1V17c0 3 1.5 5 5 5h8c3.5 0 5-2 5-5v-6.16c0-.55-.45-1-1-1zM9.21 18.21c-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08s-.26-.03-.38-.08-.23-.12-.33-.21c-.18-.19-.29-.45-.29-.71 0-.26.11-.52.29-.71.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.18.19.29.45.29.71 0 .26-.11.52-.29.71zm.21-3.83c-.05.12-.12.23-.21.33-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08s-.26-.03-.38-.08-.23-.12-.33-.21c-.09-.1-.16-.21-.21-.33A.995.995 0 017.5 14c0-.13.03-.26.08-.38s.12-.23.21-.33c.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.09.1.16.21.21.33.05.12.08.25.08.38s-.03.26-.08.38zm3.29.33c-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08s-.26-.03-.38-.08-.23-.12-.33-.21c-.18-.19-.29-.45-.29-.71 0-.26.11-.52.29-.71.1-.09.21-.16.33-.21.24-.11.52-.11.76 0 .12.05.23.12.33.21.18.19.29.45.29.71 0 .26-.11.52-.29.71z"/>
</svg>                    </a>
                </div>
                                                            ...
                                                            <div class="instructor-finder__user-card d-flex align-items-start flex-column flex-lg-row gap-24 bg-white p-16 rounded-24 mb-20">
    <a href="users/jessica-wray/profile.html" class="text-decoration-none d-flex flex-column flex-1 h-100" target="_blank">
        <div class="d-flex align-items-center justify-content-between mb-16">
            <div class="d-flex align-items-center">
                <div class="position-relative size-64 rounded-circle bg-gray-100">
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <div class="ml-8">
                    <h6 class="font-16 font-weight-bold text-dark">Jessica Wray</h6>
                    <p class="mt-4 font-14 text-gray-500">Network Technician at Cisco</p>
                </div>
            </div>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
        ...
        <div class="mb-16 font-14 text-gray-500">Hi,
...
- Gym Workouts &amp; ...</div>
  ...
  <path d="M12 2C9.38 2 7.25 4.13 7.25 6.75c0 2.57 2.01 4.65 4.63 4.74.08-.01.16-.01.22 0h.07a4.738 4.738 0 004.58-4.74C16.75 4.13 14.62 2 12 2zM17.08 14.149c-2.79-1.86-7.34-1.86-10.15 0-1.27.85-1.97 2-1.97 3.23s.7 2.37 1.96 3.21c1.4.94 3.24 1.41 5.08 1.41 1.84 0 3.68-.47 5.08-1.41 1.26-.85 1.96-1.99 1.96-3.23-.01-1.23-.7-2.37-1.96-3.21z"/>
                    ...
                    <a href="users/jessica-wray/profilec0cc.html?tab=appointments" class="d-flex-center size-36 rounded-circle bg-primary" target="_blank" data-tippy-content="Book a Meeting">
                        <svg width="20px" height="20px" class="icons text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M16.75 3.56V2c0-.41-.34-.75-.75-.75s-.75.34-.75.75v1.5h-6.5V2c0-.41-.34-.75-.75-.75s-.75.34-.75.75v1.56c-2.7.25-4.01 1.86-4.21 4.25-.02.29.22.53.5.53h16.92c.29 0 .53-.25.5-.53-.2-2.39-1.51-4-4.21-4.25zM20 9.84H4c-.55 0-1 .45-1 1V17c0 3 1.5 5 5 5h8c3.5 0 5-2 5-5v-6.16c0-.55-.45-1-1-1zM9.21 18.21c-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08s-.26-.03-.38-.08-.23-.12-.33-.21c-.18-.19-.29-.45-.29-.71 0-.26.11-.52.29-.71.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.18.19.29.45.29.71 0 .26-.11.52-.29.71zm.21-3.83c-.05.12-.12.23-.21.33-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08s-.26-.03-.38-.08-.23-.12-.33-.21c-.09-.1-.16-.21-.21-.33A.995.995 0 017.5 14c0-.13.03-.26.08-.38s.12-.23.21-.33c.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.09.1.16.21.21.33.05.12.08.25.08.38s-.03.26-.08.38zm3.29.33c-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08s-.26-.03-.38-.08-.23-.12-.33-.21c-.18-.19-.29-.45-.29-.71 0-.26.11-.52.29-.71.1-.09.21-.16.33-.21.24-.11.52-.11.76 0 .12.05.23.12.33.21.18.19.29.45.29.71 0 .26-.11.52-.29.71z"/>
</svg>                    </a>
                </div>
                    ...
                    <div class="text-center">
                        <button type="button" id="loadMoreInstructors" data-url="/instructor-finder" class="btn btn-outline-gray-500 mt-48 ">Load More Instructors</button>
                    </div>
        ...
        <div class="position-relative z-index-2">
            ...
            <div class="px-16">
                <h5 class="instructor-finder__filters-title filters-title-white font-14 font-weight-bold text-white">Top Mentors</h5>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M9.57 5.93L3.5 12l6.07 6.07M20.5 12H3.67"/>
                ...
                <div class="swiper-wrapper py-32">
                            ...
                            <div class="position-relative d-flex-center flex-column text-center">
                                ...
                                <a href="users/linda-anderson/profile.html" class="">
                                    <div class="instructor-finder__top-mentors-avatar size-80 rounded-circle">
                                        <img src="store/934/setting/avatar.jpg" alt="Linda Anderson" class="position-relative img-cover rounded-circle">
                                    </div>
                                </a>

                                <a href="users/linda-anderson/profile.html" class="">
                                    <h6 class="mt-28 font-16 font-weight-bold text-white">Linda Anderson</h6>
                                </a>

                                <div class="position-relative mt-16 d-flex align-items-center w-100">
                                    <div class="d-flex-center flex-column text-center flex-1">
                                        <div class="font-14 font-weight-bold text-white">0</div>
                                        <div class="mt-4 font-12 text-white">Total meetings</div>
                                    </div>
                                    ...
                                    <div class="d-flex-center flex-column text-center flex-1">
                                        <div class="font-14 font-weight-bold text-white">0</div>
                                        <div class="mt-4 font-12 text-white">Meeting Slots</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="position-relative d-flex-center flex-column text-center">
                                ...
                                <a href="users/robert-ransdell/profile.html" class="">
                                    <div class="instructor-finder__top-mentors-avatar size-80 rounded-circle">
                                        <img src="store/1015/setting/avatar.jpg" alt="Robert Ransdell" class="position-relative img-cover rounded-circle">
                                    </div>
                                </a>

                                <a href="users/robert-ransdell/profile.html" class="">
                                    <h6 class="mt-28 font-16 font-weight-bold text-white">Robert Ransdell</h6>
                                </a>

                                <div class="position-relative mt-16 d-flex align-items-center w-100">
                                    <div class="d-flex-center flex-column text-center flex-1">
                                        <div class="font-14 font-weight-bold text-white">2</div>
                                        <div class="mt-4 font-12 text-white">Total meetings</div>
                                    </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
        ...
        <div id="sidebarFilterInstructors" class="accordion__collapse show pt-0 mt-0 border-0 " role="tabpanel">
            ...
            <div class="form-group  mt-24">
                <label class="form-group-label" for="category_id">Category</label>
            ...
            <div class="form-group ">
                <label class="form-group-label" for="level_of_training">Skill level</label>
            ...
            <div class="form-group ">
                <label class="form-group-label" for="gender">Instructor gender</label>
            ...
            <div class="form-group mb-0 ">
                <label class="form-group-label" for="instructor_type">Instructor type</label>
    ...
    <div class="form-group ">
        <label class="form-group-label">State</label>
    ...
    <div class="form-group ">
        <label class="form-group-label">District</label>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
        ...
        <div id="sidebarFiltersMeetingType" class="accordion__collapse show pt-0 mt-0 border-0 " role="tabpanel">
                    ...
                    <input type="checkbox" name="meeting_type[]" value="in_person" id="meeting_type_in_person" class="custom-control-input" >
                    <label class="custom-control__label cursor-pointer" for="meeting_type_in_person">In-person</label>
                </div>
                            <div class="custom-control custom-checkbox mt-12">
                    <input type="checkbox" name="meeting_type[]" value="online" id="meeting_type_online" class="custom-control-input" >
                    <label class="custom-control__label cursor-pointer" for="meeting_type_online">Online</label>
                </div>
                    </div>
    </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
        ...
        <div id="sidebarFiltersPopulation" class="accordion__collapse show pt-0 mt-0 border-0 " role="tabpanel">
                            ...
                            <div class="custom-control custom-checkbox mt-16">
                    <input type="checkbox" name="population[]" value="single" id="population_single" class="custom-control-input" >
                    <label class="custom-control__label cursor-pointer" for="population_single">Individual</label>
                </div>
                            <div class="custom-control custom-checkbox mt-12">
                    <input type="checkbox" name="population[]" value="group" id="population_group" class="custom-control-input" >
                    <label class="custom-control__label cursor-pointer" for="population_group">Group</label>
                </div>
                    </div>
    </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
        ...
        <div id="sidebarFiltersPrices" class="accordion__collapse show pt-0 mt-0 border-0 " role="tabpanel">
            ...
            <div class="d-flex align-items-center mt-16">
                <div class="form-group mb-0">
                    <input type="tel" readonly value="$0" class="js-filters-min-price form-control input-xs bg-white text-center text-gray-500">
                </div>
                <div class="mx-4"></div>
                <div class="form-group mb-0">
                    <input type="tel" readonly value="$1500" class="js-filters-max-price form-control input-xs bg-white text-center text-gray-500">
                </div>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
        ...
        <div id="sidebarFiltersDays" class="accordion__collapse show pt-0 mt-0 border-0 " role="tabpanel">
                            ...
                            <div class="custom-control custom-checkbox mt-16">
                    <input type="checkbox" name="day[]" value="saturday" id="day_saturday" class="custom-control-input" >
                    <label class="custom-control__label cursor-pointer" for="day_saturday">Saturday</label>
                </div>
                            <div class="custom-control custom-checkbox mt-12">
                    <input type="checkbox" name="day[]" value="sunday" id="day_sunday" class="custom-control-input" >
                    <label class="custom-control__label cursor-pointer" for="day_sunday">Sunday</label>
                </div>
                            <div class="custom-control custom-checkbox mt-12">
                    <input type="checkbox" name="day[]" value="monday" id="day_monday" class="custom-control-input" >
                    <label class="custom-control__label cursor-pointer" for="day_monday">Monday</label>
                </div>
                            <div class="custom-control custom-checkbox mt-12">
                    <input type="checkbox" name="day[]" value="tuesday" id="day_tuesday" class="custom-control-input" >
                    <label class="custom-control__label cursor-pointer" for="day_tuesday">Tuesday</label>
                </div>
                            <div class="custom-control custom-checkbox mt-12">
                    <input type="checkbox" name="day[]" value="wednesday" id="day_wednesday" class="custom-control-input" >
                    <label class="custom-control__label cursor-pointer" for="day_wednesday">Wednesday</label>
                </div>
                            <div class="custom-control custom-checkbox mt-12">
                    <input type="checkbox" name="day[]" value="thursday" id="day_thursday" class="custom-control-input" >
                    <label class="custom-control__label cursor-pointer" for="day_thursday">Thursday</label>
                </div>
                            <div class="custom-control custom-checkbox mt-12">
                    <input type="checkbox" name="day[]" value="friday" id="day_friday" class="custom-control-input" >
                    <label class="custom-control__label cursor-pointer" for="day_friday">Friday</label>
                </div>
                    </div>
    </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
        ...
        <div id="sidebarFiltersTimeRange" class="accordion__collapse show pt-0 mt-0 border-0 " role="tabpanel">
            <div class="d-flex align-items-center mt-16">
                <div class="form-group mb-0">
                    <input type="tel" readonly value="0" class="js-filters-min-time form-control input-xs bg-white text-center text-gray-500">
                </div>
                <div class="mx-4"></div>
                <div class="form-group mb-0">
                    <input type="tel" readonly value="23" class="js-filters-max-time form-control input-xs bg-white text-center text-gray-500">
                </div>
            </div>
...
<script defer src="assets/design_1/js/parts/content_delete.min.js"></script>
    ...
    <script>
        ...
        var selectStateLang = 'Choose a State';
        var selectCityLang = 'Choose a City';
        var selectDistrictLang = 'All Districts';
        var bookAMeetingLang = 'Book a Meeting';
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
        ...
        var frameIcon = `<svg width="20px" height="20px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M12 2C9.38 2 7.25 4.13 7.25 6.75c0 2.57 2.01 4.65 4.63 4.74.08-.01.16-.01.22 0h.07a4.738 4.738 0 004.58-4.74C16.75 4.13 14.62 2 12 2zM17.08 14.149c-2.79-1.86-7.34-1.86-10.15 0-1.27.85-1.97 2-1.97 3.23s.7 2.37 1.96 3.21c1.4.94 3.24 1.41 5.08 1.41 1.84 0 3.68-.47 5.08-1.41 1.26-.85 1.96-1.99 1.96-3.23-.01-1.23-.7-2.37-1.96-3.21z"/>
</svg>`;
        var calendarIcon = `<svg width="20px" height="20px" class="icons text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M16.75 3.56V2c0-.41-.34-.75-.75-.75s-.75.34-.75.75v1.5h-6.5V2c0-.41-.34-.75-.75-.75s-.75.34-.75.75v1.56c-2.7.25-4.01 1.86-4.21 4.25-.02.29.22.53.5.53h16.92c.29 0 .53-.25.5-.53-.2-2.39-1.51-4-4.21-4.25zM20 9.84H4c-.55 0-1 .45-1 1V17c0 3 1.5 5 5 5h8c3.5 0 5-2 5-5v-6.16c0-.55-.45-1-1-1zM9.21 18.21c-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08s-.26-.03-.38-.08-.23-.12-.33-.21c-.18-.19-.29-.45-.29-.71 0-.26.11-.52.29-.71.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.18.19.29.45.29.71 0 .26-.11.52-.29.71zm.21-3.83c-.05.12-.12.23-.21.33-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08s-.26-.03-.38-.08-.23-.12-.33-.21c-.09-.1-.16-.21-.21-.33A.995.995 0 017.5 14c0-.13.03-.26.08-.38s.12-.23.21-.33c.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.09.1.16.21.21.33.05.12.08.25.08.38s-.03.26-.08.38zm3.29.33c-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08s-.26-.03-.38-.08-.23-.12-.33-.21c-.18-.19-.29-.45-.29-.71 0-.26.11-.52.29-.71.1-.09.21-.16.33-.21.24-.11.52-.11.76 0 .12.05.23.12.33.21.18.19.29.45.29.71 0 .26-.11.52-.29.71z"/>
</svg>`;
    </script>
    ...
    <script src="assets/design_1/js/parts/instructor_finder.min.js"></script>
