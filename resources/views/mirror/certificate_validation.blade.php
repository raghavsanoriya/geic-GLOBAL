...
<!-- Mirrored from lms.rocket-soft.org/certificate_validation by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:26:37 GMT -->
...
<meta name='robots' content="index, follow, all">
    ...
    <meta name="description" content="Certificate Validation Description">
    <meta property="og:description" content="Certificate Validation Description">
    <meta name='twitter:description' content='Certificate Validation Description'>
...
<!-- Open Graph -->
<meta property='og:title' content='Certificate validation'>
<meta name='twitter:card' content='summary'>
<meta name='twitter:title' content='Certificate validation'>
...
<meta property='og:type' content='website'>
    ...
    <title>Certificate validation | Rocket LMS</title>
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-lg-8">
                ...
                <form action="https://lms.rocket-soft.org/certificate_validation/validate" method="post">
                    <input type="hidden" name="_token" value="KkDAnXKdDFkgpTFwX3uTuPHuAseZywMbZmqb7QZE">
                    ...
                    <div class="instructor-finder-wizard position-relative bg-white rounded-32 p-16">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="p-16">
                                    <div class="font-16 font-weight-bold">Nice Job! 👋</div>
                                    <h1 class="font-24 font-weight-bold mt-4">Certificate Validation</h1>
                                    <p class="font-14 text-gray-500 mt-16">To validate a certificate, enter the certificate ID below and click the Validate button.</p>

                                    <div class="form-group mt-40">
                                        <label class="form-group-label" for="code">Certificate ID:</label>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M22 12c0 5.52-4.48 10-10 10s-8.89-5.56-8.89-5.56m0 0h4.52m-4.52 0v5M2 12C2 6.48 6.44 2 12 2c6.67 0 10 5.56 10 5.56m0 0v-5m0 5h-4.44"/>
    ...
    <div class="invalid-feedback mt-4 d-block">
                                    ...
                                    <div class="mt-16">
                                        <button type="button" class="js-submit-certificate-validation-form-btn btn btn-primary btn-block btn-lg" data-title="Certificate Validation">Validate</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6 mt-24 mt-md-0">
                                ...
                                <div class="instructor-finder-wizard__images-card bg-gray-100 rounded-16">
                                                                            <img src="store/1/themes/general/certificate_validation.jpg" alt="Main Image" class="img-cover rounded-16">
                                    
                                                                        <div class="wizard-overlay-image">
                                    <img src="store/1/themes/general/certificate_validation_overlay.png" alt="Overlay Image" class="img-fluid">
                                        </div>
                                                                    </div>
...
<script defer src="assets/design_1/js/parts/content_delete.min.js"></script>
    ...
    <script src="assets/design_1/js/parts/certificate_validation.min.js"></script>
...
<!-- Mirrored from lms.rocket-soft.org/certificate_validation by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:26:38 GMT -->
</html>
