...
<!-- Mirrored from www.geic.in/bundles by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:31:51 GMT -->
...
<meta property='og:type' content='website'>
    ...
    <title>Course Bundles | Trans Globe Indore LMS</title>
    ...
    <link rel="stylesheet" href="https://www.geic.in/assets/design_1/css/parts/bundles_lists.min.css">
            <link rel="stylesheet" href="https://www.geic.in/assets/design_1/css/parts/bundle_cards/grid_card_1.min.css">
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
        ...
        <section class="bundles-lists-hero position-relative">
            ...
            <img src="https://www.geic.in/store/1/themes/general/bundles_background.jpg" class="img-cover" alt="Course Bundles"/>
        </section>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
                        ...
                        <div class="font-12 text-gray-500 mt-8">Explore the bundled courses and start learning.</div>
                            ...
                            <img src="https://www.geic.in/store/1/themes/general/bundles_overlay.png" alt="Overlay Image" class="img-cover">
                        </div>
                                    </div>
            </div>
        </div>

        <form action="https://www.geic.in/bundles" class="js-get-view-data-by-timeout-change container mt-24" data-container-id="listsContainer">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
        ...
        <a href="https://www.geic.in/bundles/Solar-Energy-Design-Course-From-Zero-To-Hero" class="text-decoration-none d-block">
<div class="bundle-card position-relative">
        <div class="bundle-card__image bg-gray-200 rounded-16">
            <img src="https://www.geic.in/store/1/default_images/bundles/bundle1.jpg" class="img-cover rounded-16" alt="Solar Energy Design Course From Zero To Hero">
        </div>
    ...
    <div class="bundle-card__content d-flex flex-column rounded-16 p-16 bg-white">
            ...
            <div>
                <a href="https://www.geic.in/bundles/Solar-Energy-Design-Course-From-Zero-To-Hero" class="text-decoration-none">
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
            ...
            <div class="d-flex flex-column ml-4">
                    <a href="https://www.geic.in/users/kate-williams/profile" target="_blank" class="font-14 font-weight-bold text-dark" onclick="event.stopPropagation()">Kate Williams</a>
                        ...
                        <span class="">in</span>
                            <a href="https://www.geic.in/categories/Academics/Science" target="_blank" class="font-12 text-gray-500 text-ellipsis" onclick="event.stopPropagation()">Science</a>
                    </div>
                            </div>
        </div>
        ...
        <div class="d-flex align-items-center justify-content-between mt-auto">
            <div class="d-flex align-items-center">
                    <a href="https://www.geic.in/bundles/Solar-Energy-Design-Course-From-Zero-To-Hero" class="d-flex align-items-center text-decoration-none" style="color: inherit;">
                <svg width="16px" height="16px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M9.75 14.45v-1.2c0-1.54 1.09-2.17 2.42-1.4l1.04.6 1.04.6c1.33.77 1.33 2.03 0 2.8l-1.04.6-1.04.6c-1.33.77-2.42.14-2.42-1.4v-1.2 0z"/>
            ...
            <div class="d-flex align-items-center font-16 font-weight-bold text-primary">
                    <a href="https://www.geic.in/bundles/Solar-Energy-Design-Course-From-Zero-To-Hero" class="text-decoration-none text-primary">
                <span class="">$25</span>
                            </a>
                </div>
            </div>
    ...
    <div class="col-12 col-lg-6 mt-24">
        <a href="https://www.geic.in/bundles/Become-a-Probability-&amp;-Statistics-Master" class="text-decoration-none d-block">
<div class="bundle-card position-relative">
        <div class="bundle-card__image bg-gray-200 rounded-16">
            <img src="https://www.geic.in/store/1/default_images/bundles/bundle4.jpg" class="img-cover rounded-16" alt="Become a Probability &amp; Statistics Master">
        </div>
    ...
    <div class="bundle-card__content d-flex flex-column rounded-16 p-16 bg-white">
            ...
            <div>
                <a href="https://www.geic.in/bundles/Become-a-Probability-&amp;-Statistics-Master" class="text-decoration-none">
                        </a>
            </div>
        ...
        <div class="d-flex align-items-center justify-content-between mt-auto">
            <div class="d-flex align-items-center">
                    <a href="https://www.geic.in/bundles/Become-a-Probability-&amp;-Statistics-Master" class="d-flex align-items-center text-decoration-none" style="color: inherit;">
                <svg width="16px" height="16px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M22 15V9c0-5-2-7-7-7H9C4 2 2 4 2 9v6c0 5 2 7 7 7h6c5 0 7-2 7-7zM2.52 7.11h18.96M8.52 2.11v4.86M15.48 2.11v4.41"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M9.75 14.45v-1.2c0-1.54 1.09-2.17 2.42-1.4l1.04.6 1.04.6c1.33.77 1.33 2.03 0 2.8l-1.04.6-1.04.6c-1.33.77-2.42.14-2.42-1.4v-1.2 0z"/>
</svg>                <span class="ml-4 font-14 text-gray-500">2 Courses</span>
            ...
            <div class="d-flex align-items-center font-16 font-weight-bold text-primary">
                    <a href="https://www.geic.in/bundles/Become-a-Probability-&amp;-Statistics-Master" class="text-decoration-none text-primary">
                <span class="">$25</span>
                            </a>
                </div>
            </div>
    ...
    <div class="col-12 col-lg-6 mt-24">
        <a href="https://www.geic.in/bundles/A-Z-Web-Programming" class="text-decoration-none d-block">
<div class="bundle-card position-relative">
        <div class="bundle-card__image bg-gray-200 rounded-16">
            <img src="https://www.geic.in/store/1/default_images/bundles/bundle2.jpg" class="img-cover rounded-16" alt="A-Z Web Programming">
        </div>
    ...
    <div class="bundle-card__content d-flex flex-column rounded-16 p-16 bg-white">
            ...
            <div>
                <a href="https://www.geic.in/bundles/A-Z-Web-Programming" class="text-decoration-none">
        <div class="stars-card d-flex align-items-center mt-8">
                    <span class="stars-card__item active">
                <svg width="14px" height="14px" class="icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
            ...
            <div class="d-flex flex-column ml-4">
                    <a href="https://www.geic.in/users/linda-anderson/profile" target="_blank" class="font-14 font-weight-bold text-dark" onclick="event.stopPropagation()">Linda Anderson</a>
                                    ...
                                    <div class="d-inline-flex align-items-center gap-4 mt-2 font-14 text-gray-500">
                        <span class="">in</span>
                            <a href="https://www.geic.in/categories/Development/Web-Development" target="_blank" class="font-12 text-gray-500 text-ellipsis" onclick="event.stopPropagation()">Web Development</a>
                    </div>
                            </div>
        </div>
        ...
        <div class="d-flex align-items-center justify-content-between mt-auto">
            <div class="d-flex align-items-center">
                    <a href="https://www.geic.in/bundles/A-Z-Web-Programming" class="d-flex align-items-center text-decoration-none" style="color: inherit;">
                <svg width="16px" height="16px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M22 15V9c0-5-2-7-7-7H9C4 2 2 4 2 9v6c0 5 2 7 7 7h6c5 0 7-2 7-7zM2.52 7.11h18.96M8.52 2.11v4.86M15.48 2.11v4.41"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M9.75 14.45v-1.2c0-1.54 1.09-2.17 2.42-1.4l1.04.6 1.04.6c1.33.77 1.33 2.03 0 2.8l-1.04.6-1.04.6c-1.33.77-2.42.14-2.42-1.4v-1.2 0z"/>
</svg>                <span class="ml-4 font-14 text-gray-500">2 Courses</span>
            ...
            <div class="d-flex align-items-center font-16 font-weight-bold text-primary">
                    <a href="https://www.geic.in/bundles/A-Z-Web-Programming" class="text-decoration-none text-primary">
                <span class="">$8</span>
                            </a>
                </div>
            </div>
    ...
    <div class="col-12 col-lg-6 mt-24">
        <a href="https://www.geic.in/bundles/Microsoft-Office-Beginner-to-Expert-Bundle" class="text-decoration-none d-block">
<div class="bundle-card position-relative">
        <div class="bundle-card__image bg-gray-200 rounded-16">
            <img src="https://www.geic.in/store/1/default_images/bundles/Mask group.jpg" class="img-cover rounded-16" alt="Microsoft Office Beginner to Expert Bundle">
        </div>
    ...
    <div class="bundle-card__content d-flex flex-column rounded-16 p-16 bg-white">
            ...
            <div>
                <a href="https://www.geic.in/bundles/Microsoft-Office-Beginner-to-Expert-Bundle" class="text-decoration-none">
        <div class="stars-card d-flex align-items-center mt-8">
                    <span class="stars-card__item active">
                <svg width="14px" height="14px" class="icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
            ...
            <div class="d-flex flex-column ml-4">
                    <a href="https://www.geic.in/users/robert-ransdell/profile" target="_blank" class="font-14 font-weight-bold text-dark" onclick="event.stopPropagation()">Robert Ransdell</a>
                                    ...
                                    <div class="d-inline-flex align-items-center gap-4 mt-2 font-14 text-gray-500">
                        <span class="">in</span>
                            <a href="https://www.geic.in/categories/Business/Management" target="_blank" class="font-12 text-gray-500 text-ellipsis" onclick="event.stopPropagation()">Management</a>
                    </div>
                            </div>
        </div>
        ...
        <div class="d-flex align-items-center justify-content-between mt-auto">
            <div class="d-flex align-items-center">
                    <a href="https://www.geic.in/bundles/Microsoft-Office-Beginner-to-Expert-Bundle" class="d-flex align-items-center text-decoration-none" style="color: inherit;">
                <svg width="16px" height="16px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M22 15V9c0-5-2-7-7-7H9C4 2 2 4 2 9v6c0 5 2 7 7 7h6c5 0 7-2 7-7zM2.52 7.11h18.96M8.52 2.11v4.86M15.48 2.11v4.41"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M9.75 14.45v-1.2c0-1.54 1.09-2.17 2.42-1.4l1.04.6 1.04.6c1.33.77 1.33 2.03 0 2.8l-1.04.6-1.04.6c-1.33.77-2.42.14-2.42-1.4v-1.2 0z"/>
            ...
            <div class="d-flex align-items-center font-16 font-weight-bold text-primary">
                    <a href="https://www.geic.in/bundles/Microsoft-Office-Beginner-to-Expert-Bundle" class="text-decoration-none text-primary">
                <span class="">$50</span>
                            </a>
                </div>
            </div>
...
<script defer src="https://www.geic.in/assets/design_1/js/parts/content_delete.min.js"></script>
    ...
    <script src="https://www.geic.in/assets/design_1/js/parts/bundles_lists.min.js"></script>
