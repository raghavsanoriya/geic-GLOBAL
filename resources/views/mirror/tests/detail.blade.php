...
<style>
    ...
    .td-cta { position: relative; overflow: hidden; padding: 32px 38px; border-radius: 24px; background: var(--td-red); box-shadow: 0 16px 34px rgba(227,30,36,.16); }
    .td-cta::after { position: absolute; top: -104px; right: -92px; width: 280px; height: 280px; border: 40px solid rgba(255,255,255,.12); border-radius: 50%; content: ''; }
    .td-cta__content { position: relative; z-index: 1; max-width: 820px; }
    .td-cta .td-kicker { color: rgba(255,255,255,.76); }
    .td-cta h2 { margin: 9px 0 0; color: #fff; font-size: clamp(26px, 2.7vw, 36px); line-height: 1.14; font-weight: 800; letter-spacing: -.04em; text-wrap: balance; }
    .td-cta p { max-width: 730px; margin: 10px 0 0; color: rgba(255,255,255,.85); font-size: 14px; line-height: 1.65; }
    .td-cta .td-button { min-height: 48px; margin-top: 18px; background: #fff; color: var(--td-navy) !important; }
