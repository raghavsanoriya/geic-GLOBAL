...
<!-- Mirrored from lms.rocket-soft.org/upcoming_courses?sort=newest by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:34:15 GMT -->
...
<meta name='robots' content="NOODP, nofollow, noindex">
    ...
    <meta name="description" content="Upcoming Courses Description">
    <meta property="og:description" content="Upcoming Courses Description">
    <meta name='twitter:description' content='Upcoming Courses Description'>
...
<!-- Open Graph -->
<meta property='og:title' content='Upcoming Course'>
<meta name='twitter:card' content='summary'>
<meta name='twitter:title' content='Upcoming Course'>
...
<meta property='og:type' content='website'>
    ...
    <title>Upcoming Course | Rocket LMS</title>
    ...
    <link rel="stylesheet" href="https://lms.rocket-soft.org/assets/design_1/css/parts/upcoming_courses_lists.min.css">
            <link rel="stylesheet" href="https://lms.rocket-soft.org/assets/design_1/css/parts/upcoming_course_cards/grid_card_1.min.css">
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
        ...
        <section class="upcoming-courses-lists-hero position-relative">
            ...
            <img src="https://lms.rocket-soft.org/store/1/themes/general/upcoming_courses_background.jpg" class="img-cover" alt="Upcoming Courses"/>
        </section>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
</svg>                            <span class="">Upcoming Courses</span>
                        </div>

                        <h1 class="font-24 font-weight-bold mt-12">Upcoming Courses</h1>
                        <div class="font-12 text-gray-500 mt-8">Check upcoming courses scheduled for release.</div>
                    </div>

                                            <div class="upcoming-courses-lists-header__overlay-img">
                            <img src="https://lms.rocket-soft.org/store/1/themes/general/upcoming_courses_overlay.png" alt="Overlay Image" class="img-cover">
                        </div>
                                    </div>
            </div>
        </div>

        <form action="https://lms.rocket-soft.org/upcoming_courses" class="js-get-view-data-by-timeout-change container mt-24" data-container-id="listsContainer">
    ...
    <div class="position-relative d-flex flex-column flex-lg-row align-items-lg-center justify-content-lg-between gap-20 bg-white px-24 py-12 rounded-24 z-index-2">
        <div class="d-flex align-items-center gap-16 gap-lg-48">
                            <div class="form-group mb-0 d-flex align-items-center">
                    <div class="custom-switch mr-8">
                        <input id="top_filter_free_courses" type="checkbox" name="free_courses" value="on" class="custom-control-input">
                        <label class="custom-control-label cursor-pointer" for="top_filter_free_courses"></label>
                    </div>

                    <div class="">
                        <label class="cursor-pointer" for="top_filter_free_courses">Free Courses</label>
                    </div>
                </div>
                            <div class="form-group mb-0 d-flex align-items-center">
                    <div class="custom-switch mr-8">
                        <input id="top_filter_released_courses" type="checkbox" name="released_courses" value="on" class="custom-control-input">
                        <label class="custom-control-label cursor-pointer" for="top_filter_released_courses"></label>
                    </div>

                    <div class="">
                        <label class="cursor-pointer" for="top_filter_released_courses">Released Courses</label>
                    </div>
                </div>
                    </div>
        ...
        <div class="upcoming-courses-lists-sort-input form-group mb-0">
            <select name="sort" class="form-control select2" data-minimum-results-for-search="Infinity">
                ...
                <option value="">All</option>
                                    ...
                                    <option value="earliest_publish_date">public.earliest_publish_date</option>
                                    <option value="farthest_publish_date">public.farthest_publish_date</option>
                                    <option value="highest_price">public.highest_price</option>
                                    <option value="lowest_price">public.lowest_price</option>
                            </select>
        </div>
        ...
        <div class="font-14 font-weight-bold text-dark px-16">
            Categories
                    ...
                    <div class="accordion__title d-flex align-items-center justify-content-between">
                        <div class="font-14 font-weight-bold text-dark cursor-pointer" href="#leftFiltersCategory528" data-parent="#leftFiltersAccordion" role="button" data-toggle="collapse">
                            Development
                        </div>

                        <span class="collapse-arrow-icon d-flex cursor-pointer" href="#leftFiltersCategory528" data-parent="#leftFiltersAccordion" role="button" data-toggle="collapse">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
                    ...
                    <div id="leftFiltersCategory528" class="accordion__collapse pt-0 mt-0 border-0 show" role="tabpanel">
                        <div class="pl-8">
                                                            <div class="js-get-view-data-by-tab mt-16 cursor-pointer" data-filter-name="category_id" data-filter-value="606" data-container-id="listsContainer">Web Development</div>
                                                            <div class="js-get-view-data-by-tab mt-16 cursor-pointer" data-filter-name="category_id" data-filter-value="607" data-container-id="listsContainer">Mobile Development</div>
                                                            <div class="js-get-view-data-by-tab mt-16 cursor-pointer" data-filter-name="category_id" data-filter-value="608" data-container-id="listsContainer">Game Development</div>
                                                    </div>
                    </div>
                </div>
                                                <div class="accordion border-bottom-gray-100 mt-16 px-16 pb-16">
                    <div class="accordion__title d-flex align-items-center justify-content-between">
                        <div class="font-14 font-weight-bold text-dark cursor-pointer" href="#leftFiltersCategory526" data-parent="#leftFiltersAccordion" role="button" data-toggle="collapse">
                            Business
                        </div>

                        <span class="collapse-arrow-icon d-flex cursor-pointer" href="#leftFiltersCategory526" data-parent="#leftFiltersAccordion" role="button" data-toggle="collapse">
                            <svg width="16" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>                        </span>
                    </div>

                    <div id="leftFiltersCategory526" class="accordion__collapse pt-0 mt-0 border-0 " role="tabpanel">
                        <div class="pl-8">
                                                            <div class="js-get-view-data-by-tab mt-16 cursor-pointer" data-filter-name="category_id" data-filter-value="609" data-container-id="listsContainer">Management</div>
                                                            <div class="js-get-view-data-by-tab mt-16 cursor-pointer" data-filter-name="category_id" data-filter-value="610" data-container-id="listsContainer">Communications</div>
                                                            <div class="js-get-view-data-by-tab mt-16 cursor-pointer" data-filter-name="category_id" data-filter-value="611" data-container-id="listsContainer">Business Strategy</div>
                                                    </div>
                    </div>
                </div>
                                                <div class="js-get-view-data-by-tab mt-16 px-16 cursor-pointer font-weight-bold" data-filter-name="category_id" data-filter-value="525" data-container-id="listsContainer">Marketing</div>
                                                <div class="accordion border-bottom-gray-100 mt-16 px-16 pb-16">
                    <div class="accordion__title d-flex align-items-center justify-content-between">
                        <div class="font-14 font-weight-bold text-dark cursor-pointer" href="#leftFiltersCategory524" data-parent="#leftFiltersAccordion" role="button" data-toggle="collapse">
                            Lifestyle
                        </div>

                        <span class="collapse-arrow-icon d-flex cursor-pointer" href="#leftFiltersCategory524" data-parent="#leftFiltersAccordion" role="button" data-toggle="collapse">
                            <svg width="16" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>                        </span>
                    </div>

                    <div id="leftFiltersCategory524" class="accordion__collapse pt-0 mt-0 border-0 " role="tabpanel">
                        <div class="pl-8">
                                                            <div class="js-get-view-data-by-tab mt-16 cursor-pointer" data-filter-name="category_id" data-filter-value="604" data-container-id="listsContainer">Lifestyle</div>
                                                            <div class="js-get-view-data-by-tab mt-16 cursor-pointer" data-filter-name="category_id" data-filter-value="605" data-container-id="listsContainer">Beauty &amp; Makeup</div>
                                                    </div>
                    </div>
                </div>
                                                <div class="js-get-view-data-by-tab mt-16 px-16 cursor-pointer font-weight-bold" data-filter-name="category_id" data-filter-value="523" data-container-id="listsContainer">Health &amp; Fitness</div>
                                                <div class="accordion border-bottom-gray-100 mt-16 px-16 pb-16">
                    <div class="accordion__title d-flex align-items-center justify-content-between">
                        <div class="font-14 font-weight-bold text-dark cursor-pointer" href="#leftFiltersCategory522" data-parent="#leftFiltersAccordion" role="button" data-toggle="collapse">
                            Academics
                        </div>

                        <span class="collapse-arrow-icon d-flex cursor-pointer" href="#leftFiltersCategory522" data-parent="#leftFiltersAccordion" role="button" data-toggle="collapse">
                            <svg width="16" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
</svg>                        </span>
                    </div>

                    <div id="leftFiltersCategory522" class="accordion__collapse pt-0 mt-0 border-0 " role="tabpanel">
                        <div class="pl-8">
                                                            <div class="js-get-view-data-by-tab mt-16 cursor-pointer" data-filter-name="category_id" data-filter-value="601" data-container-id="listsContainer">Math</div>
                                                            <div class="js-get-view-data-by-tab mt-16 cursor-pointer" data-filter-name="category_id" data-filter-value="602" data-container-id="listsContainer">Science</div>
                                                            <div class="js-get-view-data-by-tab mt-16 cursor-pointer" data-filter-name="category_id" data-filter-value="603" data-container-id="listsContainer">Language</div>
                                                    </div>
                    </div>
                </div>
                                                <div class="js-get-view-data-by-tab mt-16 px-16 cursor-pointer font-weight-bold" data-filter-name="category_id" data-filter-value="520" data-container-id="listsContainer">Design</div>
                        </div>
</div>


<div class="position-relative upcoming-courses-lists-filters mt-28">
    <div class="upcoming-courses-lists-filters__mask"></div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
            ...
            <div id="leftFiltersMoreOptions" class="accordion__collapse show pt-0 mt-0 border-0" role="tabpanel">
                                    <div class="custom-control custom-checkbox mt-16">
                        <input type="checkbox" name="moreOptions[]" value="supported_courses" id="filter_type_supported_courses" class="custom-control-input">
                        <label class="custom-control__label cursor-pointer" for="filter_type_supported_courses">Supported Courses</label>
                    </div>
                                    <div class="custom-control custom-checkbox mt-12">
                        <input type="checkbox" name="moreOptions[]" value="quiz_included" id="filter_type_quiz_included" class="custom-control-input">
                        <label class="custom-control__label cursor-pointer" for="filter_type_quiz_included">Quiz Included</label>
                    </div>
                                    <div class="custom-control custom-checkbox mt-12">
                        <input type="checkbox" name="moreOptions[]" value="certificate_included" id="filter_type_certificate_included" class="custom-control-input">
                        <label class="custom-control__label cursor-pointer" for="filter_type_certificate_included">Certificate Included</label>
                    </div>
                                    <div class="custom-control custom-checkbox mt-12">
                        <input type="checkbox" name="moreOptions[]" value="assignment_included" id="filter_type_assignment_included" class="custom-control-input">
                        <label class="custom-control__label cursor-pointer" for="filter_type_assignment_included">Assignment Included</label>
                    </div>
                                    <div class="custom-control custom-checkbox mt-12">
                        <input type="checkbox" name="moreOptions[]" value="course_forum_included" id="filter_type_course_forum_included" class="custom-control-input">
                        <label class="custom-control__label cursor-pointer" for="filter_type_course_forum_included">Course Forum Included</label>
                    </div>
                                    <div class="custom-control custom-checkbox mt-12">
                        <input type="checkbox" name="moreOptions[]" value="point_courses" id="filter_type_point_courses" class="custom-control-input">
                        <label class="custom-control__label cursor-pointer" for="filter_type_point_courses">Point-Based Courses</label>
                    </div>
                            </div>
        </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
            ...
            <div id="leftFiltersPrices" class="accordion__collapse show pt-0 mt-0 border-0" role="tabpanel">
                ...
                <div class="d-flex align-items-center mt-16">
                    ...
                    <div class="mx-4"></div>
                    <div class="form-group mb-0">
                        <input type="tel" readonly value="$1,100" class="js-filters-max-price form-control input-xs bg-white text-center text-gray-500">
                    </div>
                </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
            ...
            <div id="leftFiltersInstructor" class="accordion__collapse show pt-0 mt-0 border-0" role="tabpanel">
                ...
                <div class="col-12 col-lg-9 mt-4">
                    <div id="listsContainer" class="" data-body=".js-lists-body" data-view-data-path="/upcoming_courses">
                        <div class="js-lists-body row">
                            <div class="col-12 col-md-6 col-lg-4 mt-24">
        <a href="https://lms.rocket-soft.org/upcoming_courses/laravel-advanced-course" target="_blank" class="text-decoration-none d-block">
<div class="upcoming-course-card position-relative">
    <div class="upcoming-course-card__image position-relative rounded-16 bg-gray-100">
        <img src="https://lms.rocket-soft.org/store/1/default_images/upcoming/upcoming4.jpg" alt="" class="img-cover rounded-16">
    ...
    <div class="upcoming-course-card__body position-relative px-12 pb-12">
        <div class="upcoming-course-card__content d-flex flex-column bg-white py-12 rounded-16">
                <div class="d-flex align-items-center mb-16 px-12" onclick="event.stopPropagation()">
                    <a href="https://lms.rocket-soft.org/users/kate-williams/profile" target="_blank" class="size-32 rounded-circle" onclick="event.stopPropagation()">
                    <img src="https://lms.rocket-soft.org/store/929/setting/avatar.jpg" class="img-cover rounded-circle" alt="Kate Williams">
                    </a>

                <div class="d-flex flex-column ml-4">
                        <a href="https://lms.rocket-soft.org/users/kate-williams/profile" target="_blank" class="font-14 font-weight-bold text-dark" onclick="event.stopPropagation()">Kate Williams</a>

                                            <div class="d-inline-flex align-items-center gap-4 mt-2 font-14 text-gray-500">
                            <span class="">in</span>
                                <a href="https://lms.rocket-soft.org/categories/Development/Web-Development" target="_blank" class="font-14 text-gray-500 text-ellipsis" onclick="event.stopPropagation()">Web Development</a>
                        </div>
                                    </div>
            </div>
            ...
            <div class="d-flex align-items-center justify-content-between mt-auto pt-12 px-12 border-top-gray-100">
                <div class="d-flex align-items-center font-16 font-weight-bold text-primary">
                        <a href="https://lms.rocket-soft.org/upcoming_courses/laravel-advanced-course" target="_blank" class="text-decoration-none text-primary">
                    <span class="">$90</span>
                        </a>
                </div>

                <div class="d-flex align-items-center font-14 text-gray-500">
                        <a href="https://lms.rocket-soft.org/upcoming_courses/laravel-advanced-course" target="_blank" class="text-decoration-none d-flex align-items-center" style="color: inherit;">
                    <svg width="16px" height="16px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-24">
        <a href="https://lms.rocket-soft.org/upcoming_courses/Web-Design-for-Beginners" target="_blank" class="text-decoration-none d-block">
<div class="upcoming-course-card position-relative">
    <div class="upcoming-course-card__image position-relative rounded-16 bg-gray-100">
        <img src="https://lms.rocket-soft.org/store/1/default_images/upcoming/upcoming1.jpg" alt="" class="img-cover rounded-16">
        ...
        <div class="upcoming-course-card__content d-flex flex-column bg-white py-12 rounded-16">
                ...
                <div class="d-flex flex-column ml-4">
                        <a href="https://lms.rocket-soft.org/users/linda-anderson/profile" target="_blank" class="font-14 font-weight-bold text-dark" onclick="event.stopPropagation()">Linda Anderson</a>
                                            ...
                                            <div class="d-inline-flex align-items-center gap-4 mt-2 font-14 text-gray-500">
                            <span class="">in</span>
                                <a href="https://lms.rocket-soft.org/categories/Design" target="_blank" class="font-14 text-gray-500 text-ellipsis" onclick="event.stopPropagation()">Design</a>
                        </div>
                                    </div>
            </div>
            ...
            <div class="d-flex align-items-center justify-content-between mt-auto pt-12 px-12 border-top-gray-100">
                <div class="d-flex align-items-center font-16 font-weight-bold text-primary">
                        <a href="https://lms.rocket-soft.org/upcoming_courses/Web-Design-for-Beginners" target="_blank" class="text-decoration-none text-primary">
                    <span class="">$10</span>
                        </a>
                </div>

                <div class="d-flex align-items-center font-14 text-gray-500">
                        <a href="https://lms.rocket-soft.org/upcoming_courses/Web-Design-for-Beginners" target="_blank" class="text-decoration-none d-flex align-items-center" style="color: inherit;">
                    <svg width="16px" height="16px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M22 12c0 5.52-4.48 10-10 10S2 17.52 2 12 6.48 2 12 2s10 4.48 10 10z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-24">
        <a href="https://lms.rocket-soft.org/upcoming_courses/Digital-Photography" target="_blank" class="text-decoration-none d-block">
<div class="upcoming-course-card position-relative">
    <div class="upcoming-course-card__image position-relative rounded-16 bg-gray-100">
        <img src="https://lms.rocket-soft.org/store/1/default_images/upcoming/upcoming3.jpg" alt="" class="img-cover rounded-16">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
    ...
    <div class="upcoming-course-card__body position-relative px-12 pb-12">
        <div class="upcoming-course-card__content d-flex flex-column bg-white py-12 rounded-16">
            ...
            <div class="d-flex align-items-center justify-content-between mt-auto pt-12 px-12 border-top-gray-100">
                <div class="d-flex align-items-center font-16 font-weight-bold text-primary">
                        <a href="https://lms.rocket-soft.org/upcoming_courses/Digital-Photography" target="_blank" class="text-decoration-none text-primary">
                    <span class="">$50</span>
                        </a>
                </div>

                <div class="d-flex align-items-center font-14 text-gray-500">
                        <a href="https://lms.rocket-soft.org/upcoming_courses/Digital-Photography" target="_blank" class="text-decoration-none d-flex align-items-center" style="color: inherit;">
                    <svg width="16px" height="16px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M22 12c0 5.52-4.48 10-10 10S2 17.52 2 12 6.48 2 12 2s10 4.48 10 10z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-24">
        <a href="https://lms.rocket-soft.org/upcoming_courses/Python-for-Beginners" target="_blank" class="text-decoration-none d-block">
<div class="upcoming-course-card position-relative">
    <div class="upcoming-course-card__image position-relative rounded-16 bg-gray-100">
        <img src="https://lms.rocket-soft.org/store/1/default_images/upcoming/upcoming2.jpg" alt="" class="img-cover rounded-16">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
    ...
    <div class="upcoming-course-card__body position-relative px-12 pb-12">
        <div class="upcoming-course-card__content d-flex flex-column bg-white py-12 rounded-16">
            ...
            <div class="d-flex align-items-center justify-content-between mt-auto pt-12 px-12 border-top-gray-100">
                <div class="d-flex align-items-center font-16 font-weight-bold text-primary">
                        <a href="https://lms.rocket-soft.org/upcoming_courses/Python-for-Beginners" target="_blank" class="text-decoration-none text-primary">
                    <span class="">$100</span>
                        </a>
                </div>

                <div class="d-flex align-items-center font-14 text-gray-500">
                        <a href="https://lms.rocket-soft.org/upcoming_courses/Python-for-Beginners" target="_blank" class="text-decoration-none d-flex align-items-center" style="color: inherit;">
                    <svg width="16px" height="16px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M22 12c0 5.52-4.48 10-10 10S2 17.52 2 12 6.48 2 12 2s10 4.48 10 10z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
...
<script defer src="https://lms.rocket-soft.org/assets/design_1/js/parts/content_delete.min.js"></script>
    ...
    <script src="https://lms.rocket-soft.org/assets/design_1/js/parts/upcoming_courses_lists.min.js"></script>
