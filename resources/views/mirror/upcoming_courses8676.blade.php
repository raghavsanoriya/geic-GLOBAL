...
<!-- Mirrored from www.geic.in/upcoming_courses?sort=newest by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:34:15 GMT -->
...
<meta property='og:type' content='website'>
    ...
    <title>Upcoming Course | Trans Globe Indore LMS</title>
    ...
    <link rel="stylesheet" href="https://www.geic.in/assets/design_1/css/parts/upcoming_courses_lists.min.css">
            <link rel="stylesheet" href="https://www.geic.in/assets/design_1/css/parts/upcoming_course_cards/grid_card_1.min.css">
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
        ...
        <section class="upcoming-courses-lists-hero position-relative">
            ...
            <img src="https://www.geic.in/store/1/themes/general/upcoming_courses_background.jpg" class="img-cover" alt="Upcoming Courses"/>
        </section>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
                        ...
                        <div class="font-12 text-gray-500 mt-8">Check upcoming courses scheduled for release.</div>
                            ...
                            <img src="https://www.geic.in/store/1/themes/general/upcoming_courses_overlay.png" alt="Overlay Image" class="img-cover">
                        </div>
                                    </div>
            </div>
        </div>

        <form action="https://www.geic.in/upcoming_courses" class="js-get-view-data-by-timeout-change container mt-24" data-container-id="listsContainer">
...
<div class="position-relative upcoming-courses-lists-filters mt-28">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
        ...
        <a href="https://www.geic.in/upcoming_courses/laravel-advanced-course" target="_blank" class="text-decoration-none d-block">
<div class="upcoming-course-card position-relative">
    <div class="upcoming-course-card__image position-relative rounded-16 bg-gray-100">
        <img src="https://www.geic.in/store/1/default_images/upcoming/upcoming4.jpg" alt="" class="img-cover rounded-16">
    ...
    <div class="upcoming-course-card__body position-relative px-12 pb-12">
        <div class="upcoming-course-card__content d-flex flex-column bg-white py-12 rounded-16">
                <div class="d-flex align-items-center mb-16 px-12" onclick="event.stopPropagation()">
                    <a href="https://www.geic.in/users/kate-williams/profile" target="_blank" class="size-32 rounded-circle" onclick="event.stopPropagation()">
                    <img src="https://www.geic.in/store/929/setting/avatar.jpg" class="img-cover rounded-circle" alt="Kate Williams">
                    </a>

                <div class="d-flex flex-column ml-4">
                        <a href="https://www.geic.in/users/kate-williams/profile" target="_blank" class="font-14 font-weight-bold text-dark" onclick="event.stopPropagation()">Kate Williams</a>

                                            <div class="d-inline-flex align-items-center gap-4 mt-2 font-14 text-gray-500">
                            <span class="">in</span>
                                <a href="https://www.geic.in/categories/Development/Web-Development" target="_blank" class="font-14 text-gray-500 text-ellipsis" onclick="event.stopPropagation()">Web Development</a>
                        </div>
                                    </div>
            </div>
            ...
            <div class="d-flex align-items-center justify-content-between mt-auto pt-12 px-12 border-top-gray-100">
                <div class="d-flex align-items-center font-16 font-weight-bold text-primary">
                        <a href="https://www.geic.in/upcoming_courses/laravel-advanced-course" target="_blank" class="text-decoration-none text-primary">
                    <span class="">$90</span>
                        </a>
                </div>

                <div class="d-flex align-items-center font-14 text-gray-500">
                        <a href="https://www.geic.in/upcoming_courses/laravel-advanced-course" target="_blank" class="text-decoration-none d-flex align-items-center" style="color: inherit;">
                    <svg width="16px" height="16px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-24">
        <a href="https://www.geic.in/upcoming_courses/Web-Design-for-Beginners" target="_blank" class="text-decoration-none d-block">
<div class="upcoming-course-card position-relative">
    <div class="upcoming-course-card__image position-relative rounded-16 bg-gray-100">
        <img src="https://www.geic.in/store/1/default_images/upcoming/upcoming1.jpg" alt="" class="img-cover rounded-16">
        ...
        <div class="upcoming-course-card__content d-flex flex-column bg-white py-12 rounded-16">
                ...
                <div class="d-flex flex-column ml-4">
                        <a href="https://www.geic.in/users/linda-anderson/profile" target="_blank" class="font-14 font-weight-bold text-dark" onclick="event.stopPropagation()">Linda Anderson</a>
                                            ...
                                            <div class="d-inline-flex align-items-center gap-4 mt-2 font-14 text-gray-500">
                            <span class="">in</span>
                                <a href="https://www.geic.in/categories/Design" target="_blank" class="font-14 text-gray-500 text-ellipsis" onclick="event.stopPropagation()">Design</a>
                        </div>
                                    </div>
            </div>
            ...
            <div class="d-flex align-items-center justify-content-between mt-auto pt-12 px-12 border-top-gray-100">
                <div class="d-flex align-items-center font-16 font-weight-bold text-primary">
                        <a href="https://www.geic.in/upcoming_courses/Web-Design-for-Beginners" target="_blank" class="text-decoration-none text-primary">
                    <span class="">$10</span>
                        </a>
                </div>

                <div class="d-flex align-items-center font-14 text-gray-500">
                        <a href="https://www.geic.in/upcoming_courses/Web-Design-for-Beginners" target="_blank" class="text-decoration-none d-flex align-items-center" style="color: inherit;">
                    <svg width="16px" height="16px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M22 12c0 5.52-4.48 10-10 10S2 17.52 2 12 6.48 2 12 2s10 4.48 10 10z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-24">
        <a href="https://www.geic.in/upcoming_courses/Digital-Photography" target="_blank" class="text-decoration-none d-block">
<div class="upcoming-course-card position-relative">
    <div class="upcoming-course-card__image position-relative rounded-16 bg-gray-100">
        <img src="https://www.geic.in/store/1/default_images/upcoming/upcoming3.jpg" alt="" class="img-cover rounded-16">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
    ...
    <div class="upcoming-course-card__body position-relative px-12 pb-12">
        <div class="upcoming-course-card__content d-flex flex-column bg-white py-12 rounded-16">
            ...
            <div class="d-flex align-items-center justify-content-between mt-auto pt-12 px-12 border-top-gray-100">
                <div class="d-flex align-items-center font-16 font-weight-bold text-primary">
                        <a href="https://www.geic.in/upcoming_courses/Digital-Photography" target="_blank" class="text-decoration-none text-primary">
                    <span class="">$50</span>
                        </a>
                </div>

                <div class="d-flex align-items-center font-14 text-gray-500">
                        <a href="https://www.geic.in/upcoming_courses/Digital-Photography" target="_blank" class="text-decoration-none d-flex align-items-center" style="color: inherit;">
                    <svg width="16px" height="16px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M22 12c0 5.52-4.48 10-10 10S2 17.52 2 12 6.48 2 12 2s10 4.48 10 10z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-24">
        <a href="https://www.geic.in/upcoming_courses/Python-for-Beginners" target="_blank" class="text-decoration-none d-block">
<div class="upcoming-course-card position-relative">
    <div class="upcoming-course-card__image position-relative rounded-16 bg-gray-100">
        <img src="https://www.geic.in/store/1/default_images/upcoming/upcoming2.jpg" alt="" class="img-cover rounded-16">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
    ...
    <div class="upcoming-course-card__body position-relative px-12 pb-12">
        <div class="upcoming-course-card__content d-flex flex-column bg-white py-12 rounded-16">
            ...
            <div class="d-flex align-items-center justify-content-between mt-auto pt-12 px-12 border-top-gray-100">
                <div class="d-flex align-items-center font-16 font-weight-bold text-primary">
                        <a href="https://www.geic.in/upcoming_courses/Python-for-Beginners" target="_blank" class="text-decoration-none text-primary">
                    <span class="">$100</span>
                        </a>
                </div>

                <div class="d-flex align-items-center font-14 text-gray-500">
                        <a href="https://www.geic.in/upcoming_courses/Python-for-Beginners" target="_blank" class="text-decoration-none d-flex align-items-center" style="color: inherit;">
                    <svg width="16px" height="16px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M22 12c0 5.52-4.48 10-10 10S2 17.52 2 12 6.48 2 12 2s10 4.48 10 10z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.71 15.18l-3.1-1.85c-.54-.32-.98-1.09-.98-1.72v-4.1"/>
...
<script defer src="https://www.geic.in/assets/design_1/js/parts/content_delete.min.js"></script>
    ...
    <script src="https://www.geic.in/assets/design_1/js/parts/upcoming_courses_lists.min.js"></script>
