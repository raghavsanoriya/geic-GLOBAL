...
<!-- Mirrored from lms.rocket-soft.org/jobs/data-scientist by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:36:40 GMT -->
...
<meta name='robots' content="index, follow, all">
    ...
    <meta name="description" content="Data Scientist Job Opportunity">
    <meta property="og:description" content="Data Scientist Job Opportunity">
    <meta name='twitter:description' content='Data Scientist Job Opportunity'>
...
<meta property='og:type' content='website'>
    ...
    <title>Data Scientist | Rocket LMS</title>
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
    ...
    <img src="../store/929/How%20to%20Manage%20%26%20Influence%20Your%20Virtual%20Team_c.jpg.png" class="job-hero__cover-img img-cover rounded-32" alt="Data Scientist"/>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
</svg>                <a href="../jobscfaa.html?category_id=2" class="text-white">Data Science &amp; Analytics</a>
            </div>
        
        <div class="d-flex align-items-center flex-wrap gap-12 mt-4">
            <h1 class="job-hero__title font-32 font-weight-bold text-white text-ellipsis">Data Scientist</h1>
                    ...
                    <div class="mt-8 text-white opacity-50">We are looking for a skilled Data Scientist.</div>
...
</svg>                    <span class=" font-weight-bold">Delhi, New Delhi</span>
                </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 10a2.33 2.33 0 100-4.66A2.33 2.33 0 0012 10zM16 15.66c0-1.8-1.79-3.26-4-3.26s-4 1.46-4 3.26"/>
        ...
        <div class="d-flex flex-column flex-lg-row gap-24">
            ...
            <div class="job-show-description mt-12 text-gray-500 line-height-1-5">
                <p>We are looking for a highly skilled Data Scientist to join our growing team. In this position, you will play a key role in extracting insights from complex datasets. You will collaborate closely with other departments to build predictive models and algorithms. This is a fantastic opportunity for someone who is passionate about data analytics and machine learning and wants to make a real impact in a fast-paced environment.</p><p>Your day-to-day responsibilities will include cleaning data and creating visualizations, monitoring system performance, and proposing improvements. You will be expected to stay up-to-date with the latest industry trends and bring fresh ideas to the table.</p><p>Key Requirements:</p><ul><li>At least 3 years of proven experience as a Data Scientist or similar position.</li><li>Strong understanding of Python, R, SQL and Statistical modeling and Data Mining.</li><li>Excellent communication and teamwork skills.</li><li>Ability to troubleshoot complex problems efficiently.</li></ul><p>We offer a comprehensive benefits package including health insurance, paid time off, and professional development budgets. If you meet these criteria and are ready for a new challenge, we would love to hear from you!</p>
            </div>
        </div>
            ...
            <div class="mt-16 p-16 rounded-16 border-gray-200">
                         ...
                         data-latitude="28.6176788400956"
                         data-longitude="77.2024726867676"
                         data-zoom="16"
                         data-dragging="false"
  ...
  <path d="M12 13.46a3.15 3.15 0 100-6.3 3.15 3.15 0 000 6.3z"/>
                    ...
                    <div class="ml-8">
                        ...
                        <p class="font-12 text-gray-500 mt-2">India, Delhi, New Delhi, 31, Borivali</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="js-reply-to-comment-html d-none">
  ...
  <path d="M12 2C6.49 2 2 6.49 2 12s4.49 10 10 10 10-4.49 10-10S17.51 2 12 2zm-.75 6c0-.41.34-.75.75-.75s.75.34.75.75v5c0 .41-.34.75-.75.75s-.75-.34-.75-.75V8zm1.67 8.38c-.05.13-.12.23-.21.33-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08s-.26-.03-.38-.08-.23-.12-.33-.21c-.09-.1-.16-.2-.21-.33A.995.995 0 0111 16c0-.13.03-.26.08-.38s.12-.23.21-.33c.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.09.1.16.21.21.33.05.12.08.25.08.38s-.03.26-.08.38z"/>
    ...
    <div class="position-relative bg-white rounded-24 pb-24 z-index-2">
        ...
        <div class="job-right-side__thumbnail position-relative bg-gray-200">
            <img src="../store/929/How%20to%20Manage%20%26%20Influence%20Your%20Virtual%20Team.jpg" class="img-cover" alt="Data Scientist">
        ...
        <div class="js-apply-for-job-actions-card px-16">
                            ...
                            <button type="button" class="btn bg-gray-300 btn-block btn-xlg mt-20 text-gray-500 cursor-default">Apply for Job</button>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9.59 11l1.5 1.5 4-4"/>
                ...
                <div class="js-share-job d-flex-center flex-column text-gray-500 font-12 cursor-pointer" data-path="/jobs/data-scientist/share-modal">
                    <svg width="20px" height="20px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
...
<div class="job-right-side-section position-relative mt-28">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
                ...
                <span class="">1 May 2026 | 13:00</span>
            </div>
...
<div class="job-right-side-section position-relative mt-28">
    ...
    <div class="position-relative bg-white rounded-24 p-16 z-index-2">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="ml-8">
                <a href="../users/kate-williams/profile.html" target="_blank" class="">
                    <div class="d-block font-weight-bold text-dark">Kate Williams</div>
                </a>
    ...
    <div class="container d-flex flex-column flex-lg-row align-items-lg-center justify-content-lg-between h-100">
        <div class="d-flex align-items-center mb-16 mb-lg-0">
            <div class="job-bottom-fixed-card__job-img rounded-8">
                <img src="../store/929/How%20to%20Manage%20%26%20Influence%20Your%20Virtual%20Team.jpg" class="img-cover rounded-8" alt="Data Scientist">
            </div>
            <div class="ml-8">
                <div class="font-12 text-gray-500">You are viewing</div>
                <div class="mt-4 font-14 font-weight-bold">Data Scientist</div>
            </div>
        </div>
...
<!-- Mirrored from lms.rocket-soft.org/jobs/data-scientist by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:36:46 GMT -->
</html>
