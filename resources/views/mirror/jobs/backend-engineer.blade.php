...
<!-- Mirrored from lms.rocket-soft.org/jobs/backend-engineer by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:36:18 GMT -->
...
<meta name='robots' content="index, follow, all">
    ...
    <meta name="description" content="Backend Engineer Job Opportunity">
    <meta property="og:description" content="Backend Engineer Job Opportunity">
    <meta name='twitter:description' content='Backend Engineer Job Opportunity'>
...
<meta name='twitter:title' content='Backend Engineer'>
...
<meta property='og:type' content='website'>
    ...
    <title>Backend Engineer | Rocket LMS</title>
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
    ...
    <img src="../store/1015/6.jpg" class="job-hero__cover-img img-cover rounded-32" alt="Backend Engineer"/>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
</svg>                <a href="../jobsbaa2.html?category_id=1" class="text-white">Software Development &amp; Engineering</a>
            </div>
        
        <div class="d-flex align-items-center flex-wrap gap-12 mt-4">
            <h1 class="job-hero__title font-32 font-weight-bold text-white text-ellipsis">Backend Engineer</h1>
                    ...
                    <div class="mt-8 text-white opacity-50">We are looking for a skilled Backend Engineer.</div>
  ...
  <path d="M14.84 8.45l-.62.76c-.1.11-.17.33-.16.48l.06.98c.04.6-.39.91-.95.69l-.91-.36a.92.92 0 00-.52 0l-.91.36c-.56.22-.99-.09-.95-.69l.06-.98a.751.751 0 00-.16-.48l-.62-.76c-.39-.46-.22-.97.36-1.12l.95-.24c.15-.04.33-.18.41-.31l.53-.82c.33-.51.85-.51 1.18 0l.53.82c.08.13.26.27.41.31l.95.24c.58.15.75.66.36 1.12z" opacity=".4"/>
                    ...
                    <span class=" font-weight-bold">Senior Level</span>
                </div>
...
</svg>                    <span class=" font-weight-bold">Riyadh, Riyadh</span>
                </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 11a2.33 2.33 0 100-4.66A2.33 2.33 0 0012 11zM16 16.66c0-1.8-1.79-3.26-4-3.26s-4 1.46-4 3.26"/>
</svg>                <span class=" font-weight-bold">Hybrid</span>
            </div>
        ...
        <div class="d-flex flex-column flex-lg-row gap-24">
                ...
                <div class="custom-tabs mt-16">
                    <div class="job-tabs-card position-relative">
                        ...
                        <div class="position-relative d-flex align-items-center gap-20 gap-lg-40 flex-wrap bg-white px-16 px-lg-20 rounded-12 z-index-2 w-100">
                            <div id="showJobAboutTab" class="navbar-item d-flex-center cursor-pointer active" data-tab-toggle data-tab-href="#aboutJobTab">
                                <span class="">About Job</span>
                            </div>
            ...
            <div class="job-show-description mt-12 text-gray-500 line-height-1-5">
                <p>We are looking for a highly skilled Backend Engineer to join our growing team. In this position, you will play a key role in developing robust server-side logic. You will collaborate closely with other departments to ensure efficient data flow and API integrations. This is a fantastic opportunity for someone who is passionate about scalable system architecture and wants to make a real impact in a fast-paced environment.</p><p>Your day-to-day responsibilities will include designing database schemas, monitoring system performance, and proposing improvements. You will be expected to stay up-to-date with the latest industry trends and bring fresh ideas to the table.</p><p>Key Requirements:</p><p>1. At least 3 years of proven experience as a Backend Engineer or similar position.</p><p>2. Strong understanding of PHP, Python, or Node.js and Relational and NoSQL databases.</p><p>3. Excellent communication and teamwork skills.</p><p>4. Ability to troubleshoot complex problems efficiently.</p><p>We offer a comprehensive benefits package including health insurance, paid time off, and professional development budgets. If you meet these criteria and are ready for a new challenge, we would love to hear from you!</p>
            </div>
        </div>
            ...
            <div class="mt-16 p-16 rounded-16 border-gray-200">
                         ...
                         data-latitude="24.657470201057812"
                         data-longitude="46.72734260559083"
                         data-zoom="16"
                         data-dragging="false"
  ...
  <path d="M12 13.46a3.15 3.15 0 100-6.3 3.15 3.15 0 000 6.3z"/>
                    ...
                    <div class="ml-8">
                        <h5 class="font-14">Location</h5>
                        <p class="font-12 text-gray-500 mt-2">Saudi Arabia, Riyadh, Riyadh, Al malaz</p>
                    </div>
                </div>
            </div>
        </div>
...
He enjoys teaching others how to use and ...</div>
        ...
        <div class="job-about-instructor-card__secondary-img position-relative">
            <img src="../store/1015/setting/profile_secondary_image.png" alt="Robert Ransdell" class="img-cover">
                            ...
                            <a href="../login.html" target="_blank" class="job-about-instructor-card__book-meeting-btn d-inline-flex align-items-center gap-8 px-24 py-12 cursor-pointer">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
    ...
    <div class="mt-48">
        <div class="">
            <h2 class="font-16 font-weight-bold">Similar Jobs</h2>
            <p class="mt-4 font-12 text-gray-500">You may also be interested in these job openings.</p>
        </div>
  ...
  <path d="M20.5 12.3l-.15.09a17.037 17.037 0 01-5.79 2.08c-.08.96-.5 2.06-2.69 2.06s-2.61-1.09-2.69-2.04c-1.91-.3-3.79-.93-5.5-1.88-.15-.08-.3-.16-.44-.25-.36-.2-.7-.42-1.03-.64-.02-.01-.04-.03-.05-.04l.61 6.51c.21 1.99 1.03 4.04 5.43 4.04h7.62c4.4 0 5.22-2.05 5.43-4.05l.63-6.78a.12.12 0 01-.05.05c-.43.31-.87.6-1.33.85z" opacity=".4"/>
            ...
            <div class="d-flex-center size-64">
                <img src="../store/1/default_images/courses/icons/course_icon20.svg" alt="Frontend Developer" class="img-fluid">
            </div>
        </div>

        <a href="frontend-developer.html" class="">
        ...
        <a href="../users/ricardo-dave/profile" class="d-flex align-items-center my-16 text-dark">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center gap-4 font-12 text-gray-500">
                    ...
                    <span class="">Remote</span>
                            ...
                            <a href="frontend-developer.html" class="btn btn-primary gap-4">
  ...
  <path d="M20.5 12.3l-.15.09a17.037 17.037 0 01-5.79 2.08c-.08.96-.5 2.06-2.69 2.06s-2.61-1.09-2.69-2.04c-1.91-.3-3.79-.93-5.5-1.88-.15-.08-.3-.16-.44-.25-.36-.2-.7-.42-1.03-.64-.02-.01-.04-.03-.05-.04l.61 6.51c.21 1.99 1.03 4.04 5.43 4.04h7.62c4.4 0 5.22-2.05 5.43-4.05l.63-6.78a.12.12 0 01-.05.05c-.43.31-.87.6-1.33.85z" opacity=".4"/>
            ...
            <div class="d-flex-center size-64">
                <img src="../store/1/default_images/courses/icons/course_icon2.svg" alt="System Administrator" class="img-fluid">
            </div>
        </div>

        <a href="system-administrator.html" class="">
  ...
  <path d="M20.5 12.3l-.15.09a17.037 17.037 0 01-5.79 2.08c-.08.96-.5 2.06-2.69 2.06s-2.61-1.09-2.69-2.04c-1.91-.3-3.79-.93-5.5-1.88-.15-.08-.3-.16-.44-.25-.36-.2-.7-.42-1.03-.64-.02-.01-.04-.03-.05-.04l.61 6.51c.21 1.99 1.03 4.04 5.43 4.04h7.62c4.4 0 5.22-2.05 5.43-4.05l.63-6.78a.12.12 0 01-.05.05c-.43.31-.87.6-1.33.85z" opacity=".4"/>
            ...
            <div class="d-flex-center size-64">
                <img src="../store/1/default_images/courses/icons/course_icon1.svg" alt="DevOps Engineer" class="img-fluid">
            </div>
        </div>

        <a href="devops-engineer.html" class="">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center gap-4 font-12 text-gray-500">
                    ...
                    <span class="">Hybrid</span>
                            ...
                            <a href="devops-engineer.html" class="btn btn-primary gap-4">
                    <span class="">Apply</span>
                    <svg width="16px" height="16px" class="icons" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M14.43 5.93L20.5 12l-6.07 6.07M3.5 12h16.83"/>
</svg>                </a>
...
<div class="js-reply-to-comment-html d-none">
  ...
  <path d="M12 2C6.49 2 2 6.49 2 12s4.49 10 10 10 10-4.49 10-10S17.51 2 12 2zm-.75 6c0-.41.34-.75.75-.75s.75.34.75.75v5c0 .41-.34.75-.75.75s-.75-.34-.75-.75V8zm1.67 8.38c-.05.13-.12.23-.21.33-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08s-.26-.03-.38-.08-.23-.12-.33-.21c-.09-.1-.16-.2-.21-.33A.995.995 0 0111 16c0-.13.03-.26.08-.38s.12-.23.21-.33c.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.09.1.16.21.21.33.05.12.08.25.08.38s-.03.26-.08.38z"/>
    ...
    <div class="position-relative bg-white rounded-24 pb-24 z-index-2">
        ...
        <div class="job-right-side__thumbnail position-relative bg-gray-200">
            <img src="../store/1015/hero%20(6).jpg" class="img-cover" alt="Backend Engineer">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9.59 11l1.5 1.5 4-4"/>
</svg>                    <span class="mt-2">Bookmark</span>
                </a>

                <div class="js-share-job d-flex-center flex-column text-gray-500 font-12 cursor-pointer" data-path="/jobs/backend-engineer/share-modal">
                    <svg width="20px" height="20px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
...
<div class="job-right-side-section position-relative mt-28">
    ...
    <div class="position-relative card-before-line bg-white rounded-24 p-16 z-index-2">
        <h4 class="font-14 font-weight-bold">Job Details</h4>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9.16 10.87c-.1-.01-.22-.01-.33 0a4.42 4.42 0 01-4.27-4.43C4.56 3.99 6.54 2 9 2a4.435 4.435 0 01.16 8.87zM16.41 4c1.94 0 3.5 1.57 3.5 3.5 0 1.89-1.5 3.43-3.37 3.5a1.13 1.13 0 00-.26 0M4.16 14.56c-2.42 1.62-2.42 4.26 0 5.87 2.75 1.84 7.26 1.84 10.01 0 2.42-1.62 2.42-4.26 0-5.87-2.74-1.83-7.25-1.83-10.01 0zM18.34 20c.72-.15 1.4-.44 1.96-.87 1.56-1.17 1.56-3.1 0-4.27-.55-.42-1.22-.7-1.93-.86"/>
</svg>                <span class="ml-4">Total Vacancies</span>
            </div>
            ...
            <span class="">5</span>
                ...
                <div class="d-flex align-items-center font-14 text-gray-500">
                    <svg width="20px" height="20px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M14.44 19.05l1.52 1.52L19 17.53M12.16 10.87c-.1-.01-.22-.01-.33 0a4.42 4.42 0 01-4.27-4.43A4.428 4.428 0 0111.99 2c2.45 0 4.44 1.99 4.44 4.44 0 2.4-1.9 4.35-4.27 4.43zM11.99 21.81c-1.82 0-3.63-.46-5.01-1.38-2.42-1.62-2.42-4.26 0-5.87 2.75-1.84 7.26-1.84 10.01 0"/>
</svg>                    <span class="ml-4">Applied Users</span>
                </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
            ...
            <span class="">5 May 2026 | 17:42</span>
        </div>
                ...
                <div class="d-flex align-items-center font-14 text-gray-500">
                    <svg width="20px" height="20px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8 2v3M16 2v3M3.5 9.09h17M18 23a4 4 0 100-8 4 4 0 000 8zM19.07 20.11L16.95 18M19.05 18.02l-2.12 2.12"/>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.995 13.7h.01M8.294 13.7h.01M8.294 16.7h.01"/>
</svg>                    <span class="ml-4">Expiry Date</span>
                </div>
...
</svg>                    <span class="ml-4">Employment Type</span>
                </div>
...
</svg>                <span class="ml-4">Work Arrangement</span>
            </div>
...
<div class="job-right-side-section position-relative mt-28">
        ...
        <div class="d-flex align-items-center">
            <div class="position-relative size-64 rounded-circle">
                <img src="../store/1015/setting/avatar.jpg" alt="Robert Ransdell" class="img-cover rounded-circle">
                                    ...
                                    <div class="job-right-side__teacher-verified-badge d-flex-center rounded-circle size-16 p-2 bg-primary" data-tippy-content="Verified">
    ...
    <path d="M3 7.48222L6.17305 11L13 4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <div class="ml-8">
                <a href="../users/robert-ransdell/profile.html" target="_blank" class="">
                    <div class="d-block font-weight-bold text-dark">Robert Ransdell</div>
                </a>
    ...
    <div class="container d-flex flex-column flex-lg-row align-items-lg-center justify-content-lg-between h-100">
        <div class="d-flex align-items-center mb-16 mb-lg-0">
            <div class="job-bottom-fixed-card__job-img rounded-8">
                <img src="../store/1015/hero%20(6).jpg" class="img-cover rounded-8" alt="Backend Engineer">
            </div>
            <div class="ml-8">
                <div class="font-12 text-gray-500">You are viewing</div>
                <div class="mt-4 font-14 font-weight-bold">Backend Engineer</div>
            </div>
        </div>

                    <button type="button" class="js-scroll-to-job-apply-btn btn btn-primary btn-lg">Apply for Job</button>
            </div>
</div>
...
<script defer src="../assets/design_1/js/parts/content_delete.min.js"></script>
    ...
    <script>
        ...
        var reportJobLang = 'Report Job';
        var reportLang = 'Report';
        var jobDemoLang = 'Demo Video';
    </script>
    ...
    <script src="../assets/design_1/js/parts/show_job.min.js"></script>
...
<!-- Mirrored from lms.rocket-soft.org/jobs/backend-engineer by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:36:30 GMT -->
</html>
