...
<!-- Mirrored from lms.rocket-soft.org/jobs/hr-specialist by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:37:30 GMT -->
...
<meta name='robots' content="index, follow, all">
    ...
    <meta name="description" content="HR Specialist Job Opportunity">
    <meta property="og:description" content="HR Specialist Job Opportunity">
    <meta name='twitter:description' content='HR Specialist Job Opportunity'>
...
<!-- Open Graph -->
<meta property='og:title' content='HR Specialist'>
<meta name='twitter:card' content='summary'>
<meta name='twitter:title' content='HR Specialist'>
...
<meta property='og:type' content='website'>
    ...
    <title>HR Specialist | Rocket LMS</title>
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
    ...
    <img src="../store/864/Active%20Listening%20You%20Can%20Be%20a%20Great%20Listener_c.png" class="job-hero__cover-img img-cover rounded-32" alt="HR Specialist"/>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
        ...
        <div class="d-flex align-items-center flex-wrap gap-12 mt-4">
            <h1 class="job-hero__title font-32 font-weight-bold text-white text-ellipsis">HR Specialist</h1>
                    ...
                    <div class="mt-8 text-white opacity-50">We are looking for a skilled HR Specialist.</div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 11a2.33 2.33 0 100-4.66A2.33 2.33 0 0012 11zM16 16.66c0-1.8-1.79-3.26-4-3.26s-4 1.46-4 3.26"/>
        ...
        <div class="d-flex align-items-center mt-20">
            ...
            <div class="ml-8">
                <a href="../users/affogato-media/profile.html" target="_blank" class="font-14 font-weight-bold text-white">Affogato Media</a>
                <p class="mt-2 font-12 text-white">Organization</p>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="d-flex flex-column flex-lg-row gap-24">
            ...
            <div class="job-show-description mt-12 text-gray-500 line-height-1-5">
                <p>We are looking for a highly skilled HR Specialist to join our growing team. In this position, you will play a key role in managing the full recruitment lifecycle. You will collaborate closely with other departments to foster a positive company culture. This is a fantastic opportunity for someone who is passionate about talent acquisition and employee relations and wants to make a real impact in a fast-paced environment.</p><p>Your day-to-day responsibilities will include onboarding new hires and managing benefits, monitoring system performance, and proposing improvements. You will be expected to stay up-to-date with the latest industry trends and bring fresh ideas to the table.</p><p>Key Requirements:</p><ul><li>At least 3 years of proven experience as a HR Specialist or similar position.</li><li>Strong understanding of Interviewing and candidate assessment and Employment laws and regulations.</li><li>Excellent communication and teamwork skills.</li><li>Ability to troubleshoot complex problems efficiently.</li></ul><p>We offer a comprehensive benefits package including health insurance, paid time off, and professional development budgets. If you meet these criteria and are ready for a new challenge, we would love to hear from you!</p>
            </div>
        </div>
...
<div class="job-about-instructor-card position-relative mt-32 mt-lg-60">
        ...
        <div class="job-about-instructor-card__details flex-1 py-16">
            <div class="d-flex align-items-center">
                <div class="position-relative d-flex-center size-80 rounded-12 bg-gray-200">
                    <img src="../store/864/setting/avatar.jpg" alt="Affogato Media" class="img-cover rounded-12">
                </div>

                <div class="ml-12 flex-1">
                    <a href="../users/affogato-media/profile.html" target="_blank" class="">
                        <h6 class="font-14 font-weight-bold text-dark">Affogato Media</h6>
                    </a>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M5.63 13.08l-.01 4.69c0 1.27.98 2.63 2.18 3.03l3.19 1.06c.55.18 1.46.18 2.02 0l3.19-1.06c1.2-.4 2.18-1.76 2.18-3.03v-4.64M21.4 15V9"/>
            ...
            <div class="mt-16 text-gray-500 line-height-1-5">Learn creative skills, from absolute beginner to advanced mastery. 
...
All courses have a 30-day money-back guarantee so that you can check it out, make sure it’s the right ...</div>
        </div>

        <div class="job-about-instructor-card__secondary-img position-relative">
            <img src="../store/1/themes/general/default_instructor_placeholder.png" alt="Affogato Media" class="img-cover">
...
<div class="js-reply-to-comment-html d-none">
  ...
  <path d="M12 2C6.49 2 2 6.49 2 12s4.49 10 10 10 10-4.49 10-10S17.51 2 12 2zm-.75 6c0-.41.34-.75.75-.75s.75.34.75.75v5c0 .41-.34.75-.75.75s-.75-.34-.75-.75V8zm1.67 8.38c-.05.13-.12.23-.21.33-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08s-.26-.03-.38-.08-.23-.12-.33-.21c-.09-.1-.16-.2-.21-.33A.995.995 0 0111 16c0-.13.03-.26.08-.38s.12-.23.21-.33c.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.09.1.16.21.21.33.05.12.08.25.08.38s-.03.26-.08.38z"/>
    ...
    <div class="position-relative bg-white rounded-24 pb-24 z-index-2">
        ...
        <div class="job-right-side__thumbnail position-relative bg-gray-200">
            <img src="../store/864/couple-listening-music.jpg" class="img-cover" alt="HR Specialist">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9.59 11l1.5 1.5 4-4"/>
                ...
                <div class="js-share-job d-flex-center flex-column text-gray-500 font-12 cursor-pointer" data-path="/jobs/hr-specialist/share-modal">
                    <svg width="20px" height="20px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
...
<div class="job-right-side-section position-relative mt-28">
    ...
    <div class="position-relative bg-white rounded-24 p-16 z-index-2">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="ml-8">
                <a href="../users/affogato-media/profile.html" target="_blank" class="">
                    <div class="d-block font-weight-bold text-dark">Affogato Media</div>
                </a>
    ...
    <div class="container d-flex flex-column flex-lg-row align-items-lg-center justify-content-lg-between h-100">
        <div class="d-flex align-items-center mb-16 mb-lg-0">
            <div class="job-bottom-fixed-card__job-img rounded-8">
                <img src="../store/864/couple-listening-music.jpg" class="img-cover rounded-8" alt="HR Specialist">
            </div>
            <div class="ml-8">
                <div class="font-12 text-gray-500">You are viewing</div>
                <div class="mt-4 font-14 font-weight-bold">HR Specialist</div>
            </div>
        </div>
...
<!-- Mirrored from lms.rocket-soft.org/jobs/hr-specialist by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:37:41 GMT -->
</html>
