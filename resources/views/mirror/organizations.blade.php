...
<!-- Mirrored from www.geic.in/organizations by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:36:17 GMT -->
...
<meta property='og:type' content='website'>
    ...
    <title>Organizations | Trans Globe Indore LMS</title>
    ...
    <link rel="stylesheet" href="assets/design_1/css/app.min.css">
        ...
        <link rel="stylesheet" href="assets/design_1/css/parts/organizations_lists.min.css">
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
        ...
        <section class="organizations-lists-hero position-relative">
            ...
            <img src="store/1/themes/general/organizations_background.jpg" class="img-cover" alt="Organizations"/>
        </section>


        <div class="container">

            <div class="organizations-lists-header position-relative">
    <div class="organizations-lists-header__mask"></div>
  ...
  <path d="M16.831 15.64a1 1 0 011.55.84v1.29c0 1.27-.99 2.63-2.18 3.03l-3.19 1.06c-.56.19-1.47.19-2.02 0l-3.19-1.06c-1.2-.4-2.18-1.76-2.18-3.03v-1.3c0-.79.88-1.27 1.54-.84l2.06 1.34c.79.53 1.79.79 2.79.79s2-.26 2.79-.79l2.03-1.33z"/>
  <path d="M19.98 6.459l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0l-6.02 3.93c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9v3.06c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
</svg>            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
</svg>                <span class="">Organizations</span>
            </div>

            <h1 class="font-24 font-weight-bold mt-12">Organizations</h1>
            <div class="font-12 text-gray-500 mt-8">Explore all organizations in one place and find the right one for you</div>
        </div>

                    <div class="organizations-lists-header__overlay-img">
                <img src="store/1/themes/general/organizations_overlay.png" alt="Overlay Image" class="img-cover">
            </div>
            </div>
</div>
        ...
        <form action="https://www.geic.in/organizations" class="js-get-view-data-by-timeout-change container" data-container-id="listsContainer">
    ...
    <div class="position-relative z-index-2 d-flex flex-column flex-lg-row align-items-lg-center justify-content-lg-between bg-white p-12 rounded-24">
        <div class="form-group mb-0 d-flex align-items-center">
            ...
            <div class="">
                <label class="cursor-pointer" for="top_filter_available_for_meetings">Show Only Available Organizations</label>
            </div>
        </div>
        ...
        <div class="form-group mb-0 mt-16 mt-lg-0" style="width: 200px">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-3 mt-28">
                    <div class="position-relative organizations-lists-filters mt-12">
    <div class="organizations-lists-filters__mask"></div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
            ...
            <div id="leftFiltersSkills" class="accordion__collapse show pt-0 mt-0 border-0" role="tabpanel">
                <div class="form-group mb-0 mt-24 ">
                    <label class="form-group-label">Skill Category</label>
                    <select class="js-skills-select form-control select2">
                        <option value="">Select a Category</option>
                                                    <option value="520">Design</option>
                                                    <option value="522">Academics</option>
                                                    <option value="523">Health &amp; Fitness</option>
                                                    <option value="524">Lifestyle</option>
                                                    <option value="525">Marketing</option>
                                                    <option value="526">Business</option>
                                                    <option value="528">Development</option>
                                            </select>
                </div>
...
<div class="position-relative organizations-lists-filters mt-28">
    <div class="organizations-lists-filters__mask"></div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
            ...
            <div id="leftFiltersMeetingOptions" class="accordion__collapse show pt-0 mt-0 border-0" role="tabpanel">
                        ...
                        <input type="checkbox" name="meeting_options[]" value="available_for_meetings" id="filter_meeting_options_available_for_meetings" class="custom-control-input">
                        <label class="custom-control__label cursor-pointer" for="filter_meeting_options_available_for_meetings">update.available_for_meetings</label>
                    </div>
                                    <div class="custom-control custom-checkbox mt-12">
                        <input type="checkbox" name="meeting_options[]" value="free_meetings" id="filter_meeting_options_free_meetings" class="custom-control-input">
                        <label class="custom-control__label cursor-pointer" for="filter_meeting_options_free_meetings">Free Meetings</label>
                    </div>
                                    <div class="custom-control custom-checkbox mt-12">
                        <input type="checkbox" name="meeting_options[]" value="meetings_discount" id="filter_meeting_options_meetings_discount" class="custom-control-input">
                        <label class="custom-control__label cursor-pointer" for="filter_meeting_options_meetings_discount">Meeting Discounts</label>
                    </div>
                            </div>
        </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
            ...
            <div id="leftFiltersOtherOptions" class="accordion__collapse show pt-0 mt-0 border-0" role="tabpanel">
                                    <div class="custom-control custom-checkbox mt-16">
                        <input type="checkbox" name="meeting_options[]" value="organization_with_courses" id="filter_meeting_options_organization_with_courses" class="custom-control-input">
                        <label class="custom-control__label cursor-pointer" for="filter_meeting_options_organization_with_courses">Organization with Courses</label>
                    </div>
                                    <div class="custom-control custom-checkbox mt-12">
                        <input type="checkbox" name="meeting_options[]" value="verified_organizations_only" id="filter_meeting_options_verified_organizations_only" class="custom-control-input">
                        <label class="custom-control__label cursor-pointer" for="filter_meeting_options_verified_organizations_only">Verified Organizations Only</label>
                    </div>
                            </div>
        </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
            ...
            <div id="leftFiltersOrganization" class="accordion__collapse show pt-0 mt-0 border-0" role="tabpanel">
                <div class="form-group mb-0 mt-24">
                    <label class="form-group-label">update.organization_organization</label>
...
<script defer src="assets/design_1/js/parts/content_delete.min.js"></script>
    ...
    <script>
        var selectedCloseIcon = `<svg width="16px" height="16px" class="icons close-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M6 12h12M12 18V6"/>
</svg>`;
    </script>
    ...
    <script src="assets/design_1/js/parts/instructors_lists.min.js"></script>
