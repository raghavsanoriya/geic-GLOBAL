...
<!-- Mirrored from lms.rocket-soft.org/jobs by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:25:00 GMT -->
...
<meta property='og:type' content='website'>
    ...
    <link rel="stylesheet" href="assets/design_1/css/parts/jobs_lists.min.css">
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
        ...
        <div class="jobs-lists-hero__bg-wrapper rounded-32 light-only"  style="background-image: url(store/1/default_images/jobboard/jobs_hero.svg)" ></div>
        <div class="jobs-lists-hero__bg-wrapper rounded-32 dark-only"  style="background-image: url(store/1/default_images/jobboard/jobs_hero_dark.svg)" ></div>

        <div class="position-relative z-index-2 d-flex-center flex-column text-center w-100 h-100">
            <div class="row justify-content-center w-100">

                <div class="col-12 col-lg-10 position-relative">
                                            <div class="jobs-lists-hero__badge-box d-inline-flex-center py-8 px-16 rounded-32 bg-primary font-12 text-white">Get Hired</div>
                    

                    <h1 class="jobs-lists-hero__title text-dark d-inline-flex-center flex-column gap-4">
                                                    <span class="">Find Your Next Great Career</span>
                        
                                                    <span class="">Opportunity Today</span>
                                            </h1>
                </div>

                <div class="col-12 col-lg-6 position-relative">
                                            <p class="mt-20 font-16 text-gray-500">Explore jobs and internships designed to match your expertise and career ambitions</p>
                            ...
                            <form action="#" method="get" class="position-relative z-index-3 d-flex align-items-center gap-4 mb-0 bg-white rounded-36 p-12">
                                <input type="text" name="search" class="" placeholder="What job are you looking for?" value="">

                                <button type="submit" class="btn btn-primary btn-lg rounded-32">Search</button>
                            </form>
                        </div>
                    
                                            <div class="d-flex-center flex-column mt-40">
                            <h5 class="font-14">Or explore popular jobs</h5>

                            <div class="d-flex align-items-center flex-wrap gap-16 mt-20">
                                                                                                            <a href="jobs/product-manager.html" target="_blank" class="font-weight-bold text-gray-500">Product Management</a>

                                                                                    <div class="jobs-lists-hero__circle-dot-separator"></div>
                                                                                                                                                                                        <a href="jobs/backend-engineer.html" target="_blank" class="font-weight-bold text-gray-500">Backend Development</a>
                    ...
                    <img src="store/1/default_images/jobboard/jobhero_plant.png" alt="Floating Image #1" class="img-fluid">
                </div>
            
            
                            <div class="jobs-lists-hero__floating-image-2">
                    <img src="store/1/default_images/jobboard/jobhero_briefcase.png" alt="Floating Image #2" class="img-fluid">
                </div>
            
        </div>
    </div>

        <form action="https://lms.rocket-soft.org/jobs" class="js-get-view-data-by-timeout-change container mt-40" data-container-id="listsContainer">
    ...
    <div class="position-relative d-flex flex-column flex-lg-row align-items-lg-center justify-content-lg-between gap-20 bg-white px-24 py-12 rounded-24 z-index-2">
        <div class="d-flex align-items-center flex-wrap gap-48">
                    ...
                    <div class="custom-switch mr-8">
                        <input id="top_filter_open_positions_only" type="checkbox" name="open_positions_only" value="on" class="custom-control-input">
                        <label class="custom-control-label cursor-pointer" for="top_filter_open_positions_only"></label>
                    </div>

                    <div class="">
                        <label class="cursor-pointer" for="top_filter_open_positions_only">Open Positions Only</label>
                    </div>
                </div>
                    </div>
        ...
        <div class="d-flex align-items-center gap-16">
            ...
            <div class="jobs-lists-sort-input form-group  mb-0">
        ...
        <div class="position-relative z-index-2">
            ...
            <div class="card-before-line card-before-line--white card-before-line__4-12 px-16">
                <h5 class="font-14 font-weight-bold text-white">Featured Jobs</h5>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M9.57 5.93L3.5 12l6.07 6.07M20.5 12H3.67"/>
                ...
                <div class="swiper-wrapper py-32">
                            ...
                            <a href="jobs/frontend-developer.html" class="">
                                <div class="position-relative d-flex-center flex-column text-center">
                                    ...
                                    <div class="jobs-lists-featured__avatar size-80 rounded-circle">
                                        <img src="store/1/default_images/courses/icons/course_icon20.svg" alt="Frontend Developer" class="position-relative img-cover rounded-circle">
                                    </div>

                                    <h6 class="mt-28 font-16 font-weight-bold text-white">Frontend Developer</h6>

                                    
                                                                            <div class="d-flex-center gap-4 font-12 text-white">
                                            <svg height="16" width="16" class="text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  <path d="M20.5 12.3l-.15.09a17.037 17.037 0 01-5.79 2.08c-.08.96-.5 2.06-2.69 2.06s-2.61-1.09-2.69-2.04c-1.91-.3-3.79-.93-5.5-1.88-.15-.08-.3-.16-.44-.25-.36-.2-.7-.42-1.03-.64-.02-.01-.04-.03-.05-.04l.61 6.51c.21 1.99 1.03 4.04 5.43 4.04h7.62c4.4 0 5.22-2.05 5.43-4.05l.63-6.78a.12.12 0 01-.05.05c-.43.31-.87.6-1.33.85z" opacity=".4"/>
                                    ...
                                    <div class="position-relative mt-16 d-flex align-items-center w-100">
                                        <div class="d-flex-center flex-column text-center flex-1">
                                            <div class="font-12 text-white">Salary</div>
                                        ...
                                        <div class="d-flex-center flex-column text-center flex-1">
                                            <div class="font-12 text-white">Location</div>
                            ...
                            <a href="jobs/ui-ux-designer.html" class="">
                                <div class="position-relative d-flex-center flex-column text-center">
                                    ...
                                    <div class="jobs-lists-featured__avatar size-80 rounded-circle">
                                        <img src="store/1/default_images/courses/icons/course_icon29.svg" alt="UI/UX Designer" class="position-relative img-cover rounded-circle">
                                    </div>

                                    <h6 class="mt-28 font-16 font-weight-bold text-white">UI/UX Designer</h6>
  ...
  <path d="M12 12.26H9c-.41 0-.75.34-.75.75s.34.75.75.75h3c.41 0 .75-.34.75-.75s-.34-.75-.75-.75zM9 9.76h3c.41 0 .75-.34.75-.75s-.34-.75-.75-.75H9c-.41 0-.75.34-.75.75s.34.75.75.75zM5.97 8.01c-.56 0-1 .45-1 1s.45 1 1 1 1-.45 1-1-.45-1-1-1zM5.97 12.01c-.56 0-1 .45-1 1s.45 1 1 1 1-.45 1-1-.45-1-1-1z"/>
                            ...
                            <a href="jobs/data-scientist.html" class="">
                                <div class="position-relative d-flex-center flex-column text-center">
                                    ...
                                    <div class="jobs-lists-featured__avatar size-80 rounded-circle">
                                        <img src="store/1/default_images/courses/icons/course_icon19.svg" alt="Data Scientist" class="position-relative img-cover rounded-circle">
                                    </div>

                                    <h6 class="mt-28 font-16 font-weight-bold text-white">Data Scientist</h6>
  ...
  <path d="M20.5 12.3l-.15.09a17.037 17.037 0 01-5.79 2.08c-.08.96-.5 2.06-2.69 2.06s-2.61-1.09-2.69-2.04c-1.91-.3-3.79-.93-5.5-1.88-.15-.08-.3-.16-.44-.25-.36-.2-.7-.42-1.03-.64-.02-.01-.04-.03-.05-.04l.61 6.51c.21 1.99 1.03 4.04 5.43 4.04h7.62c4.4 0 5.22-2.05 5.43-4.05l.63-6.78a.12.12 0 01-.05.05c-.43.31-.87.6-1.33.85z" opacity=".4"/>
                                    ...
                                    <div class="position-relative mt-16 d-flex align-items-center w-100">
                                        ...
                                        <div class="d-flex-center flex-column text-center flex-1">
                                            ...
                                            <div class="swiper-slide">
                            <a href="jobs/system-administrator.html" class="">
                                <div class="position-relative d-flex-center flex-column text-center">

                                    <div class="jobs-lists-featured__avatar size-80 rounded-circle">
                                        <img src="store/1/default_images/courses/icons/course_icon2.svg" alt="System Administrator" class="position-relative img-cover rounded-circle">
                                    </div>

                                    <h6 class="mt-28 font-16 font-weight-bold text-white">System Administrator</h6>
    ...
    <div id="leftFiltersAccordion" class="position-relative card-before-line card-before-line__4-12 bg-white py-16 rounded-24 z-index-2">
        <div class="font-14 font-weight-bold text-dark px-16">
            Job Categories
                                    ...
                                    <div class="js-get-view-data-by-tab mt-16 px-16 cursor-pointer font-weight-bold " data-filter-name="category_id" data-filter-value="1" data-container-id="listsContainer">Software Development &amp; Engineering</div>
                                                <div class="js-get-view-data-by-tab mt-16 px-16 cursor-pointer font-weight-bold " data-filter-name="category_id" data-filter-value="2" data-container-id="listsContainer">Data Science &amp; Analytics</div>
                                                <div class="js-get-view-data-by-tab mt-16 px-16 cursor-pointer font-weight-bold " data-filter-name="category_id" data-filter-value="3" data-container-id="listsContainer">Design &amp; Creative</div>
                                                <div class="js-get-view-data-by-tab mt-16 px-16 cursor-pointer font-weight-bold " data-filter-name="category_id" data-filter-value="4" data-container-id="listsContainer">Digital Marketing &amp; Growth</div>
                                                <div class="js-get-view-data-by-tab mt-16 px-16 cursor-pointer font-weight-bold " data-filter-name="category_id" data-filter-value="5" data-container-id="listsContainer">Business &amp; Management</div>
                        </div>
</div>
...
<div class="position-relative jobs-lists-filters mt-28">
            ...
            <div id="leftFiltersJobTypes" class="accordion__collapse show pt-0 mt-0 border-0" role="tabpanel">
                        ...
                        <select name="employment_type" class="form-control select2">
                            <option value="">All</option>
                                                            ...
                                                            <option value="4">Commission-based</option>
                                                    </select>
                    </div>
                
                
                                    <div class="form-group">
                        <label class="form-group-label">Experience Level</label>
                        <select name="experience_level" class="form-control select2">
                            <option value="">All</option>
                                                            ...
                                                            <option value="4">Lead / Manager</option>
                                                    </select>
                    </div>
                
                
                <div class="form-group mb-0 mt-20">
                    <label class="form-group-label">Work Arrangement</label>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
            ...
            <div id="leftFiltersMoreOptions" class="accordion__collapse show pt-0 mt-0 border-0" role="tabpanel">
                        ...
                        <input type="checkbox" name="more_options[]" value="featured_jobs" id="filter_more_option_featured_jobs" class="custom-control-input">
                        <label class="custom-control__label cursor-pointer" for="filter_more_option_featured_jobs">Featured Jobs</label>
                    </div>
                                    <div class="custom-control custom-checkbox mt-12">
                        <input type="checkbox" name="more_options[]" value="negotiable_salary" id="filter_more_option_negotiable_salary" class="custom-control-input">
                        <label class="custom-control__label cursor-pointer" for="filter_more_option_negotiable_salary">Negotiable Salary</label>
                    </div>
                            </div>
        </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
            ...
            <div id="leftFiltersPrices" class="accordion__collapse show pt-0 mt-0 border-0" role="tabpanel">
                ...
                <div class="d-flex align-items-center mt-16">
                    ...
                    <div class="mx-4"></div>
                    <div class="form-group mb-0">
                        <input type="tel" readonly value="0" class="js-filters-max-price form-control input-xs bg-white text-center text-gray-500">
                    </div>
                </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
            ...
            <div id="leftFiltersJobEmployer" class="accordion__collapse show pt-0 mt-0 border-0" role="tabpanel">
                ...
                <div class="form-group mt-24 ">
                    <label class="form-group-label" for="employer_type">Employer Type</label>
                ...
                <div class="form-group mb-0 ">
                    <label class="form-group-label">Employer</label>
                    <select name="employer" class="form-control searchable-select bg-white" data-allow-clear="true" data-placeholder="Search and select an employer"
                ...
                <div class="col-12 col-lg-9 mt-4">
                    <div id="listsContainer" class="" data-body=".js-lists-body" data-view-data-path="/jobs">
  ...
  <path d="M20.5 12.3l-.15.09a17.037 17.037 0 01-5.79 2.08c-.08.96-.5 2.06-2.69 2.06s-2.61-1.09-2.69-2.04c-1.91-.3-3.79-.93-5.5-1.88-.15-.08-.3-.16-.44-.25-.36-.2-.7-.42-1.03-.64-.02-.01-.04-.03-.05-.04l.61 6.51c.21 1.99 1.03 4.04 5.43 4.04h7.62c4.4 0 5.22-2.05 5.43-4.05l.63-6.78a.12.12 0 01-.05.05c-.43.31-.87.6-1.33.85z" opacity=".4"/>
        ...
        <a href="jobs/devops-engineer.html" class="">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center gap-4 font-12 text-gray-500">
                    ...
                    <span class="">Hybrid</span>
                            ...
                            <a href="jobs/devops-engineer.html" class="btn btn-primary gap-4">
                    <span class="">Apply</span>
                    <svg width="16px" height="16px" class="icons" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M14.43 5.93L20.5 12l-6.07 6.07M3.5 12h16.83"/>
</svg>                </a>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M15 19.92L8.48 13.4c-.77-.77-.77-2.03 0-2.8L15 4.08"/>
                                                            ...
                                                            <li class="page-item"><a class="page-link" href="jobs4658.html?page=2">2</a></li>
                            
                                                                                                    
            
                            <li class="page-item">
                    <a class="page-link" href="jobs4658.html?page=2" rel="next" aria-label="Next &raquo;">
                        <svg width="14px" height="14px" class="icons" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
</svg>                    </a>
                </li>
...
<script defer src="assets/design_1/js/parts/content_delete.min.js"></script>
    ...
    <script src="assets/design_1/js/parts/jobs_lists.min.js"></script>
...
<!-- Mirrored from lms.rocket-soft.org/jobs by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:25:25 GMT -->
</html>
