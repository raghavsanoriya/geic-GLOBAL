...
<!-- Mirrored from lms.rocket-soft.org/products?category_id=3 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:35:47 GMT -->
...
<meta name='robots' content="NOODP, nofollow, noindex">
    ...
    <meta name="description" content="Store Products Description">
    <meta property="og:description" content="Store Products Description">
    <meta name='twitter:description' content='Store Products Description'>
...
<!-- Open Graph -->
<meta property='og:title' content='Store Products'>
<meta name='twitter:card' content='summary'>
<meta name='twitter:title' content='Store Products'>
...
<meta property='og:type' content='website'>
    ...
    <title>Store Products | Rocket LMS</title>
    ...
    <link rel="stylesheet" href="https://lms.rocket-soft.org/assets/design_1/css/app.min.css">
        ...
        <link rel="stylesheet" href="https://lms.rocket-soft.org/assets/vendors/wrunner-html-range-slider-with-2-handles/css/wrunner-default-theme.css">
    <link rel="stylesheet" href="https://lms.rocket-soft.org/assets/default/vendors/swiper/swiper-bundle.min.css">
    <link rel="stylesheet" href="https://lms.rocket-soft.org/assets/design_1/css/parts/swiperjs.min.css">
    <link rel="stylesheet" href="https://lms.rocket-soft.org/assets/design_1/css/parts/products_lists.min.css">
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
        ...
        <section class="products-lists-hero position-relative">
            ...
            <img src="https://lms.rocket-soft.org/store/1/themes/general/products_list_background.jpg" class="img-cover" alt="Products"/>
        </section>
  ...
  <path d="M19.65 10.7H4.36c-.29 0-.61-.01-.9-.09l1.26 7.69C5 20.02 5.75 22 9.08 22h5.61c3.37 0 3.97-1.69 4.33-3.58l1.51-7.81c-.28.07-.58.09-.88.09zM12 18.5a4.26 4.26 0 01-4.25-4.25c0-.41.34-.75.75-.75s.75.34.75.75C9.25 15.77 10.48 17 12 17s2.75-1.23 2.75-2.75c0-.41.34-.75.75-.75s.75.34.75.75A4.26 4.26 0 0112 18.5z"/>
                        ...
                        <div class="d-flex align-items-center mt-16 text-gray-500">
                            <a href="https://lms.rocket-soft.org/" class="text-gray-500">Rocket LMS</a>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
</svg>                            <span class="">Store</span>
                        </div>

                        <h1 class="font-24 font-weight-bold mt-12">Store</h1>
                        <div class="font-12 text-gray-500 mt-8">Easily buy virtual and physical products</div>
                    </div>

                                            <div class="products-lists-header__overlay-img">
                            <img src="https://lms.rocket-soft.org/store/1/themes/general/products_overlay.png" alt="Overlay Image" class="img-cover">
                        </div>
                                    </div>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M15 19.92L8.48 13.4c-.77-.77-.77-2.03 0-2.8L15 4.08"/>
        ...
        >
            <div class="swiper-wrapper py-0">
                        ...
                        <a href="https://lms.rocket-soft.org/products?category_id=1" class="position-relative products-lists-top-category d-flex align-items-center p-12">
                            <div class="size-48 rounded-circle">
                                <img src="https://lms.rocket-soft.org/store/1/default_images/store/store_top_category.svg" alt="Design Tools" class="img-cover rounded-circle">
                            </div>

                            <div class="ml-8">
                                <h5 class="font-14 text-dark">Design Tools</h5>
                                <p class="mt-4 font-12 text-gray-500">2 products</p>
                            </div>
                        </a>
                    </div>
                                    <div class="swiper-slide">
                        <a href="https://lms.rocket-soft.org/products?category_id=2" class="position-relative products-lists-top-category d-flex align-items-center p-12">
                            <div class="size-48 rounded-circle">
                                <img src="https://lms.rocket-soft.org/store/1/default_images/store/store_top_category_2.svg" alt="Science Tools" class="img-cover rounded-circle">
                            </div>

                            <div class="ml-8">
                                <h5 class="font-14 text-dark">Science Tools</h5>
                                <p class="mt-4 font-12 text-gray-500">0 products</p>
                            </div>
                        </a>
                    </div>
                                    <div class="swiper-slide">
                        <a href="https://lms.rocket-soft.org/products?category_id=3" class="position-relative products-lists-top-category d-flex align-items-center p-12">
                            <div class="size-48 rounded-circle">
                                <img src="https://lms.rocket-soft.org/store/1/default_images/store/store_top_category_3.svg" alt="E-books" class="img-cover rounded-circle">
                            </div>

                            <div class="ml-8">
                                <h5 class="font-14 text-dark">E-books</h5>
                                <p class="mt-4 font-12 text-gray-500">4 products</p>
                            </div>
                        </a>
                    </div>
                                    <div class="swiper-slide">
                        <a href="https://lms.rocket-soft.org/products?category_id=17" class="position-relative products-lists-top-category d-flex align-items-center p-12">
                            <div class="size-48 rounded-circle">
                                <img src="https://lms.rocket-soft.org/store/1/default_images/store/store_top_category_4.svg" alt="Projects" class="img-cover rounded-circle">
                            </div>

                            <div class="ml-8">
                                <h5 class="font-14 text-dark">Projects</h5>
                                <p class="mt-4 font-12 text-gray-500">0 products</p>
                            </div>
                        </a>
                    </div>
                                    <div class="swiper-slide">
                        <a href="https://lms.rocket-soft.org/products?category_id=18" class="position-relative products-lists-top-category d-flex align-items-center p-12">
                            <div class="size-48 rounded-circle">
                                <img src="https://lms.rocket-soft.org/store/1/default_images/store/store_top_category_5.svg" alt="Templates" class="img-cover rounded-circle">
                            </div>

                            <div class="ml-8">
                                <h5 class="font-14 text-dark">Templates</h5>
                                <p class="mt-4 font-12 text-gray-500">0 products</p>
                            </div>
                        </a>
                    </div>
        ...
        <div class="products-lists-featured position-relative mt-48 bg-gray-200"  style="background-image: url('https://lms.rocket-soft.org/store/1/default_images/store/store_featured_categories_bg.svg')" >
        <div class="container position-relative h-100 pt-48 pb-56">

                            <div class="products-lists-featured__overlay-image d-flex-center">
                    <img src="https://lms.rocket-soft.org/store/1/default_images/store/store_featured_categories_overlay.png" alt="Overlay Image" class="img-fluid">
                </div>
                ...
                <div class="col-12 col-lg-3">
                    <div class="d-flex justify-content-center flex-column text-left w-100 h-100">
                        <div class="products-lists-featured__arrow">
                            <img src="https://lms.rocket-soft.org/assets/design_1/img/courses/featured_courses_arrow.svg" alt="featured_courses_arrow" class="">
                        </div>

                        <h3 class="font-24 font-weight-bold text-white">Featured Products</h3>
                        <div class="mt-8 text-white">Explore curated products in the store</div>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
        ...
        <form action="https://lms.rocket-soft.org/products" class="js-get-view-data-by-timeout-change container mt-24" data-container-id="listsContainer">
        ...
        <div class="d-flex align-items-center flex-wrap gap-16 gap-lg-48">
                    ...
                    <div class="">
                        <label class="cursor-pointer" for="top_filter_free">Free</label>
                            ...
                            <div class="form-group mb-0 d-flex align-items-center">
                    <div class="custom-switch mr-8">
                        <input id="top_filter_free_shipping" type="checkbox" name="free_shipping" value="on" class="custom-control-input">
                        <label class="custom-control-label cursor-pointer" for="top_filter_free_shipping"></label>
                    </div>

                    <div class="">
                        <label class="cursor-pointer" for="top_filter_free_shipping">Free Shipping</label>
                    </div>
                </div>
                            <div class="form-group mb-0 d-flex align-items-center">
                    <div class="custom-switch mr-8">
        ...
        <div class="products-lists-sort-input form-group mb-0">
            <select name="sort" class="form-control select2" data-minimum-results-for-search="Infinity">
                ...
                <option value="">All</option>
                                    ...
                                    <option value="best_rates">Top Rated</option>
                            </select>
        </div>
    ...
    <div id="leftFiltersAccordion" class="position-relative card-before-line card-before-line__4-12 bg-white py-16 rounded-24 z-index-2">
        <div class="font-14 font-weight-bold text-dark px-16">
            Store Categories
                                    ...
                                    <div class="js-get-view-data-by-tab mt-16 px-16 cursor-pointer font-weight-bold " data-filter-name="category_id" data-filter-value="1" data-container-id="listsContainer">Design Tools</div>
                                                <div class="js-get-view-data-by-tab mt-16 px-16 cursor-pointer font-weight-bold " data-filter-name="category_id" data-filter-value="2" data-container-id="listsContainer">Science Tools</div>
                                                <div class="js-get-view-data-by-tab mt-16 px-16 cursor-pointer font-weight-bold active" data-filter-name="category_id" data-filter-value="3" data-container-id="listsContainer">E-books</div>
                                                <div class="js-get-view-data-by-tab mt-16 px-16 cursor-pointer font-weight-bold " data-filter-name="category_id" data-filter-value="17" data-container-id="listsContainer">Projects</div>
                                                <div class="js-get-view-data-by-tab mt-16 px-16 cursor-pointer font-weight-bold " data-filter-name="category_id" data-filter-value="18" data-container-id="listsContainer">Templates</div>
                        </div>
</div>
...
<div class="position-relative products-lists-filters mt-28">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
            ...
            <div id="leftFiltersTypes" class="accordion__collapse show pt-0 mt-0 border-0" role="tabpanel">
                        ...
                        <input type="checkbox" name="type[]" value="virtual" id="filter_type_virtual" class="custom-control-input">
                        <label class="custom-control__label cursor-pointer" for="filter_type_virtual">Virtual</label>
                    </div>
                                    <div class="custom-control custom-checkbox mt-12">
                        <input type="checkbox" name="type[]" value="physical" id="filter_type_physical" class="custom-control-input">
                        <label class="custom-control__label cursor-pointer" for="filter_type_physical">Physical</label>
                    </div>
                            </div>
        </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
            ...
            <div id="leftFiltersMoreOptions" class="accordion__collapse show pt-0 mt-0 border-0" role="tabpanel">
                                    <div class="custom-control custom-checkbox mt-16">
                        <input type="checkbox" name="options[]" value="only_available" id="filter_type_only_available" class="custom-control-input">
                        <label class="custom-control__label cursor-pointer" for="filter_type_only_available">Only Available Items</label>
                    </div>
                                    <div class="custom-control custom-checkbox mt-12">
                        <input type="checkbox" name="options[]" value="products_with_points" id="filter_type_products_with_points" class="custom-control-input">
                        <label class="custom-control__label cursor-pointer" for="filter_type_products_with_points">Products with Points</label>
                    </div>
                                    <div class="custom-control custom-checkbox mt-12">
                        <input type="checkbox" name="options[]" value="featured" id="filter_type_featured" class="custom-control-input">
                        <label class="custom-control__label cursor-pointer" for="filter_type_featured">Featured</label>
                    </div>
                            </div>
        </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
            ...
            <div id="leftFiltersPrices" class="accordion__collapse show pt-0 mt-0 border-0" role="tabpanel">
                ...
                <div class="d-flex align-items-center mt-16">
                    ...
                    <div class="mx-4"></div>
                    <div class="form-group mb-0">
                        <input type="tel" readonly value="$3,000" class="js-filters-max-price form-control input-xs bg-white text-center text-gray-500">
                    </div>
                </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M19.92 15.05L13.4 8.53c-.77-.77-2.03-.77-2.8 0l-6.52 6.52"/>
            ...
            <div id="leftFiltersInstructor" class="accordion__collapse show pt-0 mt-0 border-0" role="tabpanel">
                <div class="form-group mb-0  mt-24">
                    <label class="form-group-label">Product Vendor</label>
                    <select name="seller" class="form-control searchable-select bg-white" data-allow-clear="true" data-placeholder="Search and select an instructor"
        ...
        <a href="https://lms.rocket-soft.org/products/ui-ux-playbook" class="text-decoration-none d-block">
    <div class="product-card position-relative">
        <div class="product-card__mask"></div>

        <div class="position-relative d-flex p-12 rounded-16 bg-white z-index-2">
            <div class="product-card__image rounded-16">
                <img src="https://lms.rocket-soft.org/store/1/default_images/store/products/book1.jpg" class="img-cover rounded-16" alt="Practical UI/UX Playbook E-book">
            </div>
            ...
            <div class="product-card__content ml-12 flex-1 d-flex flex-column">
                ...
                <div class="d-flex align-items-center my-16" onclick="event.stopPropagation()">
                    <a href="https://lms.rocket-soft.org/users/admin/profile" target="_blank" class="size-32 rounded-circle" onclick="event.stopPropagation()">
                        <img src="https://lms.rocket-soft.org/store/1/default_images/admin-avatar.jpg" class="img-cover rounded-circle" alt="Admin">
                    </a>

                    <div class="d-flex flex-column ml-4">
                        <a href="https://lms.rocket-soft.org/users/admin/profile" target="_blank" class="font-14 font-weight-bold text-dark" onclick="event.stopPropagation()">Admin</a>
                ...
                <div class="mt-auto d-flex align-items-center justify-content-between">
                    ...
                    <div class="">
                        <a href="https://lms.rocket-soft.org/products/ui-ux-playbook" class="text-decoration-none">
                            <div class="stars-card d-flex align-items-center ">
                    <span class="stars-card__item active">
                <svg width="14px" height="14px" class="icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
                    ...
                    <span class="ml-4 text-gray-500 font-14">(1)</span>
                                            ...
                                            <div class="d-flex align-items-center font-16 font-weight-bold text-primary">
                            <a href="https://lms.rocket-soft.org/products/ui-ux-playbook" class="text-decoration-none text-primary">
    ...
    <div class="col-12 col-lg-6 mt-24">
        <a href="https://lms.rocket-soft.org/products/How-to-Do-a-Website-UX-audit-ebook" class="text-decoration-none d-block">
    <div class="product-card position-relative">
        <div class="product-card__mask"></div>

        <div class="position-relative d-flex p-12 rounded-16 bg-white z-index-2">
            <div class="product-card__image rounded-16">
                <img src="https://lms.rocket-soft.org/store/1/default_images/store/products/uxbook.jpg" class="img-cover rounded-16" alt="How to Do a Website UX Audit E-book">
            </div>
            ...
            <div class="product-card__content ml-12 flex-1 d-flex flex-column">
                ...
                <div class="mt-auto d-flex align-items-center justify-content-between">
                    ...
                    <div class="">
                        <a href="https://lms.rocket-soft.org/products/How-to-Do-a-Website-UX-audit-ebook" class="text-decoration-none">
                                                    </a>
                    </div>

                                            <div class="d-flex align-items-center font-16 font-weight-bold text-primary">
                            <a href="https://lms.rocket-soft.org/products/How-to-Do-a-Website-UX-audit-ebook" class="text-decoration-none text-primary">
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
    ...
    <div class="col-12 col-lg-6 mt-24">
        <a href="https://lms.rocket-soft.org/products/chat-gpt-ui-ux" class="text-decoration-none d-block">
    <div class="product-card position-relative">
        <div class="product-card__mask"></div>

        <div class="position-relative d-flex p-12 rounded-16 bg-white z-index-2">
            <div class="product-card__image rounded-16">
                <img src="https://lms.rocket-soft.org/store/1/default_images/store/products/book2.jpg" class="img-cover rounded-16" alt="ChatGPT for UI/UX Design E-book">
            </div>
            ...
            <div class="product-card__content ml-12 flex-1 d-flex flex-column">
                ...
                <div class="d-flex align-items-center my-16" onclick="event.stopPropagation()">
                    <a href="https://lms.rocket-soft.org/users/ricardo-dave/profile" target="_blank" class="size-32 rounded-circle" onclick="event.stopPropagation()">
                        <img src="https://lms.rocket-soft.org/store/1016/setting/avatar.jpg" class="img-cover rounded-circle" alt="Ricardo Dave">
                    </a>

                    <div class="d-flex flex-column ml-4">
                        <a href="https://lms.rocket-soft.org/users/ricardo-dave/profile" target="_blank" class="font-14 font-weight-bold text-dark" onclick="event.stopPropagation()">Ricardo Dave</a>
                ...
                <div class="mt-auto d-flex align-items-center justify-content-between">
                    ...
                    <div class="">
                        <a href="https://lms.rocket-soft.org/products/chat-gpt-ui-ux" class="text-decoration-none">
                            <div class="stars-card d-flex align-items-center ">
                    <span class="stars-card__item active">
                <svg width="14px" height="14px" class="icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
                    ...
                    <span class="ml-4 text-gray-500 font-14">(1)</span>
                                            ...
                                            <div class="d-flex align-items-center font-16 font-weight-bold text-primary">
                            <a href="https://lms.rocket-soft.org/products/chat-gpt-ui-ux" class="text-decoration-none text-primary">
        ...
        >
            <div class="swiper-wrapper py-0 mx-16 mx-md-32">
                                    <div class="swiper-slide">
                        <a href="https://lms.rocket-soft.org/products?category_id=1" class="">
                            <div class="position-relative products-featured-category">
                                <img src="https://lms.rocket-soft.org/store/1/default_images/store/featured_store_category_1.jpg" alt="Design Tools" class="img-cover rounded-24">

                                <div class="products-featured-category__content d-flex flex-column align-items-start rounded-24 py-16">
                                    <div class="px-16">
                                        <span class="products-featured-category__product-count d-inline-flex-center px-8 py-4 rounded-24 font-12 text-white">2 products</span>
                                    </div>

                                    <div class="card-before-line card-before-line__4-12 px-16 mt-auto">
                                        <h5 class="font-14 text-white">Design Tools</h5>
                                        <p class="mt-4 text-white font-12">Create stunning visuals with powerful and user-friendly ...</p>
                                    </div>
                                </div>
                            </div>
                        </a>
                                    ...
                                    <div class="swiper-slide">
                        <a href="https://lms.rocket-soft.org/products?category_id=2" class="">
                            <div class="position-relative products-featured-category">
                                <img src="https://lms.rocket-soft.org/store/1/default_images/store/featured_store_category_2.jpg" alt="Science Tools" class="img-cover rounded-24">

                                <div class="products-featured-category__content d-flex flex-column align-items-start rounded-24 py-16">
                                    <div class="px-16">
                                        <span class="products-featured-category__product-count d-inline-flex-center px-8 py-4 rounded-24 font-12 text-white">0 products</span>
                                    </div>

                                    <div class="card-before-line card-before-line__4-12 px-16 mt-auto">
                                        <h5 class="font-14 text-white">Science Tools</h5>
                                        <p class="mt-4 text-white font-12">Explore experiments and concepts using practical science ...</p>
                                    </div>
                                </div>
                            </div>
                        </a>
                                    ...
                                    <div class="swiper-slide">
                        <a href="https://lms.rocket-soft.org/products?category_id=3" class="">
                            <div class="position-relative products-featured-category">
                                <img src="https://lms.rocket-soft.org/store/1/default_images/store/featured_store_category_3.jpg" alt="E-books" class="img-cover rounded-24">

                                <div class="products-featured-category__content d-flex flex-column align-items-start rounded-24 py-16">
                                    <div class="px-16">
                                        <span class="products-featured-category__product-count d-inline-flex-center px-8 py-4 rounded-24 font-12 text-white">4 products</span>
                                    </div>

                                    <div class="card-before-line card-before-line__4-12 px-16 mt-auto">
                                        <h5 class="font-14 text-white">E-books</h5>
                                        <p class="mt-4 text-white font-12">Access digital books for learning anytime and anywhere</p>
                                    </div>
                                </div>
                            </div>
                        </a>
                                    ...
                                    <div class="swiper-slide">
                        <a href="https://lms.rocket-soft.org/products?category_id=17" class="">
                            <div class="position-relative products-featured-category">
                                <img src="https://lms.rocket-soft.org/store/1/default_images/store/featured_store_category_4.jpg" alt="Projects" class="img-cover rounded-24">
                                ...
                                <div class="products-featured-category__content d-flex flex-column align-items-start rounded-24 py-16">
                                    ...
                                    <div class="card-before-line card-before-line__4-12 px-16 mt-auto">
                                        <h5 class="font-14 text-white">Projects</h5>
                                        <p class="mt-4 text-white font-12">Hands-on projects to apply and showcase your skills ...</p>
                                    </div>
                                </div>
                            </div>
                        </a>
                                    ...
                                    <div class="swiper-slide">
                        <a href="https://lms.rocket-soft.org/products?category_id=18" class="">
                            <div class="position-relative products-featured-category">
                                <img src="https://lms.rocket-soft.org/store/1/default_images/store/featured_store_category_5.jpg" alt="Templates" class="img-cover rounded-24">
                                ...
                                <div class="products-featured-category__content d-flex flex-column align-items-start rounded-24 py-16">
                                    ...
                                    <div class="card-before-line card-before-line__4-12 px-16 mt-auto">
                                        <h5 class="font-14 text-white">Templates</h5>
                                        <p class="mt-4 text-white font-12">Ready-to-use layouts to save valuable time and effort</p>
                                    </div>
                                </div>
                            </div>
                        </a>
...
<script defer src="https://lms.rocket-soft.org/assets/design_1/js/parts/content_delete.min.js"></script>
    ...
    <script src="https://lms.rocket-soft.org/assets/vendors/wrunner-html-range-slider-with-2-handles/js/wrunner-jquery.js"></script>
    <script src="https://lms.rocket-soft.org/assets/default/vendors/swiper/swiper-bundle.min.js"></script>
    <script src="https://lms.rocket-soft.org/assets/design_1/js/parts/range_slider_helpers.min.js"></script>
    <script src="https://lms.rocket-soft.org/assets/design_1/js/parts/swiper_slider.min.js"></script>
    <script src="https://lms.rocket-soft.org/assets/design_1/js/parts/get_view_data.min.js"></script>

    <script src="https://lms.rocket-soft.org/assets/design_1/js/parts/products_lists.min.js"></script>
