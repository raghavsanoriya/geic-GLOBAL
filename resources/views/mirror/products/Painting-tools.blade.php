...
<!-- Mirrored from lms.rocket-soft.org/products/Painting-tools by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:35:58 GMT -->
...
<meta name='robots' content="index, follow, all">
    ...
    <meta name="description" content="Here are some of Manfredini&#039;s favorite must-have paint products for a flawless finish and a handful of appealing painter accessories that you can skip altogether">
    <meta property="og:description" content="Here are some of Manfredini&#039;s favorite must-have paint products for a flawless finish and a handful of appealing painter accessories that you can skip altogether">
    <meta name='twitter:description' content='Here are some of Manfredini&#039;s favorite must-have paint products for a flawless finish and a handful of appealing painter accessories that you can skip altogether'>
...
<meta name='twitter:title' content='Painting tools'>


<meta property='og:site_name' content='https://lms.rocket-soft.org/Rocket LMS'>
<meta property='og:image' content='../store/1/default_images/store/products/painting.jpg'>
<meta name='twitter:image' content='../store/1/default_images/store/products/painting.jpg'>
<meta property='og:locale' content='../en_US.html'>
<meta property='og:type' content='website'>



    <title>Painting tools | Rocket LMS</title>
    ...
    <link rel="stylesheet" href="../assets/default/vendors/simplebar/simplebar.css">
    <link rel="stylesheet" href="../assets/design_1/css/parts/swiperjs.min.css">
    ...
    <link rel="stylesheet" href="../assets/design_1/css/parts/product_show.min.css">
    <link rel="stylesheet" href="../assets/design_1/css/parts/instructor_discounts.min.css">
...
<div id="app">
  ...
  <path d="M19.98 6.46l-5.99-3.93c-1.08-.71-2.86-.71-3.94 0L4.03 6.46c-1.93 1.25-1.93 4.08 0 5.34l1.6 1.04 4.42 2.88c1.08.71 2.86.71 3.94 0l4.39-2.88 1.37-.9V15c0 .41.34.75.75.75s.75-.34.75-.75v-4.92c.4-1.29-.01-2.79-1.27-3.62z"/>
    ...
    <img src="../store/1/default_images/store/products/painting.jpg" alt="Painting tools" class="js-product-main-image img-cover rounded-24 p-16">

            <div class="product-show__has-video-icon d-flex-center size-120 rounded-circle">
            <svg width="45px" height="45px" class="icons text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
...
<div class="product-show__slide-images-card mt-16" data-simplebar >
    <div class="d-flex align-items-center gap-16">
        <div class="js-product-other-image position-relative product-show__slide-image-item d-flex-center rounded-24 bg-gray-100 cursor-pointer">
            <img src="../store/1/default_images/store/products/painting.jpg" alt="Painting tools" class="img-cover rounded-24">

                            <div class="product-show__has-video-icon d-flex-center size-48 rounded-circle">
                    <svg width="18px" height="18px" class="icons text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  <path d="M17.49 9.6L5.6 16.77c-.7.42-1.6-.08-1.6-.9v-8c0-3.49 3.77-5.67 6.8-3.93l4.59 2.64 2.09 1.2c.69.41.7 1.41.01 1.82zM18.089 15.46l-4.05 2.34-4.04 2.33c-1.45.83-3.09.66-4.28-.18-.58-.4-.51-1.29.1-1.65l12.71-7.62c.6-.36 1.39-.02 1.5.67.25 1.55-.39 3.22-1.94 4.11z"/>
</svg>                </div>
                    </div>

                                    <div class="js-product-other-image position-relative product-show__slide-image-item d-flex-center rounded-24 bg-gray-100 cursor-pointer">
                    <img src="../store/1015/store%20product/paint_brushes_1.jpg" alt="Painting tools" class="img-cover rounded-24">
                </div>
                            <div class="js-product-other-image position-relative product-show__slide-image-item d-flex-center rounded-24 bg-gray-100 cursor-pointer">
                    <img src="../store/1015/store%20product/paint_brushes_2.jpg" alt="Painting tools" class="img-cover rounded-24">
                </div>
                            <div class="js-product-other-image position-relative product-show__slide-image-item d-flex-center rounded-24 bg-gray-100 cursor-pointer">
                    <img src="../store/1015/store%20product/paint_brushes_3.jpg" alt="Painting tools" class="img-cover rounded-24">
                </div>
                        </div>
</div>
            </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
                            ...
                            <svg width="14px" height="14px" class="icons text-gray-500 mx-8" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M8.91 19.92l6.52-6.52c.77-.77.77-2.03 0-2.8L8.91 4.08"/>
</svg>                <a href="../productsbaa2.html?category_id=1" class="breadcrumb-item font-14 text-gray-500">Design Tools</a>
                    </div>

        <div class="d-flex align-items-center flex-wrap gap-12 mt-12">
            <h1 class="course-hero__title font-24 font-weight-bold text-dark text-ellipsis">Painting tools</h1>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
                ...
                <a href="../users/robert-ransdell/profile.html" target="_blank" class="d-flex align-items-center text-gray-500">
                    <svg width="16px" height="16px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
...
</svg>                    <span class="ml-4 font-12 font-weight-bold">Robert Ransdell</span>
                </a>

                <div class="d-flex align-items-center text-gray-500">
                    <svg width="16px" height="16px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M17 20.5H7c-3 0-5-1.5-5-5v-7c0-3.5 2-5 5-5h10c3 0 5 1.5 5 5v7c0 3.5-2 5-5 5z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M12 15a3 3 0 100-6 3 3 0 000 6zM2 9h1c3 0 4-1 4-4V4M22 9h-1c-3 0-4-1-4-4V4M2 15h1c3 0 4 1 4 4v1M22 15h-1c-3 0-4 1-4 4v1"/>
</svg>                    <span class="mx-4 font-12 font-weight-bold">4</span>
                    <span class="font-12 ">Sales</span>
                </div>

                                    <div class="d-flex align-items-center text-gray-500">
                        <svg width="16px" height="16px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 2v10c0 1.1-.9 2-2 2H2V7.62c.73.87 1.85 1.41 3.09 1.38 1.01-.02 1.92-.41 2.6-1.06.31-.26.57-.59.77-.95.36-.61.56-1.33.54-2.08-.03-1.17-.55-2.2-1.36-2.91H15z"/>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M5.25 3.75v1.5L4 6"/>
                        ...
                        <span class="font-12 ">Shipping Days</span>
                    </div>
                            </div>
    ...
    <div class="js-product-specifications">
                    <div class="mt-16">
                <h6 class="font-14 font-weight-bold text-dark">Size</h6>
                ...
                <div class="position-relative d-flex align-items-center gap-8 flex-wrap mt-12">
                                ...
                                <input type="radio" name="specifications[Size]" value="Small" id="Small" class="js-selectable-specification-item" checked >
                                <label class="d-inline-flex-center px-12 py-8 rounded-8 font-12 cursor-pointer" for="Small">Small</label>
                            </div>
                                                                                                <div class="product-show__selectable-specification-item">
                                <input type="radio" name="specifications[Size]" value="Medium" id="Medium" class="js-selectable-specification-item"  >
                                <label class="d-inline-flex-center px-12 py-8 rounded-8 font-12 cursor-pointer" for="Medium">Medium</label>
                            </div>
                                                                                                <div class="product-show__selectable-specification-item">
                                <input type="radio" name="specifications[Size]" value="Large" id="Large" class="js-selectable-specification-item"  >
                                <label class="d-inline-flex-center px-12 py-8 rounded-8 font-12 cursor-pointer" for="Large">Large</label>
                            </div>
                                                            </div>
            </div>
            </div>
    ...
    <div class="d-flex align-items-center font-24 font-weight-bold text-primary mt-24">
            ...
            <svg width="16px" height="16px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 14h1c1.1 0 2-.9 2-2V2H6c-1.5 0-2.81.83-3.49 2.05"/>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8 22a2 2 0 100-4 2 2 0 000 4zM16 22a2 2 0 100-4 2 2 0 000 4zM22 12v2h-3c-.55 0-1-.45-1-1v-3c0-.55.45-1 1-1h1.29L22 12zM2 8h6M2 11h4M2 14h2"/>
                            ...
                            <span class="ml-4">+ $5 Shipping Fee</span>
                    </div>
    ...
    <div class="mt-20">
        <h4 class="font-14 font-weight-bold">Quantity</h4>
        ...
        <div class="js-product-quantity-card product-show__quantity-card d-inline-flex align-items-center gap-4 mt-12 p-8 rounded-12 bg-white">
            <input type="hidden" id="productAvailabilityCount" value="20">

            <button type="button" class="minus d-flex-center bg-gray-100 rounded-8" >
                <svg width="14px" height="14px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M6 12h12"/>
</svg>            </button>

            <input type="number" name="quantity" value="1"  class="bg-white font-14 font-weight-bold" data-item="1">

            <button type="button" class="plus d-flex-center bg-gray-100 rounded-8" >
                <svg width="14px" height="14px" class="icons text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
...
</svg>            <span class="ml-4 text-white">Add to Cart</span>
        </button>
...
</svg>                <span class="ml-4 ">Buy now!</span>
            </button>
  ...
  <path d="M5.5 14c-1.15 0-2.21.44-3 1.16A4.428 4.428 0 001 18.5 4.5 4.5 0 005.5 23c1.08 0 2.06-.38 2.84-1 .63-.53 1.13-1.21 1.4-2 .17-.47.26-.97.26-1.5A4.5 4.5 0 005.5 14zm2.7 3.63c0 .31-.25.55-.55.55-.3 0-.55-.24-.55-.55v-.11c0-.12-.09-.22-.21-.22H4.63a.547.547 0 01-.48.81c-.14 0-.28-.06-.38-.16l-.81-.81a.567.567 0 01-.12-.18.607.607 0 010-.42c.03-.06.07-.13.12-.18l.81-.8c.21-.22.56-.22.77 0 .18.17.2.44.09.64h2.26c.72 0 1.31.59 1.31 1.32v.11zM6.85 21.6c-.15 0-.29-.05-.39-.16a.532.532 0 01-.09-.64H4.11c-.72 0-1.31-.59-1.31-1.32v-.11c0-.31.25-.55.55-.55.3 0 .55.24.55.55v.11c0 .12.09.22.21.22h2.26a.547.547 0 01.09-.65.55.55 0 01.77 0l.81.81c.05.05.09.11.12.18.05.13.05.28 0 .42-.03.06-.07.13-.12.18l-.81.8c-.1.11-.24.16-.38.16zM14.85 3.95v3.8H6.26c-2.07 0-3.76 1.69-3.76 3.76V7.84c0-1.19.73-2.25 1.84-2.67l7.94-3c1.24-.46 2.57.45 2.57 1.78zM22.56 13.97v2.06c0 .55-.44 1-1 1.02H19.6c-1.08 0-2.07-.79-2.16-1.87-.06-.63.18-1.22.6-1.63.37-.38.88-.6 1.44-.6h2.08c.56.02 1 .47 1 1.02zM14 12.75H7c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h7c.41 0 .75.34.75.75s-.34.75-.75.75z"/>
                ...
                <div class="ml-8">
                    ...
                    <div class="instructor-discount-card d-flex align-items-center justify-content-between bg-white rounded-16 px-16 wrapped-item">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17 13.4h-3.2c-2.4 0-3.2-.8-3.2-3.2V7l6.4 6.4zM11.6 2h4M7 5c0-1.66 1.34-3 3-3h2.62M22 8v6.19c0 1.55-1.26 2.81-2.81 2.81M22 8h-3c-2.25 0-3-.75-3-3V2l6 6z"/>
        ...
        <div class="custom-tabs mt-16">
            <div class="product-show-tabs-card position-relative">
                ...
                <div class="position-relative product-show-tabs-card__items d-flex align-items-center gap-20 gap-lg-40 bg-white px-20 rounded-12 z-index-2 w-100">
                    <div class="navbar-item d-flex-center cursor-pointer active" data-tab-toggle data-tab-href="#productDescriptionTab">
                        <span class="">Description</span>
                    </div>

                    <div class="navbar-item d-flex-center cursor-pointer " data-tab-toggle data-tab-href="#productSpecificationsTab">
                        <span class="">Specifications</span>
                    </div>

                    <div class="navbar-item d-flex-center cursor-pointer " data-tab-toggle data-tab-href="#productCommentsTab">
                        <span class="ml-4">Comments</span>
                    </div>

                    <div class="navbar-item d-flex-center cursor-pointer " data-tab-toggle data-tab-href="#productReviewsTab">
                        <span class="ml-4">Reviews</span>
                    </div>

                    <div class="navbar-item d-flex-center cursor-pointer " data-tab-toggle data-tab-href="#productSellerTab">
    ...
    <h3 class="font-16">About This Product</h3>
            ...
            <p>Here are some of Manfredini's favorite must-have paint products for a flawless finish and a handful of appealing painter accessories that you can skip altogether. Keep in mind that you may not need some of these products if your walls are in good shape and don't need a lot of repairs. (Just make sure you purchase some highly-rated paint first because a quality tool won't work miracles on low-quality paint).</p><p><br></p><h3 style="color: rgba(0, 0, 0, 0.95); font-variant-numeric: normal; font-variant-east-asian: normal; font-stretch: normal; font-size: 24px; line-height: 32px; font-family: Sophia, "Helvetica Neue", sans-serif; letter-spacing: 0.5px; margin-top: 32px; margin-bottom: 16px;">Paint Key</h3><div class="paragraph" style="color: rgba(0, 0, 0, 0.95); font-family: Lora, serif; font-size: medium;"><p style="font-variant-numeric: normal; font-variant-east-asian: normal; font-stretch: normal; font-size: 18px; line-height: 28px; letter-spacing: 0px; margin-bottom: 16px; max-width: 712px; overflow-wrap: anywhere;">You don't need a special tool to open your paint cans; a standard flat-head screwdriver works just fine.</p></div><h3 style="color: rgba(0, 0, 0, 0.95); font-variant-numeric: normal; font-variant-east-asian: normal; font-stretch: normal; font-size: 24px; line-height: 32px; font-family: Sophia, "Helvetica Neue", sans-serif; letter-spacing: 0.5px; margin-top: 32px; margin-bottom: 16px;">Plastic Tube for Paint Roller</h3><div class="paragraph" style="color: rgba(0, 0, 0, 0.95); font-family: Lora, serif; font-size: medium;"><p style="font-variant-numeric: normal; font-variant-east-asian: normal; font-stretch: normal; font-size: 18px; line-height: 28px; letter-spacing: 0px; margin-bottom: 16px; max-width: 712px; overflow-wrap: anywhere;">If you're done painting for the day but want to pick it back up tomorrow, cover the roller in plastic wrap, then throw it into a plastic bag with an air-tight seal.</p></div><h3 style="color: rgba(0, 0, 0, 0.95); font-variant-numeric: normal; font-variant-east-asian: normal; font-stretch: normal; font-size: 24px; line-height: 32px; font-family: Sophia, "Helvetica Neue", sans-serif; letter-spacing: 0.5px; margin-top: 32px; margin-bottom: 16px;">Paint Tray Liners</h3><div class="paragraph" style="color: rgba(0, 0, 0, 0.95); font-family: Lora, serif; font-size: medium;"><p style="font-variant-numeric: normal; font-variant-east-asian: normal; font-stretch: normal; font-size: 18px; line-height: 28px; letter-spacing: 0px; margin-bottom: 16px; max-width: 712px; overflow-wrap: anywhere;">These aren't necessary if you get a quality hard plastic paint tray. Plus, it's less wasteful if you don't throw away a plastic liner each time you paint.</p></div><div class="div-sm-inContent" style="color: rgba(0, 0, 0, 0.95); font-family: Lora, serif; font-size: medium;"><div id="div-gpt-native" class="tablet-ad desktop-ad ads-in-content" data-tier="1" data-google-query-id="CL7-utP6uPgCFWLFuwgdOBYNvQ"><div id="google_ads_iframe_3865/ddm.realsimple.com/ntv1_0__container__" style="border: 0pt none;"></div></div></div><h3 style="color: rgba(0, 0, 0, 0.95); font-variant-numeric: normal; font-variant-east-asian: normal; font-stretch: normal; font-size: 24px; line-height: 32px; font-family: Sophia, "Helvetica Neue", sans-serif; letter-spacing: 0.5px; margin-top: 32px; margin-bottom: 16px;">Paint Pads</h3><div class="paragraph" style="color: rgba(0, 0, 0, 0.95); font-family: Lora, serif; font-size: medium;"><p style="font-variant-numeric: normal; font-variant-east-asian: normal; font-stretch: normal; font-size: 18px; line-height: 28px; letter-spacing: 0px; margin-bottom: 16px; max-width: 712px; overflow-wrap: anywhere;">Skip these, unless you're using them to paint behind hard-to-reach areas like a toilet tank or radiator.</p></div><h3 style="color: rgba(0, 0, 0, 0.95); font-variant-numeric: normal; font-variant-east-asian: normal; font-stretch: normal; font-size: 24px; line-height: 32px; font-family: Sophia, "Helvetica Neue", sans-serif; letter-spacing: 0.5px; margin-top: 32px; margin-bottom: 16px;">Fillable Paint Products</h3><div class="paragraph" style="color: rgba(0, 0, 0, 0.95); font-family: Lora, serif; font-size: medium;"><p style="font-variant-numeric: normal; font-variant-east-asian: normal; font-stretch: normal; font-size: 18px; line-height: 28px; letter-spacing: 0px; margin-bottom: 16px; max-width: 712px; overflow-wrap: anywhere;">"Any gadget that sucks paint up into its handle is a nightmare to use and to clean. In the time it takes to refill it, you could already be painting," says Manfredini. The exception here is the touch-up tool that Manfredini recommended specifically.</p></div>
                ...
                <div class="custom-tabs-content " id="productSpecificationsTab">
                    <div class="bg-white p-16 rounded-24 mt-24">
    <h3 class="font-16">Product Specifications</h3>

    <div class="">
                                    <div class="product-show__specification-item d-flex align-items-start mt-16  ">
                    ...
                    <div class="specification-item-value flex-grow-1 px-16">
                            ...
                            <div class="product-show__specification-item d-flex align-items-start mt-16 pt-16 border-top-gray-200 ">
                    <div class="specification-item-name font-weight-bold text-gray-500 ">
                        Age Range
                    </div>

                    <div class="specification-item-value flex-grow-1 px-16">
                                                                                                                        <span class="d-block">3-5</span>
                                                                                                                                <span class="d-block">5-8</span>
                                                                                                                                <span class="d-block">8-13</span>
                                                                                                        </div>
                </div>
                        </div>
</div>
                ...
                <div class="custom-tabs-content " id="productCommentsTab">
...
<div class="js-reply-to-comment-html d-none">
  ...
  <path d="M12 2C6.49 2 2 6.49 2 12s4.49 10 10 10 10-4.49 10-10S17.51 2 12 2zm-.75 6c0-.41.34-.75.75-.75s.75.34.75.75v5c0 .41-.34.75-.75.75s-.75-.34-.75-.75V8zm1.67 8.38c-.05.13-.12.23-.21.33-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08s-.26-.03-.38-.08-.23-.12-.33-.21c-.09-.1-.16-.2-.21-.33A.995.995 0 0111 16c0-.13.03-.26.08-.38s.12-.23.21-.33c.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.09.1.16.21.21.33.05.12.08.25.08.38s-.03.26-.08.38z"/>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="custom-tabs-content " id="productReviewsTab">
                    <div class="bg-white p-16 rounded-24">
    ...
    <div class="review-rate-box position-relative">
        ...
        <div class="position-relative d-flex-center flex-column text-center bg-gray-100 border-gray-200 rounded-12 p-14 p-lg-20 z-index-2 w-100 h-100">
            <div class="font-44 font-weight-bold">4.25</div>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
    ...
    <div class="flex-1 ml-24">
            ...
            <div class="mt-16">
                <div class="font-12 text-gray-500">Product Quality (4)</div>
            ...
            <div class="mt-16">
                <div class="font-12 text-gray-500">Delivery Quality (4)</div>
                <div class="review-progress position-relative mt-8 rounded-4 bg-gray-100">
                    <span class="review-progress__bar rounded-4 bg-warning" style="width: 80%"></span>
                </div>
            </div>
            ...
            <div class="mt-16">
                <div class="font-12 text-gray-500">Seller Quality (5)</div>
                <div class="review-progress position-relative mt-8 rounded-4 bg-gray-100">
    ...
    <div class="d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center">
            <div class="size-48 rounded-circle bg-gray-100">
                <img src="../store/923/setting/avatar.jpg" class="js-avatar-img img-cover rounded-circle" alt="John Powe">
            </div>
            <div class="ml-8">
                <h6 class="font-14 font-weight-bold">John Powe</h6>
  ...
  <path d="M5.74 16c.11-.49-.09-1.19-.44-1.54l-2.43-2.43c-.76-.76-1.06-1.57-.84-2.27.23-.7.94-1.18 2-1.36l3.12-.52c.45-.08 1-.48 1.21-.89l1.72-3.45C10.58 2.55 11.26 2 12 2s1.42.55 1.92 1.54l1.72 3.45c.13.26.4.51.69.68L5.56 18.44c-.14.14-.38.01-.34-.19L5.74 16zM18.7 14.462c-.36.36-.56 1.05-.44 1.54l.69 3.01c.29 1.25.11 2.19-.51 2.64a1.5 1.5 0 01-.9.27c-.51 0-1.11-.19-1.77-.58l-2.93-1.74c-.46-.27-1.22-.27-1.68 0l-2.93 1.74c-1.11.65-2.06.76-2.67.31-.23-.17-.4-.4-.51-.7l12.16-12.16c.46-.46 1.11-.67 1.74-.56l1.01.17c1.06.18 1.77.66 2 1.36.22.7-.08 1.51-.84 2.27l-2.42 2.43z"/>
        ...
        <div class="d-flex align-items-center">
            <span class="font-12 text-gray-500">24 Jun 2022 16:57</span>
                ...
                <div class="actions-dropdown__dropdown-menu dropdown-menu-top-32">
                    <ul class="my-8">
                        ...
                        <li class="actions-dropdown__dropdown-menu-item">
                            <button type="button" class="js-reply-review" data-review="2">Reply</button>
                        </li>
...
<div class="js-reply-to-review-html d-none">
  ...
  <path d="M12 2C6.49 2 2 6.49 2 12s4.49 10 10 10 10-4.49 10-10S17.51 2 12 2zm-.75 6c0-.41.34-.75.75-.75s.75.34.75.75v5c0 .41-.34.75-.75.75s-.75-.34-.75-.75V8zm1.67 8.38c-.05.13-.12.23-.21.33-.1.09-.21.16-.33.21-.12.05-.25.08-.38.08s-.26-.03-.38-.08-.23-.12-.33-.21c-.09-.1-.16-.2-.21-.33A.995.995 0 0111 16c0-.13.03-.26.08-.38s.12-.23.21-.33c.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.09.1.16.21.21.33.05.12.08.25.08.38s-.03.26-.08.38z"/>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="custom-tabs-content " id="productSellerTab">
...
He enjoys teaching others how to use and exploit the power of the Linux operating system. He is also the author of the books "Linux for Beginners" and "Command Line Kung Fu."</div>
                            ...
                            <div class="mt-auto">
                    <h5 class="font-14">More from Robert Ransdell</h5>
                    <div class="d-grid grid-columns-auto grid-lg-columns-4 gap-16 gap-lg-32 mt-8 ">
                                                    <div class="d-flex align-items-center">
                                <div class="size-48 rounded-8 bg-gray-200">
                                    <img src="../store/1/default_images/store/products/software.jpg" alt="Business Software" class="img-cover rounded-8">
                                </div>
                                <div class="ml-8">
                                    <a href="Business-Software.html">
                                        <h3 class="font-14 text-dark">Business Software</h3>
                                    </a>
                                    <span class="mt-8 font-12 text-gray-500">E-books</span>
                                </div>
                            </div>
                                            </div>
                </div>
        ...
        <div class="product-seller-card__secondary-img position-relative mt-16 mt-0">
            ...
            <a href="../users/robert-ransdell/profile.html" target="_blank" class="product-seller-card__profile-btn d-flex-center">
                <svg width="24px" height="24px" class="icons text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M13 11l8.2-8.2M22 6.83V2h-4.83"/>
</svg>                <span class="ml-8 text-white">View Vendor Profile</span>
            </a>
        </div>
    </div>
</div>
        ...
        <div class="row">
                    <div class="mt-32 mt-lg-48 col-12">
                <a href="../forums.html" class="d-flex rounded-16">
                    <img src="../store/1/default_images/banners/forum-banner-full.png" class="img-cover rounded-16" alt="Forums - Product page">
                </a>
            </div>
            </div>
...
<script defer src="../assets/design_1/js/parts/content_delete.min.js"></script>
    ...
    <script src="../assets/design_1/js/parts/product_show.min.js"></script>
...
<!-- Mirrored from lms.rocket-soft.org/products/Painting-tools by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2026 16:36:00 GMT -->
</html>
