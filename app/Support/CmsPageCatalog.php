...
class CmsPageCatalog
{
    public static function all(): array
    {
        $pages = [
            self::page('home', 'Home page', 'Manage the header, hero, main content, conversion CTA and footer of the landing page.', [
                ...
                self::field('hero_title_accent', 'Hero highlighted title (optional)', '', 'text', 'Hero'),
                ...
                self::field('hero_primary_cta_url', 'Primary button link', '/contact#enquiry', 'text', 'Hero CTA'),
                ...
                self::field('services_cta_url', 'Section button link', '/contact#enquiry', 'text', 'Services section'),
                ...
                self::field('work_visa_cta_url', 'Section button link', '/contact#enquiry', 'text', 'Work visa pathways'),
                ...
                self::field('universities_cta_url', 'Section button link', '/contact#enquiry', 'text', 'University network'),
                ...
                self::field('popup_eyebrow', 'Popup badge', 'Coming soon · 2026', 'text', 'Homepage popup'),
                self::field('popup_title', 'Popup heading', 'Global Uni Expo 2026 — Europe & Dubai Admission Summit', 'text', 'Homepage popup'),
                self::field('popup_copy', 'Popup subheading', 'A focused admission summit for students and parents who want a clearer route to Europe and Dubai. Meet university representatives, compare intakes and get practical next-step advice from our specialists.', 'textarea', 'Homepage popup'),
                self::field('popup_event_date', 'Event date label', 'Coming soon · 2026', 'text', 'Homepage popup'),
                self::field('popup_event_location', 'Event location label', 'Europe & Dubai opportunities', 'text', 'Homepage popup'),
                self::field('popup_event_format', 'Event format label', 'Admission summit · Free registration', 'text', 'Homepage popup'),
                self::field('popup_event_highlights', 'Event highlights', 'Meet university representatives, explore courses and intakes, discover scholarship routes, and connect with admissions and visa experts.', 'textarea', 'Homepage popup'),
                self::field('popup_image', 'Popup image URL', 'assets/transglobe/events/global-uni-expo-2026.png', 'image', 'Homepage popup'),
                self::field('popup_image_alt', 'Popup image alt text', 'Global Uni Expo 2026 Europe and Dubai Admission Summit coming soon poster', 'text', 'Homepage popup'),
            ...
            self::page('blog', 'Blog', 'Study-abroad articles, admissions guidance and student planning resources', [
                self::field('hero_title', 'Hero title', 'Clearer answers for your global future.'),
                self::field('hero_copy', 'Hero description', 'Practical study-abroad guidance on destinations, admissions, scholarships, tests and student visas—written for Indian students and families.', 'textarea'),
                self::field('list_title', 'Article list title', 'Explore the latest articles', 'text', 'Article list'),
                self::field('list_copy', 'Article list description', 'Useful context for choosing your destination, preparing a strong application and moving forward with a clear plan.', 'textarea', 'Article list'),
            ]),
    ...
    public static function groups(): array
    {
        return [
            ...
            'blog' => ['label' => 'Blog', 'description' => 'Study-abroad articles and guidance resources'],
    ...
    public static function groupFor(string $pageKey): string
    {
        return match (true) {
            ...
            str_starts_with($pageKey, 'blog.') || $pageKey === 'blog' => 'blog',
